...
extern void MOVE_TO_MOVE(_iq17 distance, _iq17 decel_distance, _iq17 target_velocity, _iq17 decel_velocity, _iq15 accel);
extern void MOVE_TO_END(_iq17 distance, _iq15 R_accel, _iq15 L_accel);
