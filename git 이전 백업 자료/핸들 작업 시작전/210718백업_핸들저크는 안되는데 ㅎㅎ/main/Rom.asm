...
DW$16	.dwtag  DW_TAG_variable, DW_AT_name("ACCEL_COEF_U32"), DW_AT_symbol_name("_ACCEL_COEF_U32")
...
DW$20	.dwtag  DW_TAG_variable, DW_AT_name("DECEL_COEF_U32"), DW_AT_symbol_name("_DECEL_COEF_U32")
	.dwattr DW$20, DW_AT_type(*DW$T$28)
	.dwattr DW$20, DW_AT_declaration(0x01)
	.dwattr DW$20, DW_AT_external(0x01)
DW$21	.dwtag  DW_TAG_variable, DW_AT_name("MOTOR_ACCEL_U32"), DW_AT_symbol_name("_MOTOR_ACCEL_U32")
...
DW$23	.dwtag  DW_TAG_variable, DW_AT_name("LONG_ACCEL_U32"), DW_AT_symbol_name("_LONG_ACCEL_U32")
...
DW$25	.dwtag  DW_TAG_variable, DW_AT_name("MIDDLE_ACCEL_U32"), DW_AT_symbol_name("_MIDDLE_ACCEL_U32")
...
DW$76	.dwtag  DW_TAG_loop
	.dwattr DW$76, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Rom.asm:L2:1:1626478202")
...
DW$78	.dwtag  DW_TAG_loop
	.dwattr DW$78, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Rom.asm:L1:1:1626478202")
...
;*** 311	-----------------------    save_rom[8] = ACCEL_COEF_U32&0xffuL;
;*** 312	-----------------------    save_rom[9] = (unsigned)ACCEL_COEF_U32>>8;
;*** 314	-----------------------    save_rom[10] = DECEL_COEF_U32&0xffuL;
;*** 315	-----------------------    save_rom[11] = (unsigned)DECEL_COEF_U32>>8;
...
DW$81	.dwtag  DW_TAG_variable, DW_AT_name("save_rom"), DW_AT_symbol_name("_save_rom")
	...
	.dwpsn	"Rom.c",311,2
        ...
        MOVB      AL.LSB,@_ACCEL_COEF_U32 ; |311| 
        MOV       *-SP[4],AL            ; |311| 
	.dwpsn	"Rom.c",312,2
        MOV       AL,@_ACCEL_COEF_U32   ; |312| 
        LSR       AL,8                  ; |312| 
        MOV       *-SP[3],AL            ; |312| 
	.dwpsn	"Rom.c",314,2
        MOVW      DP,#_DECEL_COEF_U32
        MOVB      AL.LSB,@_DECEL_COEF_U32 ; |314| 
        MOV       *-SP[2],AL            ; |314| 
	.dwpsn	"Rom.c",315,2
        MOV       AL,@_DECEL_COEF_U32   ; |315| 
        LSR       AL,8                  ; |315| 
        MOV       *-SP[1],AL            ; |315| 
	.dwpsn	"Rom.c",317,2
        MOVZ      AR4,SP                ; |317| 
...
DW$96	.dwtag  DW_TAG_variable, DW_AT_name("U$38"), DW_AT_symbol_name("U$38")
	.dwattr DW$96, DW_AT_type(*DW$T$76)
...
DW$111	.dwtag  DW_TAG_loop
	.dwattr DW$111, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Rom.asm:L4:1:1626478202")
...
DW$113	.dwtag  DW_TAG_loop
	.dwattr DW$113, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Rom.asm:L3:1:1626478202")
...
;*** 341	-----------------------    ACCEL_COEF_U32 = load_rom[9]<<8|(unsigned long)(load_rom[8]&0xffu);
;*** 344	-----------------------    DECEL_COEF_U32 = load_rom[11]<<8|(unsigned long)(load_rom[10]&0xffu);
;*** 344	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
