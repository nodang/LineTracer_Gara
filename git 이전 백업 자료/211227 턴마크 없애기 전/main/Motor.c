...
{
	pM->PrdNext_IQ14 	= _IQ7(MOTOR_PERIOD_MAXIMUM);
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
	...
	if(_IQ17abs(pM->NextVelocity_IQ17 - pM->TargetVel_IQ17) < _IQ16abs(_IQ16mpy(_IQ16div(pM->NextAccel_IQ16, pM->Jerk_IQ16), _IQ16div(pM->NextAccel_IQ16, _IQ16(TEN_THOUSAND)))))
	{
		if(pM->NextVelocity_IQ17 < pM->TargetVel_IQ17)		
		{
			pM->NextAccel_IQ16 -= _IQ1(_IQ16mpy(_IQ16abs(pM->Jerk_IQ16), CPUTIMER_2_PRDdiv10000_IQ16));
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
	...
	pM->PrdNext_IQ14 = _IQ7mpyIQX(_IQ13(TEN_THOUSAND), 13, pM->PrdNextTranSecon_IQ17, 17);

	pM->RolEachStep_IQ17	= _IQ17mpyIQX(STEP_D_IQ17, 17, _IQ7div(_IQ7(CPUTIMER_2_RPD), pM->PrdNext_IQ14), 7);
...
interrupt void MOTOR_PULSE_ISR()
{
	...
	if(Flag.Motor_U16 == ON)
	{
		...
		{	
			RMotor.Period_U32 = (_IQ7div(RMotor.PrdNext_IQ14, _IQ7(1000.0)) >> 7);
		...
		{
			LMotor.Period_U32 = (_IQ7div(LMotor.PrdNext_IQ14, _IQ7(1000.0)) >> 7);
...
void START_END_LINE()
{
	...
	{	
		...
		else if(Flag.Extrem_U16)	LINE_THIRD(&Search[SECOND_MARK_U16_CNT]);
	}
...
{	
	...
	while(1)
	{
		...
		{	
			...
			while((LINE_OUT_U16 < LINE_OUT) && (STOP_TIME_INDEX_U32 < (400)))		POSITION_COMPUTE(&SenAdc);
...
void VEL_COMPUTE(volatile _iq17 dist, volatile _iq17 minus_dist, volatile _iq17 cur_vel, volatile _iq16 jerk, volatile _iq17 *vel)
{
	...
	*vel 			= _IQ17mpy(cur_vel + CES3 + _IQ17mpy(_IQ17mpy(_IQ17div(_IQ17(4.0), _IQ17(9.0)), cur_vel), _IQ17div(cur_vel, CES3) - _IQ17(3.0)), _IQ17(1000.0));
	...
	else if(*vel < _IQ17(MOTOR_SPEED_U32))		*vel = _IQ17(MOTOR_SPEED_U32);
}
...
void LINE_DIVISION(TRACKINFO *LINE, Uint16 cnt)
{
	...
	{	
		...
		{	
			...
			else	{		LINE->Velo_IQ17 = LINE->VeloOut_IQ17 = LINE->VeloIn_IQ17 = _IQ17(MOTOR_SPEED_U32);		LINE->Jerk_IQ16 = _IQ16(JERK_U32);		}
		}
		else	{		LINE->Velo_IQ17 = LINE->VeloOut_IQ17 = LINE->VeloIn_IQ17 = _IQ17(MOTOR_SPEED_U32);		LINE->Jerk_IQ16 = _IQ16(JERK_U32);		}
	}
}
...
void STRAIGHT_DIVISION(TRACKINFO *LINE, Uint16 cnt)
{
	...
	{
		LINE->VeloOut_IQ17 = _IQ17(END_SPEED_U32);			
		(LINE + 1)->VeloIn_IQ17 = _IQ17(0.0); 								// If it's End Turnmark, Next enter-velocity and escape-velocity is Zero
	}
	if((LINE - 1)->TurnDir_U32 & (TURN_R_45 | TURN_R_55))	LINE->Jerk_IQ16 = _IQ16(JERK_U32);
	else if(LINE->Distance_U32 > LONG_DIST)					LINE->Jerk_IQ16 = _IQ16(JERK_LONG_U32);
	...
	if(LINE->MotorDistance_IQ17 >= _IQ17(LINE->Distance_U32))													// If compute-distance is more than total-track-distance
	{
		...
		VEL_COMPUTE(_IQ17(LINE->Distance_U32), LINE->MotorDistance_IQ17, low_vel, LINE->Jerk_IQ16, &LINE->Velo_IQ17);
	...
	{
		VEL_COMPUTE(_IQ17(LINE->Distance_U32), _IQ17(0.0), high_vel, LINE->Jerk_IQ16, &LINE->Velo_IQ17);
...
void TURN_DIVISION(TRACKINFO *LINE, Uint16 cnt)
{
	...
	LINE->VeloIn_IQ17 = LINE->VeloOut_IQ17 = _IQ17(MOTOR_SPEED_U32);	LINE->Jerk_IQ16 = _IQ16(JERK_U32);
