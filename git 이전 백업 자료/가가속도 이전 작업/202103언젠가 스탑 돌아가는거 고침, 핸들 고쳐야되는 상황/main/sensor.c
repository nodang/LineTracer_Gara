...
void HANDLE(Uint32 speed)
{
	...
	//TxPrintf("%lf\n", _IQ15toF(SenAdc.Theta_IQ15));
	//TxPrintf("%lf %lf\n", _IQ15toF(LMotor.CurveDist_IQ15), _IQ15toF(RMotor.CurveDist_IQ15));

	//TxPrintf("%lf,%ld,%ld,%lf,%lf\n",_IQ15toF(SenAdc.Theta_IQ15), LMotor.HandleVelo_IQ17 >> 17, RMotor.HandleVelo_IQ17 >> 17, _IQ15toF(LMotor.CurveDist_IQ15) ,_IQ15toF(RMotor.CurveDist_IQ15));

	//TxPrintf("%ld\n", SenAdc.PositionTemporary_IQ10 >> 10);
	//TxPrintf("%lf\n", _IQ15toF(SenAdc.Theta_IQ15)*180/PI);
}
