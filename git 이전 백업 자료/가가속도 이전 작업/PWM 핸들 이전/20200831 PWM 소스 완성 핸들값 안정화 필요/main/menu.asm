...
DW$29	.dwtag  DW_TAG_variable, DW_AT_name("HandleAccel_IQ28"), DW_AT_symbol_name("_HandleAccel_IQ28")
	.dwattr DW$29, DW_AT_type(*DW$T$76)
	.dwattr DW$29, DW_AT_declaration(0x01)
	.dwattr DW$29, DW_AT_external(0x01)

DW$30	.dwtag  DW_TAG_subprogram, DW_AT_name("_IQ28toF"), DW_AT_symbol_name("__IQ28toF")
...
DW$46	.dwtag  DW_TAG_subprogram, DW_AT_name("MENU_RUN"), DW_AT_symbol_name("_MENU_RUN")
	...
	.dwattr DW$46, DW_AT_begin_line(0x15f)
...
_MENU_RUN:
;*** 353	-----------------------    m_run_cnt = 0u;
;*** 355	-----------------------    if ( !(*(&GpioDataRegs+1)&0x8000u) ) goto g14;
...
DW$47	.dwtag  DW_TAG_variable, DW_AT_name("m_run_cnt"), DW_AT_symbol_name("_m_run_cnt")
	...
	.dwpsn	"menu.c",355,2
        ...
        TBIT      @_GpioDataRegs+1,#15  ; |355| 
        BF        L12,NTC               ; |355| 
        ; branchcc occurs ; |355| 
L5:    
DW$L$_MENU_RUN$2$B:
;***	-----------------------g3:
;*** 357	-----------------------    switch ( m_run_cnt ) {case 0u: goto g9;, case 1u: goto g6;, case 2u: goto g4;, DEFAULT goto g13};
	.dwpsn	"menu.c",357,3
        MOV       AL,*-SP[3]            ; |357| 
        BF        L8,EQ                 ; |357| 
        ; branchcc occurs ; |357| 
...
DW$L$_MENU_RUN$5$B:
;***	-----------------------g4:
;*** 370	-----------------------    VFDPrintf("mapCHECK");
;*** 371	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g13;
	.dwpsn	"menu.c",370,4
        MOVL      XAR4,#FSL1            ; |370| 
        MOVL      *-SP[2],XAR4          ; |370| 
        LCR       #_VFDPrintf           ; |370| 
...
;*** 371	-----------------------    goto g13;
	...
	.dwpsn	"menu.c",371,36
        MOVW      DP,#_Flag+2
        OR        @_Flag+2,#0x0004      ; |371| 
	.dwpsn	"menu.c",371,58
        LCR       #_LINE_PRINTF         ; |371| 
        ; call occurs [#_LINE_PRINTF] ; |371| 
        BF        L11,UNC               ; |371| 
        ; branch occurs ; |371| 
DW$L$_MENU_RUN$6$E:
L6:    
DW$L$_MENU_RUN$7$B:
;***	-----------------------g6:
;*** 365	-----------------------    VFDPrintf("2ND RACE");
;*** 366	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g13;
	.dwpsn	"menu.c",365,4
        MOVL      XAR4,#FSL2            ; |365| 
        MOVL      *-SP[2],XAR4          ; |365| 
        LCR       #_VFDPrintf           ; |365| 
...
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	...
	.dwpsn	"menu.c",366,36
        LCR       #_RUN_SECOND          ; |366| 
        ; call occurs [#_RUN_SECOND] ; |366| 
DW$L$_MENU_RUN$8$E:
L7:    
DW$L$_MENU_RUN$9$B:
;***	-----------------------g8:
;*** 366	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g8;
	.dwpsn	"menu.c",366,50
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#15  ; |366| 
        BF        L7,TC                 ; |366| 
        ; branchcc occurs ; |366| 
DW$L$_MENU_RUN$9$E:
DW$L$_MENU_RUN$10$B:
...
DW$L$_MENU_RUN$11$B:
;***	-----------------------g9:
;*** 360	-----------------------    VFDPrintf("SEARCH  ");
;*** 361	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g13;
	.dwpsn	"menu.c",360,4
        MOVL      XAR4,#FSL3            ; |360| 
        MOVL      *-SP[2],XAR4          ; |360| 
        LCR       #_VFDPrintf           ; |360| 
...
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	...
	.dwpsn	"menu.c",361,36
        LCR       #_RUN                 ; |361| 
        ; call occurs [#_RUN] ; |361| 
DW$L$_MENU_RUN$12$E:
L9:    
DW$L$_MENU_RUN$13$B:
;***	-----------------------g11:
;*** 361	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g11;
	.dwpsn	"menu.c",361,43
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#15  ; |361| 
        BF        L9,TC                 ; |361| 
        ; branchcc occurs ; |361| 
DW$L$_MENU_RUN$13$E:
L10:    
...
DW$L$_MENU_RUN$15$B:
;***	-----------------------g13:
;*** 376	-----------------------    MENU_SW(&m_run_cnt, 2u);
;*** 376	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g3;
	.dwpsn	"menu.c",376,3
        MOVZ      AR4,SP                ; |376| 
        MOVB      AL,#2                 ; |376| 
        SUBB      XAR4,#3               ; |376| 
        LCR       #_MENU_SW             ; |376| 
        ; call occurs [#_MENU_SW] ; |376| 
        MOVW      DP,#_GpioDataRegs+1
...
DW$48	.dwtag  DW_TAG_loop
	.dwattr DW$48, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L5:1:1598868380")
	.dwattr DW$48, DW_AT_begin_file("menu.c")
	.dwattr DW$48, DW_AT_begin_line(0x163)
	.dwattr DW$48, DW_AT_end_line(0x179)
...
DW$61	.dwtag  DW_TAG_loop
	.dwattr DW$61, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L7:2:1598868380")
	.dwattr DW$61, DW_AT_begin_file("menu.c")
	.dwattr DW$61, DW_AT_begin_line(0x16e)
	.dwattr DW$61, DW_AT_end_line(0x16e)
...
DW$63	.dwtag  DW_TAG_loop
	.dwattr DW$63, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L9:2:1598868380")
	.dwattr DW$63, DW_AT_begin_file("menu.c")
	.dwattr DW$63, DW_AT_begin_line(0x169)
	.dwattr DW$63, DW_AT_end_line(0x169)
DW$64	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$46, DW_AT_end_line(0x17b)
...
_MENU_MOTOR:
;*** 193	-----------------------    m_mtr_cnt = 0u;
;*** 196	-----------------------    if ( !(*(&GpioDataRegs+1)&0x8000u) ) goto g54;
;***  	-----------------------    #pragma LOOP_FLAGS(5120u)
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
;***	-----------------------g3:
;*** 198	-----------------------    switch ( m_mtr_cnt ) {case 0u: goto g29;, case 1u: goto g21;, case 2u: goto g4;, case 3u: goto g52;, DEFAULT goto g53};
	.dwpsn	"menu.c",198,3
        MOV       AL,*-SP[5]            ; |198| 
        BF        L28,EQ                ; |198| 
        ; branchcc occurs ; |198| 
...
;*** 268	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g53;
	.dwpsn	"menu.c",267,4
        MOVL      XAR4,#FSL4            ; |267| 
        MOVL      *-SP[2],XAR4          ; |267| 
        LCR       #_VFDPrintf           ; |267| 
...
;***	-----------------------g6:
;*** 274	-----------------------    switch ( m_sw_cnt ) {case 0u: goto g12;, case 1u: goto g7;, DEFAULT goto g17};
	.dwpsn	"menu.c",274,6
        MOV       AL,AR1                ; |274| 
        BF        L18,EQ                ; |274| 
        ; branchcc occurs ; |274| 
...
;***	-----------------------g7:
;*** 285	-----------------------    VFDPrintf("D%.7lf", _IQ28toF(HandleDecel_IQ28)*1000.0F);
;*** 286	-----------------------    if ( !(*&GpioDataRegs&0x4000u) ) goto g10;
	.dwpsn	"menu.c",285,7
        MOVW      DP,#_HandleDecel_IQ28
        MOVL      ACC,@_HandleDecel_IQ28 ; |285| 
        LCR       #__IQ28toF            ; |285| 
        ; call occurs [#__IQ28toF] ; |285| 
        MOVL      XAR6,ACC              ; |285| 
        MOV       AL,#0
        MOV       AH,#17530
        MOVL      *-SP[2],ACC           ; |285| 
...
;*** 286	-----------------------    ++HandleDec_U16_CNT;
	...
	.dwpsn	"menu.c",286,39
        MOVW      DP,#_HandleDec_U16_CNT
        INC       @_HandleDec_U16_CNT   ; |286| 
DW$L$_MENU_MOTOR$14$E:
L17:    
DW$L$_MENU_MOTOR$15$B:
;***	-----------------------g11:
;*** 289	-----------------------    HandleDecel_IQ28 = (long)((long double)(((float)HandleDec_U16_CNT-2000.0F)*9.99999997475242707878e-7F)*2.68435456e8L)+53687L;
;*** 291	-----------------------    goto g17;
	.dwpsn	"menu.c",289,7
        MOVW      DP,#_HandleDec_U16_CNT
        MOV       AL,@_HandleDec_U16_CNT ; |289| 
        LCR       #U$$TOFS              ; |289| 
        ; call occurs [#U$$TOFS] ; |289| 
        MOVL      XAR6,ACC              ; |289| 
        MOV       AL,#0
        MOV       AH,#17658
        MOVL      *-SP[2],ACC           ; |289| 
        ...
        MOVL      ACC,XAR6              ; |289| 
        LCR       #FS$$MPY              ; |289| 
        ; call occurs [#FS$$MPY] ; |289| 
        MOVZ      AR6,SP                ; |289| 
        SUBB      XAR6,#14              ; |289| 
        LCR       #FS$$TOFD             ; |289| 
        ; call occurs [#FS$$TOFD] ; |289| 
        MOVZ      AR6,SP                ; |289| 
        MOVZ      AR4,SP                ; |289| 
        SUBB      XAR6,#10              ; |289| 
        SUBB      XAR4,#14              ; |289| 
        ...
        ADDL      XAR4,ACC
        MOVW      DP,#_HandleDecel_IQ28
        MOVL      @_HandleDecel_IQ28,XAR4 ; |289| 
	.dwpsn	"menu.c",291,12
        BF        L21,UNC               ; |291| 
        ; branch occurs ; |291| 
...
;***	-----------------------g12:
;*** 277	-----------------------    VFDPrintf("A%.7lf", _IQ28toF(HandleAccel_IQ28)*10000.0F);
;*** 278	-----------------------    C$4 = &GpioDataRegs;
;*** 278	-----------------------    if ( !(*C$4&0x4000u) ) goto g15;
	.dwpsn	"menu.c",277,7
        MOVW      DP,#_HandleAccel_IQ28
        MOVL      ACC,@_HandleAccel_IQ28 ; |277| 
        LCR       #__IQ28toF            ; |277| 
        ; call occurs [#__IQ28toF] ; |277| 
        MOVL      XAR6,ACC              ; |277| 
        MOV       AL,#16384
        MOV       AH,#17948
        MOVL      *-SP[2],ACC           ; |277| 
...
;*** 278	-----------------------    ++HandleAcc_U16_CNT;
	...
	.dwpsn	"menu.c",278,39
        MOVW      DP,#_HandleAcc_U16_CNT
        INC       @_HandleAcc_U16_CNT   ; |278| 
DW$L$_MENU_MOTOR$19$E:
L20:    
DW$L$_MENU_MOTOR$20$B:
;***	-----------------------g16:
;*** 281	-----------------------    HandleAccel_IQ28 = (long)((long double)(((float)HandleAcc_U16_CNT-3000.0F)*1.00000001168609742308e-7F)*2.68435456e8L)+8053L;
	.dwpsn	"menu.c",281,7
        MOVW      DP,#_HandleAcc_U16_CNT
        MOV       AL,@_HandleAcc_U16_CNT ; |281| 
        LCR       #U$$TOFS              ; |281| 
        ; call occurs [#U$$TOFS] ; |281| 
        MOVL      XAR6,ACC              ; |281| 
        MOV       AL,#32768
        MOV       AH,#17723
        MOVL      *-SP[2],ACC           ; |281| 
        ...
        MOVL      ACC,XAR6              ; |281| 
        LCR       #FS$$MPY              ; |281| 
        ; call occurs [#FS$$MPY] ; |281| 
        MOVZ      AR6,SP                ; |281| 
        SUBB      XAR6,#14              ; |281| 
        LCR       #FS$$TOFD             ; |281| 
        ; call occurs [#FS$$TOFD] ; |281| 
        MOVZ      AR6,SP                ; |281| 
        MOVZ      AR4,SP                ; |281| 
        SUBB      XAR6,#10              ; |281| 
        SUBB      XAR4,#14              ; |281| 
        ...
        ADD       ACC,#8053 << 0        ; |281| 
        MOVW      DP,#_HandleAccel_IQ28
        MOVL      @_HandleAccel_IQ28,ACC ; |281| 
DW$L$_MENU_MOTOR$20$E:
L21:    
DW$L$_MENU_MOTOR$21$B:
;***	-----------------------g17:
;*** 293	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g19;
	.dwpsn	"menu.c",293,6
        MOVW      DP,#_GpioDataRegs
...
;*** 296	-----------------------    m_sw_cnt ? (m_sw_cnt = 0u) : (m_sw_cnt = m_sw_cnt+1u);
	.dwpsn	"menu.c",295,7
        MOV       AL,#9630
        MOV       AH,#38
...
;***	-----------------------g19:
;*** 300	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g6;
	.dwpsn	"menu.c",300,5
        MOVW      DP,#_GpioDataRegs+1
...
;*** 302	-----------------------    goto g53;
	.dwpsn	"menu.c",301,5
        LCR       #_save_handle_rom     ; |301| 
        ; call occurs [#_save_handle_rom] ; |301| 
	.dwpsn	"menu.c",302,5
        MOV       AL,#9630
        MOV       AH,#38
...
;***	-----------------------g21:
;*** 250	-----------------------    VFDPrintf("ACCEL   ");
;*** 251	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g53;
	.dwpsn	"menu.c",250,4
        MOVL      XAR4,#FSL7            ; |250| 
        MOVL      *-SP[2],XAR4          ; |250| 
        LCR       #_VFDPrintf           ; |250| 
...
;*** 257	-----------------------    if ( !(*&GpioDataRegs&0x4000u) ) goto g26;
	.dwpsn	"menu.c",256,6
	...
	.dwpsn	"menu.c",257,6
        MOVW      DP,#_GpioDataRegs
        TBIT      @_GpioDataRegs,#14    ; |257| 
        BF        L26,NTC               ; |257| 
        ; branchcc occurs ; |257| 
DW$L$_MENU_MOTOR$29$E:
DW$L$_MENU_MOTOR$30$B:
;*** 258	-----------------------    if ( *(&GpioDataRegs+1)&0x4000u ) goto g27;
	.dwpsn	"menu.c",258,11
        TBIT      @_GpioDataRegs+1,#14  ; |258| 
        BF        L27,TC                ; |258| 
        ; branchcc occurs ; |258| 
...
;***	-----------------------g27:
;*** 260	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g23;
	.dwpsn	"menu.c",260,5
        MOVW      DP,#_GpioDataRegs+1
...
;*** 202	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g53;
	.dwpsn	"menu.c",201,4
        MOVL      XAR4,#FSL9            ; |201| 
        MOVL      *-SP[2],XAR4          ; |201| 
        LCR       #_VFDPrintf           ; |201| 
...
;*** 230	-----------------------    if ( !(*&GpioDataRegs&0x4000u) ) goto g35;
	.dwpsn	"menu.c",229,7
...
;*** 231	-----------------------    if ( *(&GpioDataRegs+1)&0x4000u ) goto g48;
	.dwpsn	"menu.c",231,12
        TBIT      @_GpioDataRegs+1,#14  ; |231| 
        BF        L37,TC                ; |231| 
        ; branchcc occurs ; |231| 
...
;*** 218	-----------------------    C$2 = &GpioDataRegs;
;*** 218	-----------------------    if ( !(*C$2&0x4000u) ) goto g43;
	.dwpsn	"menu.c",217,7
...
;***	-----------------------g50:
;*** 242	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g31;
	.dwpsn	"menu.c",242,5
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#15  ; |242| 
        BF        L29,TC                ; |242| 
        ; branchcc occurs ; |242| 
...
;*** 308	-----------------------    *&GpioDataRegs;
	...
	.dwpsn	"menu.c",308,4
        MOVW      DP,#_GpioDataRegs
        MOV       AL,@_GpioDataRegs     ; |308| 
DW$L$_MENU_MOTOR$63$E:
L41:    
DW$L$_MENU_MOTOR$64$B:
;***	-----------------------g53:
;*** 346	-----------------------    MENU_SW(&m_mtr_cnt, 3u);
;*** 346	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g3;
	.dwpsn	"menu.c",346,3
        MOVZ      AR4,SP                ; |346| 
        MOVB      AL,#3                 ; |346| 
        SUBB      XAR4,#5               ; |346| 
        LCR       #_MENU_SW             ; |346| 
        ; call occurs [#_MENU_SW] ; |346| 
        MOVW      DP,#_GpioDataRegs+1
...
DW$73	.dwtag  DW_TAG_loop
	.dwattr DW$73, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L13:1:1598868380")
	.dwattr DW$73, DW_AT_begin_file("menu.c")
	.dwattr DW$73, DW_AT_begin_line(0xc4)
	.dwattr DW$73, DW_AT_end_line(0x15b)
DW$74	.dwtag  DW_TAG_loop_range
	.dwattr DW$74, DW_AT_low_pc(DW$L$_MENU_MOTOR$2$B)
	.dwattr DW$74, DW_AT_high_pc(DW$L$_MENU_MOTOR$2$E)
DW$75	.dwtag  DW_TAG_loop_range
	.dwattr DW$75, DW_AT_low_pc(DW$L$_MENU_MOTOR$36$B)
	.dwattr DW$75, DW_AT_high_pc(DW$L$_MENU_MOTOR$36$E)
DW$76	.dwtag  DW_TAG_loop_range
	.dwattr DW$76, DW_AT_low_pc(DW$L$_MENU_MOTOR$28$B)
	.dwattr DW$76, DW_AT_high_pc(DW$L$_MENU_MOTOR$28$E)
DW$77	.dwtag  DW_TAG_loop_range
	.dwattr DW$77, DW_AT_low_pc(DW$L$_MENU_MOTOR$8$B)
	.dwattr DW$77, DW_AT_high_pc(DW$L$_MENU_MOTOR$8$E)
...
DW$80	.dwtag  DW_TAG_loop_range
	.dwattr DW$80, DW_AT_low_pc(DW$L$_MENU_MOTOR$5$B)
	.dwattr DW$80, DW_AT_high_pc(DW$L$_MENU_MOTOR$5$E)
DW$81	.dwtag  DW_TAG_loop_range
	.dwattr DW$81, DW_AT_low_pc(DW$L$_MENU_MOTOR$6$B)
	.dwattr DW$81, DW_AT_high_pc(DW$L$_MENU_MOTOR$6$E)
DW$82	.dwtag  DW_TAG_loop_range
	.dwattr DW$82, DW_AT_low_pc(DW$L$_MENU_MOTOR$7$B)
	.dwattr DW$82, DW_AT_high_pc(DW$L$_MENU_MOTOR$7$E)
DW$83	.dwtag  DW_TAG_loop_range
	.dwattr DW$83, DW_AT_low_pc(DW$L$_MENU_MOTOR$26$B)
	.dwattr DW$83, DW_AT_high_pc(DW$L$_MENU_MOTOR$26$E)
DW$84	.dwtag  DW_TAG_loop_range
	.dwattr DW$84, DW_AT_low_pc(DW$L$_MENU_MOTOR$27$B)
	.dwattr DW$84, DW_AT_high_pc(DW$L$_MENU_MOTOR$27$E)
DW$85	.dwtag  DW_TAG_loop_range
	.dwattr DW$85, DW_AT_low_pc(DW$L$_MENU_MOTOR$34$B)
	.dwattr DW$85, DW_AT_high_pc(DW$L$_MENU_MOTOR$34$E)
DW$86	.dwtag  DW_TAG_loop_range
	.dwattr DW$86, DW_AT_low_pc(DW$L$_MENU_MOTOR$35$B)
	.dwattr DW$86, DW_AT_high_pc(DW$L$_MENU_MOTOR$35$E)
DW$87	.dwtag  DW_TAG_loop_range
	.dwattr DW$87, DW_AT_low_pc(DW$L$_MENU_MOTOR$62$B)
	.dwattr DW$87, DW_AT_high_pc(DW$L$_MENU_MOTOR$62$E)
DW$88	.dwtag  DW_TAG_loop_range
	.dwattr DW$88, DW_AT_low_pc(DW$L$_MENU_MOTOR$63$B)
	.dwattr DW$88, DW_AT_high_pc(DW$L$_MENU_MOTOR$63$E)
DW$89	.dwtag  DW_TAG_loop_range
	.dwattr DW$89, DW_AT_low_pc(DW$L$_MENU_MOTOR$64$B)
	.dwattr DW$89, DW_AT_high_pc(DW$L$_MENU_MOTOR$64$E)

DW$90	.dwtag  DW_TAG_loop
	.dwattr DW$90, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L39:2:1598868380")
	.dwattr DW$90, DW_AT_begin_file("menu.c")
	.dwattr DW$90, DW_AT_begin_line(0xce)
	.dwattr DW$90, DW_AT_end_line(0xf2)
DW$91	.dwtag  DW_TAG_loop_range
	.dwattr DW$91, DW_AT_low_pc(DW$L$_MENU_MOTOR$61$B)
	.dwattr DW$91, DW_AT_high_pc(DW$L$_MENU_MOTOR$61$E)
DW$92	.dwtag  DW_TAG_loop_range
	.dwattr DW$92, DW_AT_low_pc(DW$L$_MENU_MOTOR$58$B)
	.dwattr DW$92, DW_AT_high_pc(DW$L$_MENU_MOTOR$58$E)
DW$93	.dwtag  DW_TAG_loop_range
	.dwattr DW$93, DW_AT_low_pc(DW$L$_MENU_MOTOR$53$B)
	.dwattr DW$93, DW_AT_high_pc(DW$L$_MENU_MOTOR$53$E)
DW$94	.dwtag  DW_TAG_loop_range
	.dwattr DW$94, DW_AT_low_pc(DW$L$_MENU_MOTOR$49$B)
	.dwattr DW$94, DW_AT_high_pc(DW$L$_MENU_MOTOR$49$E)
DW$95	.dwtag  DW_TAG_loop_range
	.dwattr DW$95, DW_AT_low_pc(DW$L$_MENU_MOTOR$45$B)
	.dwattr DW$95, DW_AT_high_pc(DW$L$_MENU_MOTOR$45$E)
DW$96	.dwtag  DW_TAG_loop_range
	.dwattr DW$96, DW_AT_low_pc(DW$L$_MENU_MOTOR$41$B)
	.dwattr DW$96, DW_AT_high_pc(DW$L$_MENU_MOTOR$41$E)
...
DW$99	.dwtag  DW_TAG_loop_range
	.dwattr DW$99, DW_AT_low_pc(DW$L$_MENU_MOTOR$39$B)
	.dwattr DW$99, DW_AT_high_pc(DW$L$_MENU_MOTOR$39$E)
...
DW$102	.dwtag  DW_TAG_loop_range
	.dwattr DW$102, DW_AT_low_pc(DW$L$_MENU_MOTOR$43$B)
	.dwattr DW$102, DW_AT_high_pc(DW$L$_MENU_MOTOR$43$E)
...
DW$105	.dwtag  DW_TAG_loop_range
	.dwattr DW$105, DW_AT_low_pc(DW$L$_MENU_MOTOR$47$B)
	.dwattr DW$105, DW_AT_high_pc(DW$L$_MENU_MOTOR$47$E)
...
DW$108	.dwtag  DW_TAG_loop_range
	.dwattr DW$108, DW_AT_low_pc(DW$L$_MENU_MOTOR$51$B)
	.dwattr DW$108, DW_AT_high_pc(DW$L$_MENU_MOTOR$51$E)
DW$109	.dwtag  DW_TAG_loop_range
	.dwattr DW$109, DW_AT_low_pc(DW$L$_MENU_MOTOR$52$B)
	.dwattr DW$109, DW_AT_high_pc(DW$L$_MENU_MOTOR$52$E)
DW$110	.dwtag  DW_TAG_loop_range
	.dwattr DW$110, DW_AT_low_pc(DW$L$_MENU_MOTOR$54$B)
	.dwattr DW$110, DW_AT_high_pc(DW$L$_MENU_MOTOR$54$E)
DW$111	.dwtag  DW_TAG_loop_range
	.dwattr DW$111, DW_AT_low_pc(DW$L$_MENU_MOTOR$55$B)
	.dwattr DW$111, DW_AT_high_pc(DW$L$_MENU_MOTOR$55$E)
DW$112	.dwtag  DW_TAG_loop_range
	.dwattr DW$112, DW_AT_low_pc(DW$L$_MENU_MOTOR$56$B)
	.dwattr DW$112, DW_AT_high_pc(DW$L$_MENU_MOTOR$56$E)
DW$113	.dwtag  DW_TAG_loop_range
	.dwattr DW$113, DW_AT_low_pc(DW$L$_MENU_MOTOR$60$B)
	.dwattr DW$113, DW_AT_high_pc(DW$L$_MENU_MOTOR$60$E)
DW$114	.dwtag  DW_TAG_loop_range
	.dwattr DW$114, DW_AT_low_pc(DW$L$_MENU_MOTOR$59$B)
	.dwattr DW$114, DW_AT_high_pc(DW$L$_MENU_MOTOR$59$E)
DW$115	.dwtag  DW_TAG_loop_range
	.dwattr DW$115, DW_AT_low_pc(DW$L$_MENU_MOTOR$57$B)
	.dwattr DW$115, DW_AT_high_pc(DW$L$_MENU_MOTOR$57$E)
	.dwendtag DW$90


DW$116	.dwtag  DW_TAG_loop
	.dwattr DW$116, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L27:2:1598868380")
	.dwattr DW$116, DW_AT_begin_file("menu.c")
	.dwattr DW$116, DW_AT_begin_line(0xfe)
	.dwattr DW$116, DW_AT_end_line(0x104)
DW$117	.dwtag  DW_TAG_loop_range
	.dwattr DW$117, DW_AT_low_pc(DW$L$_MENU_MOTOR$33$B)
	.dwattr DW$117, DW_AT_high_pc(DW$L$_MENU_MOTOR$33$E)
DW$118	.dwtag  DW_TAG_loop_range
	.dwattr DW$118, DW_AT_low_pc(DW$L$_MENU_MOTOR$29$B)
	.dwattr DW$118, DW_AT_high_pc(DW$L$_MENU_MOTOR$29$E)
DW$119	.dwtag  DW_TAG_loop_range
	.dwattr DW$119, DW_AT_low_pc(DW$L$_MENU_MOTOR$32$B)
	.dwattr DW$119, DW_AT_high_pc(DW$L$_MENU_MOTOR$32$E)
DW$120	.dwtag  DW_TAG_loop_range
	.dwattr DW$120, DW_AT_low_pc(DW$L$_MENU_MOTOR$31$B)
	.dwattr DW$120, DW_AT_high_pc(DW$L$_MENU_MOTOR$31$E)
DW$121	.dwtag  DW_TAG_loop_range
	.dwattr DW$121, DW_AT_low_pc(DW$L$_MENU_MOTOR$30$B)
	.dwattr DW$121, DW_AT_high_pc(DW$L$_MENU_MOTOR$30$E)
	.dwendtag DW$116


DW$122	.dwtag  DW_TAG_loop
	.dwattr DW$122, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L23:2:1598868380")
	.dwattr DW$122, DW_AT_begin_file("menu.c")
	.dwattr DW$122, DW_AT_begin_line(0x110)
	.dwattr DW$122, DW_AT_end_line(0x12c)
DW$123	.dwtag  DW_TAG_loop_range
	.dwattr DW$123, DW_AT_low_pc(DW$L$_MENU_MOTOR$25$B)
	.dwattr DW$123, DW_AT_high_pc(DW$L$_MENU_MOTOR$25$E)
DW$124	.dwtag  DW_TAG_loop_range
	.dwattr DW$124, DW_AT_low_pc(DW$L$_MENU_MOTOR$22$B)
	.dwattr DW$124, DW_AT_high_pc(DW$L$_MENU_MOTOR$22$E)
...
DW$127	.dwtag  DW_TAG_loop_range
	.dwattr DW$127, DW_AT_low_pc(DW$L$_MENU_MOTOR$18$B)
	.dwattr DW$127, DW_AT_high_pc(DW$L$_MENU_MOTOR$18$E)
DW$128	.dwtag  DW_TAG_loop_range
	.dwattr DW$128, DW_AT_low_pc(DW$L$_MENU_MOTOR$19$B)
	.dwattr DW$128, DW_AT_high_pc(DW$L$_MENU_MOTOR$19$E)
...
DW$132	.dwtag  DW_TAG_loop_range
	.dwattr DW$132, DW_AT_low_pc(DW$L$_MENU_MOTOR$14$B)
	.dwattr DW$132, DW_AT_high_pc(DW$L$_MENU_MOTOR$14$E)
DW$133	.dwtag  DW_TAG_loop_range
	.dwattr DW$133, DW_AT_low_pc(DW$L$_MENU_MOTOR$9$B)
	.dwattr DW$133, DW_AT_high_pc(DW$L$_MENU_MOTOR$9$E)
DW$134	.dwtag  DW_TAG_loop_range
	.dwattr DW$134, DW_AT_low_pc(DW$L$_MENU_MOTOR$10$B)
	.dwattr DW$134, DW_AT_high_pc(DW$L$_MENU_MOTOR$10$E)
DW$135	.dwtag  DW_TAG_loop_range
	.dwattr DW$135, DW_AT_low_pc(DW$L$_MENU_MOTOR$15$B)
	.dwattr DW$135, DW_AT_high_pc(DW$L$_MENU_MOTOR$15$E)
DW$136	.dwtag  DW_TAG_loop_range
	.dwattr DW$136, DW_AT_low_pc(DW$L$_MENU_MOTOR$20$B)
	.dwattr DW$136, DW_AT_high_pc(DW$L$_MENU_MOTOR$20$E)
DW$137	.dwtag  DW_TAG_loop_range
	.dwattr DW$137, DW_AT_low_pc(DW$L$_MENU_MOTOR$24$B)
	.dwattr DW$137, DW_AT_high_pc(DW$L$_MENU_MOTOR$24$E)
DW$138	.dwtag  DW_TAG_loop_range
	.dwattr DW$138, DW_AT_low_pc(DW$L$_MENU_MOTOR$23$B)
	.dwattr DW$138, DW_AT_high_pc(DW$L$_MENU_MOTOR$23$E)
DW$139	.dwtag  DW_TAG_loop_range
	.dwattr DW$139, DW_AT_low_pc(DW$L$_MENU_MOTOR$21$B)
	.dwattr DW$139, DW_AT_high_pc(DW$L$_MENU_MOTOR$21$E)
	.dwendtag DW$122

	.dwendtag DW$73

	.dwattr DW$65, DW_AT_end_file("menu.c")
	.dwattr DW$65, DW_AT_end_line(0x15d)
...
DW$140	.dwtag  DW_TAG_subprogram, DW_AT_name("MENU_SENSOR"), DW_AT_symbol_name("_MENU_SENSOR")
	...
	.dwattr DW$140, DW_AT_begin_line(0x43)
...
DW$145	.dwtag  DW_TAG_variable, DW_AT_name("K$6"), DW_AT_symbol_name("K$6")
	.dwattr DW$145, DW_AT_type(*DW$T$69)
	.dwattr DW$145, DW_AT_location[DW_OP_breg20 -12]
;* AR2   assigned to K$58
DW$146	.dwtag  DW_TAG_variable, DW_AT_name("K$58"), DW_AT_symbol_name("K$58")
	.dwattr DW$146, DW_AT_type(*DW$T$55)
	.dwattr DW$146, DW_AT_location[DW_OP_reg8]
;* AR1   assigned to K$60
DW$147	.dwtag  DW_TAG_variable, DW_AT_name("K$60"), DW_AT_symbol_name("K$60")
	.dwattr DW$147, DW_AT_type(*DW$T$55)
...
DW$155	.dwtag  DW_TAG_variable, DW_AT_name("count"), DW_AT_symbol_name("_count")
	.dwattr DW$155, DW_AT_type(*DW$T$21)
...
DW$156	.dwtag  DW_TAG_loop
	.dwattr DW$156, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L45:1:1598868380")
	.dwattr DW$156, DW_AT_begin_file("menu.c")
	.dwattr DW$156, DW_AT_begin_line(0x52)
	.dwattr DW$156, DW_AT_end_line(0xba)
...
DW$159	.dwtag  DW_TAG_loop_range
	.dwattr DW$159, DW_AT_low_pc(DW$L$_MENU_SENSOR$23$B)
	.dwattr DW$159, DW_AT_high_pc(DW$L$_MENU_SENSOR$23$E)
DW$160	.dwtag  DW_TAG_loop_range
	.dwattr DW$160, DW_AT_low_pc(DW$L$_MENU_SENSOR$27$B)
	.dwattr DW$160, DW_AT_high_pc(DW$L$_MENU_SENSOR$27$E)
DW$161	.dwtag  DW_TAG_loop_range
	.dwattr DW$161, DW_AT_low_pc(DW$L$_MENU_SENSOR$29$B)
	.dwattr DW$161, DW_AT_high_pc(DW$L$_MENU_SENSOR$29$E)
DW$162	.dwtag  DW_TAG_loop_range
	.dwattr DW$162, DW_AT_low_pc(DW$L$_MENU_SENSOR$31$B)
	.dwattr DW$162, DW_AT_high_pc(DW$L$_MENU_SENSOR$31$E)
DW$163	.dwtag  DW_TAG_loop_range
	.dwattr DW$163, DW_AT_low_pc(DW$L$_MENU_SENSOR$33$B)
	.dwattr DW$163, DW_AT_high_pc(DW$L$_MENU_SENSOR$33$E)
DW$164	.dwtag  DW_TAG_loop_range
	.dwattr DW$164, DW_AT_low_pc(DW$L$_MENU_SENSOR$15$B)
	.dwattr DW$164, DW_AT_high_pc(DW$L$_MENU_SENSOR$15$E)
DW$165	.dwtag  DW_TAG_loop_range
	.dwattr DW$165, DW_AT_low_pc(DW$L$_MENU_SENSOR$12$B)
	.dwattr DW$165, DW_AT_high_pc(DW$L$_MENU_SENSOR$12$E)
DW$166	.dwtag  DW_TAG_loop_range
	.dwattr DW$166, DW_AT_low_pc(DW$L$_MENU_SENSOR$8$B)
	.dwattr DW$166, DW_AT_high_pc(DW$L$_MENU_SENSOR$8$E)
DW$167	.dwtag  DW_TAG_loop_range
	.dwattr DW$167, DW_AT_low_pc(DW$L$_MENU_SENSOR$9$B)
	.dwattr DW$167, DW_AT_high_pc(DW$L$_MENU_SENSOR$9$E)
DW$168	.dwtag  DW_TAG_loop_range
	.dwattr DW$168, DW_AT_low_pc(DW$L$_MENU_SENSOR$10$B)
	.dwattr DW$168, DW_AT_high_pc(DW$L$_MENU_SENSOR$10$E)
DW$169	.dwtag  DW_TAG_loop_range
	.dwattr DW$169, DW_AT_low_pc(DW$L$_MENU_SENSOR$11$B)
	.dwattr DW$169, DW_AT_high_pc(DW$L$_MENU_SENSOR$11$E)
DW$170	.dwtag  DW_TAG_loop_range
	.dwattr DW$170, DW_AT_low_pc(DW$L$_MENU_SENSOR$13$B)
	.dwattr DW$170, DW_AT_high_pc(DW$L$_MENU_SENSOR$13$E)
DW$171	.dwtag  DW_TAG_loop_range
	.dwattr DW$171, DW_AT_low_pc(DW$L$_MENU_SENSOR$14$B)
	.dwattr DW$171, DW_AT_high_pc(DW$L$_MENU_SENSOR$14$E)
DW$172	.dwtag  DW_TAG_loop_range
	.dwattr DW$172, DW_AT_low_pc(DW$L$_MENU_SENSOR$21$B)
	.dwattr DW$172, DW_AT_high_pc(DW$L$_MENU_SENSOR$21$E)
DW$173	.dwtag  DW_TAG_loop_range
	.dwattr DW$173, DW_AT_low_pc(DW$L$_MENU_SENSOR$22$B)
	.dwattr DW$173, DW_AT_high_pc(DW$L$_MENU_SENSOR$22$E)
DW$174	.dwtag  DW_TAG_loop_range
	.dwattr DW$174, DW_AT_low_pc(DW$L$_MENU_SENSOR$28$B)
	.dwattr DW$174, DW_AT_high_pc(DW$L$_MENU_SENSOR$28$E)
...
DW$180	.dwtag  DW_TAG_loop
	.dwattr DW$180, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L54:2:1598868380")
	.dwattr DW$180, DW_AT_begin_file("menu.c")
	.dwattr DW$180, DW_AT_begin_line(0x78)
	.dwattr DW$180, DW_AT_end_line(0x78)
DW$181	.dwtag  DW_TAG_loop_range
	.dwattr DW$181, DW_AT_low_pc(DW$L$_MENU_SENSOR$30$B)
	.dwattr DW$181, DW_AT_high_pc(DW$L$_MENU_SENSOR$30$E)
	.dwendtag DW$180


DW$182	.dwtag  DW_TAG_loop
	.dwattr DW$182, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L51:2:1598868380")
	.dwattr DW$182, DW_AT_begin_file("menu.c")
	.dwattr DW$182, DW_AT_begin_line(0x86)
	.dwattr DW$182, DW_AT_end_line(0x8c)
DW$183	.dwtag  DW_TAG_loop_range
	.dwattr DW$183, DW_AT_low_pc(DW$L$_MENU_SENSOR$24$B)
	.dwattr DW$183, DW_AT_high_pc(DW$L$_MENU_SENSOR$24$E)
DW$184	.dwtag  DW_TAG_loop_range
	.dwattr DW$184, DW_AT_low_pc(DW$L$_MENU_SENSOR$26$B)
	.dwattr DW$184, DW_AT_high_pc(DW$L$_MENU_SENSOR$26$E)

DW$185	.dwtag  DW_TAG_loop
	.dwattr DW$185, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L52:3:1598868380")
	.dwattr DW$185, DW_AT_begin_file("menu.c")
	.dwattr DW$185, DW_AT_begin_line(0x88)
	.dwattr DW$185, DW_AT_end_line(0x88)
DW$186	.dwtag  DW_TAG_loop_range
	.dwattr DW$186, DW_AT_low_pc(DW$L$_MENU_SENSOR$25$B)
	.dwattr DW$186, DW_AT_high_pc(DW$L$_MENU_SENSOR$25$E)
	.dwendtag DW$185
...
DW$187	.dwtag  DW_TAG_loop
	.dwattr DW$187, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L56:2:1598868380")
	.dwattr DW$187, DW_AT_begin_file("menu.c")
	.dwattr DW$187, DW_AT_begin_line(0x61)
	.dwattr DW$187, DW_AT_end_line(0x6b)
DW$188	.dwtag  DW_TAG_loop_range
	.dwattr DW$188, DW_AT_low_pc(DW$L$_MENU_SENSOR$35$B)
	.dwattr DW$188, DW_AT_high_pc(DW$L$_MENU_SENSOR$35$E)
DW$189	.dwtag  DW_TAG_loop_range
	.dwattr DW$189, DW_AT_low_pc(DW$L$_MENU_SENSOR$37$B)
	.dwattr DW$189, DW_AT_high_pc(DW$L$_MENU_SENSOR$37$E)

DW$190	.dwtag  DW_TAG_loop
	.dwattr DW$190, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L57:3:1598868380")
	.dwattr DW$190, DW_AT_begin_file("menu.c")
	.dwattr DW$190, DW_AT_begin_line(0x63)
	.dwattr DW$190, DW_AT_end_line(0x63)
...
DW$192	.dwtag  DW_TAG_loop
	.dwattr DW$192, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L49:2:1598868380")
	.dwattr DW$192, DW_AT_begin_file("menu.c")
	.dwattr DW$192, DW_AT_begin_line(0x99)
	.dwattr DW$192, DW_AT_end_line(0xb1)
...
DW$198	.dwtag  DW_TAG_loop
	.dwattr DW$198, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L44:1:1598868380")
	.dwattr DW$198, DW_AT_begin_file("menu.c")
	.dwattr DW$198, DW_AT_begin_line(0x4e)
	.dwattr DW$198, DW_AT_end_line(0x4e)
...
DW$200	.dwtag  DW_TAG_loop
	.dwattr DW$200, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L43:1:1598868380")
	.dwattr DW$200, DW_AT_begin_file("menu.c")
	.dwattr DW$200, DW_AT_begin_line(0x4b)
	.dwattr DW$200, DW_AT_end_line(0x4b)
DW$201	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$140, DW_AT_end_line(0xbd)
...
DW$203	.dwtag  DW_TAG_variable, DW_AT_name("K$15"), DW_AT_symbol_name("K$15")
	.dwattr DW$203, DW_AT_type(*DW$T$63)
...
DW$204	.dwtag  DW_TAG_loop
	.dwattr DW$204, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L63:1:1598868380")
	.dwattr DW$204, DW_AT_begin_file("menu.c")
	.dwattr DW$204, DW_AT_begin_line(0x2a)
	.dwattr DW$204, DW_AT_end_line(0x40)
...
DW$215	.dwtag  DW_TAG_loop
	.dwattr DW$215, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L62:1:1598868380")
	.dwattr DW$215, DW_AT_begin_file("menu.c")
	.dwattr DW$215, DW_AT_begin_line(0x27)
	.dwattr DW$215, DW_AT_end_line(0x27)
DW$216	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$202, DW_AT_end_line(0x41)
...
DW$217	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$49)
...
DW$220	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$55)
	.dwendtag DW$T$56


DW$T$58	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$58, DW_AT_language(DW_LANG_C)
DW$221	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$25)
	.dwendtag DW$T$58
...
DW$223	.dwtag  DW_TAG_far_type
	.dwattr DW$223, DW_AT_type(*DW$T$63)
...
DW$224	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$63)
...
DW$T$66	.dwtag  DW_TAG_const_type
	.dwattr DW$T$66, DW_AT_type(*DW$226)
...
DW$228	.dwtag  DW_TAG_far_type
	.dwattr DW$228, DW_AT_type(*DW$T$30)
DW$T$84	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$84, DW_AT_type(*DW$228)
DW$229	.dwtag  DW_TAG_far_type
	.dwattr DW$229, DW_AT_type(*DW$T$41)
...
DW$T$67	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$67, DW_AT_type(*DW$230)
...
DW$263	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$44)
...
DW$272	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$272, DW_AT_name("LineStop"), DW_AT_symbol_name("_LineStop")
...
DW$275	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$275, DW_AT_name("TxFlag_U16"), DW_AT_symbol_name("_TxFlag_U16")
...
DW$T$20	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$20, DW_AT_type(*DW$278)
...
DW$280	.dwtag  DW_TAG_far_type
	.dwattr DW$280, DW_AT_type(*DW$T$43)
DW$T$44	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$44, DW_AT_type(*DW$280)
...
DW$295	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$295, DW_AT_name("GPIO0"), DW_AT_symbol_name("_GPIO0")
...
DW$296	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$296, DW_AT_name("GPIO1"), DW_AT_symbol_name("_GPIO1")
...
DW$297	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$297, DW_AT_name("GPIO2"), DW_AT_symbol_name("_GPIO2")
...
DW$298	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$298, DW_AT_name("GPIO3"), DW_AT_symbol_name("_GPIO3")
...
DW$299	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$299, DW_AT_name("GPIO4"), DW_AT_symbol_name("_GPIO4")
...
DW$300	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$300, DW_AT_name("GPIO5"), DW_AT_symbol_name("_GPIO5")
...
DW$301	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$301, DW_AT_name("GPIO6"), DW_AT_symbol_name("_GPIO6")
...
DW$302	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$302, DW_AT_name("GPIO7"), DW_AT_symbol_name("_GPIO7")
...
DW$303	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$303, DW_AT_name("GPIO8"), DW_AT_symbol_name("_GPIO8")
...
DW$304	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$304, DW_AT_name("GPIO9"), DW_AT_symbol_name("_GPIO9")
...
DW$305	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$305, DW_AT_name("GPIO10"), DW_AT_symbol_name("_GPIO10")
...
DW$306	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$306, DW_AT_name("GPIO11"), DW_AT_symbol_name("_GPIO11")
...
DW$307	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$307, DW_AT_name("GPIO12"), DW_AT_symbol_name("_GPIO12")
...
DW$308	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$308, DW_AT_name("GPIO13"), DW_AT_symbol_name("_GPIO13")
...
DW$309	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$309, DW_AT_name("GPIO14"), DW_AT_symbol_name("_GPIO14")
...
DW$310	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$310, DW_AT_name("GPIO15"), DW_AT_symbol_name("_GPIO15")
...
DW$311	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$311, DW_AT_name("GPIO16"), DW_AT_symbol_name("_GPIO16")
...
DW$312	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$312, DW_AT_name("GPIO17"), DW_AT_symbol_name("_GPIO17")
...
DW$313	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$313, DW_AT_name("GPIO18"), DW_AT_symbol_name("_GPIO18")
...
DW$314	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$314, DW_AT_name("GPIO19"), DW_AT_symbol_name("_GPIO19")
...
DW$315	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$315, DW_AT_name("GPIO20"), DW_AT_symbol_name("_GPIO20")
...
DW$316	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$316, DW_AT_name("GPIO21"), DW_AT_symbol_name("_GPIO21")
...
DW$317	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$317, DW_AT_name("GPIO22"), DW_AT_symbol_name("_GPIO22")
...
DW$318	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$318, DW_AT_name("GPIO23"), DW_AT_symbol_name("_GPIO23")
...
DW$319	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$319, DW_AT_name("GPIO24"), DW_AT_symbol_name("_GPIO24")
...
DW$320	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$320, DW_AT_name("GPIO25"), DW_AT_symbol_name("_GPIO25")
...
DW$321	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$321, DW_AT_name("GPIO26"), DW_AT_symbol_name("_GPIO26")
...
DW$322	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$322, DW_AT_name("GPIO27"), DW_AT_symbol_name("_GPIO27")
...
DW$323	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$323, DW_AT_name("GPIO28"), DW_AT_symbol_name("_GPIO28")
...
DW$324	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$324, DW_AT_name("GPIO29"), DW_AT_symbol_name("_GPIO29")
...
DW$325	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$325, DW_AT_name("GPIO30"), DW_AT_symbol_name("_GPIO30")
...
DW$326	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$326, DW_AT_name("GPIO31"), DW_AT_symbol_name("_GPIO31")
...
DW$327	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$327, DW_AT_name("GPIO32"), DW_AT_symbol_name("_GPIO32")
...
DW$328	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$328, DW_AT_name("GPIO33"), DW_AT_symbol_name("_GPIO33")
...
DW$329	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$329, DW_AT_name("GPIO34"), DW_AT_symbol_name("_GPIO34")
...
DW$331	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	...
	.dwattr DW$331, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0c)
...
DW$332	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	...
	.dwattr DW$332, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x10)
...
DW$335	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$335, DW_AT_name("LSW"), DW_AT_symbol_name("_LSW")
	.dwattr DW$335, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$335, DW_AT_accessibility(DW_ACCESS_public)
DW$336	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$336, DW_AT_name("MSW"), DW_AT_symbol_name("_MSW")
...
DW$338	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$338, DW_AT_name("TSS"), DW_AT_symbol_name("_TSS")
...
DW$339	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$339, DW_AT_name("TRB"), DW_AT_symbol_name("_TRB")
...
DW$340	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	...
	.dwattr DW$340, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x04)
	.dwattr DW$340, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$340, DW_AT_accessibility(DW_ACCESS_public)
DW$341	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$341, DW_AT_name("SOFT"), DW_AT_symbol_name("_SOFT")
...
DW$342	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$342, DW_AT_name("FREE"), DW_AT_symbol_name("_FREE")
...
DW$344	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$344, DW_AT_name("TIE"), DW_AT_symbol_name("_TIE")
...
DW$345	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$345, DW_AT_name("TIF"), DW_AT_symbol_name("_TIF")
...
DW$346	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$346, DW_AT_name("TDDR"), DW_AT_symbol_name("_TDDR")
...
DW$347	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$347, DW_AT_name("PSC"), DW_AT_symbol_name("_PSC")
...
DW$348	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$348, DW_AT_name("TDDRH"), DW_AT_symbol_name("_TDDRH")
	.dwattr DW$348, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x08)
	.dwattr DW$348, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$348, DW_AT_accessibility(DW_ACCESS_public)
DW$349	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$349, DW_AT_name("PSCH"), DW_AT_symbol_name("_PSCH")
	.dwattr DW$349, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x08)
