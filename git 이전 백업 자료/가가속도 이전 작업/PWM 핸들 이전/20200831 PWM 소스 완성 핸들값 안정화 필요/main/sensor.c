...
interrupt void ADC_ISR()  
{
	...
	else	
	{
		...
		SenAdc.Div127_U16[SENSOR_COUNT] = IQ_TO_UINT16(_IQ17mpy(_IQ17div(_IQ17(SenAdc.AdcValue_U16[SENSOR_COUNT]),			SenAdc.MaxminusMin_IQ17[SENSOR_COUNT]),		DIV_127_IQ17));
	}
	...
	else	
	{
		...
		SenAdc.Div127_U16[SENSOR_COUNT + 8] = IQ_TO_UINT16(_IQ17mpy(_IQ17div(_IQ17(SenAdc.AdcValue_U16[SENSOR_COUNT + 8]),	SenAdc.MaxminusMin_IQ17[SENSOR_COUNT + 8]),	DIV_127_IQ17)) ;
	}
...
void START_END_LINE()
{
	...
	else if((Flag.MoveState_U16 == ON) && (TIME_INDEX_U32 > (10000)))	
	{
		...
		RMotor.StopAccel_IQ15 = _IQ15mpy(RMotor.NextVelocity_IQ15, _IQ16div(RMotor.NextVelocity_IQ15, HEIGHT_ME_IQ22 >> 6));
		LMotor.StopAccel_IQ15 = _IQ15mpy(LMotor.NextVelocity_IQ15, _IQ16div(LMotor.NextVelocity_IQ15, HEIGHT_ME_IQ22 >> 6));
