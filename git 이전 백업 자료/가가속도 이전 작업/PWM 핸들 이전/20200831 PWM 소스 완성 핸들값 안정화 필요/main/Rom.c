...
void save_sensitive_rom()
{
	...
	//save_rom[ j++ ] = ( (Uint16)MAXMIN_SENSITIVE_U16 >> 0 ) & 0xff;
	//save_rom[ j++ ] = ( (Uint16)MAXMIN_SENSITIVE_U16 >> 8 ) & 0xff;
...
void load_sensitive_rom()
{
	...
	//MAXMIN_SENSITIVE_U16 = ( ( load_rom[ j++ ] & 0xff ) << 0 );
	//MAXMIN_SENSITIVE_U16 |= ( ( load_rom[ j++ ] & 0xff ) << 8 );
}
...
//	save_rom[ j++ ] = ( (Uint16)PID_P_U16 >> 0 ) & 0xff;
//	save_rom[ j++ ] = ( (Uint16)PID_P_U16 >> 8 ) & 0xff;
	
//	save_rom[ j++ ] = ( (Uint16)PID_D_U16 >> 0 ) & 0xff;
//	save_rom[ j++ ] = ( (Uint16)PID_D_U16 >> 8 ) & 0xff;
...
//	PID_P_U16 = ( ( load_rom[ j++ ] & 0xff ) << 0 );
//	PID_P_U16 |= ( ( load_rom[ j++ ] & 0xff ) << 8 );
	
//	PID_D_U16 = ( ( load_rom[ j++ ] & 0xff ) << 0 );
//	PID_D_U16 |= ( ( load_rom[ j++ ] & 0xff ) << 8 );
}
