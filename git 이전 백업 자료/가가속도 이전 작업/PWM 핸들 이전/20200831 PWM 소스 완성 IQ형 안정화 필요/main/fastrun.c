...
void RUN_SECOND()
{
	...
	MOVE_TO_MOVE(	_IQ17(Search[SECOND_MARK_U16_CNT].Distance_U32), Search[SECOND_MARK_U16_CNT].DecelDistance_IQ7 << 10, Search[SECOND_MARK_U16_CNT].Velo_IQ7 << 8, 
					Search[SECOND_MARK_U16_CNT].VeloOut_IQ7 << 8, _IQ15(Search[SECOND_MARK_U16_CNT].Accel_U32));
	...
	while(1)
	{
		...
		if(Flag.STOP & ((LMotor.NextVelocity_IQ15 <= _IQ15(1000.0)) && (RMotor.NextVelocity_IQ15 <= _IQ15(1000.0))))		
		{	END_STOP();				return;	}
		else;
