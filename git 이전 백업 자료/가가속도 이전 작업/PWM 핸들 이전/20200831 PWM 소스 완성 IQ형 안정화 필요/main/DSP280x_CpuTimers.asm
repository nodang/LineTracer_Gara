...
DW$10	.dwtag  DW_TAG_variable, DW_AT_name("PieCtrlRegs"), DW_AT_symbol_name("_PieCtrlRegs")
	.dwattr DW$10, DW_AT_type(*DW$T$74)
...
DW$13	.dwtag  DW_TAG_formal_parameter, DW_AT_name("Timer"), DW_AT_symbol_name("_Timer")
	.dwattr DW$13, DW_AT_type(*DW$T$50)
...
;*** 138	-----------------------    ConfigCpuTimer(&CpuTimer2, 100.0F, 250.0F);
;*** 140	-----------------------    asm(" clrc INTM");
;*** 141	-----------------------    asm(" clrc DBGM");
;*** 141	-----------------------    return;
	.dwcfa	0x1d, -2
...
DW$24	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$50)
...
DW$T$53	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$53, DW_AT_type(*DW$27)
