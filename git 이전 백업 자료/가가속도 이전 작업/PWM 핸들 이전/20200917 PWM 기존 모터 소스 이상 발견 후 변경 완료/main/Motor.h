...
extern void MOVE_TO_MOVE(_iq17 distance, _iq17 decel_distance, _iq16 target_velocity, _iq16 decel_velocity, _iq16 accel);
extern void MOVE_TO_END(_iq17 distance, _iq16 velocity, _iq16 R_accel, _iq16 L_accel);
extern Uint16 END_STOP();
extern Uint16 LINE_OUT_STOP();
extern Uint16 SHUTDOWN();
