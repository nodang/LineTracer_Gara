...
void Init_SENSOR()
{
	...
	memset((void *)SenAdc.ErrorPos_IQ10,0x00,sizeof(_iq10)*5);
...
void HANDLE()
{
/*	SenAdc.ErrorPos_IQ10[4] = SenAdc.ErrorPos_IQ10[3];
	SenAdc.ErrorPos_IQ10[3] = SenAdc.ErrorPos_IQ10[2];
	SenAdc.ErrorPos_IQ10[2] = SenAdc.ErrorPos_IQ10[1];
	SenAdc.ErrorPos_IQ10[1] = SenAdc.PositionTemporary_IQ10;
	SenAdc.ErrorPos_IQ10[0] = _IQ10div((SenAdc.ErrorPos_IQ10[1] - SenAdc.ErrorPos_IQ10[4]), _IQ10(3.0));
*/	
	POScheck_GONE_DISTANCE_IQ15 = _IQ15(HEIGHT_BODY) + _IQ15div(LMotor.PosCheckDist_IQ15 + RMotor.PosCheckDist_IQ15, _IQ15(2.0));
	LMotor.PosCheckDist_IQ15 = _IQ15(0.0);		RMotor.PosCheckDist_IQ15 = _IQ15(0.0);

	SenAdc.Theta_IQ15 = _IQ15atan2(_IQ15div(SenAdc.PositionTemporary_IQ10 << 5, _IQ15(100.0)), _IQ15(HEIGHT_BODY));
	SenAdc.Theta_IQ15 = _IQ15abs(SenAdc.Theta_IQ15) < _IQ15(0.017453) ? _IQ15(0.017453) : SenAdc.Theta_IQ15;
	//SenAdc.DeltaTheta_IQ15 = _IQ15atan2(_IQ15div(SenAdc.ErrorPos_IQ10[0] << 5, _IQ15(100.0)), POScheck_GONE_DISTANCE_IQ15);
	SenAdc.DeltaTheta_IQ15 = _IQ15(0.0);
	SenAdc.Radius_IQ15 = _IQ15div(POScheck_GONE_DISTANCE_IQ15, SenAdc.Theta_IQ15 + SenAdc.DeltaTheta_IQ15);
	RMotor.CurveDist_IQ15 = _IQ15mpy(SenAdc.Radius_IQ15 - _IQ15(HEIGHT_REARdiv2), SenAdc.Theta_IQ15 + SenAdc.DeltaTheta_IQ15) - POScheck_GONE_DISTANCE_IQ15;
	LMotor.CurveDist_IQ15 = _IQ15mpy(SenAdc.Radius_IQ15 + _IQ15(HEIGHT_REARdiv2), SenAdc.Theta_IQ15 + SenAdc.DeltaTheta_IQ15) - POScheck_GONE_DISTANCE_IQ15;

	if(SenAdc.PositionTemporary_IQ10 > _IQ10(0.0))			// Right curve
	{
		RMotor.HandleVelo_IQ18 = _IQ10(_IQ8sqrt(_IQ8mpyIQX(-RMotor.CurveDist_IQ15, 15, _IQ15(TURN_DECEL_U32), 15)));
		LMotor.HandleVelo_IQ18 = _IQ10(_IQ8sqrt(_IQ8mpyIQX(LMotor.CurveDist_IQ15, 15, _IQ15(TURN_ACCEL_U32), 15)));
		
		RMotor.Handle_IQ28 = _IQ18div(RMotor.NextVelocity_IQ18 + RMotor.HandleVelo_IQ18, RMotor.NextVelocity_IQ18);
		LMotor.Handle_IQ28 = _IQ18div(LMotor.NextVelocity_IQ18, LMotor.NextVelocity_IQ18 + LMotor.HandleVelo_IQ18);
		
	}
	else if(SenAdc.PositionTemporary_IQ10 < _IQ10(0.0))		// left curve
	{
		RMotor.HandleVelo_IQ18 = _IQ10(_IQ8sqrt(_IQ8mpyIQX(RMotor.CurveDist_IQ15, 15, _IQ15(TURN_ACCEL_U32), 15)));
		LMotor.HandleVelo_IQ18 = _IQ10(_IQ8sqrt(_IQ8mpyIQX(-LMotor.CurveDist_IQ15, 15, _IQ15(TURN_DECEL_U32), 15)));

		RMotor.Handle_IQ28 = _IQ18div(RMotor.NextVelocity_IQ18, RMotor.NextVelocity_IQ18 + RMotor.HandleVelo_IQ18);
		LMotor.Handle_IQ28 = _IQ18div(LMotor.NextVelocity_IQ18 + LMotor.HandleVelo_IQ18, LMotor.NextVelocity_IQ18);
	}
	else													// Straight
	{	
		RMotor.CurveDist_IQ15 = _IQ15(0.0);		LMotor.CurveDist_IQ15 = _IQ15(0.0);		
		RMotor.HandleVelo_IQ18 = _IQ18(0.0);	LMotor.HandleVelo_IQ18 = _IQ18(0.0);
	...
	//TxPrintf(" %lf %lf %ld %ld %lf %lf %lf %lf\n",_IQ15toF(SenAdc.Theta_IQ15),_IQ15toF(SenAdc.DeltaTheta_IQ15), LMotor.HandleVelo_IQ18 >> 18, RMotor.HandleVelo_IQ18 >> 18, _IQ15toF(LMotor.CurveDist_IQ15) ,_IQ15toF(RMotor.CurveDist_IQ15) ,_IQ15toF(POScheck_GONE_DISTANCE_IQ15), _IQ15toF(SenAdc.Radius_IQ15));
/*
...
void START_END_LINE()
{
	...
	else if((Flag.MoveState_U16 == ON) && (TIME_INDEX_U32 > (10000)))	
	{
		...
		RMotor.StopAccel_IQ15 = _IQ5mpy(_IQ5div(RMotor.NextVelocity_IQ18 >> 13, _IQ5(HEIGHT_ME)), RMotor.NextVelocity_IQ18 >> 13);
		if(RMotor.StopAccel_IQ15 > _IQ4(MOTOR_PERIOD_MAXIMUMdiv2))		RMotor.StopAccel_IQ15 = _IQ14(MOTOR_PERIOD_MAXIMUMdiv2);
		else														RMotor.StopAccel_IQ15 = RMotor.StopAccel_IQ15 << 10;
		LMotor.StopAccel_IQ15 = _IQ5mpy(_IQ5div(LMotor.NextVelocity_IQ18 >> 13, _IQ5(HEIGHT_ME)), LMotor.NextVelocity_IQ18 >> 13);
		if(LMotor.StopAccel_IQ15 > _IQ4(MOTOR_PERIOD_MAXIMUMdiv2))		LMotor.StopAccel_IQ15 = _IQ14(MOTOR_PERIOD_MAXIMUMdiv2);
		else														LMotor.StopAccel_IQ15 = LMotor.StopAccel_IQ15 << 10;
		MOVE_TO_END(_IQ17(200.0), _IQ18(0.0), RMotor.StopAccel_IQ15, LMotor.StopAccel_IQ15); 
	}
	else;
}
