...
#define PERIOD_1SENCONDdivCPUTIMERdiv10	_IQ1(500000.0)		//	1 000 000 / (20 / 10) = 50 000
#define PERIOD_1SENCONDdivCPUTIMER		_IQ1(50000.0)		//	1 000 000 / 20 = 50 000
#define PERIOD_1div2SENCONDdivCPUTIMER	_IQ1(25000.0)		//	0 500 000 / 20 = 50 000
#define PERIOD_1div4SENCONDdivCPUTIMER	_IQ1(12500.0)		//	0 250 000 / 20 = 50 000

#define	HEIGHT_ME_IQ6	_IQ6(340.0)		// Turnmark and wheel distance * 2
#define	STOP_ACCEL_IQ16	(_IQ6div(_IQ6mpy(_IQ6(MOTOR_SPEED_U32), _IQ6(MOTOR_SPEED_U32)), HEIGHT_ME_IQ6) << 10)
