...
DW$66	.dwtag  DW_TAG_subprogram, DW_AT_name("VEL_COMPUTE"), DW_AT_symbol_name("_VEL_COMPUTE")
	...
	.dwattr DW$66, DW_AT_begin_line(0x158)
...
;*** 345	-----------------------    acc = acc;
;*** 348	-----------------------    dist -= minus_dist;
;*** 350	-----------------------    dist = _IQ7div(dist, 256000L);
;*** 351	-----------------------    cur_vel = _IQ7div(cur_vel, 128000L)>>1;
;*** 353	-----------------------    acc_iq7 = _IQ7div((long)((long double)acc*128.0L), 128000L);
;*** 355	-----------------------    *vel = __IQmpy(_IQ6sqrt(__IQmpy(cur_vel, cur_vel, 6)+__IQmpy(acc_iq7, dist>>1, 6))*2L, 128000L, 7);
;*** 357	-----------------------    U$16 = (long)((long double)SECOND_MAX_SPEED_U32*128.0L);
;*** 357	-----------------------    if ( *vel > U$16 ) goto g4;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        MOVL      *SP++,XAR1
...
DW$83	.dwtag  DW_TAG_variable, DW_AT_name("acc"), DW_AT_symbol_name("_acc")
	...
	.dwpsn	"Motor.c",350,2
        ...
        MOVL      *-SP[4],ACC           ; |350| 
	.dwpsn	"Motor.c",351,2
        MOVL      XAR4,#128000          ; |351| 
        MOVL      *-SP[2],XAR4          ; |351| 
        MOVL      ACC,*-SP[8]           ; |351| 
        LCR       #__IQ7div             ; |351| 
        ; call occurs [#__IQ7div] ; |351| 
        SETC      SXM
        SFR       ACC,1                 ; |351| 
        MOVL      *-SP[8],ACC           ; |351| 
	.dwpsn	"Motor.c",353,2
        ...
        MOVL      XAR4,#128000          ; |353| 
        MOVL      *-SP[2],XAR4          ; |353| 
        LCR       #__IQ7div             ; |353| 
        ; call occurs [#__IQ7div] ; |353| 
        MOVL      XAR6,ACC              ; |353| 
	.dwpsn	"Motor.c",355,2
        MOVL      ACC,*-SP[8]           ; |355| 
        MOVL      XT,*-SP[8]            ; |355| 
        ...
        MOVL      ACC,P                 ; |355| 
        LCR       #__IQ6sqrt            ; |355| 
        ; call occurs [#__IQ6sqrt] ; |355| 
        LSL       ACC,1                 ; |355| 
        MOVL      XAR4,#128000          ; |355| 
        MOVL      XT,ACC                ; |355| 
        IMPYL     P,XT,XAR4             ; |355| 
        MOVL      XT,ACC                ; |355| 
	...
	.dwpsn	"Motor.c",357,2
        ...
        SUBB      XAR6,#18              ; |357| 
        MOVL      ACC,@_SECOND_MAX_SPEED_U32 ; |357| 
        LCR       #UL$$TOFD             ; |357| 
        ...
        BF        L1,LT                 ; |357| 
        ; branchcc occurs ; |357| 
;*** 358	-----------------------    C$1 = (long)((long double)SECOND_SPEED_U32*128.0L);
;*** 358	-----------------------    if ( *vel >= C$1 ) goto g5;
	.dwpsn	"Motor.c",358,7
        MOVZ      AR6,SP                ; |358| 
        MOVW      DP,#_SECOND_SPEED_U32
        MOVL      ACC,@_SECOND_SPEED_U32 ; |358| 
        SUBB      XAR6,#18              ; |358| 
        LCR       #UL$$TOFD             ; |358| 
...
L2:    
	...
	.dwattr DW$66, DW_AT_end_line(0x168)
...
DW$84	.dwtag  DW_TAG_subprogram, DW_AT_name("START_END_LINE"), DW_AT_symbol_name("_START_END_LINE")
	...
	.dwattr DW$84, DW_AT_begin_line(0xed)
...
DW$85	.dwtag  DW_TAG_variable, DW_AT_name("v$1"), DW_AT_symbol_name("v$1")
	...
	.dwpsn	"Motor.c",239,2
        MOVW      DP,#_Flag
        AND       AL,@_Flag,#0x0001     ; |239| 
        BF        L4,NEQ                ; |239| 
        ; branchcc occurs ; |239| 
;*** 239	-----------------------    if ( *&Flag&0x20u ) goto g5;
        TBIT      @_Flag,#5             ; |239| 
        BF        L3,TC                 ; |239| 
        ; branchcc occurs ; |239| 
;*** 241	-----------------------    *&Flag |= 1u;
;*** 241	-----------------------    TIME_INDEX_U32 = 0uL;
;*** 243	-----------------------    if ( !(*&Flag&0x80u) ) goto g8;
	.dwpsn	"Motor.c",241,3
        OR        @_Flag,#0x0001        ; |241| 
	.dwpsn	"Motor.c",241,28
        MOVB      ACC,#0
        MOVW      DP,#_TIME_INDEX_U32
        MOVL      @_TIME_INDEX_U32,ACC  ; |241| 
	.dwpsn	"Motor.c",243,3
        MOVW      DP,#_Flag
        TBIT      @_Flag,#7             ; |243| 
        BF        L5,NTC                ; |243| 
        ; branchcc occurs ; |243| 
;*** 243	-----------------------    LINE_SECOND((long)SECOND_MARK_U16_CNT*24+&Search);
;*** 243	-----------------------    goto g8;
	.dwpsn	"Motor.c",243,21
        MOVW      DP,#_SECOND_MARK_U16_CNT
        MOV       T,#24                 ; |243| 
        MPYXU     ACC,T,@_SECOND_MARK_U16_CNT ; |243| 
        MOVL      XAR4,#_Search         ; |243| 
        ADDL      XAR4,ACC
        LCR       #_LINE_SECOND         ; |243| 
        ; call occurs [#_LINE_SECOND] ; |243| 
        BF        L5,UNC                ; |243| 
        ; branch occurs ; |243| 
L3:    
;***	-----------------------g5:
...
L4:    
;***	-----------------------g6:
;*** 246	-----------------------    if ( TIME_INDEX_U32 <= 10000uL ) goto g8;
        MOV       ACC,#10000            ; |246| 
        MOVW      DP,#_TIME_INDEX_U32
        CMPL      ACC,@_TIME_INDEX_U32  ; |246| 
        BF        L5,HIS                ; |246| 
        ; branchcc occurs ; |246| 
;*** 248	-----------------------    *&Flag &= 0xfffeu;
;*** 248	-----------------------    *&Flag |= 0x20u;
...
L5:    
	...
	.dwattr DW$84, DW_AT_end_line(0xfb)
...
DW$94	.dwtag  DW_TAG_subprogram, DW_AT_name("SHUTDOWN"), DW_AT_symbol_name("_SHUTDOWN")
	...
	.dwattr DW$94, DW_AT_begin_line(0xfd)
...
;***************************************************************
_SHUTDOWN:
;*** 255	-----------------------    K$1 = &GpioDataRegs+10L;
;*** 255	-----------------------    *(volatile unsigned *)K$1 |= 4u;
;*** 255	-----------------------    *(volatile unsigned *)K$1 |= 2u;
...
DW$101	.dwtag  DW_TAG_variable, DW_AT_name("K$1"), DW_AT_symbol_name("K$1")
	...
	.dwpsn	"Motor.c",255,2
        MOVL      XAR4,#_GpioDataRegs+10 ; |255| 
        OR        *+XAR4[0],#0x0004     ; |255| 
	.dwpsn	"Motor.c",255,13
        OR        *+XAR4[0],#0x0002     ; |255| 
        BF        L8,UNC
        ; branch occurs
L6:    
DW$L$_SHUTDOWN$2$B:
;***	-----------------------g2:
;*** 290	-----------------------    POSITION_COMPUTE();
;*** 290	-----------------------    HANDLE(1600uL);
;*** 292	-----------------------    if ( LINE_OUT_U16 >= 777u ) goto g4;
	.dwpsn	"Motor.c",290,4
        LCR       #_POSITION_COMPUTE    ; |290| 
        ; call occurs [#_POSITION_COMPUTE] ; |290| 
	.dwpsn	"Motor.c",290,25
        MOV       ACC,#25 << 6
        LCR       #_HANDLE              ; |290| 
        ; call occurs [#_HANDLE] ; |290| 
	.dwpsn	"Motor.c",292,4
...
DW$L$_SHUTDOWN$3$B:
;*** 295	-----------------------    K$10 = &RMotor;
;*** 295	-----------------------    v$1 = (long)((long double)_IQ5div(__IQxmpy(RMotor.NextVelocity_IQ17>>2, (*K$10).NextVelocity_IQ17>>2, 7), 8000L)*1024.0L);
;*** 296	-----------------------    (*K$10).StopAccel_IQ15 = __lmax(v$1, 327680000L);
;*** 297	-----------------------    K$6 = &LMotor;
;*** 297	-----------------------    v$2 = (long)((long double)_IQ5div(__IQxmpy((*K$6).NextVelocity_IQ17>>2, (*K$10).NextVelocity_IQ17>>2, 7), 8000L)*1024.0L);
;*** 298	-----------------------    (*K$6).StopAccel_IQ15 = v$2 = __lmax(v$2, 327680000L);
;*** 299	-----------------------    MOVE_TO_END(RMotor.ErrorDistance_IQ17+(*K$6).ErrorDistance_IQ17>>1, 0L, RMotor.StopAccel_IQ15, v$2);
;*** 299	-----------------------    if ( (*K$6).NextVelocity_IQ17 >= 1310720L ) goto g2;
	.dwpsn	"Motor.c",295,5
        MOVL      XAR4,#_RMotor         ; |295| 
        SETC      SXM
        MOVL      XAR1,XAR4             ; |295| 
        MOVW      DP,#_RMotor+6
        MOVL      XAR4,#8000            ; |295| 
        ...
        SFR       ACC,2                 ; |295| 
        MOVL      XAR6,ACC              ; |295| 
        MOVL      ACC,@_RMotor+6        ; |295| 
        SFR       ACC,2                 ; |295| 
        MOVL      XT,ACC                ; |295| 
        IMPYL     P,XT,XAR6             ; |295| 
        MOVL      XT,ACC                ; |295| 
        QMPYL     ACC,XT,XAR6           ; |295| 
        LSL64     ACC:P,#7              ; |295| 
        LCR       #__IQ5div             ; |295| 
        ; call occurs [#__IQ5div] ; |295| 
        MOVZ      AR6,SP                ; |295| 
        SUBB      XAR6,#14              ; |295| 
        LCR       #L$$TOFD              ; |295| 
        ; call occurs [#L$$TOFD] ; |295| 
        MOVZ      AR6,SP                ; |295| 
        MOVZ      AR4,SP                ; |295| 
        MOVL      XAR5,#FL2             ; |295| 
        SUBB      XAR6,#10              ; |295| 
	...
	.dwpsn	"Motor.c",297,5
        ...
        IMPYL     P,XT,XAR6             ; |297| 
        MOVL      XT,ACC                ; |297| 
        QMPYL     ACC,XT,XAR6           ; |297| 
        LSL64     ACC:P,#7              ; |297| 
        LCR       #__IQ5div             ; |297| 
        ; call occurs [#__IQ5div] ; |297| 
        MOVZ      AR6,SP                ; |297| 
        SUBB      XAR6,#14              ; |297| 
        LCR       #L$$TOFD              ; |297| 
	...
	.dwpsn	"Motor.c",299,5
        ...
        MOVW      DP,#_RMotor+10
        MOVL      *-SP[2],XAR6          ; |299| 
        MOVL      XAR6,@_RMotor+10      ; |299| 
        MOVL      *-SP[4],XAR6          ; |299| 
        MOVB      XAR0,#24              ; |299| 
        MOVL      *-SP[6],ACC           ; |299| 
        MOVL      ACC,*+XAR3[AR0]       ; |299| 
        SETC      SXM
        ADDL      ACC,@_RMotor+24       ; |299| 
        SFR       ACC,1                 ; |299| 
        LCR       #_MOVE_TO_END         ; |299| 
        ; call occurs [#_MOVE_TO_END] ; |299| 
        MOVL      XAR4,#1310720         ; |299| 
        MOVL      ACC,XAR4              ; |299| 
        CMPL      ACC,*+XAR3[6]         ; |299| 
        BF        L6,LEQ                ; |299| 
        ; branchcc occurs ; |299| 
...
DW$L$_SHUTDOWN$5$B:
;***	-----------------------g4:
;*** 292	-----------------------    MOVE_TO_END(0L, 0L, 491520000L, 491520000L);
	.dwpsn	"Motor.c",292,33
        MOVB      ACC,#0
        MOV       PH,#7500
        MOV       PL,#0
        MOVL      *-SP[2],ACC           ; |292| 
        ...
        MOVL      *-SP[6],P             ; |292| 
        MOVB      ACC,#0
        LCR       #_MOVE_TO_END         ; |292| 
        ; call occurs [#_MOVE_TO_END] ; |292| 
DW$L$_SHUTDOWN$5$E:
L8:    
DW$L$_SHUTDOWN$6$B:
;***	-----------------------g5:
...
DW$L$_SHUTDOWN$7$B:
;***	-----------------------g6:
;*** 259	-----------------------    if ( RMotor.NextVelocity_IQ17 >= 1310720L ) goto g2;
	.dwpsn	"Motor.c",259,3
        MOVL      ACC,XAR4              ; |259| 
        MOVW      DP,#_RMotor+6
        CMPL      ACC,@_RMotor+6        ; |259| 
        BF        L6,LEQ                ; |259| 
        ; branchcc occurs ; |259| 
DW$L$_SHUTDOWN$7$E:
;*** 261	-----------------------    if ( LMotor.NextVelocity_IQ17 == 0L ) goto g11;
;***  	-----------------------    #pragma LOOP_FLAGS(5376u)
	.dwpsn	"Motor.c",261,4
        MOVW      DP,#_LMotor+6
        MOVL      ACC,@_LMotor+6        ; |261| 
        BF        L11,EQ                ; |261| 
        ; branchcc occurs ; |261| 
L10:    
DW$L$_SHUTDOWN$9$B:
;***	-----------------------g9:
;*** 261	-----------------------    if ( RMotor.NextVelocity_IQ17 == 0L ) goto g11;
	.dwpsn	"Motor.c",261,11
        MOVW      DP,#_RMotor+6
        MOVL      ACC,@_RMotor+6        ; |261| 
        BF        L11,EQ                ; |261| 
        ; branchcc occurs ; |261| 
DW$L$_SHUTDOWN$9$E:
DW$L$_SHUTDOWN$10$B:
;*** 263	-----------------------    POSITION_COMPUTE();
;*** 263	-----------------------    HANDLE(1600uL);
;*** 263	-----------------------    if ( LMotor.NextVelocity_IQ17 ) goto g9;
	.dwpsn	"Motor.c",263,5
        LCR       #_POSITION_COMPUTE    ; |263| 
        ; call occurs [#_POSITION_COMPUTE] ; |263| 
	.dwpsn	"Motor.c",263,26
        MOV       ACC,#25 << 6
        LCR       #_HANDLE              ; |263| 
        ; call occurs [#_HANDLE] ; |263| 
        MOVW      DP,#_LMotor+6
...
;***	-----------------------g11:
;*** 265	-----------------------    *&Flag &= 0xfffbu;
;*** 266	-----------------------    K$1 = &GpioDataRegs;
;*** 266	-----------------------    (*(volatile struct _GPIO_DATA_REGS *)K$1).GPACLEAR.all = 7344000uL;
;*** 267	-----------------------    *(&CpuTimer0Regs+4L) |= 0x10u;
;*** 268	-----------------------    *(&CpuTimer2Regs+4L) |= 0x10u;
;*** 269	-----------------------    *&Flag &= 0xfffdu;
;*** 270	-----------------------    EPwm2Regs.CMPA.half.CMPA = 0u;
;*** 270	-----------------------    EPwm1Regs.CMPA.half.CMPA = 0u;
;*** 271	-----------------------    (*(volatile struct _GPIO_DATA_REGS *)K$1).GPACLEAR.all = 96uL;
;*** 273	-----------------------    if ( LINE_OUT_U16 >= 777u ) goto g13;
	.dwpsn	"Motor.c",265,4
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfffb        ; |265| 
	.dwpsn	"Motor.c",266,4
        MOV       PH,#112
        MOV       PL,#3968
        MOVL      XAR3,#_GpioDataRegs   ; |266| 
        MOVL      *+XAR3[4],P           ; |266| 
	.dwpsn	"Motor.c",267,4
        MOVW      DP,#_CpuTimer0Regs+4
	...
	.dwpsn	"Motor.c",268,4
        MOVW      DP,#_CpuTimer2Regs+4
        OR        @_CpuTimer2Regs+4,#0x0010 ; |268| 
	.dwpsn	"Motor.c",269,4
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfffd        ; |269| 
	.dwpsn	"Motor.c",270,4
        MOVW      DP,#_EPwm2Regs+9
        MOV       @_EPwm2Regs+9,#0      ; |270| 
        MOVW      DP,#_EPwm1Regs+9
        MOV       @_EPwm1Regs+9,#0      ; |270| 
	.dwpsn	"Motor.c",271,4
        MOVB      ACC,#96
        MOVL      *+XAR3[4],ACC         ; |271| 
	.dwpsn	"Motor.c",273,4
        MOVW      DP,#_LINE_OUT_U16
        CMP       @_LINE_OUT_U16,#777   ; |273| 
        BF        L12,HIS               ; |273| 
        ; branchcc occurs ; |273| 
;*** 276	-----------------------    (*(volatile struct _GPIO_DATA_REGS *)K$1).GPASET.all = 96uL;
;*** 277	-----------------------    DSP28x_usDelay(999998uL);
;*** 278	-----------------------    (*(volatile struct _GPIO_DATA_REGS *)K$1).GPACLEAR.all = 96uL;
;*** 279	-----------------------    DSP28x_usDelay(999998uL);
;*** 280	-----------------------    (*(volatile struct _GPIO_DATA_REGS *)K$1).GPASET.all = 96uL;
;*** 281	-----------------------    DSP28x_usDelay(999998uL);
;*** 282	-----------------------    (*(volatile struct _GPIO_DATA_REGS *)K$1).GPACLEAR.all = 96uL;
	.dwpsn	"Motor.c",276,5
        MOVL      *+XAR3[2],ACC         ; |276| 
	.dwpsn	"Motor.c",277,5
        MOV       AL,#16958
...
L12:    
;***	-----------------------g13:
;*** 284	-----------------------    K$1 = &GpioDataRegs+12L;
;*** 284	-----------------------    *(volatile unsigned *)K$1 |= 4u;
;*** 284	-----------------------    *(volatile unsigned *)K$1 |= 2u;
;*** 286	-----------------------    return;
	.dwpsn	"Motor.c",284,4
        MOVL      XAR4,#_GpioDataRegs+12 ; |284| 
        OR        *+XAR4[0],#0x0004     ; |284| 
	.dwpsn	"Motor.c",284,16
        OR        *+XAR4[0],#0x0002     ; |284| 
	.dwpsn	"Motor.c",286,4
	.dwpsn	"Motor.c",303,1
        SUBB      SP,#14
	.dwcfa	0x1d, -6
...
DW$102	.dwtag  DW_TAG_loop
	.dwattr DW$102, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L10:1:1611733583")
	.dwattr DW$102, DW_AT_begin_file("Motor.c")
	.dwattr DW$102, DW_AT_begin_line(0x105)
	.dwattr DW$102, DW_AT_end_line(0x108)
...
DW$105	.dwtag  DW_TAG_loop
	.dwattr DW$105, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L8:1:1611733583")
	.dwattr DW$105, DW_AT_begin_file("Motor.c")
	.dwattr DW$105, DW_AT_begin_line(0x103)
	.dwattr DW$105, DW_AT_end_line(0x12b)
...
DW$110	.dwtag  DW_TAG_loop
	.dwattr DW$110, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L6:2:1611733583")
	.dwattr DW$110, DW_AT_begin_file("Motor.c")
	.dwattr DW$110, DW_AT_begin_line(0x101)
	.dwattr DW$110, DW_AT_end_line(0x12e)
...
DW$112	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$94, DW_AT_end_line(0x12f)
...
DW$113	.dwtag  DW_TAG_subprogram, DW_AT_name("SECOND_DECEL_VALUE"), DW_AT_symbol_name("_SECOND_DECEL_VALUE")
	...
	.dwattr DW$113, DW_AT_begin_line(0x131)
...
;***************************************************************
_SECOND_DECEL_VALUE:
;*** 307	-----------------------    if ( RMotor.DecelFlag_U16 ) goto g4;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
	.dwpsn	"Motor.c",307,2
        MOVW      DP,#_RMotor+28
        MOV       AL,@_RMotor+28        ; |307| 
        BF        L13,NEQ               ; |307| 
        ; branchcc occurs ; |307| 
;*** 318	-----------------------    if ( !LMotor.DecelFlag_U16 ) goto g6;
	.dwpsn	"Motor.c",318,7
        MOVW      DP,#_LMotor+28
        MOV       AL,@_LMotor+28        ; |318| 
        BF        L15,EQ                ; |318| 
        ; branchcc occurs ; |318| 
;*** 320	-----------------------    if ( LMotor.DecelDistance_IQ17 >= LMotor.ErrorDistance_IQ17 ) goto g5;
	.dwpsn	"Motor.c",320,3
        MOVL      ACC,@_LMotor+24       ; |320| 
        CMPL      ACC,@_LMotor+22       ; |320| 
        BF        L14,LEQ               ; |320| 
        ; branchcc occurs ; |320| 
;*** 320	-----------------------    goto g6;
        BF        L15,UNC               ; |320| 
...
L13:    
;***	-----------------------g4:
;*** 309	-----------------------    if ( RMotor.DecelDistance_IQ17 < RMotor.ErrorDistance_IQ17 ) goto g6;
	.dwpsn	"Motor.c",309,3
        MOVL      ACC,@_RMotor+24       ; |309| 
        CMPL      ACC,@_RMotor+22       ; |309| 
        BF        L15,GT                ; |309| 
        ; branchcc occurs ; |309| 
L14:    
;***	-----------------------g5:
...
;***  	-----------------------    return;
	.dwpsn	"Motor.c",311,4
        MOVW      DP,#_RMotor+12
        MOVL      ACC,@_RMotor+12       ; |311| 
        MOVL      @_RMotor+2,ACC        ; |311| 
	.dwpsn	"Motor.c",312,4
        MOVW      DP,#_LMotor+12
        MOVL      ACC,@_LMotor+12       ; |312| 
        MOVL      @_LMotor+2,ACC        ; |312| 
	.dwpsn	"Motor.c",314,4
        MOVB      AL,#0
        MOV       @_LMotor+28,AL        ; |314| 
        MOVW      DP,#_RMotor+28
        MOV       @_RMotor+28,AL        ; |314| 
L15:    
	.dwpsn	"Motor.c",330,1
        LRETR
        ; return occurs
	.dwattr DW$113, DW_AT_end_file("Motor.c")
	.dwattr DW$113, DW_AT_end_line(0x14a)
...
;***  	-----------------------    return;
	...
	.dwpsn	"Motor.c",178,3
        LCR       #_SECOND_DECEL_VALUE  ; |178| 
        ; call occurs [#_SECOND_DECEL_VALUE] ; |178| 
L34:    
	.dwpsn	"Motor.c",181,1
	.dwcfa	0x1d, -14
        MOVL      XT,*--SP
	...
	.dwattr DW$134, DW_AT_end_line(0xb5)
...
DW$137	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_OUT_STOP"), DW_AT_symbol_name("_LINE_OUT_STOP")
	...
	.dwattr DW$137, DW_AT_begin_line(0xde)
...
;***************************************************************
_LINE_OUT_STOP:
;*** 224	-----------------------    if ( LINE_OUT_U16 >= 300u ) goto g3;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        ADDB      SP,#2
	...
	.dwpsn	"Motor.c",224,2
        MOVW      DP,#_LINE_OUT_U16
        CMP       @_LINE_OUT_U16,#300   ; |224| 
        BF        L35,HIS               ; |224| 
        ; branchcc occurs ; |224| 
;*** 224	-----------------------    return 0u;
	.dwpsn	"Motor.c",224,26
        MOVB      AL,#0
        BF        L36,UNC               ; |224| 
        ; branch occurs ; |224| 
L35:    
;***	-----------------------g3:
;*** 227	-----------------------    LINE_OUT_U16 = 777u;
;*** 228	-----------------------    *&Flag &= 0xfffeu;
;*** 230	-----------------------    SHUTDOWN();
;*** 232	-----------------------    VFDPrintf("line OUT");
;*** 234	-----------------------    return 1u;
	.dwpsn	"Motor.c",227,2
        MOV       @_LINE_OUT_U16,#777   ; |227| 
	.dwpsn	"Motor.c",228,2
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfffe        ; |228| 
	.dwpsn	"Motor.c",230,2
        LCR       #_SHUTDOWN            ; |230| 
        ; call occurs [#_SHUTDOWN] ; |230| 
	.dwpsn	"Motor.c",232,2
        MOVL      XAR4,#FSL1            ; |232| 
        MOVL      *-SP[2],XAR4          ; |232| 
        LCR       #_VFDPrintf           ; |232| 
...
L36:    
	...
	.dwattr DW$137, DW_AT_end_line(0xeb)
...
DW$145	.dwtag  DW_TAG_subprogram, DW_AT_name("END_STOP"), DW_AT_symbol_name("_END_STOP")
	...
	.dwattr DW$145, DW_AT_begin_line(0xb7)
...
L37:    
;***	-----------------------g3:
;*** 187	-----------------------    LMotor.GoneDistance_IQ15 = 0L;
;*** 187	-----------------------    RMotor.GoneDistance_IQ15 = 0L;
;*** 188	-----------------------    SHUTDOWN();
;*** 190	-----------------------    if ( !(*(&CpuTimer0Regs+4L)&0x10u) ) goto g15;
	.dwpsn	"Motor.c",187,3
        MOVB      ACC,#0
        MOVW      DP,#_LMotor+18
        MOVL      @_LMotor+18,ACC       ; |187| 
        MOVW      DP,#_RMotor+18
        MOVL      @_RMotor+18,ACC       ; |187| 
	.dwpsn	"Motor.c",188,3
        LCR       #_SHUTDOWN            ; |188| 
        ; call occurs [#_SHUTDOWN] ; |188| 
	.dwpsn	"Motor.c",190,3
        MOVW      DP,#_CpuTimer0Regs+4
        TBIT      @_CpuTimer0Regs+4,#4  ; |190| 
        BF        L42,NTC               ; |190| 
        ; branchcc occurs ; |190| 
;*** 191	-----------------------    if ( *&Flag&0x40u ) goto g9;
	.dwpsn	"Motor.c",191,8
        MOVW      DP,#_Flag
        TBIT      @_Flag,#6             ; |191| 
        BF        L39,TC                ; |191| 
        ; branchcc occurs ; |191| 
;*** 204	-----------------------    if ( !(*&Flag&0x80u) ) goto g16;
;***  	-----------------------    #pragma LOOP_FLAGS(5376u)
	.dwpsn	"Motor.c",204,8
        TBIT      @_Flag,#7             ; |204| 
        BF        L43,NTC               ; |204| 
...
DW$L$_END_STOP$6$B:
;***	-----------------------g7:
;*** 206	-----------------------    if ( !(*(&CpuTimer0Regs+4L)&0x10u) ) goto g16;
	.dwpsn	"Motor.c",206,10
        MOVW      DP,#_CpuTimer0Regs+4
...
DW$L$_END_STOP$6$E:
DW$L$_END_STOP$7$B:
;*** 208	-----------------------    VFDPrintf("M%3u|C%2lu", SECOND_MARK_U16_CNT-1u, CROSS_PLUS_SEARCH_U32);
;*** 209	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g7;
	.dwpsn	"Motor.c",208,5
        MOVW      DP,#_SECOND_MARK_U16_CNT
        MOVL      XAR4,#FSL2            ; |208| 
        MOV       AL,@_SECOND_MARK_U16_CNT ; |208| 
        MOVL      *-SP[2],XAR4          ; |208| 
        ADDB      AL,#-1
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        MOV       *-SP[3],AL            ; |208| 
        MOVL      ACC,@_CROSS_PLUS_SEARCH_U32 ; |208| 
        MOVL      *-SP[6],ACC           ; |208| 
        LCR       #_VFDPrintf           ; |208| 
        ; call occurs [#_VFDPrintf] ; |208| 
	.dwpsn	"Motor.c",209,16
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#15  ; |209| 
        BF        L38,TC                ; |209| 
        ; branchcc occurs ; |209| 
DW$L$_END_STOP$7$E:
;*** 209	-----------------------    goto g16;
...
;***  	-----------------------    #pragma LOOP_FLAGS(5376u)
	.dwpsn	"Motor.c",193,4
        MOVB      XAR4,#0
        LCR       #_LINE_INFO           ; |193| 
        ; call occurs [#_LINE_INFO] ; |193| 
L40:    
DW$L$_END_STOP$10$B:
;***	-----------------------g10:
;*** 194	-----------------------    if ( !(*(&CpuTimer0Regs+4L)&0x10u) ) goto g16;
	.dwpsn	"Motor.c",194,10
        MOVW      DP,#_CpuTimer0Regs+4
        TBIT      @_CpuTimer0Regs+4,#4  ; |194| 
        BF        L43,NTC               ; |194| 
        ; branchcc occurs ; |194| 
DW$L$_END_STOP$10$E:
DW$L$_END_STOP$11$B:
;*** 196	-----------------------    VFDPrintf("M%3u|C%2lu", MARK_U16_CNT, CROSS_PLUS_SEARCH_U32);
;*** 197	-----------------------    DSP28x_usDelay(7999998uL);
;*** 198	-----------------------    VFDPrintf("<-N  S->");
;*** 199	-----------------------    DSP28x_usDelay(3999998uL);
;*** 200	-----------------------    C$1 = &GpioDataRegs;
;*** 200	-----------------------    if ( !(*C$1&0x4000u) ) goto g14;
	.dwpsn	"Motor.c",196,5
        ...
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        MOV       *-SP[3],AL            ; |196| 
        MOVL      ACC,@_CROSS_PLUS_SEARCH_U32 ; |196| 
        MOVL      *-SP[6],ACC           ; |196| 
        LCR       #_VFDPrintf           ; |196| 
...
DW$L$_END_STOP$11$E:
DW$L$_END_STOP$12$B:
;*** 201	-----------------------    if ( C$1[1]&0x4000u ) goto g10;
	.dwpsn	"Motor.c",201,10
        TBIT      *+XAR4[1],#14         ; |201| 
        BF        L40,TC                ; |201| 
        ; branchcc occurs ; |201| 
DW$L$_END_STOP$12$E:
;*** 201	-----------------------    VFDPrintf("saveNONE");
;*** 201	-----------------------    goto g16;
	.dwpsn	"Motor.c",201,22
        MOVL      XAR4,#FSL4            ; |201| 
        MOVL      *-SP[2],XAR4          ; |201| 
        LCR       #_VFDPrintf           ; |201| 
...
L41:    
;***	-----------------------g14:
;*** 200	-----------------------    VFDPrintf("lineSAVE");
;*** 200	-----------------------    save_mark_rom();
;*** 200	-----------------------    save_line_info_rom();
;*** 200	-----------------------    goto g16;
	.dwpsn	"Motor.c",200,18
        MOVL      XAR4,#FSL5            ; |200| 
        MOVL      *-SP[2],XAR4          ; |200| 
        LCR       #_VFDPrintf           ; |200| 
        ; call occurs [#_VFDPrintf] ; |200| 
	.dwpsn	"Motor.c",200,41
        LCR       #_save_mark_rom       ; |200| 
        ; call occurs [#_save_mark_rom] ; |200| 
	.dwpsn	"Motor.c",200,58
        LCR       #_save_line_info_rom  ; |200| 
        ; call occurs [#_save_line_info_rom] ; |200| 
	.dwpsn	"Motor.c",200,80
        BF        L43,UNC               ; |200| 
        ; branch occurs ; |200| 
L42:    
;***	-----------------------g15:
;*** 190	-----------------------    VFDPrintf("runERROR");
	.dwpsn	"Motor.c",190,38
        MOVL      XAR4,#FSL6            ; |190| 
        MOVL      *-SP[2],XAR4          ; |190| 
        LCR       #_VFDPrintf           ; |190| 
...
;*** 215	-----------------------    VFDPrintf("T %3lf", (float)TIME_INDEX_U32*2.49999993684468790889e-5F);
;*** 217	-----------------------    return 1u;
	.dwpsn	"Motor.c",214,3
        MOV       AL,#9630
        MOV       AH,#38
	...
	.dwpsn	"Motor.c",215,3
        MOVW      DP,#_TIME_INDEX_U32
        MOVL      ACC,@_TIME_INDEX_U32  ; |215| 
        LCR       #UL$$TOFS             ; |215| 
        ; call occurs [#UL$$TOFS] ; |215| 
        MOVL      XAR6,ACC              ; |215| 
        MOV       AL,#46871
        MOV       AH,#14289
        MOVL      *-SP[2],ACC           ; |215| 
...
DW$147	.dwtag  DW_TAG_loop
	.dwattr DW$147, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L40:1:1611733583")
	.dwattr DW$147, DW_AT_begin_file("Motor.c")
	.dwattr DW$147, DW_AT_begin_line(0xc2)
	.dwattr DW$147, DW_AT_end_line(0xca)
...
DW$151	.dwtag  DW_TAG_loop
	.dwattr DW$151, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L38:1:1611733583")
	.dwattr DW$151, DW_AT_begin_file("Motor.c")
	.dwattr DW$151, DW_AT_begin_line(0xce)
	.dwattr DW$151, DW_AT_end_line(0xd3)
...
DW$153	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$145, DW_AT_end_line(0xdc)
...
DW$154	.dwtag  DW_TAG_subprogram, DW_AT_name("DECEL_DIST_COMPUTE"), DW_AT_symbol_name("_DECEL_DIST_COMPUTE")
	...
	.dwattr DW$154, DW_AT_begin_line(0x14d)
...
;*** 334	-----------------------    tarVEL = tarVEL;
;*** 334	-----------------------    Acc = Acc;
;*** 337	-----------------------    curVEL = _IQ7div(curVEL, 128000L)>>1;
;*** 338	-----------------------    tarVEL = _IQ7div(tarVEL, 128000L)>>1;
;*** 340	-----------------------    acc_IQ7 = _IQ7div((long)((long double)Acc*128.0L), 128000L);
;*** 341	-----------------------    *decel_dist = __IQmpy(_IQ7div(ABS(__IQmpy(curVEL, curVEL, 6)-__IQmpy(tarVEL, tarVEL, 6))*2L, acc_IQ7*2L), 128000L, 7);
;*** 341	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$165	.dwtag  DW_TAG_variable, DW_AT_name("Acc"), DW_AT_symbol_name("_Acc")
	...
	.dwpsn	"Motor.c",337,2
        ...
        MOVL      *-SP[4],ACC           ; |337| 
	.dwpsn	"Motor.c",338,2
        MOVL      XAR4,#128000          ; |338| 
        MOVL      *-SP[2],XAR4          ; |338| 
        MOVL      ACC,*-SP[6]           ; |338| 
        LCR       #__IQ7div             ; |338| 
        ; call occurs [#__IQ7div] ; |338| 
        SETC      SXM
        SFR       ACC,1                 ; |338| 
        MOVL      *-SP[6],ACC           ; |338| 
	.dwpsn	"Motor.c",340,2
	...
	.dwpsn	"Motor.c",341,2
        ...
        LSL       ACC,1                 ; |341| 
        LCR       #__IQ7div             ; |341| 
        ; call occurs [#__IQ7div] ; |341| 
        MOVL      XAR4,#128000          ; |341| 
        MOVL      XT,ACC                ; |341| 
        QMPYL     ACC,XT,XAR4           ; |341| 
        IMPYL     P,XT,XAR4             ; |341| 
        ASR64     ACC:P,#7              ; |341| 
        MOVL      *+XAR1[0],P           ; |341| 
	.dwpsn	"Motor.c",342,1
	...
	.dwattr DW$154, DW_AT_end_line(0x156)
