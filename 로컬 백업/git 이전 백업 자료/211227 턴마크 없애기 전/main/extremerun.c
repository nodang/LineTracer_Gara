...
void RUN_THIRD()
{
	...
	while(1)
	{
		...
		if(ERROR_U16_FLAG)	{	MOVE_TO_MOVE(_IQ17(500.0), _IQ17(0.0), _IQ17(MOTOR_SPEED_U32), _IQ17(MOTOR_SPEED_U32), _IQ16(JERK_U32));	Flag.Extrem_U16 = OFF;	ERROR_U16_FLAG = OFF;	}
		else;
	} 
}
