...
void POSITION_COMPUTE(SENSORADC *pS)
{
	int32 *pA;
	Uint16 *state;
	Uint16 *enable;
	...
	pA = POSITION_WEIGHT_I32;
	state = &SENSOR_STATE_U16_CNT;
	...
	{	
		...
		sum_mpy_wd_iq8 += _IQ8mpy(_IQ8(*(pA + pS->Position_U16_CNT)), _IQ8(pS->Div127_U16[pS->Position_U16_CNT])); 
		sum_mpy_wd_iq8 += _IQ8mpy(_IQ8(*(pA + pS->Position_U16_CNT + 1)), _IQ8(pS->Div127_U16[pS->Position_U16_CNT + 1]));
		sum_mpy_wd_iq8 += _IQ8mpy(_IQ8(*(pA + pS->Position_U16_CNT + 2)), _IQ8(pS->Div127_U16[pS->Position_U16_CNT + 2]));
		sum_mpy_wd_iq8 += _IQ8mpy(_IQ8(*(pA + pS->Position_U16_CNT + 3)), _IQ8(pS->Div127_U16[pS->Position_U16_CNT + 3]));	

		pS->Position_IQ10 = _IQ2(_IQ8div(sum_mpy_wd_iq8, _IQ8(sum_127div_u16)));
		...
		cur_position_i32	= (int32)(pS->Position_IQ10 >> 10);
		
		if((cur_position_i32 > *(pA)))			{ pS->Position_U16_CNT = 0;		*state = 8;	*enable = RIGHT_ENABLE; }
...
inline void HANDLE()
{
	...
	HanPID.Pos_Err_IQ10[1] = HanPID.Pos_Err_IQ10[0];
	...
	HanPID.Pos_P_IQ17 = _IQ10mpyIQX(/*_IQ17(3.0)*/PID_Kp_IQ17, 17, HanPID.Pos_Err_IQ10[1], 10);

	HanPID.Pos_D_IQ17 = _IQ17mpyIQX(PID_Kd_IQ17, 17, HanPID.Pos_Err_IQ10[2] - HanPID.Pos_Err_IQ10[1], 10);

	HanPID.Pos_PID_IQ17 = HanPID.Pos_P_IQ17;	// + HanPID.Pos_D_IQ17;
	...
	if(HanPID.Pos_PID_IQ17 > _IQ10(0.0))			// Right curve
	{
		...
		RMotor.TargetHandle_IQ17 = -_IQ17mpy(_IQ7(_IQ10div(HanPID.Pos_PID_IQ17, _IQ10(MAX_POSITION))), _IQ17mpy(RMotor.TargetVel_IQ17, HANDLE_DEC_IQ17));
		LMotor.TargetHandle_IQ17 = _IQ17mpy(_IQ7(_IQ10div(HanPID.Pos_PID_IQ17, _IQ10(MAX_POSITION))), _IQ17mpy(LMotor.TargetVel_IQ17, HANDLE_ACC_IQ17));
	}
	...
	else if(HanPID.Pos_PID_IQ17 < _IQ10(0.0))		// left curve
	{
		...
		RMotor.TargetHandle_IQ17 = -_IQ17mpy(_IQ7(_IQ10div(HanPID.Pos_PID_IQ17, _IQ10(MAX_POSITION))), _IQ17mpy(RMotor.TargetVel_IQ17, HANDLE_ACC_IQ17));
		LMotor.TargetHandle_IQ17 = _IQ17mpy(_IQ7(_IQ10div(HanPID.Pos_PID_IQ17, _IQ10(MAX_POSITION))), _IQ17mpy(LMotor.TargetVel_IQ17, HANDLE_DEC_IQ17));
	}
	else													// Straight
	{
