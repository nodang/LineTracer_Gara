...
void Init_MotorCtrl(MOTORCTRL *pM)
{
	...
	pM->Jerk_IQ16		= _IQ16(5.0);		// 5000/1000
...
{	
	...
	if(pM->NextVelocity_IQ17 < pM->TargetVel_IQ17)
	{
		...
		pM->MaxTargetAcc_IQ16 = MAX_ACC_IQ17 - (_IQ17mpy(ACC_GRADIENT_IQ17, pM->NextVelocity_IQ17) >> 1);
		if(MIN_ACC_IQ16 < pM->MaxTargetAcc_IQ16)	pM->AccActable_IQ16 = pM->MaxTargetAcc_IQ16 - _IQ16(HANDLE_ACCEL_U32);
		else										pM->AccActable_IQ16 = _IQ16(0.0);
	}
	...
	case 0 :
		if(labs(pM->NextVelocity_IQ17 - pM->TargetVel_IQ17) > pM->ErrorVelocity_IQ17)			
		{
			...
			else
			{
				...
				if((pM->NextAccel_IQ16 > pM->AccActable_IQ16) || (pM->NextAccel_IQ16 < -(pM->AccActable_IQ16)))		pM->AccHold_U16 = ON;
...
void MOVE_TO_END(_iq17 distance)
{
	...
	RMotor.Jerk_IQ16 = STOP_JERK_IQ17(RMotor.NextVelocity_IQ17) >> 1;
	LMotor.Jerk_IQ16 = STOP_JERK_IQ17(LMotor.NextVelocity_IQ17) >> 1;
...
{	
	...
	while(1)
	{
		//TxPrintf("%5ld %5ld %5ld %5ld  %4ld %4ld %4ld %4ld %u %u\n", LMotor.PrdNext_IQ14 >> 14, RMotor.PrdNext_IQ14 >> 14, LMotor.TargetHandle_IQ17 >> 17, RMotor.TargetHandle_IQ17 >> 17, LMotor.HandleVelo_IQ17 >> 17, RMotor.HandleVelo_IQ17 >> 17, LMotor.FinalVelo_IQ17 >> 17, RMotor.FinalVelo_IQ17 >> 17, EPwm2Regs.TBCTL.bit.CLKDIV, EPwm1Regs.TBCTL.bit.CLKDIV);
