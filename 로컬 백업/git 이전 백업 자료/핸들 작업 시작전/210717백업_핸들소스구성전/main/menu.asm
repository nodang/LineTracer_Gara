...
;* Date/Time created: Sat Jul 10 04:15:01 2021                 *
;***************************************************************
...
DW$26	.dwtag  DW_TAG_variable, DW_AT_name("TURN_DECEL_U32"), DW_AT_symbol_name("_TURN_DECEL_U32")
...
DW$34	.dwtag  DW_TAG_variable, DW_AT_name("SECOND_CURVE_U32"), DW_AT_symbol_name("_SECOND_CURVE_U32")
	.dwattr DW$34, DW_AT_type(*DW$T$23)
	.dwattr DW$34, DW_AT_declaration(0x01)
	.dwattr DW$34, DW_AT_external(0x01)
DW$35	.dwtag  DW_TAG_variable, DW_AT_name("TURN_ACCEL_U32"), DW_AT_symbol_name("_TURN_ACCEL_U32")
...
DW$38	.dwtag  DW_TAG_variable, DW_AT_name("CpuTimer2Regs"), DW_AT_symbol_name("_CpuTimer2Regs")
	.dwattr DW$38, DW_AT_type(*DW$T$87)
...
DW$43	.dwtag  DW_TAG_formal_parameter, DW_AT_name("count"), DW_AT_symbol_name("_count")
	.dwattr DW$43, DW_AT_type(*DW$T$62)
...
DW$47	.dwtag  DW_TAG_subprogram, DW_AT_name("MENU_RUN"), DW_AT_symbol_name("_MENU_RUN")
	...
	.dwattr DW$47, DW_AT_begin_line(0x1ad)
...
_MENU_RUN:
;*** 431	-----------------------    m_run_cnt = 0u;
;*** 433	-----------------------    if ( !(*(&GpioDataRegs+1)&0x8000u) ) goto g14;
...
DW$48	.dwtag  DW_TAG_variable, DW_AT_name("m_run_cnt"), DW_AT_symbol_name("_m_run_cnt")
	...
	.dwpsn	"menu.c",433,2
        ...
        TBIT      @_GpioDataRegs+1,#15  ; |433| 
        BF        L12,NTC               ; |433| 
        ; branchcc occurs ; |433| 
L5:    
DW$L$_MENU_RUN$2$B:
;***	-----------------------g3:
;*** 435	-----------------------    switch ( m_run_cnt ) {case 0u: goto g9;, case 1u: goto g6;, case 2u: goto g4;, DEFAULT goto g13};
	.dwpsn	"menu.c",435,3
        MOV       AL,*-SP[3]            ; |435| 
        BF        L8,EQ                 ; |435| 
        ; branchcc occurs ; |435| 
...
DW$L$_MENU_RUN$5$B:
;***	-----------------------g4:
;*** 448	-----------------------    VFDPrintf("mapCHECK");
;*** 449	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g13;
	.dwpsn	"menu.c",448,4
        MOVL      XAR4,#FSL1            ; |448| 
        MOVL      *-SP[2],XAR4          ; |448| 
        LCR       #_VFDPrintf           ; |448| 
...
;*** 449	-----------------------    goto g13;
	...
	.dwpsn	"menu.c",449,36
        ...
        OR        @_Flag,#0x0100        ; |449| 
	.dwpsn	"menu.c",449,58
        LCR       #_LINE_PRINTF         ; |449| 
        ; call occurs [#_LINE_PRINTF] ; |449| 
        BF        L11,UNC               ; |449| 
        ; branch occurs ; |449| 
DW$L$_MENU_RUN$6$E:
L6:    
DW$L$_MENU_RUN$7$B:
;***	-----------------------g6:
;*** 443	-----------------------    VFDPrintf("2ND RACE");
;*** 444	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g13;
	.dwpsn	"menu.c",443,4
        MOVL      XAR4,#FSL2            ; |443| 
        MOVL      *-SP[2],XAR4          ; |443| 
        LCR       #_VFDPrintf           ; |443| 
...
DW$L$_MENU_RUN$11$B:
;***	-----------------------g9:
;*** 438	-----------------------    VFDPrintf("SEARCH  ");
;*** 439	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g13;
	.dwpsn	"menu.c",438,4
        MOVL      XAR4,#FSL3            ; |438| 
        MOVL      *-SP[2],XAR4          ; |438| 
        LCR       #_VFDPrintf           ; |438| 
...
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	...
	.dwpsn	"menu.c",439,36
        LCR       #_RUN                 ; |439| 
        ; call occurs [#_RUN] ; |439| 
DW$L$_MENU_RUN$12$E:
L9:    
DW$L$_MENU_RUN$13$B:
;***	-----------------------g11:
;*** 439	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g11;
	.dwpsn	"menu.c",439,43
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#15  ; |439| 
        BF        L9,TC                 ; |439| 
        ; branchcc occurs ; |439| 
DW$L$_MENU_RUN$13$E:
L10:    
...
DW$L$_MENU_RUN$15$B:
;***	-----------------------g13:
;*** 454	-----------------------    MENU_SW(&m_run_cnt, 2u);
;*** 454	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g3;
	.dwpsn	"menu.c",454,3
        MOVZ      AR4,SP                ; |454| 
        MOVB      AL,#2                 ; |454| 
        SUBB      XAR4,#3               ; |454| 
        LCR       #_MENU_SW             ; |454| 
        ; call occurs [#_MENU_SW] ; |454| 
        MOVW      DP,#_GpioDataRegs+1
...
DW$49	.dwtag  DW_TAG_loop
	.dwattr DW$49, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L5:1:1625858101")
	.dwattr DW$49, DW_AT_begin_file("menu.c")
	.dwattr DW$49, DW_AT_begin_line(0x1b1)
	.dwattr DW$49, DW_AT_end_line(0x1c7)
...
DW$62	.dwtag  DW_TAG_loop
	.dwattr DW$62, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L7:2:1625858101")
	.dwattr DW$62, DW_AT_begin_file("menu.c")
	.dwattr DW$62, DW_AT_begin_line(0x1bc)
	.dwattr DW$62, DW_AT_end_line(0x1bc)
...
DW$64	.dwtag  DW_TAG_loop
	.dwattr DW$64, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L9:2:1625858101")
	.dwattr DW$64, DW_AT_begin_file("menu.c")
	.dwattr DW$64, DW_AT_begin_line(0x1b7)
	.dwattr DW$64, DW_AT_end_line(0x1b7)
DW$65	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$47, DW_AT_end_line(0x1c9)
...
DW$66	.dwtag  DW_TAG_subprogram, DW_AT_name("MENU_MOTOR"), DW_AT_symbol_name("_MENU_MOTOR")
	...
	.dwattr DW$66, DW_AT_begin_line(0xb7)
...
_MENU_MOTOR:
;*** 185	-----------------------    m_mtr_cnt = 0u;
;*** 188	-----------------------    if ( !(*(&GpioDataRegs+1)&0x8000u) ) goto g39;
;***  	-----------------------    #pragma LOOP_FLAGS(5120u)
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$67	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	.dwattr DW$67, DW_AT_type(*DW$T$69)
...
DW$70	.dwtag  DW_TAG_variable, DW_AT_name("m_mtr_cnt"), DW_AT_symbol_name("_m_mtr_cnt")
	.dwattr DW$70, DW_AT_type(*DW$T$20)
	.dwattr DW$70, DW_AT_location[DW_OP_breg20 -5]
;* AR1   assigned to _m_sw_cnt
DW$71	.dwtag  DW_TAG_variable, DW_AT_name("m_sw_cnt"), DW_AT_symbol_name("_m_sw_cnt")
...
;***	-----------------------g3:
;*** 190	-----------------------    switch ( m_mtr_cnt ) {case 0u: goto g19;, case 1u: goto g4;, DEFAULT goto g38};
	.dwpsn	"menu.c",190,3
        MOV       AL,*-SP[5]            ; |190| 
        BF        L21,EQ                ; |190| 
        ; branchcc occurs ; |190| 
...
;***	-----------------------g4:
;*** 291	-----------------------    VFDPrintf("HANDLE  ");
;*** 292	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g38;
	.dwpsn	"menu.c",291,4
        MOVL      XAR4,#FSL4            ; |291| 
        MOVL      *-SP[2],XAR4          ; |291| 
        LCR       #_VFDPrintf           ; |291| 
...
;***	-----------------------g6:
;*** 298	-----------------------    switch ( m_sw_cnt ) {case 0u: goto g11;, case 1u: goto g7;, DEFAULT goto g15};
	.dwpsn	"menu.c",298,6
        MOV       AL,AR1                ; |298| 
        BF        L16,EQ                ; |298| 
        ; branchcc occurs ; |298| 
...
;***	-----------------------g7:
;*** 307	-----------------------    VFDPrintf("DC%6lu", (unsigned long)(__IQmpy(_IQ10div((long)((long double)TURN_DECEL_U32*1024.0L), 1638400L), (long)((long double)MOTOR_SPEED_U32*1024.0L), 10)>>10));
;*** 308	-----------------------    if ( !(*&GpioDataRegs&0x4000u) ) goto g10;
	.dwpsn	"menu.c",307,7
        MOVZ      AR6,SP                ; |307| 
        ...
        LCR       #FD$$TOL              ; |307| 
        ; call occurs [#FD$$TOL] ; |307| 
        MOVL      XAR4,#1638400         ; |307| 
        MOVL      *-SP[2],XAR4          ; |307| 
        LCR       #__IQ10div            ; |307| 
        ; call occurs [#__IQ10div] ; |307| 
        MOVL      XT,ACC                ; |307| 
	...
	.dwpsn	"menu.c",308,7
        MOVW      DP,#_GpioDataRegs
        TBIT      @_GpioDataRegs,#14    ; |308| 
        BF        L15,NTC               ; |308| 
        ; branchcc occurs ; |308| 
DW$L$_MENU_MOTOR$8$E:
DW$L$_MENU_MOTOR$9$B:
;*** 309	-----------------------    if ( *(&GpioDataRegs+1)&0x4000u ) goto g15;
	.dwpsn	"menu.c",309,12
        TBIT      @_GpioDataRegs+1,#14  ; |309| 
        BF        L18,TC                ; |309| 
        ; branchcc occurs ; |309| 
DW$L$_MENU_MOTOR$9$E:
DW$L$_MENU_MOTOR$10$B:
;*** 309	-----------------------    DSP28x_usDelay(2499998uL);
;*** 309	-----------------------    TURN_DECEL_U32 -= 10uL;
;*** 309	-----------------------    goto g15;
	.dwpsn	"menu.c",309,24
        MOV       AL,#9630
        MOV       AH,#38
...
;***	-----------------------g11:
;*** 301	-----------------------    VFDPrintf("AC%6lu", (unsigned long)(__IQmpy(_IQ10div((long)((long double)TURN_ACCEL_U32*1024.0L), 1638400L), (long)((long double)MOTOR_SPEED_U32*1024.0L), 10)>>10));
;*** 302	-----------------------    C$3 = &GpioDataRegs;
;*** 302	-----------------------    if ( !(*C$3&0x4000u) ) goto g14;
	.dwpsn	"menu.c",301,7
        MOVZ      AR6,SP                ; |301| 
        MOVW      DP,#_MOTOR_SPEED_U32
        ...
        LCR       #FD$$TOL              ; |301| 
        ; call occurs [#FD$$TOL] ; |301| 
        MOVL      XAR4,#1638400         ; |301| 
        MOVL      *-SP[2],XAR4          ; |301| 
        LCR       #__IQ10div            ; |301| 
        ; call occurs [#__IQ10div] ; |301| 
        MOVL      XT,ACC                ; |301| 
...
;*** 302	-----------------------    TURN_ACCEL_U32 += 10uL;
	...
	.dwpsn	"menu.c",302,39
        MOVW      DP,#_TURN_ACCEL_U32
        MOVB      ACC,#10
        ADDL      @_TURN_ACCEL_U32,ACC  ; |302| 
DW$L$_MENU_MOTOR$15$E:
L18:    
DW$L$_MENU_MOTOR$16$B:
;***	-----------------------g15:
;*** 313	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g17;
	.dwpsn	"menu.c",313,6
        MOVW      DP,#_GpioDataRegs
        TBIT      @_GpioDataRegs,#15    ; |313| 
        BF        L20,TC                ; |313| 
        ; branchcc occurs ; |313| 
DW$L$_MENU_MOTOR$16$E:
DW$L$_MENU_MOTOR$17$B:
;*** 315	-----------------------    DSP28x_usDelay(2499998uL);
;*** 316	-----------------------    m_sw_cnt ? (m_sw_cnt = 0u) : (m_sw_cnt = m_sw_cnt+1u);
	.dwpsn	"menu.c",315,7
        MOV       AL,#9630
        MOV       AH,#38
...
;***	-----------------------g17:
;*** 320	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g6;
	.dwpsn	"menu.c",320,5
        MOVW      DP,#_GpioDataRegs+1
...
;*** 324	-----------------------    goto g38;
	.dwpsn	"menu.c",323,5
        LCR       #_save_accel_rom      ; |323| 
        ; call occurs [#_save_accel_rom] ; |323| 
	.dwpsn	"menu.c",324,5
        MOV       AL,#9630
        MOV       AH,#38
...
;*** 194	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g38;
	.dwpsn	"menu.c",193,4
        MOVL      XAR4,#FSL7            ; |193| 
        MOVL      *-SP[2],XAR4          ; |193| 
        LCR       #_VFDPrintf           ; |193| 
...
;***	-----------------------g21:
;*** 200	-----------------------    switch ( m_sw_cnt ) {case 0u: goto g30;, case 1u: goto g26;, case 2u: goto g22;, DEFAULT goto g34};
	.dwpsn	"menu.c",200,6
        MOV       AL,AR1                ; |200| 
        BF        L26,EQ                ; |200| 
        ; branchcc occurs ; |200| 
...
;*** 222	-----------------------    if ( !(*&GpioDataRegs&0x4000u) ) goto g25;
	.dwpsn	"menu.c",221,7
...
;*** 223	-----------------------    if ( *(&GpioDataRegs+1)&0x4000u ) goto g34;
	.dwpsn	"menu.c",223,12
...
;***	-----------------------g34:
;*** 227	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g36;
	.dwpsn	"menu.c",227,6
        MOVW      DP,#_GpioDataRegs
...
;***	-----------------------g36:
;*** 234	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g21;
	.dwpsn	"menu.c",234,5
        MOVW      DP,#_GpioDataRegs+1
...
;***	-----------------------g38:
;*** 424	-----------------------    MENU_SW(&m_mtr_cnt, 1u);
;*** 424	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g3;
	.dwpsn	"menu.c",424,3
        MOVZ      AR4,SP                ; |424| 
        MOVB      AL,#1                 ; |424| 
        SUBB      XAR4,#5               ; |424| 
        LCR       #_MENU_SW             ; |424| 
        ; call occurs [#_MENU_SW] ; |424| 
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#15  ; |424| 
        BF        L13,TC                ; |424| 
        ; branchcc occurs ; |424| 
DW$L$_MENU_MOTOR$45$E:
L32:    
;***	-----------------------g39:
;*** 426	-----------------------    DSP28x_usDelay(2499998uL);
;*** 426	-----------------------    return;
	.dwpsn	"menu.c",426,2
        MOV       AL,#9630
        MOV       AH,#38
...
DW$73	.dwtag  DW_TAG_loop
	.dwattr DW$73, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L13:1:1625858101")
	.dwattr DW$73, DW_AT_begin_file("menu.c")
	.dwattr DW$73, DW_AT_begin_line(0xbc)
	.dwattr DW$73, DW_AT_end_line(0x1a9)
DW$74	.dwtag  DW_TAG_loop_range
	.dwattr DW$74, DW_AT_low_pc(DW$L$_MENU_MOTOR$2$B)
	.dwattr DW$74, DW_AT_high_pc(DW$L$_MENU_MOTOR$2$E)
DW$75	.dwtag  DW_TAG_loop_range
	.dwattr DW$75, DW_AT_low_pc(DW$L$_MENU_MOTOR$23$B)
	.dwattr DW$75, DW_AT_high_pc(DW$L$_MENU_MOTOR$23$E)
DW$76	.dwtag  DW_TAG_loop_range
	.dwattr DW$76, DW_AT_low_pc(DW$L$_MENU_MOTOR$5$B)
	.dwattr DW$76, DW_AT_high_pc(DW$L$_MENU_MOTOR$5$E)
...
DW$79	.dwtag  DW_TAG_loop_range
	.dwattr DW$79, DW_AT_low_pc(DW$L$_MENU_MOTOR$21$B)
	.dwattr DW$79, DW_AT_high_pc(DW$L$_MENU_MOTOR$21$E)
DW$80	.dwtag  DW_TAG_loop_range
	.dwattr DW$80, DW_AT_low_pc(DW$L$_MENU_MOTOR$22$B)
	.dwattr DW$80, DW_AT_high_pc(DW$L$_MENU_MOTOR$22$E)
DW$81	.dwtag  DW_TAG_loop_range
	.dwattr DW$81, DW_AT_low_pc(DW$L$_MENU_MOTOR$44$B)
	.dwattr DW$81, DW_AT_high_pc(DW$L$_MENU_MOTOR$44$E)
DW$82	.dwtag  DW_TAG_loop_range
	.dwattr DW$82, DW_AT_low_pc(DW$L$_MENU_MOTOR$45$B)
	.dwattr DW$82, DW_AT_high_pc(DW$L$_MENU_MOTOR$45$E)

DW$83	.dwtag  DW_TAG_loop
	.dwattr DW$83, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L30:2:1625858101")
	.dwattr DW$83, DW_AT_begin_file("menu.c")
	.dwattr DW$83, DW_AT_begin_line(0xc6)
	.dwattr DW$83, DW_AT_end_line(0xea)
DW$84	.dwtag  DW_TAG_loop_range
	.dwattr DW$84, DW_AT_low_pc(DW$L$_MENU_MOTOR$43$B)
	.dwattr DW$84, DW_AT_high_pc(DW$L$_MENU_MOTOR$43$E)
DW$85	.dwtag  DW_TAG_loop_range
	.dwattr DW$85, DW_AT_low_pc(DW$L$_MENU_MOTOR$40$B)
	.dwattr DW$85, DW_AT_high_pc(DW$L$_MENU_MOTOR$40$E)
DW$86	.dwtag  DW_TAG_loop_range
	.dwattr DW$86, DW_AT_low_pc(DW$L$_MENU_MOTOR$35$B)
	.dwattr DW$86, DW_AT_high_pc(DW$L$_MENU_MOTOR$35$E)
DW$87	.dwtag  DW_TAG_loop_range
	.dwattr DW$87, DW_AT_low_pc(DW$L$_MENU_MOTOR$31$B)
	.dwattr DW$87, DW_AT_high_pc(DW$L$_MENU_MOTOR$31$E)
DW$88	.dwtag  DW_TAG_loop_range
	.dwattr DW$88, DW_AT_low_pc(DW$L$_MENU_MOTOR$27$B)
	.dwattr DW$88, DW_AT_high_pc(DW$L$_MENU_MOTOR$27$E)
DW$89	.dwtag  DW_TAG_loop_range
	.dwattr DW$89, DW_AT_low_pc(DW$L$_MENU_MOTOR$24$B)
	.dwattr DW$89, DW_AT_high_pc(DW$L$_MENU_MOTOR$24$E)
DW$90	.dwtag  DW_TAG_loop_range
	.dwattr DW$90, DW_AT_low_pc(DW$L$_MENU_MOTOR$25$B)
	.dwattr DW$90, DW_AT_high_pc(DW$L$_MENU_MOTOR$25$E)
DW$91	.dwtag  DW_TAG_loop_range
	.dwattr DW$91, DW_AT_low_pc(DW$L$_MENU_MOTOR$26$B)
	.dwattr DW$91, DW_AT_high_pc(DW$L$_MENU_MOTOR$26$E)
DW$92	.dwtag  DW_TAG_loop_range
	.dwattr DW$92, DW_AT_low_pc(DW$L$_MENU_MOTOR$28$B)
	.dwattr DW$92, DW_AT_high_pc(DW$L$_MENU_MOTOR$28$E)
DW$93	.dwtag  DW_TAG_loop_range
	.dwattr DW$93, DW_AT_low_pc(DW$L$_MENU_MOTOR$29$B)
	.dwattr DW$93, DW_AT_high_pc(DW$L$_MENU_MOTOR$29$E)
DW$94	.dwtag  DW_TAG_loop_range
	.dwattr DW$94, DW_AT_low_pc(DW$L$_MENU_MOTOR$30$B)
	.dwattr DW$94, DW_AT_high_pc(DW$L$_MENU_MOTOR$30$E)
DW$95	.dwtag  DW_TAG_loop_range
	.dwattr DW$95, DW_AT_low_pc(DW$L$_MENU_MOTOR$32$B)
	.dwattr DW$95, DW_AT_high_pc(DW$L$_MENU_MOTOR$32$E)
DW$96	.dwtag  DW_TAG_loop_range
	.dwattr DW$96, DW_AT_low_pc(DW$L$_MENU_MOTOR$33$B)
	.dwattr DW$96, DW_AT_high_pc(DW$L$_MENU_MOTOR$33$E)
DW$97	.dwtag  DW_TAG_loop_range
	.dwattr DW$97, DW_AT_low_pc(DW$L$_MENU_MOTOR$34$B)
	.dwattr DW$97, DW_AT_high_pc(DW$L$_MENU_MOTOR$34$E)
...
DW$102	.dwtag  DW_TAG_loop_range
	.dwattr DW$102, DW_AT_low_pc(DW$L$_MENU_MOTOR$41$B)
	.dwattr DW$102, DW_AT_high_pc(DW$L$_MENU_MOTOR$41$E)
DW$103	.dwtag  DW_TAG_loop_range
	.dwattr DW$103, DW_AT_low_pc(DW$L$_MENU_MOTOR$39$B)
	.dwattr DW$103, DW_AT_high_pc(DW$L$_MENU_MOTOR$39$E)
	.dwendtag DW$83


DW$104	.dwtag  DW_TAG_loop
	.dwattr DW$104, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L20:2:1625858101")
	.dwattr DW$104, DW_AT_begin_file("menu.c")
	.dwattr DW$104, DW_AT_begin_line(0x128)
	.dwattr DW$104, DW_AT_end_line(0x140)
DW$105	.dwtag  DW_TAG_loop_range
	.dwattr DW$105, DW_AT_low_pc(DW$L$_MENU_MOTOR$20$B)
	.dwattr DW$105, DW_AT_high_pc(DW$L$_MENU_MOTOR$20$E)
DW$106	.dwtag  DW_TAG_loop_range
	.dwattr DW$106, DW_AT_low_pc(DW$L$_MENU_MOTOR$17$B)
	.dwattr DW$106, DW_AT_high_pc(DW$L$_MENU_MOTOR$17$E)
DW$107	.dwtag  DW_TAG_loop_range
	.dwattr DW$107, DW_AT_low_pc(DW$L$_MENU_MOTOR$12$B)
	.dwattr DW$107, DW_AT_high_pc(DW$L$_MENU_MOTOR$12$E)
DW$108	.dwtag  DW_TAG_loop_range
	.dwattr DW$108, DW_AT_low_pc(DW$L$_MENU_MOTOR$8$B)
	.dwattr DW$108, DW_AT_high_pc(DW$L$_MENU_MOTOR$8$E)
DW$109	.dwtag  DW_TAG_loop_range
	.dwattr DW$109, DW_AT_low_pc(DW$L$_MENU_MOTOR$6$B)
	.dwattr DW$109, DW_AT_high_pc(DW$L$_MENU_MOTOR$6$E)
DW$110	.dwtag  DW_TAG_loop_range
	.dwattr DW$110, DW_AT_low_pc(DW$L$_MENU_MOTOR$7$B)
	.dwattr DW$110, DW_AT_high_pc(DW$L$_MENU_MOTOR$7$E)
DW$111	.dwtag  DW_TAG_loop_range
	.dwattr DW$111, DW_AT_low_pc(DW$L$_MENU_MOTOR$9$B)
	.dwattr DW$111, DW_AT_high_pc(DW$L$_MENU_MOTOR$9$E)
DW$112	.dwtag  DW_TAG_loop_range
	.dwattr DW$112, DW_AT_low_pc(DW$L$_MENU_MOTOR$10$B)
	.dwattr DW$112, DW_AT_high_pc(DW$L$_MENU_MOTOR$10$E)
DW$113	.dwtag  DW_TAG_loop_range
	.dwattr DW$113, DW_AT_low_pc(DW$L$_MENU_MOTOR$11$B)
	.dwattr DW$113, DW_AT_high_pc(DW$L$_MENU_MOTOR$11$E)
DW$114	.dwtag  DW_TAG_loop_range
	.dwattr DW$114, DW_AT_low_pc(DW$L$_MENU_MOTOR$13$B)
	.dwattr DW$114, DW_AT_high_pc(DW$L$_MENU_MOTOR$13$E)
DW$115	.dwtag  DW_TAG_loop_range
	.dwattr DW$115, DW_AT_low_pc(DW$L$_MENU_MOTOR$14$B)
	.dwattr DW$115, DW_AT_high_pc(DW$L$_MENU_MOTOR$14$E)
DW$116	.dwtag  DW_TAG_loop_range
	.dwattr DW$116, DW_AT_low_pc(DW$L$_MENU_MOTOR$15$B)
	.dwattr DW$116, DW_AT_high_pc(DW$L$_MENU_MOTOR$15$E)
DW$117	.dwtag  DW_TAG_loop_range
	.dwattr DW$117, DW_AT_low_pc(DW$L$_MENU_MOTOR$19$B)
	.dwattr DW$117, DW_AT_high_pc(DW$L$_MENU_MOTOR$19$E)
DW$118	.dwtag  DW_TAG_loop_range
	.dwattr DW$118, DW_AT_low_pc(DW$L$_MENU_MOTOR$18$B)
	.dwattr DW$118, DW_AT_high_pc(DW$L$_MENU_MOTOR$18$E)
DW$119	.dwtag  DW_TAG_loop_range
	.dwattr DW$119, DW_AT_low_pc(DW$L$_MENU_MOTOR$16$B)
	.dwattr DW$119, DW_AT_high_pc(DW$L$_MENU_MOTOR$16$E)
	.dwendtag DW$104

	.dwendtag DW$73

	.dwattr DW$66, DW_AT_end_file("menu.c")
	.dwattr DW$66, DW_AT_end_line(0x1ab)
...
DW$120	.dwtag  DW_TAG_subprogram, DW_AT_name("MENU_SENSOR"), DW_AT_symbol_name("_MENU_SENSOR")
	.dwattr DW$120, DW_AT_low_pc(_MENU_SENSOR)
	.dwattr DW$120, DW_AT_high_pc(0x00)
	.dwattr DW$120, DW_AT_begin_file("menu.c")
	.dwattr DW$120, DW_AT_begin_line(0x4a)
...
DW$122	.dwtag  DW_TAG_variable, DW_AT_name("C$2"), DW_AT_symbol_name("C$2")
	.dwattr DW$122, DW_AT_type(*DW$T$69)
...
DW$124	.dwtag  DW_TAG_variable, DW_AT_name("C$4"), DW_AT_symbol_name("C$4")
	.dwattr DW$124, DW_AT_type(*DW$T$69)
	.dwattr DW$124, DW_AT_location[DW_OP_reg10]
DW$125	.dwtag  DW_TAG_variable, DW_AT_name("K$6"), DW_AT_symbol_name("K$6")
	.dwattr DW$125, DW_AT_type(*DW$T$68)
	.dwattr DW$125, DW_AT_location[DW_OP_breg20 -12]
;* AR2   assigned to K$63
DW$126	.dwtag  DW_TAG_variable, DW_AT_name("K$63"), DW_AT_symbol_name("K$63")
	.dwattr DW$126, DW_AT_type(*DW$T$54)
	.dwattr DW$126, DW_AT_location[DW_OP_reg8]
;* AR1   assigned to K$65
DW$127	.dwtag  DW_TAG_variable, DW_AT_name("K$65"), DW_AT_symbol_name("K$65")
...
;* AR2   assigned to L$2
DW$129	.dwtag  DW_TAG_variable, DW_AT_name("L$2"), DW_AT_symbol_name("L$2")
	.dwattr DW$129, DW_AT_type(*DW$T$10)
	.dwattr DW$129, DW_AT_location[DW_OP_reg8]
DW$130	.dwtag  DW_TAG_variable, DW_AT_name("m_adc_cnt"), DW_AT_symbol_name("_m_adc_cnt")
	.dwattr DW$130, DW_AT_type(*DW$T$20)
	.dwattr DW$130, DW_AT_location[DW_OP_breg20 -9]
DW$131	.dwtag  DW_TAG_variable, DW_AT_name("m_sen_cnt"), DW_AT_symbol_name("_m_sen_cnt")
	.dwattr DW$131, DW_AT_type(*DW$T$20)
	.dwattr DW$131, DW_AT_location[DW_OP_breg20 -10]
;* AR1   assigned to U$7
DW$132	.dwtag  DW_TAG_variable, DW_AT_name("U$7"), DW_AT_symbol_name("U$7")
...
DW$134	.dwtag  DW_TAG_variable, DW_AT_name("count"), DW_AT_symbol_name("_count")
	.dwattr DW$134, DW_AT_type(*DW$T$20)
	.dwattr DW$134, DW_AT_location[DW_OP_reg6]
;* AR3   assigned to _count
DW$135	.dwtag  DW_TAG_variable, DW_AT_name("count"), DW_AT_symbol_name("_count")
...
DW$136	.dwtag  DW_TAG_loop
	.dwattr DW$136, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L35:1:1625858101")
	.dwattr DW$136, DW_AT_begin_file("menu.c")
	.dwattr DW$136, DW_AT_begin_line(0x59)
	.dwattr DW$136, DW_AT_end_line(0xb2)
DW$137	.dwtag  DW_TAG_loop_range
	.dwattr DW$137, DW_AT_low_pc(DW$L$_MENU_SENSOR$7$B)
	.dwattr DW$137, DW_AT_high_pc(DW$L$_MENU_SENSOR$7$E)
DW$138	.dwtag  DW_TAG_loop_range
	.dwattr DW$138, DW_AT_low_pc(DW$L$_MENU_SENSOR$34$B)
	.dwattr DW$138, DW_AT_high_pc(DW$L$_MENU_SENSOR$34$E)
DW$139	.dwtag  DW_TAG_loop_range
	.dwattr DW$139, DW_AT_low_pc(DW$L$_MENU_SENSOR$33$B)
	.dwattr DW$139, DW_AT_high_pc(DW$L$_MENU_SENSOR$33$E)
DW$140	.dwtag  DW_TAG_loop_range
	.dwattr DW$140, DW_AT_low_pc(DW$L$_MENU_SENSOR$23$B)
	.dwattr DW$140, DW_AT_high_pc(DW$L$_MENU_SENSOR$23$E)
DW$141	.dwtag  DW_TAG_loop_range
	.dwattr DW$141, DW_AT_low_pc(DW$L$_MENU_SENSOR$27$B)
	.dwattr DW$141, DW_AT_high_pc(DW$L$_MENU_SENSOR$27$E)
DW$142	.dwtag  DW_TAG_loop_range
	.dwattr DW$142, DW_AT_low_pc(DW$L$_MENU_SENSOR$29$B)
	.dwattr DW$142, DW_AT_high_pc(DW$L$_MENU_SENSOR$29$E)
DW$143	.dwtag  DW_TAG_loop_range
	.dwattr DW$143, DW_AT_low_pc(DW$L$_MENU_SENSOR$15$B)
	.dwattr DW$143, DW_AT_high_pc(DW$L$_MENU_SENSOR$15$E)
DW$144	.dwtag  DW_TAG_loop_range
	.dwattr DW$144, DW_AT_low_pc(DW$L$_MENU_SENSOR$12$B)
	.dwattr DW$144, DW_AT_high_pc(DW$L$_MENU_SENSOR$12$E)
DW$145	.dwtag  DW_TAG_loop_range
	.dwattr DW$145, DW_AT_low_pc(DW$L$_MENU_SENSOR$8$B)
	.dwattr DW$145, DW_AT_high_pc(DW$L$_MENU_SENSOR$8$E)
DW$146	.dwtag  DW_TAG_loop_range
	.dwattr DW$146, DW_AT_low_pc(DW$L$_MENU_SENSOR$9$B)
	.dwattr DW$146, DW_AT_high_pc(DW$L$_MENU_SENSOR$9$E)
DW$147	.dwtag  DW_TAG_loop_range
	.dwattr DW$147, DW_AT_low_pc(DW$L$_MENU_SENSOR$10$B)
	.dwattr DW$147, DW_AT_high_pc(DW$L$_MENU_SENSOR$10$E)
DW$148	.dwtag  DW_TAG_loop_range
	.dwattr DW$148, DW_AT_low_pc(DW$L$_MENU_SENSOR$11$B)
	.dwattr DW$148, DW_AT_high_pc(DW$L$_MENU_SENSOR$11$E)
DW$149	.dwtag  DW_TAG_loop_range
	.dwattr DW$149, DW_AT_low_pc(DW$L$_MENU_SENSOR$13$B)
	.dwattr DW$149, DW_AT_high_pc(DW$L$_MENU_SENSOR$13$E)
DW$150	.dwtag  DW_TAG_loop_range
	.dwattr DW$150, DW_AT_low_pc(DW$L$_MENU_SENSOR$14$B)
	.dwattr DW$150, DW_AT_high_pc(DW$L$_MENU_SENSOR$14$E)
DW$151	.dwtag  DW_TAG_loop_range
	.dwattr DW$151, DW_AT_low_pc(DW$L$_MENU_SENSOR$21$B)
	.dwattr DW$151, DW_AT_high_pc(DW$L$_MENU_SENSOR$21$E)
DW$152	.dwtag  DW_TAG_loop_range
	.dwattr DW$152, DW_AT_low_pc(DW$L$_MENU_SENSOR$22$B)
	.dwattr DW$152, DW_AT_high_pc(DW$L$_MENU_SENSOR$22$E)
DW$153	.dwtag  DW_TAG_loop_range
	.dwattr DW$153, DW_AT_low_pc(DW$L$_MENU_SENSOR$28$B)
	.dwattr DW$153, DW_AT_high_pc(DW$L$_MENU_SENSOR$28$E)
DW$154	.dwtag  DW_TAG_loop_range
	.dwattr DW$154, DW_AT_low_pc(DW$L$_MENU_SENSOR$31$B)
	.dwattr DW$154, DW_AT_high_pc(DW$L$_MENU_SENSOR$31$E)
DW$155	.dwtag  DW_TAG_loop_range
	.dwattr DW$155, DW_AT_low_pc(DW$L$_MENU_SENSOR$32$B)
	.dwattr DW$155, DW_AT_high_pc(DW$L$_MENU_SENSOR$32$E)
DW$156	.dwtag  DW_TAG_loop_range
	.dwattr DW$156, DW_AT_low_pc(DW$L$_MENU_SENSOR$38$B)
	.dwattr DW$156, DW_AT_high_pc(DW$L$_MENU_SENSOR$38$E)
DW$157	.dwtag  DW_TAG_loop_range
	.dwattr DW$157, DW_AT_low_pc(DW$L$_MENU_SENSOR$39$B)
	.dwattr DW$157, DW_AT_high_pc(DW$L$_MENU_SENSOR$39$E)
DW$158	.dwtag  DW_TAG_loop_range
	.dwattr DW$158, DW_AT_low_pc(DW$L$_MENU_SENSOR$40$B)
	.dwattr DW$158, DW_AT_high_pc(DW$L$_MENU_SENSOR$40$E)
DW$159	.dwtag  DW_TAG_loop_range
	.dwattr DW$159, DW_AT_low_pc(DW$L$_MENU_SENSOR$41$B)
	.dwattr DW$159, DW_AT_high_pc(DW$L$_MENU_SENSOR$41$E)

DW$160	.dwtag  DW_TAG_loop
	.dwattr DW$160, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L47:2:1625858101")
	.dwattr DW$160, DW_AT_begin_file("menu.c")
	.dwattr DW$160, DW_AT_begin_line(0x6b)
	.dwattr DW$160, DW_AT_end_line(0x74)
DW$161	.dwtag  DW_TAG_loop_range
	.dwattr DW$161, DW_AT_low_pc(DW$L$_MENU_SENSOR$35$B)
	.dwattr DW$161, DW_AT_high_pc(DW$L$_MENU_SENSOR$35$E)
DW$162	.dwtag  DW_TAG_loop_range
	.dwattr DW$162, DW_AT_low_pc(DW$L$_MENU_SENSOR$37$B)
	.dwattr DW$162, DW_AT_high_pc(DW$L$_MENU_SENSOR$37$E)

DW$163	.dwtag  DW_TAG_loop
	.dwattr DW$163, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L48:3:1625858101")
	.dwattr DW$163, DW_AT_begin_file("menu.c")
	.dwattr DW$163, DW_AT_begin_line(0x6d)
	.dwattr DW$163, DW_AT_end_line(0x6d)
DW$164	.dwtag  DW_TAG_loop_range
	.dwattr DW$164, DW_AT_low_pc(DW$L$_MENU_SENSOR$36$B)
	.dwattr DW$164, DW_AT_high_pc(DW$L$_MENU_SENSOR$36$E)
	.dwendtag DW$163
...
DW$165	.dwtag  DW_TAG_loop
	.dwattr DW$165, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L41:2:1625858101")
	.dwattr DW$165, DW_AT_begin_file("menu.c")
	.dwattr DW$165, DW_AT_begin_line(0x90)
	.dwattr DW$165, DW_AT_end_line(0x96)
DW$166	.dwtag  DW_TAG_loop_range
	.dwattr DW$166, DW_AT_low_pc(DW$L$_MENU_SENSOR$24$B)
	.dwattr DW$166, DW_AT_high_pc(DW$L$_MENU_SENSOR$24$E)
DW$167	.dwtag  DW_TAG_loop_range
	.dwattr DW$167, DW_AT_low_pc(DW$L$_MENU_SENSOR$26$B)
	.dwattr DW$167, DW_AT_high_pc(DW$L$_MENU_SENSOR$26$E)

DW$168	.dwtag  DW_TAG_loop
	.dwattr DW$168, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L42:3:1625858101")
	.dwattr DW$168, DW_AT_begin_file("menu.c")
	.dwattr DW$168, DW_AT_begin_line(0x92)
	.dwattr DW$168, DW_AT_end_line(0x92)
DW$169	.dwtag  DW_TAG_loop_range
	.dwattr DW$169, DW_AT_low_pc(DW$L$_MENU_SENSOR$25$B)
	.dwattr DW$169, DW_AT_high_pc(DW$L$_MENU_SENSOR$25$E)
	.dwendtag DW$168
...
DW$170	.dwtag  DW_TAG_loop
	.dwattr DW$170, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L44:2:1625858101")
	.dwattr DW$170, DW_AT_begin_file("menu.c")
	.dwattr DW$170, DW_AT_begin_line(0x82)
	.dwattr DW$170, DW_AT_end_line(0x82)
DW$171	.dwtag  DW_TAG_loop_range
	.dwattr DW$171, DW_AT_low_pc(DW$L$_MENU_SENSOR$30$B)
	.dwattr DW$171, DW_AT_high_pc(DW$L$_MENU_SENSOR$30$E)
	.dwendtag DW$170


DW$172	.dwtag  DW_TAG_loop
	.dwattr DW$172, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L39:2:1625858101")
	.dwattr DW$172, DW_AT_begin_file("menu.c")
	.dwattr DW$172, DW_AT_begin_line(0xa3)
	.dwattr DW$172, DW_AT_end_line(0xa9)
DW$173	.dwtag  DW_TAG_loop_range
	.dwattr DW$173, DW_AT_low_pc(DW$L$_MENU_SENSOR$20$B)
	.dwattr DW$173, DW_AT_high_pc(DW$L$_MENU_SENSOR$20$E)
DW$174	.dwtag  DW_TAG_loop_range
	.dwattr DW$174, DW_AT_low_pc(DW$L$_MENU_SENSOR$16$B)
	.dwattr DW$174, DW_AT_high_pc(DW$L$_MENU_SENSOR$16$E)
DW$175	.dwtag  DW_TAG_loop_range
	.dwattr DW$175, DW_AT_low_pc(DW$L$_MENU_SENSOR$19$B)
	.dwattr DW$175, DW_AT_high_pc(DW$L$_MENU_SENSOR$19$E)
DW$176	.dwtag  DW_TAG_loop_range
	.dwattr DW$176, DW_AT_low_pc(DW$L$_MENU_SENSOR$18$B)
	.dwattr DW$176, DW_AT_high_pc(DW$L$_MENU_SENSOR$18$E)
DW$177	.dwtag  DW_TAG_loop_range
	.dwattr DW$177, DW_AT_low_pc(DW$L$_MENU_SENSOR$17$B)
	.dwattr DW$177, DW_AT_high_pc(DW$L$_MENU_SENSOR$17$E)
	.dwendtag DW$172
...
DW$178	.dwtag  DW_TAG_loop
	.dwattr DW$178, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L34:1:1625858101")
	.dwattr DW$178, DW_AT_begin_file("menu.c")
	.dwattr DW$178, DW_AT_begin_line(0x55)
	.dwattr DW$178, DW_AT_end_line(0x55)
DW$179	.dwtag  DW_TAG_loop_range
	.dwattr DW$179, DW_AT_low_pc(DW$L$_MENU_SENSOR$4$B)
	.dwattr DW$179, DW_AT_high_pc(DW$L$_MENU_SENSOR$4$E)
	.dwendtag DW$178


DW$180	.dwtag  DW_TAG_loop
	.dwattr DW$180, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L33:1:1625858101")
	.dwattr DW$180, DW_AT_begin_file("menu.c")
	.dwattr DW$180, DW_AT_begin_line(0x52)
	.dwattr DW$180, DW_AT_end_line(0x52)
DW$181	.dwtag  DW_TAG_loop_range
	.dwattr DW$181, DW_AT_low_pc(DW$L$_MENU_SENSOR$2$B)
	.dwattr DW$181, DW_AT_high_pc(DW$L$_MENU_SENSOR$2$E)
	.dwendtag DW$180

	.dwattr DW$120, DW_AT_end_file("menu.c")
	.dwattr DW$120, DW_AT_end_line(0xb5)
...
DW$182	.dwtag  DW_TAG_subprogram, DW_AT_name("MENU_TOP"), DW_AT_symbol_name("_MENU_TOP")
	.dwattr DW$182, DW_AT_low_pc(_MENU_TOP)
	.dwattr DW$182, DW_AT_high_pc(0x00)
	.dwattr DW$182, DW_AT_begin_file("menu.c")
	.dwattr DW$182, DW_AT_begin_line(0x2a)
...
DW$183	.dwtag  DW_TAG_variable, DW_AT_name("K$15"), DW_AT_symbol_name("K$15")
	.dwattr DW$183, DW_AT_type(*DW$T$62)
...
DW$184	.dwtag  DW_TAG_loop
	.dwattr DW$184, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L54:1:1625858101")
	.dwattr DW$184, DW_AT_begin_file("menu.c")
	.dwattr DW$184, DW_AT_begin_line(0x31)
	.dwattr DW$184, DW_AT_end_line(0x47)
DW$185	.dwtag  DW_TAG_loop_range
	.dwattr DW$185, DW_AT_low_pc(DW$L$_MENU_TOP$4$B)
	.dwattr DW$185, DW_AT_high_pc(DW$L$_MENU_TOP$4$E)
DW$186	.dwtag  DW_TAG_loop_range
	.dwattr DW$186, DW_AT_low_pc(DW$L$_MENU_TOP$5$B)
	.dwattr DW$186, DW_AT_high_pc(DW$L$_MENU_TOP$5$E)
DW$187	.dwtag  DW_TAG_loop_range
	.dwattr DW$187, DW_AT_low_pc(DW$L$_MENU_TOP$6$B)
	.dwattr DW$187, DW_AT_high_pc(DW$L$_MENU_TOP$6$E)
DW$188	.dwtag  DW_TAG_loop_range
	.dwattr DW$188, DW_AT_low_pc(DW$L$_MENU_TOP$7$B)
	.dwattr DW$188, DW_AT_high_pc(DW$L$_MENU_TOP$7$E)
DW$189	.dwtag  DW_TAG_loop_range
	.dwattr DW$189, DW_AT_low_pc(DW$L$_MENU_TOP$8$B)
	.dwattr DW$189, DW_AT_high_pc(DW$L$_MENU_TOP$8$E)
DW$190	.dwtag  DW_TAG_loop_range
	.dwattr DW$190, DW_AT_low_pc(DW$L$_MENU_TOP$9$B)
	.dwattr DW$190, DW_AT_high_pc(DW$L$_MENU_TOP$9$E)
DW$191	.dwtag  DW_TAG_loop_range
	.dwattr DW$191, DW_AT_low_pc(DW$L$_MENU_TOP$10$B)
	.dwattr DW$191, DW_AT_high_pc(DW$L$_MENU_TOP$10$E)
DW$192	.dwtag  DW_TAG_loop_range
	.dwattr DW$192, DW_AT_low_pc(DW$L$_MENU_TOP$11$B)
	.dwattr DW$192, DW_AT_high_pc(DW$L$_MENU_TOP$11$E)
DW$193	.dwtag  DW_TAG_loop_range
	.dwattr DW$193, DW_AT_low_pc(DW$L$_MENU_TOP$12$B)
	.dwattr DW$193, DW_AT_high_pc(DW$L$_MENU_TOP$12$E)
DW$194	.dwtag  DW_TAG_loop_range
	.dwattr DW$194, DW_AT_low_pc(DW$L$_MENU_TOP$13$B)
	.dwattr DW$194, DW_AT_high_pc(DW$L$_MENU_TOP$13$E)
	.dwendtag DW$184


DW$195	.dwtag  DW_TAG_loop
	.dwattr DW$195, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L53:1:1625858101")
	.dwattr DW$195, DW_AT_begin_file("menu.c")
	.dwattr DW$195, DW_AT_begin_line(0x2e)
	.dwattr DW$195, DW_AT_end_line(0x2e)
DW$196	.dwtag  DW_TAG_loop_range
	.dwattr DW$196, DW_AT_low_pc(DW$L$_MENU_TOP$2$B)
	.dwattr DW$196, DW_AT_high_pc(DW$L$_MENU_TOP$2$E)
	.dwendtag DW$195

	.dwattr DW$182, DW_AT_end_file("menu.c")
	.dwattr DW$182, DW_AT_end_line(0x48)
...
DW$197	.dwtag  DW_TAG_subprogram, DW_AT_name("MENU_PA"), DW_AT_symbol_name("_MENU_PA")
	.dwattr DW$197, DW_AT_low_pc(_MENU_PA)
	.dwattr DW$197, DW_AT_high_pc(0x00)
	.dwattr DW$197, DW_AT_begin_file("menu.c")
	.dwattr DW$197, DW_AT_begin_line(0x22)
...
DW$198	.dwtag  DW_TAG_loop
	.dwattr DW$198, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L58:1:1625858101")
	.dwattr DW$198, DW_AT_begin_file("menu.c")
	.dwattr DW$198, DW_AT_begin_line(0x26)
	.dwattr DW$198, DW_AT_end_line(0x26)
DW$199	.dwtag  DW_TAG_loop_range
	.dwattr DW$199, DW_AT_low_pc(DW$L$_MENU_PA$2$B)
	.dwattr DW$199, DW_AT_high_pc(DW$L$_MENU_PA$2$E)
	.dwendtag DW$198

	.dwattr DW$197, DW_AT_end_file("menu.c")
	.dwattr DW$197, DW_AT_end_line(0x28)
...
DW$200	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$48)
...
DW$203	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$54)
	.dwendtag DW$T$55
...
DW$205	.dwtag  DW_TAG_far_type
	.dwattr DW$205, DW_AT_type(*DW$T$62)
DW$T$63	.dwtag  DW_TAG_const_type
	.dwattr DW$T$63, DW_AT_type(*DW$205)

DW$T$64	.dwtag  DW_TAG_subroutine_type, DW_AT_type(*DW$T$20)
	.dwattr DW$T$64, DW_AT_language(DW_LANG_C)
DW$206	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$62)
...
DW$T$65	.dwtag  DW_TAG_const_type
	.dwattr DW$T$65, DW_AT_type(*DW$208)
...
DW$T$66	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$66, DW_AT_type(*DW$216)
...
DW$218	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$218, DW_AT_name("TurnmarkDistance_IQ17"), DW_AT_symbol_name("_TurnmarkDistance_IQ17")
...
DW$220	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$220, DW_AT_name("MarkEnable_U16"), DW_AT_symbol_name("_MarkEnable_U16")
	.dwattr DW$220, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$220, DW_AT_accessibility(DW_ACCESS_public)
DW$221	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$221, DW_AT_name("TurnFlag_U16"), DW_AT_symbol_name("_TurnFlag_U16")
...
DW$222	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$222, DW_AT_name("SingleFlag_U16"), DW_AT_symbol_name("_SingleFlag_U16")
...
DW$223	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$223, DW_AT_name("CrossMark_U16"), DW_AT_symbol_name("_CrossMark_U16")
...
DW$239	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$239, DW_AT_name("Position_U16_CNT"), DW_AT_symbol_name("_Position_U16_CNT")
	.dwattr DW$239, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$239, DW_AT_accessibility(DW_ACCESS_public)
DW$240	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$41)
	.dwattr DW$240, DW_AT_name("Adc_U16"), DW_AT_symbol_name("_Adc_U16")
	.dwattr DW$240, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$240, DW_AT_accessibility(DW_ACCESS_public)
DW$241	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$241, DW_AT_name("Max_U16"), DW_AT_symbol_name("_Max_U16")
	.dwattr DW$241, DW_AT_data_member_location[DW_OP_plus_uconst 0x11]
	.dwattr DW$241, DW_AT_accessibility(DW_ACCESS_public)
DW$242	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$242, DW_AT_name("Min_U16"), DW_AT_symbol_name("_Min_U16")
	.dwattr DW$242, DW_AT_data_member_location[DW_OP_plus_uconst 0x21]
	.dwattr DW$242, DW_AT_accessibility(DW_ACCESS_public)
DW$243	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$41)
	.dwattr DW$243, DW_AT_name("Div127_U16"), DW_AT_symbol_name("_Div127_U16")
	.dwattr DW$243, DW_AT_data_member_location[DW_OP_plus_uconst 0x31]
	.dwattr DW$243, DW_AT_accessibility(DW_ACCESS_public)
DW$244	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$42)
	.dwattr DW$244, DW_AT_name("Position_IQ10"), DW_AT_symbol_name("_Position_IQ10")
	.dwattr DW$244, DW_AT_data_member_location[DW_OP_plus_uconst 0x42]
	.dwattr DW$244, DW_AT_accessibility(DW_ACCESS_public)
DW$245	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$42)
	.dwattr DW$245, DW_AT_name("PositionTemporary_IQ10"), DW_AT_symbol_name("_PositionTemporary_IQ10")
	.dwattr DW$245, DW_AT_data_member_location[DW_OP_plus_uconst 0x44]
	.dwattr DW$245, DW_AT_accessibility(DW_ACCESS_public)
DW$246	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$43)
	.dwattr DW$246, DW_AT_name("Theta_IQ15"), DW_AT_symbol_name("_Theta_IQ15")
	.dwattr DW$246, DW_AT_data_member_location[DW_OP_plus_uconst 0x46]
	.dwattr DW$246, DW_AT_accessibility(DW_ACCESS_public)
DW$247	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$43)
	.dwattr DW$247, DW_AT_name("Radius_IQ15"), DW_AT_symbol_name("_Radius_IQ15")
	.dwattr DW$247, DW_AT_data_member_location[DW_OP_plus_uconst 0x48]
	.dwattr DW$247, DW_AT_accessibility(DW_ACCESS_public)
DW$248	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$41)
	.dwattr DW$248, DW_AT_name("AdcValue_U16"), DW_AT_symbol_name("_AdcValue_U16")
	.dwattr DW$248, DW_AT_data_member_location[DW_OP_plus_uconst 0x4a]
	.dwattr DW$248, DW_AT_accessibility(DW_ACCESS_public)
DW$249	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$44)
	.dwattr DW$249, DW_AT_name("MaxminusMin_IQ17"), DW_AT_symbol_name("_MaxminusMin_IQ17")
	.dwattr DW$249, DW_AT_data_member_location[DW_OP_plus_uconst 0x5a]
...
DW$256	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$256, DW_AT_name("Search_U16"), DW_AT_symbol_name("_Search_U16")
...
DW$257	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$257, DW_AT_name("Fast_U16"), DW_AT_symbol_name("_Fast_U16")
...
DW$275	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$37)
...
DW$276	.dwtag  DW_TAG_far_type
	.dwattr DW$276, DW_AT_type(*DW$T$20)
DW$T$40	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$40, DW_AT_type(*DW$276)
...
DW$315	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$315, DW_AT_name("LSW"), DW_AT_symbol_name("_LSW")
	.dwattr DW$315, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$315, DW_AT_accessibility(DW_ACCESS_public)
DW$316	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$316, DW_AT_name("MSW"), DW_AT_symbol_name("_MSW")
...
DW$319	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$319, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x04)
	.dwattr DW$319, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$319, DW_AT_accessibility(DW_ACCESS_public)
DW$320	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$320, DW_AT_name("TSS"), DW_AT_symbol_name("_TSS")
...
DW$321	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$321, DW_AT_name("TRB"), DW_AT_symbol_name("_TRB")
...
DW$322	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$322, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x04)
	.dwattr DW$322, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$322, DW_AT_accessibility(DW_ACCESS_public)
DW$323	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$323, DW_AT_name("SOFT"), DW_AT_symbol_name("_SOFT")
...
DW$324	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$324, DW_AT_name("FREE"), DW_AT_symbol_name("_FREE")
...
DW$325	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$325, DW_AT_name("rsvd3"), DW_AT_symbol_name("_rsvd3")
	.dwattr DW$325, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
	.dwattr DW$325, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$325, DW_AT_accessibility(DW_ACCESS_public)
DW$326	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$326, DW_AT_name("TIE"), DW_AT_symbol_name("_TIE")
...
DW$327	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$327, DW_AT_name("TIF"), DW_AT_symbol_name("_TIF")
...
DW$328	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$328, DW_AT_name("TDDR"), DW_AT_symbol_name("_TDDR")
	.dwattr DW$328, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x08)
	.dwattr DW$328, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$328, DW_AT_accessibility(DW_ACCESS_public)
DW$329	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$329, DW_AT_name("PSC"), DW_AT_symbol_name("_PSC")
	.dwattr DW$329, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x08)
...
DW$330	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$330, DW_AT_name("TDDRH"), DW_AT_symbol_name("_TDDRH")
...
DW$331	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$331, DW_AT_name("PSCH"), DW_AT_symbol_name("_PSCH")
...
DW$332	.dwtag  DW_TAG_assign_register, DW_AT_name("AL")
	.dwattr DW$332, DW_AT_location[DW_OP_reg0]
DW$333	.dwtag  DW_TAG_assign_register, DW_AT_name("AH")
	.dwattr DW$333, DW_AT_location[DW_OP_reg1]
DW$334	.dwtag  DW_TAG_assign_register, DW_AT_name("PL")
	.dwattr DW$334, DW_AT_location[DW_OP_reg2]
DW$335	.dwtag  DW_TAG_assign_register, DW_AT_name("PH")
	.dwattr DW$335, DW_AT_location[DW_OP_reg3]
DW$336	.dwtag  DW_TAG_assign_register, DW_AT_name("AR0")
	.dwattr DW$336, DW_AT_location[DW_OP_reg4]
DW$337	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR0")
	.dwattr DW$337, DW_AT_location[DW_OP_reg5]
DW$338	.dwtag  DW_TAG_assign_register, DW_AT_name("AR1")
	.dwattr DW$338, DW_AT_location[DW_OP_reg6]
DW$339	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR1")
	.dwattr DW$339, DW_AT_location[DW_OP_reg7]
DW$340	.dwtag  DW_TAG_assign_register, DW_AT_name("AR2")
	.dwattr DW$340, DW_AT_location[DW_OP_reg8]
DW$341	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR2")
	.dwattr DW$341, DW_AT_location[DW_OP_reg9]
DW$342	.dwtag  DW_TAG_assign_register, DW_AT_name("AR3")
	.dwattr DW$342, DW_AT_location[DW_OP_reg10]
DW$343	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR3")
	.dwattr DW$343, DW_AT_location[DW_OP_reg11]
DW$344	.dwtag  DW_TAG_assign_register, DW_AT_name("AR4")
	.dwattr DW$344, DW_AT_location[DW_OP_reg12]
DW$345	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR4")
	.dwattr DW$345, DW_AT_location[DW_OP_reg13]
DW$346	.dwtag  DW_TAG_assign_register, DW_AT_name("AR5")
	.dwattr DW$346, DW_AT_location[DW_OP_reg14]
DW$347	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR5")
	.dwattr DW$347, DW_AT_location[DW_OP_reg15]
DW$348	.dwtag  DW_TAG_assign_register, DW_AT_name("AR6")
	.dwattr DW$348, DW_AT_location[DW_OP_reg16]
DW$349	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR6")
	.dwattr DW$349, DW_AT_location[DW_OP_reg17]
DW$350	.dwtag  DW_TAG_assign_register, DW_AT_name("AR7")
	.dwattr DW$350, DW_AT_location[DW_OP_reg18]
DW$351	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR7")
	.dwattr DW$351, DW_AT_location[DW_OP_reg19]
DW$352	.dwtag  DW_TAG_assign_register, DW_AT_name("SP")
	.dwattr DW$352, DW_AT_location[DW_OP_reg20]
DW$353	.dwtag  DW_TAG_assign_register, DW_AT_name("XT")
	.dwattr DW$353, DW_AT_location[DW_OP_reg21]
DW$354	.dwtag  DW_TAG_assign_register, DW_AT_name("T")
	.dwattr DW$354, DW_AT_location[DW_OP_reg22]
DW$355	.dwtag  DW_TAG_assign_register, DW_AT_name("ST0")
	.dwattr DW$355, DW_AT_location[DW_OP_reg23]
DW$356	.dwtag  DW_TAG_assign_register, DW_AT_name("ST1")
	.dwattr DW$356, DW_AT_location[DW_OP_reg24]
DW$357	.dwtag  DW_TAG_assign_register, DW_AT_name("PC")
	.dwattr DW$357, DW_AT_location[DW_OP_reg25]
DW$358	.dwtag  DW_TAG_assign_register, DW_AT_name("RPC")
	.dwattr DW$358, DW_AT_location[DW_OP_reg26]
DW$359	.dwtag  DW_TAG_assign_register, DW_AT_name("FP")
	.dwattr DW$359, DW_AT_location[DW_OP_reg27]
DW$360	.dwtag  DW_TAG_assign_register, DW_AT_name("DP")
	.dwattr DW$360, DW_AT_location[DW_OP_reg28]
DW$361	.dwtag  DW_TAG_assign_register, DW_AT_name("SXM")
	.dwattr DW$361, DW_AT_location[DW_OP_reg29]
DW$362	.dwtag  DW_TAG_assign_register, DW_AT_name("PM")
	.dwattr DW$362, DW_AT_location[DW_OP_reg30]
DW$363	.dwtag  DW_TAG_assign_register, DW_AT_name("OVM")
	.dwattr DW$363, DW_AT_location[DW_OP_reg31]
DW$364	.dwtag  DW_TAG_assign_register, DW_AT_name("PAGE0")
	.dwattr DW$364, DW_AT_location[DW_OP_regx 0x20]
DW$365	.dwtag  DW_TAG_assign_register, DW_AT_name("AMODE")
	.dwattr DW$365, DW_AT_location[DW_OP_regx 0x21]
DW$366	.dwtag  DW_TAG_assign_register, DW_AT_name("IFR")
	.dwattr DW$366, DW_AT_location[DW_OP_regx 0x22]
DW$367	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$367, DW_AT_location[DW_OP_regx 0x23]
DW$368	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$368, DW_AT_location[DW_OP_regx 0x24]
DW$369	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDO")
	.dwattr DW$369, DW_AT_location[DW_OP_regx 0x25]
DW$370	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDOH")
	.dwattr DW$370, DW_AT_location[DW_OP_regx 0x26]
DW$371	.dwtag  DW_TAG_assign_register, DW_AT_name("VOL")
	.dwattr DW$371, DW_AT_location[DW_OP_regx 0x27]
DW$372	.dwtag  DW_TAG_assign_register, DW_AT_name("CIE_RETA")
	.dwattr DW$372, DW_AT_location[DW_OP_regx 0x28]
	.dwendtag DW$CU
