...
void RUN_SECOND()
{
	...
	MOVE_TO_MOVE(_IQ17(500.0), _IQ17(0.0), _IQ17(SECOND_SPEED_U32), _IQ17(SECOND_SPEED_U32), _IQ15(MOTOR_ACCEL_U32));
	...
	while(1)
	{
		...
		if(ERROR_U16_FLAG)	{	MOVE_TO_MOVE(_IQ17(500.0), _IQ17(0.0), _IQ17(SECOND_SPEED_U32), _IQ17(SECOND_SPEED_U32), _IQ15(MOTOR_ACCEL_U32));	Flag.Fast_U16 = OFF;	ERROR_U16_FLAG = OFF;	}
		else;
	} 
}
