...
#define ACCEL_COEF			1.5		//coefficeint
#define	ACCELTIMING_COEF	3.0
...
//____________________________________________________________________________________//
	...
	volatile	_iq15	NextAccel_IQ15;

	volatile	_iq17	ErrorVelocity_IQ17;		//	TargetVel + NextVel
	volatile	_iq15	AccelTime_IQ15;			//	MAX Accel Holding Time
	volatile	_iq15	AccelTimeDivCOEF_IQ15;	//	AccelTime / timing coef * 10000
	volatile	_iq15	AccelDT_IQ15;			//	Accel Delta Time
	volatile	_iq15	Jerk_IQ15;
...
__VARIABLE_EXT__ Uint32	SECOND_SPEED_U32;		//필요 여부 확인 해야함
