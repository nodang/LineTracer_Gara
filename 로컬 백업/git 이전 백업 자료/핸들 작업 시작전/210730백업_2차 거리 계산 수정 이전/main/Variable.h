...
#define	HEIGHT_ME			255.0		// 약 255mm
...
#define STOP_TIMING_IQ16(A)		_IQ16div(_IQ16mpy(_IQ16div(_IQ16(5.0), _IQ16(6.0)), _IQ16(HEIGHT_ME)), A)
#define STOP_JERK_IQ16(B)		_IQ16div(_IQ16div(_IQ16div(_IQ16div(_IQ16(HEIGHT_ME), _IQ16(1000.0)), STOP_TIMING_IQ16(B)), STOP_TIMING_IQ16(B)), STOP_TIMING_IQ16(B))
...
//------------------------------------------------------------------------------------//
	...
	volatile	_iq16	MaxTargetAcc_IQ16;

	volatile	_iq17	TargetHandle_IQ17;
	volatile	_iq16	AccActable_IQ16;
