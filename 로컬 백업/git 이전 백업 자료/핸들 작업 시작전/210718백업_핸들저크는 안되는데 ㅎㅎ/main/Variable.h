...
#define STOP_TIMING_IQ17(A)		_IQ17div(_IQ17mpy(_IQ17div(_IQ17(5.0), _IQ17(6.0)), _IQ17(HEIGHT_ME)), A)
#define STOP_JERK_IQ17(B)		_IQ17div(_IQ17div(_IQ17div(_IQ16(HEIGHT_ME), STOP_TIMING_IQ17(B)), STOP_TIMING_IQ17(B)), STOP_TIMING_IQ17(B))
...
//____________________________________________________________________________________//
	...
	volatile	_iq17	ErrorVelocity_IQ17;			//	(TargetVel + NextVel)/2
	volatile	_iq15	AccelTimeDiv10000_IQ15;		//	MAX Accel Holding Time / 10000
	volatile	_iq15	AccelHoldTimeDiv10000_IQ15;
	volatile	_iq15	AccelDT_IQ15;				//	Accel Delta Time

	volatile	Uint16	AccHold_U16;
	volatile	Uint16	AccStep_U16;

	// Handle Section
	volatile	_iq17	H_NextAccel_IQ17;			
	volatile	_iq17	H_NextVelo_IQ17;

	volatile	_iq17	H_ErrorVelocity_IQ17;		//	(TargetVel + NextVel)/2
	volatile	_iq15	H_AccelTimeDiv10000_IQ15;	//	MAX Accel Holding Time / 10000
	volatile	_iq15	H_AccelHoldTimeDiv10000_IQ15;
	volatile	_iq15	H_AccelDT_IQ15;				//	Accel Delta Time

	volatile	Uint16	H_AccHold_U16;
	volatile	Uint16	H_AccStep_U16;
...
__VARIABLE_EXT__ Uint32	ACCEL_COEF_U32;
__VARIABLE_EXT__ Uint32	DECEL_COEF_U32;

__VARIABLE_EXT__ _iq17	HANDLE_ACC_IQ17;
__VARIABLE_EXT__ _iq17	HANDLE_DEC_IQ17;
// And here.
