...
void RUN_SECOND()
{
	...
	MOVE_TO_MOVE(_IQ17(500.0), _IQ17(0.0), _IQ15(MOTOR_SPEED_U32), _IQ15(MOTOR_SPEED_U32), _IQ15(MOTOR_ACCEL_U32));

	GpioDataRegs.GPASET.all = MOTOR_ResetEnable;
	while(1)
	{
	
	//TxPrintf("%5ld %5ld %5ld %5ld %4ld %4ld %4ld %4ld %u %u\n", LMotor.TargetAcc_IQ15 >> 15, RMotor.TargetAcc_IQ15 >> 15, LMotor.PrdNext_IQ14 >> 14, RMotor.PrdNext_IQ14 >> 14, LMotor.Velocity_IQ15 >> 18, RMotor.Velocity_IQ15 >> 18, LMotor.NextVelocity_IQ15 >> 18, RMotor.NextVelocity_IQ15 >> 18, EPwm1Regs.TBCTL.bit.CLKDIV, EPwm2Regs.TBCTL.bit.CLKDIV);
		POSITION_COMPUTE();
		HANDLE();
		...
		if(ERROR_U16_FLAG)	{	MOVE_TO_MOVE(_IQ17(500.0), _IQ17(0.0), _IQ15(MOTOR_SPEED_U32), _IQ15(MOTOR_SPEED_U32), _IQ15(MOTOR_ACCEL_U32));		Flag.Fast_U16 = OFF;	ERROR_U16_FLAG = OFF;	}
		else;
	} 
}
...
{	
	MOVE_TO_MOVE(	_IQ17(LINE->Distance_U32), LINE->DecelDistance_IQ7 << 10, LINE->Velo_IQ7 << 8, LINE->VeloOut_IQ7 << 8, _IQ15(LINE->Accel_U32)	);
