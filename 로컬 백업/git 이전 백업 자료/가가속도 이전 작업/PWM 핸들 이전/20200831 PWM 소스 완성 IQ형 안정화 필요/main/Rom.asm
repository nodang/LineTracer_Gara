...
DW$50	.dwtag  DW_TAG_variable, DW_AT_name("save_rom"), DW_AT_symbol_name("_save_rom")
	...
	.dwattr DW$49, DW_AT_end_line(0x14a)
...
DW$54	.dwtag  DW_TAG_subprogram, DW_AT_name("save_mark_rom"), DW_AT_symbol_name("_save_mark_rom")
	...
	.dwattr DW$54, DW_AT_begin_line(0x176)
...
;***************************************************************
_save_mark_rom:
;*** 380	-----------------------    mark_rom[0] = MARK_U16_CNT&0xffu;
;*** 381	-----------------------    mark_rom[1] = MARK_U16_CNT>>8;
;*** 383	-----------------------    SpiWriteRom(5u, 0u, 2u, &mark_rom);
;*** 383	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$55	.dwtag  DW_TAG_variable, DW_AT_name("mark_rom"), DW_AT_symbol_name("_mark_rom")
	...
	.dwpsn	"Rom.c",380,2
        ...
        MOVB      AL.LSB,@_MARK_U16_CNT ; |380| 
        MOV       *-SP[2],AL            ; |380| 
	.dwpsn	"Rom.c",381,2
        MOV       AL,@_MARK_U16_CNT     ; |381| 
        LSR       AL,8                  ; |381| 
        MOV       *-SP[1],AL            ; |381| 
	.dwpsn	"Rom.c",383,2
        MOVZ      AR4,SP                ; |383| 
        ...
        MOVB      ACC,#5
        SUBB      XAR4,#2               ; |383| 
        LCR       #_SpiWriteRom         ; |383| 
        ; call occurs [#_SpiWriteRom] ; |383| 
	.dwpsn	"Rom.c",384,1
        SUBB      SP,#2
	.dwcfa	0x1d, -2
        LRETR
	...
	.dwattr DW$54, DW_AT_end_line(0x180)
...
DW$56	.dwtag  DW_TAG_subprogram, DW_AT_name("save_line_info_rom"), DW_AT_symbol_name("_save_line_info_rom")
	...
	.dwattr DW$56, DW_AT_begin_line(0x18d)
...
;***	-----------------------g2:
;*** 411	-----------------------    *U$28++ = (*U$22).Distance_U32&0xffuL;
;*** 412	-----------------------    *U$28++ = (unsigned)(*U$22).Distance_U32>>8;
;*** 414	-----------------------    *U$38++ = (*U$22).TurnWay_U32&0xffuL;
;*** 415	-----------------------    *U$38++ = (unsigned)(*U$22).TurnWay_U32>>8;
;*** 417	-----------------------    *U$46++ = (*U$22).Distance_L_U32&0xffuL;
;*** 418	-----------------------    *U$46++ = (unsigned)(*U$22).Distance_L_U32>>8;
;*** 420	-----------------------    *U$54++ = (*U$22).Distance_R_U32&0xffuL;
;*** 421	-----------------------    *U$54++ = (unsigned)(*U$22).Distance_R_U32>>8;
;*** 423	-----------------------    *U$62++ = (*U$22).CrossPlus_U32&0xffuL;
;*** 424	-----------------------    *U$62++ = (unsigned)(*U$22).CrossPlus_U32>>8;
;*** 409	-----------------------    U$22 += 24;
;*** 409	-----------------------    if ( (--L$1) != (-1) ) goto g2;
	.dwpsn	"Rom.c",411,3
        MOVL      XAR0,XAR3
        MOVL      ACC,*+XAR0[4]         ; |411| 
        ANDB      AL,#0xff              ; |411| 
...
;*** 427	-----------------------    SpiWriteRom(6u, 0u, 256u, &dist_rom);
;*** 428	-----------------------    SpiWriteRom(8u, 0u, 256u, &turn_rom);
;*** 429	-----------------------    SpiWriteRom(10u, 0u, 256u, &ldist_rom);
;*** 430	-----------------------    SpiWriteRom(12u, 0u, 256u, &rdist_rom);
;*** 431	-----------------------    SpiWriteRom(14u, 0u, 256u, &cross_rom);
;***  	-----------------------    #pragma MUST_ITERATE(128, 128, 128)
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;***  	-----------------------    U$22 = &Search[128];
;***  	-----------------------    U$62 = &cross_rom[0];
...
;*** 452	-----------------------    SpiWriteRom(7u, 0u, 256u, &dist_rom);
;*** 453	-----------------------    SpiWriteRom(9u, 0u, 256u, &turn_rom);
;*** 454	-----------------------    SpiWriteRom(11u, 0u, 256u, &ldist_rom);
;*** 455	-----------------------    SpiWriteRom(13u, 0u, 256u, &rdist_rom);
;*** 456	-----------------------    SpiWriteRom(15u, 0u, 256u, &cross_rom);
;*** 456	-----------------------    return;
	.dwpsn	"Rom.c",452,2
        MOVZ      AR4,SP                ; |452| 
        MOVL      XAR5,#256             ; |452| 
...
DW$76	.dwtag  DW_TAG_loop
	.dwattr DW$76, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Rom.asm:L2:1:1598809994")
	.dwattr DW$76, DW_AT_begin_file("Rom.c")
	.dwattr DW$76, DW_AT_begin_line(0x1b2)
	.dwattr DW$76, DW_AT_end_line(0x1c2)
...
DW$78	.dwtag  DW_TAG_loop
	.dwattr DW$78, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Rom.asm:L1:1:1598809994")
	.dwattr DW$78, DW_AT_begin_file("Rom.c")
	.dwattr DW$78, DW_AT_begin_line(0x199)
	.dwattr DW$78, DW_AT_end_line(0x1a9)
DW$79	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$56, DW_AT_end_line(0x1ca)
...
DW$80	.dwtag  DW_TAG_subprogram, DW_AT_name("save_handle_rom"), DW_AT_symbol_name("_save_handle_rom")
	...
	.dwattr DW$80, DW_AT_begin_line(0x15a)
...
;*** 357	-----------------------    SpiWriteRom(4u, 0u, 8u, &save_rom);
;*** 357	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$81	.dwtag  DW_TAG_variable, DW_AT_name("save_rom"), DW_AT_symbol_name("_save_rom")
	...
	.dwpsn	"Rom.c",357,2
        ...
        MOVB      ACC,#4
        SUBB      XAR4,#8               ; |357| 
        LCR       #_SpiWriteRom         ; |357| 
        ; call occurs [#_SpiWriteRom] ; |357| 
	.dwpsn	"Rom.c",358,1
        SUBB      SP,#8
	.dwcfa	0x1d, -2
        LRETR
...
DW$86	.dwtag  DW_TAG_subprogram, DW_AT_name("load_sensitive_rom"), DW_AT_symbol_name("_load_sensitive_rom")
	...
	.dwattr DW$86, DW_AT_begin_line(0x14c)
...
DW$91	.dwtag  DW_TAG_subprogram, DW_AT_name("load_mark_rom"), DW_AT_symbol_name("_load_mark_rom")
	...
	.dwattr DW$91, DW_AT_begin_line(0x182)
...
_load_mark_rom:
;*** 389	-----------------------    mark_rom[] = {...};
;*** 391	-----------------------    SpiReadRom(5u, 0u, 2u, &mark_rom);
;*** 394	-----------------------    MARK_U16_CNT = mark_rom[1]<<8|mark_rom[0]&0xffu;
;*** 394	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$92	.dwtag  DW_TAG_variable, DW_AT_name("mark_rom"), DW_AT_symbol_name("_mark_rom")
	...
	.dwpsn	"Rom.c",389,9
        MOVZ      AR4,SP                ; |389| 
        MOVB      ACC,#2
        MOVL      XAR5,#_$T11$12$0      ; |389| 
        SUBB      XAR4,#2               ; |389| 
        LCR       #___memcpy_ff         ; |389| 
        ; call occurs [#___memcpy_ff] ; |389| 
	.dwpsn	"Rom.c",391,2
        MOVZ      AR4,SP                ; |391| 
        MOVB      XAR5,#2               ; |391| 
        MOVB      ACC,#5
        SUBB      XAR4,#2               ; |391| 
        LCR       #_SpiReadRom          ; |391| 
        ; call occurs [#_SpiReadRom] ; |391| 
	.dwpsn	"Rom.c",394,2
        MOV       AH,*-SP[1]            ; |394| 
        MOV       AL,*-SP[2]            ; |394| 
        MOVB      AL.MSB,AH             ; |394| 
        MOVW      DP,#_MARK_U16_CNT
        MOV       @_MARK_U16_CNT,AL     ; |394| 
	.dwpsn	"Rom.c",395,1
        SUBB      SP,#2
	.dwcfa	0x1d, -2
        LRETR
	...
	.dwattr DW$91, DW_AT_end_line(0x18b)
...
DW$93	.dwtag  DW_TAG_subprogram, DW_AT_name("load_line_info_rom"), DW_AT_symbol_name("_load_line_info_rom")
	...
	.dwattr DW$93, DW_AT_begin_line(0x1cc)
...
;*** 467	-----------------------    rdist_rom[] = {...};
;*** 468	-----------------------    cross_rom[] = {...};
;*** 471	-----------------------    SpiReadRom(6u, 0u, 256u, &dist_rom);
;*** 472	-----------------------    SpiReadRom(8u, 0u, 256u, &turn_rom);
;*** 473	-----------------------    SpiReadRom(10u, 0u, 256u, &ldist_rom);
;*** 474	-----------------------    SpiReadRom(12u, 0u, 256u, &rdist_rom);
;*** 475	-----------------------    SpiReadRom(14u, 0u, 256u, &cross_rom);
;***  	-----------------------    #pragma MUST_ITERATE(128, 128, 128)
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;***  	-----------------------    U$65 = &cross_rom[0];
;***  	-----------------------    U$58 = &rdist_rom[0];
...
;***	-----------------------g2:
;*** 479	-----------------------    (*U$38).Distance_U32 = (long)(*U$28++&0xffu);
;*** 480	-----------------------    (*U$38).Distance_U32 |= *U$28++<<8;
;*** 482	-----------------------    (*U$38).TurnWay_U32 = (long)(*U$44++&0xffu);
;*** 483	-----------------------    (*U$38).TurnWay_U32 |= *U$44++<<8;
;*** 485	-----------------------    (*U$38).Distance_L_U32 = (long)(*U$51++&0xffu);
;*** 486	-----------------------    (*U$38).Distance_L_U32 |= *U$51++<<8;
;*** 488	-----------------------    (*U$38).Distance_R_U32 = (long)(*U$58++&0xffu);
;*** 489	-----------------------    (*U$38).Distance_R_U32 |= *U$58++<<8;
;*** 491	-----------------------    (*U$38).CrossPlus_U32 = (long)(*U$65++&0xffu);
;*** 492	-----------------------    (*U$38).CrossPlus_U32 |= *U$65++<<8;
;*** 477	-----------------------    U$38 += 24;
;*** 477	-----------------------    if ( (--L$1) != (-1) ) goto g2;
	.dwpsn	"Rom.c",479,3
        MOVL      XAR0,XAR3             ; |479| 
        MOV       AL,*XAR1++            ; |479| 
        ANDB      AL,#0xff              ; |479| 
...
;*** 496	-----------------------    SpiReadRom(7u, 0u, 256u, &dist_rom);
;*** 497	-----------------------    SpiReadRom(9u, 0u, 256u, &turn_rom);
;*** 498	-----------------------    SpiReadRom(11u, 0u, 256u, &ldist_rom);
;*** 499	-----------------------    SpiReadRom(13u, 0u, 256u, &rdist_rom);
;*** 500	-----------------------    SpiReadRom(15u, 0u, 256u, &cross_rom);
;***  	-----------------------    #pragma MUST_ITERATE(128, 128, 128)
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;***  	-----------------------    U$38 = &Search[128];
;***  	-----------------------    U$65 = &cross_rom[0];
...
;*** 520	-----------------------    return;
	.dwpsn	"Rom.c",520,2
        LCR       #_load_mark_rom       ; |520| 
        ; call occurs [#_load_mark_rom] ; |520| 
	.dwpsn	"Rom.c",521,1
        ADD       SP,#-1280
	.dwcfa	0x1d, -6
        MOVL      XAR3,*--SP
...
DW$113	.dwtag  DW_TAG_loop
	.dwattr DW$113, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Rom.asm:L4:1:1598809994")
...
DW$115	.dwtag  DW_TAG_loop
	.dwattr DW$115, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Rom.asm:L3:1:1598809994")
	.dwattr DW$115, DW_AT_begin_file("Rom.c")
	.dwattr DW$115, DW_AT_begin_line(0x1dd)
	.dwattr DW$115, DW_AT_end_line(0x1ed)
DW$116	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$93, DW_AT_end_line(0x209)
...
DW$117	.dwtag  DW_TAG_subprogram, DW_AT_name("load_handle_rom"), DW_AT_symbol_name("_load_handle_rom")
	...
	.dwattr DW$117, DW_AT_begin_line(0x168)
...
_load_handle_rom:
;*** 363	-----------------------    load_rom[] = {...};
;*** 365	-----------------------    SpiReadRom(4u, 0u, 8u, &load_rom);
;*** 368	-----------------------    HandleAcc_U16_CNT = load_rom[1]<<8|load_rom[0]&0xffu;
;*** 371	-----------------------    HandleDec_U16_CNT = load_rom[3]<<8|load_rom[2]&0xffu;
;*** 371	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$118	.dwtag  DW_TAG_variable, DW_AT_name("load_rom"), DW_AT_symbol_name("_load_rom")
	...
	.dwpsn	"Rom.c",368,2
        ...
        MOVW      DP,#_HandleAcc_U16_CNT
        MOVB      AL.MSB,AH             ; |368| 
        MOV       @_HandleAcc_U16_CNT,AL ; |368| 
	.dwpsn	"Rom.c",371,2
        MOV       AH,*-SP[5]            ; |371| 
        MOV       AL,*-SP[6]            ; |371| 
        MOVB      AL.MSB,AH             ; |371| 
        MOVW      DP,#_HandleDec_U16_CNT
        MOV       @_HandleDec_U16_CNT,AL ; |371| 
	.dwpsn	"Rom.c",372,1
        SUBB      SP,#8
	.dwcfa	0x1d, -2
        LRETR
	...
	.dwattr DW$117, DW_AT_end_line(0x174)
...
DW$145	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$145, DW_AT_name("AdcValue_U16"), DW_AT_symbol_name("_AdcValue_U16")
	.dwattr DW$145, DW_AT_data_member_location[DW_OP_plus_uconst 0x46]
	.dwattr DW$145, DW_AT_accessibility(DW_ACCESS_public)
DW$146	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$146, DW_AT_name("MaxminusMin_IQ17"), DW_AT_symbol_name("_MaxminusMin_IQ17")
	.dwattr DW$146, DW_AT_data_member_location[DW_OP_plus_uconst 0x56]
...
DW$T$20	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$20, DW_AT_type(*DW$159)
...
DW$162	.dwtag  DW_TAG_far_type
	.dwattr DW$162, DW_AT_type(*DW$T$23)
DW$T$24	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$24, DW_AT_type(*DW$162)
