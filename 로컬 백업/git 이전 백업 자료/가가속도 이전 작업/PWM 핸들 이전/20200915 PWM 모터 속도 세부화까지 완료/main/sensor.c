...
void START_END_LINE()
{
	...
	else if((Flag.MoveState_U16 == ON) && (TIME_INDEX_U32 > (10000)))	
	{
		...
		RMotor.StopAccel_IQ15 = _IQ5mpy(_IQ5div(RMotor.NextVelocity_IQ15 >> 10, _IQ5(HEIGHT_ME)), RMotor.NextVelocity_IQ15 >> 10);
		...
		LMotor.StopAccel_IQ15 = _IQ5mpy(_IQ5div(LMotor.NextVelocity_IQ15 >> 10, _IQ5(HEIGHT_ME)), LMotor.NextVelocity_IQ15 >> 10);
