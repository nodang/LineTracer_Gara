...
//__VARIABLE_EXT__ Uint16	MAXMIN_SENSITIVE_U16;
...
#define MOTOR_HOLD		0x0400304f												//	0000 0100 0000 0000  0011 0000 0100 1111
...
#define STEP_D_IQ22		_IQ22(0.418224522)

#define STEP_D_IQ17		_IQ17(0.418224522)	//_IQ17(0.4084)	// ver12	angle	0.9
#define STEP_2D_IQ17	_IQ17(0.836449044)	//<-3M tape | nomal tape->_IQ17(0.8168)	// ver12	anlge	0.9 * 2				or 			ver2		anlge	1.8
#define STEP_4D_IQ17	_IQ17(1.6729)	//<-3M tape | nomal tape->_IQ17(1.6336)	// ver2		anlge	1.8 * 2
//#define STEP_8D_IQ17	_IQ17(3.2673)

#define STEP_D_IQ16		_IQ16(0.418224522)	//_IQ16(0.4084)	// ver12	angle	0.9
#define STEP_2D_IQ16	_IQ16(0.836449044)	//<-3M tape | nomal tape->_IQ16(0.8168)	// ver12	anlge	0.9 * 2				or 			ver2		anlge	1.8
#define STEP_4D_IQ16	_IQ16(1.6729)	//<-3M tape | nomal tape->_IQ16(1.6336)	// ver2		anlge	1.8 * 2
//#define STEP_8D_IQ16	_IQ16(3.2673)

#define STEP_D_IQ15		_IQ15(0.418224522)	//_IQ15(0.4084)	//	(R*pi/360)*1.8 //0.4003
#define STEP_2D_IQ15	_IQ15(0.836449044)	//<-3M tape | nomal tape->_IQ15(0.8168)	//	D*2 //0.8006

#define PERIOD_2SECOND					2000000//80000
#define PERIOD_1SECOND					1000000//40000
#define PERIOD_1div2SECOND				500000//20000
#define PERIOD_1div4SECOND				250000//20000

#define PERIOD_1SECONDdivCPUTIMER		_IQ1(10000000.0)		//	1 000 000 / 25 = 40 000
//#define PERIOD_3div4SECONDdivCPUTIMER	_IQ1(30000.0)			//	0 750 000 / 25 = 30 000
#define PERIOD_1div2SECONDdivCPUTIMER	_IQ1(500000.0)		//	0 500 000 / 25 = 20 000
#define PERIOD_1div4SECONDdivCPUTIMER	_IQ1(250000.0)		//	0 250 000 / 25 = 10 000

#define	HEIGHT_ME_IQ22	_IQ22(300.0)		// Turnmark and wheel distance * 2

#define MOTOR_PERIOD_LIMIT		65535.0
#define CPUTIMER_2_RPD_IQ15		_IQ15(CpuTimer2Regs.PRD.all)


typedef struct
{
	_iq15	TargetAcc_IQ15;			//	TARGETA_CCEL
	_iq15	TargetVel_IQ15;			//	TARGET_VELOCITY
	volatile	_iq15	Velocity_IQ15;			//	NOW_VELOCITY
	volatile	_iq15	NextVelocity_IQ15;		//	NEXT_VELOCITY
	volatile	_iq15	NextVelminusVel_IQ15;
...
//____________________________________________________________________________________//
	...
	volatile	_iq15	PrdNext_IQ15;
	volatile	_iq15	Prd_IQ15;
	volatile	_iq15	PrdHandle_IQ15;
	volatile	_iq22	PrdNextTranSecon_IQ22;
	volatile	_iq22	PrdTranSecon_IQ22;
	volatile	_iq15	PrdTranSeconBackset_IQ15;
	_iq22	CputmrTranSecon_IQ22;

	volatile	_iq22	RolEach_IQ22;
	volatile	_iq22	RolEachStep_IQ22;
}MOTORCTRL;
...
__VARIABLE_EXT__ volatile	Uint16	SECOND_MARK_U16_CNT;
