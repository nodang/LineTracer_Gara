...
void START_END_LINE()
{
	...
	else if((Flag.MoveState_U16 == ON) && (TIME_INDEX_U32 > (10000)))	
	{
		...
		RMotor.StopAccel_IQ15 = _IQ15mpy(RMotor.Velocity_IQ15, _IQ16div(RMotor.Velocity_IQ15, HEIGHT_ME_IQ22 >> 6));
		LMotor.StopAccel_IQ15 = _IQ15mpy(LMotor.Velocity_IQ15, _IQ16div(LMotor.Velocity_IQ15, HEIGHT_ME_IQ22 >> 6));
