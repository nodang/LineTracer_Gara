...
void Init_MotorCtrl(MOTORCTRL *pM)
{
	...
	pM->PrdNext_IQ14 = _IQ14(MOTOR_PERIOD_LIMIT);
	
	pM->CputmrTranSecon_IQ27	= _IQ27mpyIQX(_IQ21mpyIQX(_IQ21(0.01), 21, CPUTIMER_2_RPD_IQ15, 15), 21, _IQ27(0.01), 27);
...
void MOTOR_MOTION_VALUE(MOTORCTRL *pM)
{
	...
	pM->PrdTranSecon_IQ27	= _IQ27mpyIQX(_IQ21mpyIQX(_IQ21(0.01), 21, pM->Prd_IQ14, 14), 21, _IQ27(0.01), 27);
	
	pM->RolEach_IQ27		= _IQ27div(pM->CputmrTranSecon_IQ27, pM->PrdTranSecon_IQ27);
	pM->RolEachStep100_IQ17	= _IQ17mpyIQX(STEP_10000D_IQ17, 17, pM->RolEach_IQ27, 27);
	pM->RolEachStep_IQ17	= _IQ17mpyIQX(STEP_D_IQ17, 17, pM->RolEach_IQ27, 27);

	pM->Velocity_IQ15		= _IQ17div(pM->RolEachStep100_IQ17, pM->PrdTranSecon_IQ27 >> 10) >> 2;
	...
	pM->PrdNextTranSecon_IQ17	= _IQ17sqrt(_IQ17div(_IQ17mpyIQX(STEP_10000D_IQ17, 17, pM->CputmrTranSecon_IQ27, 27),  pM->NextVelocity_IQ15 << 2));
	pM->PrdNext_IQ14			= _IQ14mpyIQX(_IQ14(10000.0), 14, pM->PrdNextTranSecon_IQ17, 17);
		
	if(pM->PrdNext_IQ14 > _IQ14(MOTOR_PERIOD_LIMIT))	pM->PrdNext_IQ14 	= _IQ14(MOTOR_PERIOD_LIMIT);
	else if(pM->PrdNext_IQ14 < _IQ14(10000.0))  		pM->PrdNext_IQ14 	= _IQ14(10000.0);
	else;
