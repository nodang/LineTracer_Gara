...
void HANDLE(Uint32 speed)
{
	if(SenAdc.PositionTemporary_IQ10 > _IQ10(0.0))			// Right curve
	{
		RMotor.HandleVelo_IQ17 = _IQ17mpy(_IQ7(_IQ10div(SenAdc.PositionTemporary_IQ10, _IQ10(POSITION_WEIGHT_I32[15]))), _IQ17mpy(RMotor.TargetVel_IQ17, HANDLE_DEC_IQ17));
		LMotor.HandleVelo_IQ17 = _IQ17mpy(_IQ7(_IQ10div(SenAdc.PositionTemporary_IQ10, _IQ10(POSITION_WEIGHT_I32[0]))), _IQ17mpy(LMotor.TargetVel_IQ17, HANDLE_ACC_IQ17));
	}
	else if(SenAdc.PositionTemporary_IQ10 < _IQ10(0.0))		// left curve
	{
		RMotor.HandleVelo_IQ17 = _IQ17mpy(_IQ7(_IQ10div(SenAdc.PositionTemporary_IQ10, _IQ10(POSITION_WEIGHT_I32[15]))), _IQ17mpy(RMotor.TargetVel_IQ17, HANDLE_ACC_IQ17));
		LMotor.HandleVelo_IQ17 = _IQ17mpy(_IQ7(_IQ10div(SenAdc.PositionTemporary_IQ10, _IQ10(POSITION_WEIGHT_I32[0]))), _IQ17mpy(LMotor.TargetVel_IQ17, HANDLE_DEC_IQ17));
	}
	else													// Straight
	{
		RMotor.HandleVelo_IQ17 = _IQ17(0.0);	
		LMotor.HandleVelo_IQ17 = _IQ17(0.0);
	}
	RMotor.H_AccStep_U16 = LMotor.H_AccStep_U16 = 0;
	RMotor.H_AccHold_U16 = LMotor.H_AccHold_U16 = OFF;
	...
	/*
	SenAdc.Theta_IQ15 = _IQ1(_IQ15atan2(_IQ15div(_IQ5(SenAdc.PositionTemporary_IQ10), _IQ15(100.0)),  _IQ15(HEIGHT_BODY)));
	//SenAdc.Radius_IQ15 = _IQ15div(_IQ15(HEIGHT_BODY), SenAdc.Theta_IQ15);OO
	RMotor.CurveDist_IQ15 = -_IQ15mpy(_IQ15(HEIGHT_REARdiv2), SenAdc.Theta_IQ15);
	LMotor.CurveDist_IQ15 = _IQ15mpy(_IQ15(HEIGHT_REARdiv2), SenAdc.Theta_IQ15);

	if(SenAdc.PositionTemporary_IQ10 > _IQ10(0.0))			// Right curve
	{
		RMotor.HandleVelo_IQ17 = _IQ12(_IQ5sqrt(_IQ5mpyIQX(-RMotor.CurveDist_IQ15, 15, _IQ10mpy(DECELdivVEL_IQ10(speed), _IQ10(10.0)), 10)));
		LMotor.HandleVelo_IQ17 = _IQ12(_IQ5sqrt(_IQ5mpyIQX(LMotor.CurveDist_IQ15, 15, _IQ10mpy(ACCELdivVEL_IQ10(speed), _IQ10(10.0)), 10)));

		RMotor.Handle_IQ17 = _IQ17div(RMotor.NextVelocity_IQ17 + RMotor.HandleVelo_IQ17, RMotor.NextVelocity_IQ17);
		LMotor.Handle_IQ17 = _IQ17div(LMotor.NextVelocity_IQ17, LMotor.NextVelocity_IQ17 + LMotor.HandleVelo_IQ17);
	}
	else if(SenAdc.PositionTemporary_IQ10 < _IQ10(0.0))		// left curve
	{
		RMotor.HandleVelo_IQ17 = _IQ12(_IQ5sqrt(_IQ5mpyIQX(RMotor.CurveDist_IQ15, 15, _IQ10mpy(ACCELdivVEL_IQ10(speed), _IQ10(10.0)), 10)));
		LMotor.HandleVelo_IQ17 = _IQ12(_IQ5sqrt(_IQ5mpyIQX(-LMotor.CurveDist_IQ15, 15, _IQ10mpy(DECELdivVEL_IQ10(speed), _IQ10(10.0)), 10)));

		RMotor.Handle_IQ17 = _IQ17div(RMotor.NextVelocity_IQ17, RMotor.NextVelocity_IQ17 + RMotor.HandleVelo_IQ17);
		LMotor.Handle_IQ17 = _IQ17div(LMotor.NextVelocity_IQ17 + LMotor.HandleVelo_IQ17, LMotor.NextVelocity_IQ17);
	}
	else													// Straight
	{	
		RMotor.HandleVelo_IQ17 = _IQ17(0.0);	LMotor.HandleVelo_IQ17 = _IQ17(0.0);
		RMotor.Handle_IQ17 = _IQ17(1.0);		LMotor.Handle_IQ17 = _IQ17(1.0);
	}*/	
}
