...
{	
	...
	HANDLE_ACC_IQ17 = _IQ17(1.0) + _IQ17mpy(_IQ17(0.1), _IQ17(ACCEL_COEF_U32));
	HANDLE_DEC_IQ17 = _IQ17(1.0) - _IQ17mpy(_IQ17(0.1), _IQ17(DECEL_COEF_U32));
...
void Init_MotorCtrl(MOTORCTRL *pM)
{
	...
	pM->Jerk_IQ17		= _IQ17(5.0);		// 5000/1000
...
{	
	...
	{
		pM->NextVelocity_IQ17	+= _IQ17mpy(_IQ17div(pM->NextAccel_IQ17, _IQ17(TEN_THOUSAND)), CPUTIMER_2_PRDdiv10000_IQ17);
	...
	// Handle Velocity Compute
	if(pM->H_NextVelo_IQ17< pM->HandleVelo_IQ17)
	{
		pM->H_NextVelo_IQ17	+= _IQ17mpy(_IQ17div(pM->H_NextAccel_IQ17, _IQ17(TEN_THOUSAND)), CPUTIMER_2_PRDdiv10000_IQ17);
		if(pM->H_NextVelo_IQ17 >= pM->HandleVelo_IQ17)		pM->H_NextVelo_IQ17 		= pM->HandleVelo_IQ17;
		else;
	}
	else if(pM->H_NextVelo_IQ17 > pM->HandleVelo_IQ17)
	{
		pM->H_NextVelo_IQ17	+= _IQ17mpy(_IQ17div(pM->H_NextAccel_IQ17, _IQ17(TEN_THOUSAND)), CPUTIMER_2_PRDdiv10000_IQ17);
		if(pM->H_NextVelo_IQ17 <= pM->HandleVelo_IQ17)		pM->H_NextVelo_IQ17 		= pM->HandleVelo_IQ17;
		else;
	...
	pM->MaxTargetAcc_Iq17 = MAX_ACC_IQ17 - _IQ17mpy(ACC_GRADIENT_IQ17, pM->NextVelocity_IQ17);
	...
	switch(pM->AccStep_U16)
	{
		case 0 :
			if(labs(pM->NextVelocity_IQ17 - pM->TargetVel_IQ17) > pM->ErrorVelocity_IQ17)			
			{
				if(pM->AccHold_U16)		pM->AccelHoldTimeDiv10000_IQ15 += CPUTIMER_2_PRDdiv10000_IQ15;
				else
				{
					if(pM->NextVelocity_IQ17 < pM->TargetVel_IQ17)			pM->NextAccel_IQ17 += _IQ17mpy(pM->Jerk_IQ17, CPUTIMER_2_PRDdiv10000_IQ17);
					else if(pM->NextVelocity_IQ17 > pM->TargetVel_IQ17)		pM->NextAccel_IQ17 -= _IQ17mpy(pM->Jerk_IQ17, CPUTIMER_2_PRDdiv10000_IQ17);
					else;

					if((pM->NextAccel_IQ17 > pM->MaxTargetAcc_Iq17) || (pM->NextAccel_IQ17 < -(pM->MaxTargetAcc_Iq17)))		pM->AccHold_U16 = ON;
					else																									pM->AccelTimeDiv10000_IQ15 += CPUTIMER_2_PRDdiv10000_IQ15;
				}
			}
			else	
			{
		...
		case 1 :
			if(pM->AccelHoldTimeDiv10000_IQ15 > pM->AccelDT_IQ15)		pM->AccelDT_IQ15 += CPUTIMER_2_PRDdiv10000_IQ15;
			else	
			{
				pM->AccStep_U16 = 2;
				pM->AccelDT_IQ15 = _IQ15(0.0);
				pM->AccelHoldTimeDiv10000_IQ15 = _IQ15(0.0);
			}
			break;
			
		case 2 :
			if(pM->AccelTimeDiv10000_IQ15 >= pM->AccelDT_IQ15)	
			{
				if(pM->NextVelocity_IQ17 < pM->TargetVel_IQ17)
				{
					pM->NextAccel_IQ17 -= _IQ17mpy(pM->Jerk_IQ17, CPUTIMER_2_PRDdiv10000_IQ17);
				...
				pM->AccelDT_IQ15 += CPUTIMER_2_PRDdiv10000_IQ15;
			}
			else
			{
				pM->AccStep_U16 = 3;
				pM->AccelDT_IQ15 = _IQ15(0.0);
				pM->AccelTimeDiv10000_IQ15 = _IQ15(0.0);
				pM->NextAccel_IQ17 = _IQ17(0.0);
			}
			break;
			
	}
	// Handle Accel Compute
	switch(pM->H_AccStep_U16)
	{
		case 0:
			//pM->HandleVelo_IQ17 = _IQ17(0.0); //pM->TargetVel_IQ17;
			if(pM->HandleVelo_IQ17 > (MAX_VELO_IQ17 - pM->TargetVel_IQ17))		pM->HandleVelo_IQ17 = (MAX_VELO_IQ17 - pM->TargetVel_IQ17);
			pM->H_ErrorVelocity_IQ17 = (labs(pM->HandleVelo_IQ17 - pM->H_NextVelo_IQ17) >> 1);
			pM->H_AccStep_U16 = 1;
			break;
		case 1:
			if(labs(pM->H_NextVelo_IQ17 - pM->HandleVelo_IQ17) > pM->H_ErrorVelocity_IQ17)			
			{
				if(pM->H_AccHold_U16)		pM->H_AccelHoldTimeDiv10000_IQ15 += CPUTIMER_2_PRDdiv10000_IQ15;
				else
				{
					if(pM->H_NextVelo_IQ17 < pM->HandleVelo_IQ17)			pM->H_NextAccel_IQ17 += _IQ17mpy(pM->Jerk_IQ17, CPUTIMER_2_PRDdiv10000_IQ17);
					else if(pM->H_NextVelo_IQ17 > pM->HandleVelo_IQ17)		pM->H_NextAccel_IQ17 -= _IQ17mpy(pM->Jerk_IQ17, CPUTIMER_2_PRDdiv10000_IQ17);
					else;

					if((pM->H_NextAccel_IQ17 > (pM->MaxTargetAcc_Iq17 - labs(pM->NextAccel_IQ17))) || (pM->H_NextAccel_IQ17 < -(pM->MaxTargetAcc_Iq17 - labs(pM->NextAccel_IQ17))))	pM->H_AccHold_U16 = ON;
					else																															pM->H_AccelTimeDiv10000_IQ15 += CPUTIMER_2_PRDdiv10000_IQ15;
				}
			}
			else	{		pM->H_AccHold_U16 = OFF;		pM->H_AccStep_U16 = 2;		}
			break;
		case 2:
			if(pM->H_AccelHoldTimeDiv10000_IQ15 > pM->H_AccelDT_IQ15)		pM->H_AccelDT_IQ15 += CPUTIMER_2_PRDdiv10000_IQ15;
			else
			{
				pM->H_AccStep_U16 = 3;
				pM->H_AccelDT_IQ15 = _IQ15(0.0);
				pM->H_AccelHoldTimeDiv10000_IQ15 = _IQ15(0.0);
			}
			break;
		case 3:
			if(pM->H_AccelTimeDiv10000_IQ15 >= pM->H_AccelDT_IQ15)	
			{
				if(pM->H_NextVelo_IQ17 < pM->HandleVelo_IQ17)
				{
					pM->H_NextAccel_IQ17 -= _IQ17mpy(pM->Jerk_IQ17, CPUTIMER_2_PRDdiv10000_IQ17);
					if(pM->H_NextAccel_IQ17 < _IQ17(0.0))		pM->H_NextAccel_IQ17 = _IQ17(0.0);
					else;
				}
				else if(pM->H_NextVelo_IQ17 > pM->HandleVelo_IQ17)	
				{
				...
				pM->H_AccelDT_IQ15 += CPUTIMER_2_PRDdiv10000_IQ15;
			}
			else
			{
				pM->H_AccStep_U16 = 0;
				pM->H_AccelDT_IQ15 = _IQ15(0.0);
				pM->H_AccelTimeDiv10000_IQ15 = _IQ15(0.0);
				pM->H_NextAccel_IQ17 = _IQ17(0.0);
			}
			break;
	}
...
{	
	...
	RMotor.ErrorVelocity_IQ17 = (labs(RMotor.TargetVel_IQ17 - RMotor.NextVelocity_IQ17) >> 1);
	LMotor.ErrorVelocity_IQ17 = (labs(LMotor.TargetVel_IQ17 - LMotor.NextVelocity_IQ17) >> 1);

	RMotor.DecelFlag_U16 = LMotor.DecelFlag_U16 = ON;
	RMotor.AccStep_U16 = LMotor.AccStep_U16 = RMotor.H_AccStep_U16 = LMotor.H_AccStep_U16 = 0;
	RMotor.AccHold_U16 = LMotor.AccHold_U16 = RMotor.H_AccHold_U16 = LMotor.H_AccHold_U16 = OFF;

	RMotor.AccelDT_IQ15 = RMotor.AccelTimeDiv10000_IQ15 = RMotor.AccelHoldTimeDiv10000_IQ15 = _IQ15(0.0);
	LMotor.AccelDT_IQ15 = LMotor.AccelTimeDiv10000_IQ15 = LMotor.AccelHoldTimeDiv10000_IQ15 = _IQ15(0.0);

	RMotor.H_AccelDT_IQ15 = RMotor.H_AccelTimeDiv10000_IQ15 = RMotor.H_AccelHoldTimeDiv10000_IQ15 = _IQ15(0.0);
	LMotor.H_AccelDT_IQ15 = LMotor.H_AccelTimeDiv10000_IQ15 = LMotor.H_AccelHoldTimeDiv10000_IQ15 = _IQ15(0.0);
...
void MOVE_TO_END(_iq17 distance)
{
	...
	RMotor.Jerk_IQ17 = STOP_JERK_IQ17(RMotor.NextVelocity_IQ17);
	LMotor.Jerk_IQ17 = STOP_JERK_IQ17(LMotor.NextVelocity_IQ17);;
...
{	
	...
	{	
		...
		EPwm1Regs.TBPRD = (Uint16)(RMotor.PrdNext_IQ14 >> 13);
		EPwm1Regs.CMPA.half.CMPA =  ((EPwm1Regs.TBPRD) >> 1) + ((EPwm1Regs.TBPRD) >> 2);
		
		EPwm2Regs.TBPRD = (Uint16)(LMotor.PrdNext_IQ14 >> 13);
