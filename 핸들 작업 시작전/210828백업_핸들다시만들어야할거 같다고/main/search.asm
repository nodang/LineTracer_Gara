...
DW$3	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$96)
	.dwendtag DW$1
...
DW$14	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$79)
	.dwendtag DW$9
...
DW$20	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$88)
...
DW$34	.dwtag  DW_TAG_variable, DW_AT_name("STOP_TIME_INDEX_U32"), DW_AT_symbol_name("_STOP_TIME_INDEX_U32")
...
DW$49	.dwtag  DW_TAG_variable, DW_AT_name("RMotor"), DW_AT_symbol_name("_RMotor")
	.dwattr DW$49, DW_AT_type(*DW$T$123)
...
;*** 63	-----------------------    GpioDataRegs.GPASET.all = 96uL;
;*** 64	-----------------------    GpioDataRegs.GPACLEAR.all = 96uL;
;*** 66	-----------------------    *&EPwm1Regs |= 0x1c00u;
;*** 67	-----------------------    *&EPwm2Regs |= 0x1c00u;
;*** 69	-----------------------    EPwm1Regs.TBPRD = 0xfffeu;
;*** 70	-----------------------    EPwm2Regs.TBPRD = 0xfffeu;
;*** 70	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
	...
	.dwpsn	"search.c",66,2
        MOVW      DP,#_EPwm1Regs
        OR        @_EPwm1Regs,#0x1c00   ; |66| 
	.dwpsn	"search.c",67,2
        MOVW      DP,#_EPwm2Regs
        OR        @_EPwm2Regs,#0x1c00   ; |67| 
	.dwpsn	"search.c",69,2
        MOVW      DP,#_EPwm1Regs+5
        MOV       @_EPwm1Regs+5,#65534  ; |69| 
	.dwpsn	"search.c",70,2
        MOVW      DP,#_EPwm2Regs+5
        MOV       @_EPwm2Regs+5,#65534  ; |70| 
	.dwpsn	"search.c",71,1
        LRETR
        ; return occurs
	.dwattr DW$51, DW_AT_end_file("search.c")
	.dwattr DW$51, DW_AT_end_line(0x47)
...
DW$52	.dwtag  DW_TAG_subprogram, DW_AT_name("RUN"), DW_AT_symbol_name("_RUN")
	...
	.dwattr DW$52, DW_AT_begin_line(0x49)
...
_RUN:
;*** 75	-----------------------    Init_RUN();
;*** 77	-----------------------    VFDPrintf("1stREADY");
;*** 78	-----------------------    DSP28x_usDelay(0x1312cfeuL);
;*** 79	-----------------------    VFDPrintf("        ");
;*** 81	-----------------------    *&Flag |= 0x40u;
;*** 82	-----------------------    *&Flag |= 4u;
;*** 83	-----------------------    *&Flag |= 2u;
;*** 85	-----------------------    C$1 = (long)((long double)MOTOR_SPEED_U32*1.31072e5L);
;*** 85	-----------------------    MOVE_TO_MOVE(65536000L, 0L, C$1, C$1, (long)((long double)JERK_U32*65536.0L));
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        MOVL      *SP++,XAR1
...
DW$54	.dwtag  DW_TAG_variable, DW_AT_name("K$29"), DW_AT_symbol_name("K$29")
	.dwattr DW$54, DW_AT_type(*DW$T$96)
	.dwattr DW$54, DW_AT_location[DW_OP_reg6]
;* AR3   assigned to K$33
DW$55	.dwtag  DW_TAG_variable, DW_AT_name("K$33"), DW_AT_symbol_name("K$33")
	...
	.dwpsn	"search.c",85,2
        ...
        SUBB      XAR6,#16              ; |85| 
        MOVL      ACC,@_MOTOR_SPEED_U32 ; |85| 
        LCR       #UL$$TOFD             ; |85| 
        ; call occurs [#UL$$TOFD] ; |85| 
        MOVZ      AR6,SP                ; |85| 
        MOVZ      AR4,SP                ; |85| 
        SUBB      XAR6,#12              ; |85| 
        SUBB      XAR4,#16              ; |85| 
...
;*** 87	-----------------------    GpioDataRegs.GPASET.all = 96uL;
;***  	-----------------------    #pragma LOOP_FLAGS(5376u)
	.dwpsn	"search.c",87,2
        MOVB      ACC,#96
        MOVW      DP,#_GpioDataRegs+2
        MOVL      XAR3,#_LMark          ; |102| 
        MOVL      @_GpioDataRegs+2,ACC  ; |87| 
L1:    
DW$L$_RUN$3$B:
;***	-----------------------g2:
;*** 99	-----------------------    POSITION_COMPUTE();
...
;*** 102	-----------------------    K$33 = &LMark;
;*** 102	-----------------------    K$29 = &RMark;
;*** 102	-----------------------    (*K$33).TurnmarkDistance_IQ17 = (*K$29).TurnmarkDistance_IQ17 = (RMotor.TurnMarkCheckDistance_IQ17>>1)+(LMotor.TurnMarkCheckDistance_IQ17>>1);
;*** 104	-----------------------    TURN_DECIDE(K$29, K$33);
;*** 105	-----------------------    TURN_DECIDE(K$33, K$29);
;*** 106	-----------------------    if ( LINE_OUT_STOP() ) goto g4;
	.dwpsn	"search.c",99,3
        LCR       #_POSITION_COMPUTE    ; |99| 
        ; call occurs [#_POSITION_COMPUTE] ; |99| 
...
DW$56	.dwtag  DW_TAG_loop
	.dwattr DW$56, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L1:1:1630093851")
	.dwattr DW$56, DW_AT_begin_file("search.c")
	.dwattr DW$56, DW_AT_begin_line(0x59)
	.dwattr DW$56, DW_AT_end_line(0x6c)
DW$57	.dwtag  DW_TAG_loop_range
	.dwattr DW$57, DW_AT_low_pc(DW$L$_RUN$3$B)
	.dwattr DW$57, DW_AT_high_pc(DW$L$_RUN$3$E)
DW$58	.dwtag  DW_TAG_loop_range
	.dwattr DW$58, DW_AT_low_pc(DW$L$_RUN$4$B)
	.dwattr DW$58, DW_AT_high_pc(DW$L$_RUN$4$E)
	.dwendtag DW$56

	.dwattr DW$52, DW_AT_end_file("search.c")
	.dwattr DW$52, DW_AT_end_line(0x6d)
...
DW$59	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_PRINTF"), DW_AT_symbol_name("_LINE_PRINTF")
	.dwattr DW$59, DW_AT_low_pc(_LINE_PRINTF)
	.dwattr DW$59, DW_AT_high_pc(0x00)
	.dwattr DW$59, DW_AT_begin_file("search.c")
	.dwattr DW$59, DW_AT_begin_line(0x84)
...
DW$61	.dwtag  DW_TAG_variable, DW_AT_name("map_U16_cnt"), DW_AT_symbol_name("_map_U16_cnt")
	.dwattr DW$61, DW_AT_type(*DW$T$20)
	.dwattr DW$61, DW_AT_location[DW_OP_breg20 -7]
;* AR1   assigned to _menu_U16_cnt
DW$62	.dwtag  DW_TAG_variable, DW_AT_name("menu_U16_cnt"), DW_AT_symbol_name("_menu_U16_cnt")
...
DW$63	.dwtag  DW_TAG_variable, DW_AT_name("U$16"), DW_AT_symbol_name("U$16")
	.dwattr DW$63, DW_AT_type(*DW$T$131)
...
DW$64	.dwtag  DW_TAG_variable, DW_AT_name("U$16"), DW_AT_symbol_name("U$16")
	.dwattr DW$64, DW_AT_type(*DW$T$131)
	.dwattr DW$64, DW_AT_location[DW_OP_reg12]
DW$65	.dwtag  DW_TAG_variable, DW_AT_name("shutdown_U16"), DW_AT_symbol_name("_shutdown_U16")
...
;***	-----------------------g10:
;*** 205	-----------------------    U$16 = &Search[(long)map_U16_cnt];
;*** 205	-----------------------    switch ( (*U$16).TurnWay_U32 ) {case 1uL: goto g11;, case 2uL: goto g11;, case 4uL: goto g11;, case 4096uL: goto g11;, case 8192uL: goto g11;, DEFAULT goto g15};
	.dwpsn	"search.c",205,4
        MOV       T,#24                 ; |205| 
        MOVL      XAR5,#_Search         ; |205| 
        MPYXU     ACC,T,*-SP[7]         ; |205| 
        ADDL      XAR5,ACC
        MOVL      XAR6,*+XAR5[6]        ; |205| 
        MOVB      XAR7,#1
        MOVL      ACC,XAR6              ; |205| 
        SUBB      ACC,#1                ; |205| 
        CMPL      ACC,XAR7              ; |205| 
...
;***	-----------------------g11:
;*** 208	-----------------------    VFDPrintf("%3u:%4lu", map_U16_cnt, (*U$16).TurnDir_U32);
;*** 209	-----------------------    goto g21;
...
;***	-----------------------g13:
;*** 185	-----------------------    VFDPrintf("%3u:%4lu", map_U16_cnt, (*U$16).Distance_U32);
;*** 186	-----------------------    goto g21;
...
;***	-----------------------g21:
;*** 228	-----------------------    if ( !(*(&GpioDataRegs+1)&0x8000u) ) goto g24;
...
;*** 229	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g25;
	.dwpsn	"search.c",229,8
        TBIT      @_GpioDataRegs,#15    ; |229| 
        BF        L21,TC                ; |229| 
        ; branchcc occurs ; |229| 
DW$L$_LINE_PRINTF$35$E:
DW$L$_LINE_PRINTF$36$B:
;*** 231	-----------------------    DSP28x_usDelay(2499998uL);
;*** 232	-----------------------    (menu_U16_cnt < 2u) ? (menu_U16_cnt = menu_U16_cnt+1u) : (menu_U16_cnt = 0u);
...
;*** 228	-----------------------    shutdown_U16 = 0u;
	.dwpsn	"search.c",228,16
        MOV       AL,#9630
        MOV       AH,#38
        LCR       #_DSP28x_usDelay      ; |228| 
        ; call occurs [#_DSP28x_usDelay] ; |228| 
	.dwpsn	"search.c",228,36
        MOV       *-SP[8],#0            ; |228| 
DW$L$_LINE_PRINTF$39$E:
L21:    
DW$L$_LINE_PRINTF$40$B:
;***	-----------------------g25:
;*** 235	-----------------------    MENU_SW(&map_U16_cnt, MARK_U16_CNT);
;*** 236	-----------------------    if ( shutdown_U16 ) goto g9;
	.dwpsn	"search.c",235,3
        MOVZ      AR4,SP                ; |235| 
        MOVW      DP,#_MARK_U16_CNT
        MOV       AL,@_MARK_U16_CNT     ; |235| 
        SUBB      XAR4,#7               ; |235| 
        LCR       #_MENU_SW             ; |235| 
        ; call occurs [#_MENU_SW] ; |235| 
...
DW$66	.dwtag  DW_TAG_loop
	.dwattr DW$66, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L6:1:1630093851")
	.dwattr DW$66, DW_AT_begin_file("search.c")
	.dwattr DW$66, DW_AT_begin_line(0x9a)
	.dwattr DW$66, DW_AT_end_line(0xec)
DW$67	.dwtag  DW_TAG_loop_range
	.dwattr DW$67, DW_AT_low_pc(DW$L$_LINE_PRINTF$8$B)
	.dwattr DW$67, DW_AT_high_pc(DW$L$_LINE_PRINTF$8$E)
DW$68	.dwtag  DW_TAG_loop_range
	.dwattr DW$68, DW_AT_low_pc(DW$L$_LINE_PRINTF$36$B)
	.dwattr DW$68, DW_AT_high_pc(DW$L$_LINE_PRINTF$36$E)
DW$69	.dwtag  DW_TAG_loop_range
	.dwattr DW$69, DW_AT_low_pc(DW$L$_LINE_PRINTF$26$B)
	.dwattr DW$69, DW_AT_high_pc(DW$L$_LINE_PRINTF$26$E)
...
DW$72	.dwtag  DW_TAG_loop_range
	.dwattr DW$72, DW_AT_low_pc(DW$L$_LINE_PRINTF$23$B)
	.dwattr DW$72, DW_AT_high_pc(DW$L$_LINE_PRINTF$23$E)
DW$73	.dwtag  DW_TAG_loop_range
	.dwattr DW$73, DW_AT_low_pc(DW$L$_LINE_PRINTF$24$B)
	.dwattr DW$73, DW_AT_high_pc(DW$L$_LINE_PRINTF$24$E)
DW$74	.dwtag  DW_TAG_loop_range
	.dwattr DW$74, DW_AT_low_pc(DW$L$_LINE_PRINTF$25$B)
	.dwattr DW$74, DW_AT_high_pc(DW$L$_LINE_PRINTF$25$E)
DW$75	.dwtag  DW_TAG_loop_range
	.dwattr DW$75, DW_AT_low_pc(DW$L$_LINE_PRINTF$27$B)
	.dwattr DW$75, DW_AT_high_pc(DW$L$_LINE_PRINTF$27$E)
...
DW$80	.dwtag  DW_TAG_loop_range
	.dwattr DW$80, DW_AT_low_pc(DW$L$_LINE_PRINTF$11$B)
	.dwattr DW$80, DW_AT_high_pc(DW$L$_LINE_PRINTF$11$E)
DW$81	.dwtag  DW_TAG_loop_range
	.dwattr DW$81, DW_AT_low_pc(DW$L$_LINE_PRINTF$12$B)
	.dwattr DW$81, DW_AT_high_pc(DW$L$_LINE_PRINTF$12$E)
DW$82	.dwtag  DW_TAG_loop_range
	.dwattr DW$82, DW_AT_low_pc(DW$L$_LINE_PRINTF$13$B)
	.dwattr DW$82, DW_AT_high_pc(DW$L$_LINE_PRINTF$13$E)
DW$83	.dwtag  DW_TAG_loop_range
	.dwattr DW$83, DW_AT_low_pc(DW$L$_LINE_PRINTF$14$B)
	.dwattr DW$83, DW_AT_high_pc(DW$L$_LINE_PRINTF$14$E)
DW$84	.dwtag  DW_TAG_loop_range
	.dwattr DW$84, DW_AT_low_pc(DW$L$_LINE_PRINTF$9$B)
	.dwattr DW$84, DW_AT_high_pc(DW$L$_LINE_PRINTF$9$E)
DW$85	.dwtag  DW_TAG_loop_range
	.dwattr DW$85, DW_AT_low_pc(DW$L$_LINE_PRINTF$10$B)
	.dwattr DW$85, DW_AT_high_pc(DW$L$_LINE_PRINTF$10$E)
DW$86	.dwtag  DW_TAG_loop_range
	.dwattr DW$86, DW_AT_low_pc(DW$L$_LINE_PRINTF$15$B)
	.dwattr DW$86, DW_AT_high_pc(DW$L$_LINE_PRINTF$15$E)
DW$87	.dwtag  DW_TAG_loop_range
	.dwattr DW$87, DW_AT_low_pc(DW$L$_LINE_PRINTF$20$B)
	.dwattr DW$87, DW_AT_high_pc(DW$L$_LINE_PRINTF$20$E)
DW$88	.dwtag  DW_TAG_loop_range
	.dwattr DW$88, DW_AT_low_pc(DW$L$_LINE_PRINTF$28$B)
	.dwattr DW$88, DW_AT_high_pc(DW$L$_LINE_PRINTF$28$E)
DW$89	.dwtag  DW_TAG_loop_range
	.dwattr DW$89, DW_AT_low_pc(DW$L$_LINE_PRINTF$29$B)
	.dwattr DW$89, DW_AT_high_pc(DW$L$_LINE_PRINTF$29$E)
DW$90	.dwtag  DW_TAG_loop_range
	.dwattr DW$90, DW_AT_low_pc(DW$L$_LINE_PRINTF$30$B)
	.dwattr DW$90, DW_AT_high_pc(DW$L$_LINE_PRINTF$30$E)
DW$91	.dwtag  DW_TAG_loop_range
	.dwattr DW$91, DW_AT_low_pc(DW$L$_LINE_PRINTF$31$B)
	.dwattr DW$91, DW_AT_high_pc(DW$L$_LINE_PRINTF$31$E)
...
DW$96	.dwtag  DW_TAG_loop_range
	.dwattr DW$96, DW_AT_low_pc(DW$L$_LINE_PRINTF$37$B)
	.dwattr DW$96, DW_AT_high_pc(DW$L$_LINE_PRINTF$37$E)
DW$97	.dwtag  DW_TAG_loop_range
	.dwattr DW$97, DW_AT_low_pc(DW$L$_LINE_PRINTF$38$B)
	.dwattr DW$97, DW_AT_high_pc(DW$L$_LINE_PRINTF$38$E)
DW$98	.dwtag  DW_TAG_loop_range
	.dwattr DW$98, DW_AT_low_pc(DW$L$_LINE_PRINTF$39$B)
	.dwattr DW$98, DW_AT_high_pc(DW$L$_LINE_PRINTF$39$E)
DW$99	.dwtag  DW_TAG_loop_range
	.dwattr DW$99, DW_AT_low_pc(DW$L$_LINE_PRINTF$40$B)
	.dwattr DW$99, DW_AT_high_pc(DW$L$_LINE_PRINTF$40$E)
	.dwendtag DW$66


DW$100	.dwtag  DW_TAG_loop
	.dwattr DW$100, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L5:1:1630093851")
	.dwattr DW$100, DW_AT_begin_file("search.c")
	.dwattr DW$100, DW_AT_begin_line(0x8e)
	.dwattr DW$100, DW_AT_end_line(0x92)
DW$101	.dwtag  DW_TAG_loop_range
	.dwattr DW$101, DW_AT_low_pc(DW$L$_LINE_PRINTF$6$B)
	.dwattr DW$101, DW_AT_high_pc(DW$L$_LINE_PRINTF$6$E)
DW$102	.dwtag  DW_TAG_loop_range
	.dwattr DW$102, DW_AT_low_pc(DW$L$_LINE_PRINTF$2$B)
	.dwattr DW$102, DW_AT_high_pc(DW$L$_LINE_PRINTF$2$E)
DW$103	.dwtag  DW_TAG_loop_range
	.dwattr DW$103, DW_AT_low_pc(DW$L$_LINE_PRINTF$5$B)
	.dwattr DW$103, DW_AT_high_pc(DW$L$_LINE_PRINTF$5$E)
DW$104	.dwtag  DW_TAG_loop_range
	.dwattr DW$104, DW_AT_low_pc(DW$L$_LINE_PRINTF$4$B)
	.dwattr DW$104, DW_AT_high_pc(DW$L$_LINE_PRINTF$4$E)
DW$105	.dwtag  DW_TAG_loop_range
	.dwattr DW$105, DW_AT_low_pc(DW$L$_LINE_PRINTF$3$B)
	.dwattr DW$105, DW_AT_high_pc(DW$L$_LINE_PRINTF$3$E)
	.dwendtag DW$100
...
DW$106	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_INFO"), DW_AT_symbol_name("_LINE_INFO")
	...
	.dwattr DW$106, DW_AT_begin_line(0x6f)
...
;* AR4   assigned to _mark
DW$110	.dwtag  DW_TAG_variable, DW_AT_name("mark"), DW_AT_symbol_name("_mark")
	.dwattr DW$110, DW_AT_type(*DW$T$113)
	.dwattr DW$110, DW_AT_location[DW_OP_reg12]
;* AR6   assigned to U$11
DW$111	.dwtag  DW_TAG_variable, DW_AT_name("U$11"), DW_AT_symbol_name("U$11")
	.dwattr DW$111, DW_AT_type(*DW$T$131)
	.dwattr DW$111, DW_AT_location[DW_OP_reg16]
;* AR4   assigned to U$11
DW$112	.dwtag  DW_TAG_variable, DW_AT_name("U$11"), DW_AT_symbol_name("U$11")
	.dwattr DW$112, DW_AT_type(*DW$T$131)
	.dwattr DW$112, DW_AT_location[DW_OP_reg12]
;* AR5   assigned to K$10
DW$113	.dwtag  DW_TAG_variable, DW_AT_name("K$10"), DW_AT_symbol_name("K$10")
	.dwattr DW$113, DW_AT_type(*DW$T$131)
	.dwattr DW$113, DW_AT_location[DW_OP_reg14]
;* AR5   assigned to K$10
DW$114	.dwtag  DW_TAG_variable, DW_AT_name("K$10"), DW_AT_symbol_name("K$10")
	.dwattr DW$114, DW_AT_type(*DW$T$131)
...
L25:    
        MOVB      XAR6,#4
L26:    
;*** 127	-----------------------    U$11 = &K$10[(long)MARK_U16_CNT];
;*** 127	-----------------------    (*U$11).TurnWay_U32 = S$1;
;*** 128	-----------------------    if ( MARK_U16_CNT == 0u || S$1 != (K$10[(long)(MARK_U16_CNT-1u)]).TurnWay_U32 ) goto g7;
        MOV       T,#24                 ; |127| 
...
L27:    
	...
	.dwattr DW$106, DW_AT_end_line(0x82)
...
DW$116	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$10)
DW$117	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$84)
	.dwendtag DW$T$85


DW$T$89	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$89, DW_AT_language(DW_LANG_C)
DW$118	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$88)
DW$119	.dwtag  DW_TAG_unspecified_parameters
	.dwendtag DW$T$89
...
DW$124	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$79)
	.dwendtag DW$T$93


DW$T$97	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$97, DW_AT_language(DW_LANG_C)
DW$125	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$96)
DW$126	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$96)
	.dwendtag DW$T$97


DW$T$99	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$99, DW_AT_language(DW_LANG_C)
DW$127	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$23)
	.dwendtag DW$T$99


DW$T$101	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$101, DW_AT_language(DW_LANG_C)
DW$128	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$96)
	.dwendtag DW$T$101
...
DW$T$105	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$105, DW_AT_type(*DW$129)
...
DW$T$111	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$111, DW_AT_type(*DW$130)
DW$T$84	.dwtag  DW_TAG_typedef, DW_AT_name("size_t"), DW_AT_type(*DW$T$13)
	.dwattr DW$T$84, DW_AT_language(DW_LANG_C)
DW$T$95	.dwtag  DW_TAG_typedef, DW_AT_name("TURNMARK"), DW_AT_type(*DW$T$21)
...
DW$T$106	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$106, DW_AT_type(*DW$136)
...
DW$T$81	.dwtag  DW_TAG_structure_type
	.dwattr DW$T$81, DW_AT_byte_size(0x26)
...
DW$194	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$78)
...
DW$196	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$74)
...
DW$200	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$74)
...
DW$T$128	.dwtag  DW_TAG_typedef, DW_AT_name("TRACKINFO"), DW_AT_type(*DW$T$83)
...
DW$216	.dwtag  DW_TAG_far_type
	.dwattr DW$216, DW_AT_type(*DW$T$75)
DW$T$76	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$76, DW_AT_type(*DW$216)
DW$217	.dwtag  DW_TAG_far_type
	.dwattr DW$217, DW_AT_type(*DW$T$77)
DW$T$78	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$78, DW_AT_type(*DW$217)
DW$218	.dwtag  DW_TAG_far_type
	.dwattr DW$218, DW_AT_type(*DW$T$79)
DW$T$80	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$80, DW_AT_type(*DW$218)
...
DW$226	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$31)
...
DW$228	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$33)
	.dwattr DW$228, DW_AT_name("half"), DW_AT_symbol_name("_half")
...
DW$232	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$37)
...
DW$242	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$47)
...
DW$248	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$53)
...
DW$254	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$59)
...
DW$256	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$61)
...
DW$258	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$63)
...
DW$260	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$65)
...
DW$262	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$67)
...
DW$266	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$71)
...
DW$267	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$267, DW_AT_name("MoveState_U16"), DW_AT_symbol_name("_MoveState_U16")
...
DW$268	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$268, DW_AT_name("Motor_U16"), DW_AT_symbol_name("_Motor_U16")
...
DW$269	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$269, DW_AT_name("Sensor_U16"), DW_AT_symbol_name("_Sensor_U16")
...
DW$270	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$270, DW_AT_name("Cross"), DW_AT_symbol_name("_Cross")
...
DW$271	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$271, DW_AT_name("CrossFlag_U16"), DW_AT_symbol_name("_CrossFlag_U16")
...
DW$272	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$272, DW_AT_name("STOP"), DW_AT_symbol_name("_STOP")
...
DW$273	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$273, DW_AT_name("Search_U16"), DW_AT_symbol_name("_Search_U16")
...
DW$274	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$274, DW_AT_name("Fast_U16"), DW_AT_symbol_name("_Fast_U16")
...
DW$275	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$275, DW_AT_name("Extrem_U16"), DW_AT_symbol_name("_Extrem_U16")
...
DW$276	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$276, DW_AT_name("TxFlag_U16"), DW_AT_symbol_name("_TxFlag_U16")
