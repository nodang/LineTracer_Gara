...
;* Date/Time created: Tue Jul 06 05:06:11 2021                 *
;***************************************************************
...
;	..\Compiler\bin\opt2000.exe C:\Users\노호진\AppData\Local\Temp\TI15210 C:\Users\노호진\AppData\Local\Temp\TI1524 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\노호진\AppData\Local\Temp\TI1522 --template_info_file C:\Users\노호진\AppData\Local\Temp\TI1526 --object_file sensor.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
DW$76	.dwtag  DW_TAG_subprogram, DW_AT_name("MARK_ENABLE_SHIFT"), DW_AT_symbol_name("_MARK_ENABLE_SHIFT")
	...
	.dwattr DW$76, DW_AT_begin_line(0x1b5)
...
;*** 441	-----------------------    goto g6;
	.dwpsn	"sensor.c",441,17
        MOV       *+XAR4[4],#61440      ; |441| 
	.dwpsn	"sensor.c",441,53
        MOV       *+XAR5[4],#15         ; |441| 
        BF        L3,UNC                ; |441| 
        ; branch occurs ; |441| 
L1:    
...
L3:    
	...
	.dwattr DW$76, DW_AT_end_line(0x1ba)
...
DW$81	.dwtag  DW_TAG_subprogram, DW_AT_name("TURN_DECIDE"), DW_AT_symbol_name("_TURN_DECIDE")
	...
	.dwattr DW$81, DW_AT_begin_line(0x1bc)
...
;***************************************************************
_TURN_DECIDE:
;*** 446	-----------------------    v$2 = *((unsigned * const)mark+5);
;*** 446	-----------------------    if ( v$2&2u ) goto g10;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$91	.dwtag  DW_TAG_variable, DW_AT_name("K$12"), DW_AT_symbol_name("K$12")
	...
	.dwpsn	"sensor.c",446,2
        MOVZ      AR7,*+XAR6[5]         ; |446| 
        AND       AL,AR7,#0x0002        ; |446| 
        BF        L7,NEQ                ; |446| 
        ; branchcc occurs ; |446| 
;*** 487	-----------------------    K$12 = &RMark;
;*** 487	-----------------------    MARK_ENABLE_SHIFT(&LMark, K$12);
;*** 489	-----------------------    if ( !((*mark).MarkEnable_U16&SENSOR_STATE_U16) ) goto g9;
	...
	.dwpsn	"sensor.c",489,2
        ...
        BF        L6,EQ                 ; |489| 
        ; branchcc occurs ; |489| 
;*** 491	-----------------------    C$1 = *((unsigned * const)mark+5);
;*** 491	-----------------------    if ( !(C$1&1u) ) goto g8;
	.dwpsn	"sensor.c",491,3
        MOVZ      AR4,*+XAR6[5]         ; |491| 
        AND       AL,AR4,#0x0001        ; |491| 
        BF        L5,EQ                 ; |491| 
        ; branchcc occurs ; |491| 
;*** 500	-----------------------    v$1 = (*mark).TurnmarkDistance_IQ17;
;*** 500	-----------------------    if ( v$1 <= (*mark).LimitDistance_IQ17 ) goto g23;
	.dwpsn	"sensor.c",500,8
        ...
        BF        L13,LEQ               ; |500| 
        ; branchcc occurs ; |500| 
;*** 502	-----------------------    *((unsigned * const)mark+5) = C$1|2u;
;*** 503	-----------------------    (*mark).LimitDistance_IQ17 = v$1+7864320L;
;*** 505	-----------------------    if ( mark == K$12 ) goto g7;
	...
	.dwpsn	"sensor.c",505,4
        ...
        BF        L4,EQ                 ; |505| 
        ; branchcc occurs ; |505| 
;*** 506	-----------------------    *(&GpioDataRegs+10L) |= 2u;
;*** 506	-----------------------    goto g23;
	.dwpsn	"sensor.c",506,12
        MOVW      DP,#_GpioDataRegs+10
        OR        @_GpioDataRegs+10,#0x0002 ; |506| 
        BF        L13,UNC               ; |506| 
        ; branch occurs ; |506| 
L4:    
;***	-----------------------g7:
...
;*** 497	-----------------------    (*mark).LimitDistance_IQ17 = 655360L;
;*** 498	-----------------------    *((unsigned * const)mark+5) |= 1u;
;*** 499	-----------------------    goto g23;
	.dwpsn	"sensor.c",493,4
        MOVB      ACC,#0
        MOVW      DP,#_RMotor+16
        MOVL      @_RMotor+16,ACC       ; |493| 
	.dwpsn	"sensor.c",494,4
        MOVW      DP,#_LMotor+16
        MOVL      @_LMotor+16,ACC       ; |494| 
	.dwpsn	"sensor.c",495,4
        MOVL      *+XAR6[0],ACC         ; |495| 
	.dwpsn	"sensor.c",497,4
        MOVL      XAR4,#655360          ; |497| 
        MOVL      *+XAR6[2],XAR4        ; |497| 
	.dwpsn	"sensor.c",498,4
        OR        *+XAR6[5],#0x0001     ; |498| 
	.dwpsn	"sensor.c",499,3
        BF        L13,UNC               ; |499| 
        ; branch occurs ; |499| 
L6:    
;***	-----------------------g9:
;*** 512	-----------------------    (*mark).TurnmarkDistance_IQ17 = 0L;
;*** 513	-----------------------    *((unsigned * const)mark+5) &= 0xfffeu;
;*** 513	-----------------------    goto g23;
	.dwpsn	"sensor.c",512,3
        MOVB      ACC,#0
        MOVL      *+XAR6[0],ACC         ; |512| 
	.dwpsn	"sensor.c",513,3
        AND       *+XAR6[5],#0xfffe     ; |513| 
        BF        L13,UNC               ; |513| 
        ; branch occurs ; |513| 
L7:    
;***	-----------------------g10:
;*** 448	-----------------------    if ( (*mark).TurnmarkDistance_IQ17 <= (*mark).LimitDistance_IQ17 ) goto g22;
	.dwpsn	"sensor.c",448,3
        ...
        ; branchcc occurs ; |448| 
;*** 450	-----------------------    K$12 = &RMark;
;*** 450	-----------------------    if ( mark == K$12 ) goto g13;
	.dwpsn	"sensor.c",450,4
        MOVL      XAR4,#_RMark          ; |450| 
        MOVL      ACC,XAR4
        CMPL      ACC,XAR6              ; |450| 
        BF        L8,EQ                 ; |450| 
        ; branchcc occurs ; |450| 
...
;*** 457	-----------------------    if ( v$2&4u ) goto g20;
	...
	.dwpsn	"sensor.c",457,4
        AND       AL,AR7,#0x0004        ; |457| 
        BF        L11,NEQ               ; |457| 
        ; branchcc occurs ; |457| 
;***  	-----------------------    *((unsigned * const)mark+5) = v$3;
;*** 472	-----------------------    if ( (*&Flag&1u) == 0 || *&Flag&0x8 ) goto g23;
        MOV       *+XAR6[5],AR7
	.dwpsn	"sensor.c",472,5
        ...
        BF        L13,TC                ; |472| 
        ; branchcc occurs ; |472| 
;*** 475	-----------------------    if ( *&Flag&0x40u ) goto g19;
	.dwpsn	"sensor.c",475,5
        TBIT      @_Flag,#6             ; |475| 
        BF        L10,TC                ; |475| 
        ; branchcc occurs ; |475| 
;*** 476	-----------------------    if ( !(*&Flag&0x80u) ) goto g23;
	.dwpsn	"sensor.c",476,10
        TBIT      @_Flag,#7             ; |476| 
        BF        L13,NTC               ; |476| 
        ; branchcc occurs ; |476| 
;*** 476	-----------------------    LINE_SECOND((long)SECOND_MARK_U16_CNT*24+&Search);
;*** 476	-----------------------    goto g23;
	.dwpsn	"sensor.c",476,28
...
L11:    
;***	-----------------------g20:
;*** 459	-----------------------    *((unsigned * const)mark+5) = v$2&0xfffbu;
;*** 461	-----------------------    if ( mark != K$12 || *&Flag&0x8 ) goto g23;
	.dwpsn	"sensor.c",459,5
        AND       AL,AR7,#0xfffb        ; |459| 
        MOV       *+XAR6[5],AL          ; |459| 
...
L12:    
;***	-----------------------g22:
;*** 480	-----------------------    *((unsigned * const)mark+5) = (*((unsigned * const)remark+5)&2u)*2u|v$2;
;***	-----------------------g23:
;***  	-----------------------    return;
...
L13:    
	...
	.dwattr DW$81, DW_AT_end_line(0x203)
...
DW$132	.dwtag  DW_TAG_loop
	.dwattr DW$132, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L46:1:1625515571")
...
DW$142	.dwtag  DW_TAG_loop
	.dwattr DW$142, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L40:1:1625515571")
...
DW$144	.dwtag  DW_TAG_loop
	.dwattr DW$144, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L39:1:1625515571")
...
DW$146	.dwtag  DW_TAG_loop
	.dwattr DW$146, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L35:1:1625515571")
...
DW$152	.dwtag  DW_TAG_loop
	.dwattr DW$152, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L31:1:1625515571")
...
DW$158	.dwtag  DW_TAG_loop
	.dwattr DW$158, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L27:1:1625515571")
...
DW$164	.dwtag  DW_TAG_loop
	.dwattr DW$164, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L23:1:1625515571")
...
DW$170	.dwtag  DW_TAG_loop
	.dwattr DW$170, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L22:1:1625515571")
...
DW$172	.dwtag  DW_TAG_loop
	.dwattr DW$172, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L18:1:1625515571")
...
DW$175	.dwtag  DW_TAG_loop
	.dwattr DW$175, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L19:2:1625515571")
...
DW$179	.dwtag  DW_TAG_loop
	.dwattr DW$179, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L14:1:1625515571")
...
DW$182	.dwtag  DW_TAG_loop
	.dwattr DW$182, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L15:2:1625515571")
...
DW$189	.dwtag  DW_TAG_subprogram, DW_AT_name("CROSS_CHECK"), DW_AT_symbol_name("_CROSS_CHECK")
	...
	.dwattr DW$189, DW_AT_begin_line(0x205)
	.dwattr DW$189, DW_AT_begin_column(0x06)
	.dwpsn	"sensor.c",518,1
...
;*** 521	-----------------------    condition2 = 0u;
;*** 522	-----------------------    condition3 = 0u;
;*** 524	-----------------------    if ( SENSOR_ENABLE&0xfu ) goto g5;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        ADDB      SP,#4
...
DW$194	.dwtag  DW_TAG_variable, DW_AT_name("condition3"), DW_AT_symbol_name("_condition3")
	...
	.dwpsn	"sensor.c",524,2
        MOVW      DP,#_SENSOR_ENABLE
        MOV       AL,@_SENSOR_ENABLE    ; |524| 
        ANDB      AL,#0x0f              ; |524| 
        BF        L50,NEQ               ; |524| 
        ; branchcc occurs ; |524| 
;*** 525	-----------------------    if ( SENSOR_ENABLE&0xf000u ) goto g4;
	.dwpsn	"sensor.c",525,7
        AND       AL,@_SENSOR_ENABLE,#0xf000 ; |525| 
        BF        L49,NEQ               ; |525| 
        ; branchcc occurs ; |525| 
;*** 526	-----------------------    state = 9u;
;*** 526	-----------------------    goto g6;
	.dwpsn	"sensor.c",526,15
        MOV       *-SP[1],#9            ; |526| 
        BF        L51,UNC               ; |526| 
        ; branch occurs ; |526| 
L49:    
;***	-----------------------g4:
;*** 525	-----------------------    state = SENSOR_STATE_U16_CNT+9u;
;*** 525	-----------------------    goto g6;
	.dwpsn	"sensor.c",525,39
        MOVW      DP,#_SENSOR_STATE_U16_CNT
        MOV       AL,@_SENSOR_STATE_U16_CNT ; |525| 
        ADDB      AL,#9                 ; |525| 
        MOV       *-SP[1],AL            ; |525| 
        BF        L51,UNC               ; |525| 
        ; branch occurs ; |525| 
L50:    
;***	-----------------------g5:
;*** 524	-----------------------    state = 9u-SENSOR_STATE_U16_CNT;
	.dwpsn	"sensor.c",524,36
        MOVB      AL,#9                 ; |524| 
        MOVW      DP,#_SENSOR_STATE_U16_CNT
        SUB       AL,@_SENSOR_STATE_U16_CNT ; |524| 
        MOV       *-SP[1],AL            ; |524| 
L51:    
;***	-----------------------g6:
;*** 528	-----------------------    C$1 = &state_table[0];
;*** 528	-----------------------    condition1 = (C$1[state]&SENSOR_STATE_U16) == C$1[state];
	.dwpsn	"sensor.c",528,2
        MOVW      DP,#_SENSOR_STATE_U16
        MOVZ      AR0,*-SP[1]           ; |528| 
        MOVB      AH,#0
        MOVL      XAR5,#_state_table    ; |528| 
        MOV       AL,@_SENSOR_STATE_U16 ; |528| 
        AND       AL,*+XAR5[AR0]        ; |528| 
        MOVZ      AR0,*-SP[1]           ; |528| 
        CMP       AL,*+XAR5[AR0]        ; |528| 
        BF        L52,NEQ               ; |528| 
        ...
        MOVB      AH,#1                 ; |528| 
L52:    
;*** 529	-----------------------    condition2 = (C$1[state-1]&SENSOR_STATE_U16) == C$1[state-1];
        MOV       *-SP[2],AH            ; |528| 
	.dwpsn	"sensor.c",529,2
        ...
        MOVB      XAR4,#1               ; |529| 
L53:    
;*** 530	-----------------------    condition3 = (C$1[state+1]&SENSOR_STATE_U16) == C$1[state+1];
        MOV       *-SP[3],AR4           ; |529| 
	.dwpsn	"sensor.c",530,2
        ...
        MOVB      XAR4,#1               ; |530| 
L54:    
;*** 531	-----------------------    if ( condition1 ) goto g16;
        MOV       *-SP[4],AR4           ; |530| 
	.dwpsn	"sensor.c",531,2
        MOV       AL,*-SP[2]            ; |531| 
        BF        L57,NEQ               ; |531| 
        ; branchcc occurs ; |531| 
;*** 531	-----------------------    if ( condition2 ) goto g16;
        MOV       AL,*-SP[3]            ; |531| 
        BF        L57,NEQ               ; |531| 
        ; branchcc occurs ; |531| 
;*** 531	-----------------------    if ( condition3 ) goto g16;
        MOV       AL,*-SP[4]            ; |531| 
        BF        L57,NEQ               ; |531| 
        ; branchcc occurs ; |531| 
;*** 532	-----------------------    if ( !(*&Flag&0x8u) ) goto g15;
	.dwpsn	"sensor.c",532,7
        MOVW      DP,#_Flag
        TBIT      @_Flag,#3             ; |532| 
        BF        L56,NTC               ; |532| 
        ; branchcc occurs ; |532| 
;*** 534	-----------------------    if ( (CROSS_DISTANCE_IQ15 = RMotor.CrossCheckDistance_IQ15+LMotor.CrossCheckDistance_IQ15>>1) <= 4915200L ) goto g17;
	.dwpsn	"sensor.c",534,3
        MOVW      DP,#_LMotor+20
        MOVL      ACC,@_LMotor+20       ; |534| 
        SETC      SXM
        MOVW      DP,#_RMotor+20
        ADDL      ACC,@_RMotor+20       ; |534| 
        SFR       ACC,1                 ; |534| 
...
;*** 538	-----------------------    *(&LMark+5) &= 0xfffeu;
;*** 538	-----------------------    *(&RMark+5) &= 0xfffeu;
;*** 539	-----------------------    RMark.TurnmarkDistance_IQ17 = LMark.TurnmarkDistance_IQ17 = 0L;
;*** 540	-----------------------    LMotor.CrossCheckDistance_IQ15 = 0L;
;*** 540	-----------------------    RMotor.CrossCheckDistance_IQ15 = 0L;
;*** 541	-----------------------    CROSS_DISTANCE_IQ15 = 0L;
;*** 543	-----------------------    if ( *&Flag&0x40u ) goto g14;
	.dwpsn	"sensor.c",537,4
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfff7        ; |537| 
	.dwpsn	"sensor.c",538,4
        MOVW      DP,#_LMark+5
        AND       @_LMark+5,#0xfffe     ; |538| 
        MOVW      DP,#_RMark+5
        AND       @_RMark+5,#0xfffe     ; |538| 
	...
	.dwpsn	"sensor.c",540,4
        MOVW      DP,#_LMotor+20
        MOVL      @_LMotor+20,ACC       ; |540| 
        MOVW      DP,#_RMotor+20
        MOVL      @_RMotor+20,ACC       ; |540| 
...
;*** 544	-----------------------    goto g17;
	.dwpsn	"sensor.c",544,29
        MOVB      ACC,#1
        MOVW      DP,#_CROSS_PLUS_U32
        ADDL      @_CROSS_PLUS_U32,ACC  ; |544| 
	.dwpsn	"sensor.c",544,52
...
L55:    
;***	-----------------------g14:
;*** 543	-----------------------    ++(Search[(long)MARK_U16_CNT]).CrossPlus_U32;
;*** 543	-----------------------    ++CROSS_PLUS_SEARCH_U32;
;*** 543	-----------------------    goto g17;
	.dwpsn	"sensor.c",543,27
        MOVW      DP,#_MARK_U16_CNT
        MOV       T,#24                 ; |543| 
        MOVL      XAR4,#_Search+10      ; |543| 
        MPYXU     ACC,T,@_MARK_U16_CNT  ; |543| 
        ADDL      XAR4,ACC
        MOVB      ACC,#1
        ADDL      *+XAR4[0],ACC         ; |543| 
	.dwpsn	"sensor.c",543,65
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        ADDL      @_CROSS_PLUS_SEARCH_U32,ACC ; |543| 
	.dwpsn	"sensor.c",543,90
        BF        L58,UNC               ; |543| 
        ; branch occurs ; |543| 
L56:    
;***	-----------------------g15:
...
;*** 552	-----------------------    goto g17;
	.dwpsn	"sensor.c",551,3
        MOVB      ACC,#0
        MOVW      DP,#_LMotor+20
        MOVL      @_LMotor+20,ACC       ; |551| 
        MOVW      DP,#_RMotor+20
        MOVL      @_RMotor+20,ACC       ; |551| 
...
;***	-----------------------g17:
;***  	-----------------------    return;
	.dwpsn	"sensor.c",531,51
        MOVW      DP,#_Flag
        OR        @_Flag,#0x0008        ; |531| 
L58:    
	.dwpsn	"sensor.c",554,1
        SUBB      SP,#4
	.dwcfa	0x1d, -2
        LRETR
        ; return occurs
	.dwattr DW$189, DW_AT_end_file("sensor.c")
	.dwattr DW$189, DW_AT_end_line(0x22a)
...
DW$228	.dwtag  DW_TAG_loop
	.dwattr DW$228, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\sensor.asm:L84:1:1625515571")
...
DW$237	.dwtag  DW_TAG_variable, DW_AT_name("speed"), DW_AT_symbol_name("_speed")
	...
	.dwpsn	"sensor.c",404,2
        ...
        MOVW      DP,#_RMotor+56
        NEG       ACC                   ; |404| 
        MOVL      @_RMotor+56,ACC       ; |404| 
        MOVL      XAR1,ACC              ; |404| 
	.dwpsn	"sensor.c",405,2
        MOVW      DP,#_LMotor+56
        MOVL      @_LMotor+56,P         ; |405| 
...
;*** 426	-----------------------    goto g6;
	.dwpsn	"sensor.c",425,3
        MOVB      ACC,#0
        MOVW      DP,#_RMotor+8
        MOVL      @_RMotor+8,ACC        ; |425| 
	.dwpsn	"sensor.c",425,40
        MOVW      DP,#_LMotor+8
        MOVL      @_LMotor+8,ACC        ; |425| 
	.dwpsn	"sensor.c",426,3
        MOVL      XAR4,#131072          ; |426| 
        MOVW      DP,#_RMotor+14
        MOVL      @_RMotor+14,XAR4      ; |426| 
	.dwpsn	"sensor.c",426,37
        MOVW      DP,#_LMotor+14
        MOVL      @_LMotor+14,XAR4      ; |426| 
        BF        L87,UNC               ; |426| 
        ; branch occurs ; |426| 
L85:    
;***	-----------------------g4:
...
;*** 422	-----------------------    goto g6;
	...
	.dwpsn	"sensor.c",420,3
        MOVW      DP,#_RMotor+8
        MOVL      ACC,@_RMotor+8        ; |420| 
        ADDL      ACC,@_RMotor+6        ; |420| 
        MOVL      *-SP[2],ACC           ; |420| 
        MOVL      ACC,@_RMotor+6        ; |420| 
        LCR       #__IQ17div            ; |420| 
        ; call occurs [#__IQ17div] ; |420| 
        MOVW      DP,#_RMotor+14
        MOVL      @_RMotor+14,ACC       ; |420| 
	.dwpsn	"sensor.c",421,3
        MOVW      DP,#_LMotor+6
        MOVL      ACC,@_LMotor+6        ; |421| 
        MOVL      *-SP[2],ACC           ; |421| 
        MOVL      ACC,@_LMotor+8        ; |421| 
        ADDL      ACC,@_LMotor+6        ; |421| 
        LCR       #__IQ17div            ; |421| 
        ; call occurs [#__IQ17div] ; |421| 
        MOVW      DP,#_LMotor+14
        MOVL      @_LMotor+14,ACC       ; |421| 
...
L87:    
	...
	.dwattr DW$230, DW_AT_end_line(0x1b3)
