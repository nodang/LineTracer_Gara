...
void Init_SENSOR()
{
	...
	memset((void *)SenAdc.PT_IQ10,0x00,sizeof(_iq10)*4);
...
void START_END_LINE()
{
	...
	else if((Flag.MoveState_U16 == ON) && (TIME_INDEX_U32 > (10000)))	
	{
		...
		if(RMotor.StopAccel_IQ15 > _IQ5(MOTOR_PERIOD_MAXIMUM))		RMotor.StopAccel_IQ15 = _IQ15(MOTOR_PERIOD_MAXIMUM);
		...
		if(LMotor.StopAccel_IQ15 > _IQ5(MOTOR_PERIOD_MAXIMUM))		LMotor.StopAccel_IQ15 = _IQ15(MOTOR_PERIOD_MAXIMUM);
