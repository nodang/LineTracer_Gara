...
DW$48	.dwtag  DW_TAG_loop
	.dwattr DW$48, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L5:1:1598809993")
...
DW$61	.dwtag  DW_TAG_loop
	.dwattr DW$61, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L7:2:1598809993")
...
DW$63	.dwtag  DW_TAG_loop
	.dwattr DW$63, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L9:2:1598809993")
...
;***	-----------------------g7:
;*** 292	-----------------------    VFDPrintf("%.7lf", _IQ28toF(HandleDecel_IQ28));
;*** 293	-----------------------    K$2 = &GpioDataRegs;
;*** 293	-----------------------    if ( !(*K$2&0x4000u) ) goto g10;
	.dwpsn	"menu.c",292,6
        MOVW      DP,#_HandleDecel_IQ28
        MOVL      ACC,@_HandleDecel_IQ28 ; |292| 
        LCR       #__IQ28toF            ; |292| 
        ; call occurs [#__IQ28toF] ; |292| 
        MOVL      XAR4,#FSL5            ; |292| 
        MOVL      *-SP[2],XAR4          ; |292| 
        MOVL      *-SP[4],ACC           ; |292| 
        LCR       #_VFDPrintf           ; |292| 
...
;***	-----------------------g11:
;*** 296	-----------------------    HandleDecel_IQ28 = (long)((long double)(((float)HandleDec_U16_CNT-2000.0F)*9.99999997475242707878e-7F)*2.68435456e8L)+53687L;
;*** 296	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g7;
	.dwpsn	"menu.c",296,6
        ...
        ADDL      XAR4,ACC
        MOVW      DP,#_HandleDecel_IQ28
        MOVL      @_HandleDecel_IQ28,XAR4 ; |296| 
        MOVW      DP,#_GpioDataRegs+1
...
;***	-----------------------g15:
;*** 273	-----------------------    VFDPrintf("%.7lf", _IQ28toF(HandleAccel_IQ28)*10.0F);
;*** 274	-----------------------    K$2 = &GpioDataRegs;
;*** 274	-----------------------    if ( !(*K$2&0x4000u) ) goto g18;
	.dwpsn	"menu.c",273,6
        MOVW      DP,#_HandleAccel_IQ28
        MOVL      ACC,@_HandleAccel_IQ28 ; |273| 
        LCR       #__IQ28toF            ; |273| 
        ; call occurs [#__IQ28toF] ; |273| 
        MOVL      XAR6,ACC              ; |273| 
        MOV       AL,#0
        MOV       AH,#16672
        MOVL      *-SP[2],ACC           ; |273| 
...
;***	-----------------------g19:
;*** 277	-----------------------    HandleAccel_IQ28 = (long)((long double)(((float)HandleAcc_U16_CNT-3000.0F)*1.00000001168609742308e-7F)*2.68435456e8L)+8053L;
;*** 277	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g15;
	.dwpsn	"menu.c",277,6
        ...
        MOVW      DP,#_HandleAccel_IQ28
        ADD       ACC,#8053 << 0        ; |277| 
        MOVL      @_HandleAccel_IQ28,ACC ; |277| 
        MOVW      DP,#_GpioDataRegs+1
...
DW$77	.dwtag  DW_TAG_loop
	.dwattr DW$77, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L13:1:1598809993")
...
DW$95	.dwtag  DW_TAG_loop
	.dwattr DW$95, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L37:2:1598809993")
...
DW$121	.dwtag  DW_TAG_loop
	.dwattr DW$121, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L25:2:1598809993")
...
DW$127	.dwtag  DW_TAG_loop
	.dwattr DW$127, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L14:2:1598809993")
...
DW$133	.dwtag  DW_TAG_loop
	.dwattr DW$133, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L18:2:1598809993")
...
DW$155	.dwtag  DW_TAG_loop
	.dwattr DW$155, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L42:1:1598809993")
...
DW$179	.dwtag  DW_TAG_loop
	.dwattr DW$179, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L51:2:1598809993")
...
DW$181	.dwtag  DW_TAG_loop
	.dwattr DW$181, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L48:2:1598809993")
...
DW$184	.dwtag  DW_TAG_loop
	.dwattr DW$184, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L49:3:1598809993")
...
DW$186	.dwtag  DW_TAG_loop
	.dwattr DW$186, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L53:2:1598809993")
...
DW$189	.dwtag  DW_TAG_loop
	.dwattr DW$189, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L54:3:1598809993")
...
DW$191	.dwtag  DW_TAG_loop
	.dwattr DW$191, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L46:2:1598809993")
...
DW$197	.dwtag  DW_TAG_loop
	.dwattr DW$197, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L41:1:1598809993")
...
DW$199	.dwtag  DW_TAG_loop
	.dwattr DW$199, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L40:1:1598809993")
...
DW$203	.dwtag  DW_TAG_loop
	.dwattr DW$203, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L60:1:1598809993")
...
DW$214	.dwtag  DW_TAG_loop
	.dwattr DW$214, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\menu.asm:L59:1:1598809993")
