...
void save_sensitive_rom()
{
	...
	save_rom[ j++ ] = ( (Uint16)MOTOR_SENSITIVE_U16 >> 0 ) & 0xff;
	save_rom[ j++ ] = ( (Uint16)MOTOR_SENSITIVE_U16 >> 8 ) & 0xff;
...
void load_sensitive_rom()
{
	...
	MOTOR_SENSITIVE_U16 = ( ( load_rom[ j++ ] & 0xff ) << 0 );
	MOTOR_SENSITIVE_U16 |= ( ( load_rom[ j++ ] & 0xff ) << 8 );
}
