...
//#define	Kb	_IQ10(0.1116352117046)		//(W_cut *  F_dt) / (2.0 + W_cut * F_dt)
//#define	Ka	_IQ10(-0.776729576590)		//(W_cut *  F_dt - 2.0) / (2.0 + W_cut * F_dt)

#define	Kb	_IQ10(0.040143550)		//(W_cut *  F_dt) / (2.0 + W_cut * F_dt)
#define	Ka	_IQ10(-0.91971289)		//(W_cut *  F_dt - 2.0) / (2.0 + W_cut * F_dt)
...
#define MIN_VELO		650.0

#define	HandleAcc_IQ28	_IQ28(0.0000300)
#define	HandleDec_IQ28	_IQ28(0.0002000)

#define	HEIGHT_ME_IQ22	_IQ22(200.0)		// Turnmark and wheel distance * 2

#define	MOTOR_PERIOD_LIMIT		65534.0
...
//____________________________________________________________________________________//
	...
	volatile	_iq27	PrdTranSecon_IQ27;
	_iq27	CputmrTranSecon_IQ27;

	volatile	_iq27	RolEach_IQ27;
	volatile	_iq17	RolEachStep100_IQ17;
