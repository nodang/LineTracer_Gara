...
void Init_RUN()
{
	...
	RightPwmRegs.TBPRD = (Uint16)MOTOR_PERIOD_LIMIT;
	LeftPwmRegs.TBPRD = (Uint16)MOTOR_PERIOD_LIMIT;
}
...
void RUN()
{
	...
	while(1)
	{
		...
		if(Flag.STOP & ((LMotor.Velocity_IQ15 <= _IQ15(1000.0)) && (RMotor.Velocity_IQ15 <= _IQ15(1000.0))))		
		{	END_STOP();				return;	}
		else;
	} 
}
