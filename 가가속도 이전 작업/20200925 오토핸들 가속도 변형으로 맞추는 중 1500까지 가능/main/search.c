...
void RUN()
{
	...
	MOVE_TO_MOVE(_IQ17(500.0), _IQ17(0.0), _IQ18(MOTOR_SPEED_U32), _IQ18(MOTOR_SPEED_U32), _IQ15(MOTOR_ACCEL_U32));
	...
	while(1)
	{
		...
		//TxPrintf("%5ld %5ld %5ld %5ld %5ld %5ld %4ld %4ld %4ld %4ld %u %u\n", LMotor.PrdNext_IQ14 >> 14, RMotor.PrdNext_IQ14 >> 14, LMotor.PrdHandle_IQ13 >> 13, RMotor.PrdHandle_IQ13 >> 13, LMotor.HandleVelo_IQ18 >> 18, RMotor.HandleVelo_IQ18 >> 18, LMotor.Velocity_IQ18 >> 18, RMotor.Velocity_IQ18 >> 18, LMotor.NextVelocity_IQ18 >> 18, RMotor.NextVelocity_IQ18 >> 18, EPwm2Regs.TBCTL.bit.CLKDIV, EPwm1Regs.TBCTL.bit.CLKDIV);
		...
		//TxPrintf("%lf %lf\n", _IQ15toF(_IQ15mpy(SenAdc.Theta_IQ15, _IQ15(57.295))), _IQ15toF(_IQ15mpy(SenAdc.ErrPos_IQ15[0], _IQ15(57.295))));
