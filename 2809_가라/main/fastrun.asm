...
;	..\Compiler\bin\opt2000.exe C:\Users\노호진\AppData\Local\Temp\TI20010 C:\Users\노호진\AppData\Local\Temp\TI2004 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\노호진\AppData\Local\Temp\TI2002 --template_info_file C:\Users\노호진\AppData\Local\Temp\TI2006 --object_file fastrun.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_cubeRoot
...
DW$48	.dwtag  DW_TAG_loop
	.dwattr DW$48, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\fastrun.asm:L3:1:1658750190")
...
DW$50	.dwtag  DW_TAG_loop
	.dwattr DW$50, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\fastrun.asm:L1:1:1658750190")
...
;*** 106	-----------------------    jerk = _IQ14div(jerk, 16384000L)<<3;
...
;*** 74	-----------------------    curVEL = curVEL;
;*** 74	-----------------------    tarVEL = tarVEL;
;*** 83	-----------------------    curACC = 786432000L-__IQmpy(_IQ17div(393216000L, 589824000L), curVEL, 17)>>3;
;*** 84	-----------------------    tarACC = 786432000L-__IQmpy(_IQ17div(393216000L, 589824000L), tarVEL, 17)>>3;
...
DW$87	.dwtag  DW_TAG_subprogram, DW_AT_name("STRAIGHT_DIVISION"), DW_AT_symbol_name("_STRAIGHT_DIVISION$0")
	...
	.dwattr DW$87, DW_AT_begin_line(0xe6)
...
;*** 233	-----------------------    low_vel = 0L;
;*** 234	-----------------------    m_dist = 0L;
;*** 236	-----------------------    cnt ? (S$1 = *((long * const)LINE-20L)) : (S$1 = 0L);
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        MOVL      *SP++,XAR1
...
DW$93	.dwtag  DW_TAG_variable, DW_AT_name("K$53"), DW_AT_symbol_name("K$53")
	.dwattr DW$93, DW_AT_type(*DW$T$71)
...
DW$95	.dwtag  DW_TAG_variable, DW_AT_name("LINE"), DW_AT_symbol_name("_LINE")
	.dwattr DW$95, DW_AT_type(*DW$T$74)
...
DW$103	.dwtag  DW_TAG_variable, DW_AT_name("m_dist"), DW_AT_symbol_name("_m_dist")
	...
	.dwattr DW$103, DW_AT_location[DW_OP_breg20 -12]
        MOV       *-SP[13],AL           ; |231| 
        MOVL      XAR1,XAR4             ; |231| 
	.dwpsn	"fastrun.c",232,17
        MOVB      ACC,#0
        MOVL      *-SP[8],ACC           ; |232| 
	.dwpsn	"fastrun.c",233,17
        MOVL      *-SP[10],ACC          ; |233| 
	...
	.dwpsn	"fastrun.c",236,2
        ...
        MOVL      XAR4,XAR1             ; |236| 
        SUBB      XAR4,#20              ; |236| 
        MOVL      XAR6,*+XAR4[0]        ; |236| 
        BF        L8,UNC                ; |236| 
        ; branch occurs ; |236| 
L7:    
        MOVB      XAR6,#0
L8:    
;*** 236	-----------------------    (*LINE).VeloIn_IQ17 = v$2 = S$1;
;*** 239	-----------------------    if ( (*LINE).TurnDir_U32&0x2000uL ) goto g5;
        MOVB      XAR0,#14              ; |236| 
        MOVL      *+XAR1[AR0],XAR6      ; |236| 
	.dwpsn	"fastrun.c",239,2
        ...
        BF        L10,NEQ               ; |239| 
        ; branchcc occurs ; |239| 
;*** 242	-----------------------    LINE_DIVISION(LINE+36L, cnt+1u);
;*** 244	-----------------------    (*LINE).VeloOut_IQ17 = v$1 = *((long * const)LINE+50L);
;*** 245	-----------------------    if ( (v$3 = (*LINE).Distance_U32) > 1500uL ) goto g4;
	.dwpsn	"fastrun.c",242,3
        ...
        MOVB      AL,#1                 ; |242| 
        ADD       AL,*-SP[13]           ; |242| 
        LCR       #_LINE_DIVISION$0     ; |242| 
        ; call occurs [#_LINE_DIVISION$0] ; |242| 
	.dwpsn	"fastrun.c",244,3
        MOVB      XAR0,#50              ; |244| 
        MOVL      XAR7,*+XAR1[AR0]      ; |244| 
        MOVB      XAR0,#16              ; |244| 
        MOVL      *+XAR1[AR0],XAR7      ; |244| 
	.dwpsn	"fastrun.c",245,2
        MOVL      P,*+XAR1[4]           ; |245| 
        MOV       ACC,#1500             ; |245| 
        CMPL      ACC,P                 ; |245| 
        BF        L9,LO                 ; |245| 
...
L10:    
;***	-----------------------g5:
;*** 247	-----------------------    (*LINE).VeloOut_IQ17 = v$1 = END_SPEED_U32<<17;
;*** 250	-----------------------    *((long * const)LINE+50L) = 0L;
;*** 250	-----------------------    if ( (v$3 = (*LINE).Distance_U32) > 1500uL ) goto g7;
	.dwpsn	"fastrun.c",247,3
        MOVW      DP,#_END_SPEED_U32
        MOV       T,#17                 ; |247| 
        MOVB      XAR0,#16              ; |247| 
        MOVL      ACC,@_END_SPEED_U32   ; |247| 
        LSLL      ACC,T                 ; |247| 
...
L11:    
;***	-----------------------g6:
;*** 255	-----------------------    (*LINE).Jerk_IQ14 = (v$3 > 700uL) ? JERK_MIDDLE_U32<<14 : (v$3 > 300uL) ? JERK_SHORT_U32<<14 : JERK_U32<<14;
	.dwpsn	"fastrun.c",255,7
        MOV       ACC,#700              ; |255| 
        CMPL      ACC,P                 ; |255| 
        BF        L12,HIS               ; |255| 
        ; branchcc occurs ; |255| 
        MOVW      DP,#_JERK_MIDDLE_U32
        MOVL      ACC,@_JERK_MIDDLE_U32 ; |255| 
        LSL       ACC,14                ; |255| 
        BF        L14,UNC               ; |255| 
        ; branch occurs ; |255| 
L12:    
        ...
        MOVL      ACC,@_JERK_SHORT_U32  ; |255| 
        LSL       ACC,14                ; |255| 
        BF        L14,UNC               ; |255| 
        ; branch occurs ; |255| 
L13:    
        MOVW      DP,#_JERK_U32
        MOVL      ACC,@_JERK_U32        ; |255| 
        LSL       ACC,14                ; |255| 
L14:    
;*** 256	-----------------------    goto g8;
        MOVB      XAR0,#22              ; |255| 
...
L16:    
;***	-----------------------g8:
;*** 262	-----------------------    high_vel = __lmax(v$2, v$1);
;*** 263	-----------------------    low_vel = __lmin(v$1, v$2);
;*** 266	-----------------------    K$53 = (long * const)LINE+24L;
;*** 266	-----------------------    DECEL_DIST_COMPUTE(v$2, v$1, (long * const)LINE+20L, K$53);
;*** 269	-----------------------    v$3 = (*LINE).Distance_U32;
;*** 269	-----------------------    U$57 = v$3<<17;
;*** 269	-----------------------    if ( (*LINE).MotorDistance_IQ17 >= U$57 ) goto g13;
	...
	.dwpsn	"fastrun.c",266,2
        ...
        MOVL      *-SP[2],XAR7          ; |266| 
        MOVL      ACC,XAR6              ; |266| 
        LCR       #_DECEL_DIST_COMPUTE  ; |266| 
        ; call occurs [#_DECEL_DIST_COMPUTE] ; |266| 
	.dwpsn	"fastrun.c",269,2
        MOVL      XAR6,*+XAR1[4]        ; |269| 
        MOV       T,#17                 ; |269| 
        MOVL      ACC,XAR6              ; |269| 
        MOVB      XAR0,#20              ; |269| 
        LSLL      ACC,T                 ; |269| 
        ...
        BF        L19,LEQ               ; |269| 
        ; branchcc occurs ; |269| 
;*** 282	-----------------------    m_dist = __IQmpy(U$57, _IQ17div(131072L, 393216L), 17);
;*** 284	-----------------------    C$3 = (*LINE).MotorDistance_IQ17;
;*** 284	-----------------------    if ( C$3 < m_dist ) goto g11;
	.dwpsn	"fastrun.c",282,3
        MOVL      XAR4,#393216          ; |282| 
        MOV       AL,#0
        MOVL      *-SP[2],XAR4          ; |282| 
        MOV       AH,#2
        LCR       #__IQ17div            ; |282| 
	...
	.dwpsn	"fastrun.c",284,3
        ...
        BF        L17,LT                ; |284| 
        ; branchcc occurs ; |284| 
;*** 287	-----------------------    VEL_COMPUTE(U$57, C$3, high_vel, (*LINE).Jerk_IQ14, (long * const)LINE+12L);
;*** 287	-----------------------    goto g12;
	.dwpsn	"fastrun.c",287,4
        ...
        MOVL      XAR4,ACC              ; |287| 
        MOVL      ACC,XAR2              ; |287| 
        LCR       #_VEL_COMPUTE         ; |287| 
        ; call occurs [#_VEL_COMPUTE] ; |287| 
        BF        L18,UNC               ; |287| 
        ; branch occurs ; |287| 
L17:    
;***	-----------------------g11:
;*** 285	-----------------------    VEL_COMPUTE(U$57, m_dist, high_vel, (*LINE).Jerk_IQ14, (long * const)LINE+12L);
	.dwpsn	"fastrun.c",285,4
        MOVL      ACC,*-SP[12]          ; |285| 
        MOVB      XAR0,#22              ; |285| 
        MOVL      *-SP[2],ACC           ; |285| 
        MOVL      ACC,*-SP[8]           ; |285| 
        ...
        MOVL      XAR4,ACC              ; |285| 
        MOVL      ACC,XAR2              ; |285| 
        LCR       #_VEL_COMPUTE         ; |285| 
        ; call occurs [#_VEL_COMPUTE] ; |285| 
L18:    
;***	-----------------------g12:
;*** 289	-----------------------    DECEL_DIST_COMPUTE((*LINE).Velo_IQ17, (*LINE).VeloOut_IQ17, (long * const)LINE+18L, K$53);
;*** 289	-----------------------    goto g18;
	.dwpsn	"fastrun.c",289,3
        MOVB      XAR0,#16              ; |289| 
        MOVL      ACC,*+XAR1[AR0]       ; |289| 
        MOVL      XAR5,XAR3             ; |289| 
        MOVL      *-SP[2],ACC           ; |289| 
        MOVB      ACC,#18
        ADDL      ACC,XAR1
        ...
        MOVB      XAR0,#12              ; |289| 
        MOVL      ACC,*+XAR1[AR0]       ; |289| 
        LCR       #_DECEL_DIST_COMPUTE  ; |289| 
        ; call occurs [#_DECEL_DIST_COMPUTE] ; |289| 
        BF        L22,UNC               ; |289| 
        ; branch occurs ; |289| 
L19:    
;***	-----------------------g13:
;*** 272	-----------------------    (*LINE).DecelDistance_IQ17 = C$2 = v$3<<17;
;*** 274	-----------------------    VEL_COMPUTE(C$2, 0L, low_vel, (*LINE).Jerk_IQ14, (long * const)LINE+12L);
;*** 276	-----------------------    if ( (*LINE).VeloIn_IQ17 > (*LINE).VeloOut_IQ17 ) goto g15;
	...
	.dwpsn	"fastrun.c",274,3
        ...
        MOVL      XAR4,ACC              ; |274| 
        MOVL      ACC,XAR6              ; |274| 
        LCR       #_VEL_COMPUTE         ; |274| 
        ; call occurs [#_VEL_COMPUTE] ; |274| 
	.dwpsn	"fastrun.c",276,3
        MOVB      XAR0,#16              ; |276| 
        MOVL      ACC,*+XAR1[AR0]       ; |276| 
        MOVB      XAR0,#14              ; |276| 
        CMPL      ACC,*+XAR1[AR0]       ; |276| 
        BF        L20,LT                ; |276| 
        ; branchcc occurs ; |276| 
;*** 277	-----------------------    (*LINE).VeloOut_IQ17 = (*LINE).Velo_IQ17;
;*** 277	-----------------------    goto g16;
...
L20:    
;***	-----------------------g15:
;*** 276	-----------------------    (*LINE).VeloIn_IQ17 = (*LINE).Velo_IQ17;
	.dwpsn	"fastrun.c",276,46
        MOVB      XAR0,#12              ; |276| 
        MOVL      ACC,*+XAR1[AR0]       ; |276| 
        MOVB      XAR0,#14              ; |276| 
...
;*** 276	-----------------------    if ( cnt ) goto g18;
        ...
        BF        L22,NEQ               ; |276| 
        ; branchcc occurs ; |276| 
;*** 279	-----------------------    (*LINE).Velo_IQ17 = 0L;
;***	-----------------------g18:
;***  	-----------------------    return;
	.dwpsn	"fastrun.c",279,12
        MOVB      ACC,#0
        MOVB      XAR0,#12              ; |279| 
        MOVL      *+XAR1[AR0],ACC       ; |279| 
L22:    
	.dwpsn	"fastrun.c",291,1
        SUBB      SP,#14
	.dwcfa	0x1d, -8
        MOVL      XAR3,*--SP
	.dwcfa	0x1d, -6
...
DW$104	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_DIVISION"), DW_AT_symbol_name("_LINE_DIVISION$0")
	...
	.dwattr DW$104, DW_AT_begin_line(0xd8)
...
;*** 224	-----------------------    (*LINE).Jerk_IQ14 = JERK_U32<<14;
;*** 226	-----------------------    (*LINE).Decel_IQ14 = 786432000L-__IQmpy(_IQ17div(393216000L, 589824000L), (*LINE).Velo_IQ17, 17)>>3;
;*** 226	-----------------------    goto g4;
	...
	.dwpsn	"fastrun.c",226,3
        ...
        MOV       ACC,#12000 << 15
        LCR       #__IQ17div            ; |226| 
        ; call occurs [#__IQ17div] ; |226| 
        MOVB      XAR0,#12              ; |226| 
        MOVL      XT,ACC                ; |226| 
        IMPYL     P,XT,*+XAR1[AR0]      ; |226| 
        QMPYL     ACC,XT,*+XAR1[AR0]    ; |226| 
        LSL64     ACC:P,#15             ; |226| 
        MOVL      XAR6,ACC              ; |226| 
        MOV       ACC,#24000 << 15
        SETC      SXM
...
DW$109	.dwtag  DW_TAG_subprogram, DW_AT_name("TURN_DIVISION_FUNC"), DW_AT_symbol_name("_TURN_DIVISION_FUNC")
	...
	.dwattr DW$109, DW_AT_begin_line(0x36)
...
DW$113	.dwtag  DW_TAG_variable, DW_AT_name("U$7"), DW_AT_symbol_name("U$7")
	.dwattr DW$113, DW_AT_type(*DW$T$77)
...
DW$114	.dwtag  DW_TAG_loop
	.dwattr DW$114, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\fastrun.asm:L25:1:1658750190")
	.dwattr DW$114, DW_AT_begin_file("fastrun.c")
	.dwattr DW$114, DW_AT_begin_line(0x3a)
	.dwattr DW$114, DW_AT_end_line(0x45)
...
DW$123	.dwtag  DW_TAG_subprogram, DW_AT_name("TURN_COMPUTE"), DW_AT_symbol_name("_TURN_COMPUTE$0")
	.dwattr DW$123, DW_AT_low_pc(_TURN_COMPUTE$0)
	.dwattr DW$123, DW_AT_high_pc(0x00)
	.dwattr DW$123, DW_AT_begin_file("fastrun.c")
	.dwattr DW$123, DW_AT_begin_line(0x84)
...
DW$127	.dwtag  DW_TAG_variable, DW_AT_name("turn_theta_L"), DW_AT_symbol_name("_turn_theta_L")
	.dwattr DW$127, DW_AT_type(*DW$T$65)
	.dwattr DW$127, DW_AT_location[DW_OP_breg20 -10]
;* AR2   assigned to _turn_theta_R
DW$128	.dwtag  DW_TAG_variable, DW_AT_name("turn_theta_R"), DW_AT_symbol_name("_turn_theta_R")
	.dwattr DW$128, DW_AT_type(*DW$T$65)
	.dwattr DW$128, DW_AT_location[DW_OP_reg8]
DW$129	.dwtag  DW_TAG_variable, DW_AT_name("turn_radian_L"), DW_AT_symbol_name("_turn_radian_L")
	.dwattr DW$129, DW_AT_type(*DW$T$65)
	.dwattr DW$129, DW_AT_location[DW_OP_breg20 -8]
;* AR1   assigned to _turn_radian_R
DW$130	.dwtag  DW_TAG_variable, DW_AT_name("turn_radian_R"), DW_AT_symbol_name("_turn_radian_R")
	.dwattr DW$130, DW_AT_type(*DW$T$65)
	.dwattr DW$130, DW_AT_location[DW_OP_reg6]
;* AR3   assigned to _LINE
DW$131	.dwtag  DW_TAG_variable, DW_AT_name("LINE"), DW_AT_symbol_name("_LINE")
	.dwattr DW$131, DW_AT_type(*DW$T$74)
...
L49:    
	...
	.dwattr DW$123, DW_AT_end_line(0xd6)
...
DW$132	.dwtag  DW_TAG_subprogram, DW_AT_name("TURN_COMPUTE_FUNC"), DW_AT_symbol_name("_TURN_COMPUTE_FUNC")
	.dwattr DW$132, DW_AT_low_pc(_TURN_COMPUTE_FUNC)
...
DW$136	.dwtag  DW_TAG_loop
	.dwattr DW$136, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\fastrun.asm:L50:1:1658750190")
	.dwattr DW$136, DW_AT_begin_file("fastrun.c")
	.dwattr DW$136, DW_AT_begin_line(0x27)
	.dwattr DW$136, DW_AT_end_line(0x32)
DW$137	.dwtag  DW_TAG_loop_range
	.dwattr DW$137, DW_AT_low_pc(DW$L$_TURN_COMPUTE_FUNC$2$B)
	.dwattr DW$137, DW_AT_high_pc(DW$L$_TURN_COMPUTE_FUNC$2$E)
DW$138	.dwtag  DW_TAG_loop_range
	.dwattr DW$138, DW_AT_low_pc(DW$L$_TURN_COMPUTE_FUNC$4$B)
	.dwattr DW$138, DW_AT_high_pc(DW$L$_TURN_COMPUTE_FUNC$4$E)
DW$139	.dwtag  DW_TAG_loop_range
	.dwattr DW$139, DW_AT_low_pc(DW$L$_TURN_COMPUTE_FUNC$5$B)
	.dwattr DW$139, DW_AT_high_pc(DW$L$_TURN_COMPUTE_FUNC$5$E)
DW$140	.dwtag  DW_TAG_loop_range
	.dwattr DW$140, DW_AT_low_pc(DW$L$_TURN_COMPUTE_FUNC$6$B)
	.dwattr DW$140, DW_AT_high_pc(DW$L$_TURN_COMPUTE_FUNC$6$E)
	.dwendtag DW$136

	.dwattr DW$132, DW_AT_end_file("fastrun.c")
	.dwattr DW$132, DW_AT_end_line(0x34)
...
DW$141	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_SECOND"), DW_AT_symbol_name("_LINE_SECOND")
	.dwattr DW$141, DW_AT_low_pc(_LINE_SECOND)
	.dwattr DW$141, DW_AT_high_pc(0x00)
	.dwattr DW$141, DW_AT_begin_file("fastrun.c")
	.dwattr DW$141, DW_AT_begin_line(0x18)
...
DW$144	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$31)
...
DW$150	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$21)
...
DW$152	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$37)
	.dwendtag DW$T$38
...
DW$155	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$39)
DW$156	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$41)
	.dwendtag DW$T$42


DW$T$44	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$44, DW_AT_language(DW_LANG_C)
DW$157	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$22)
DW$158	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$22)
DW$159	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$22)
DW$160	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$40)
DW$161	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$39)
	.dwendtag DW$T$44


DW$T$46	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$46, DW_AT_language(DW_LANG_C)
DW$162	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$37)
DW$163	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$23)
	.dwendtag DW$T$46
...
DW$T$50	.dwtag  DW_TAG_const_type
	.dwattr DW$T$50, DW_AT_type(*DW$164)
...
DW$T$22	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$22, DW_AT_type(*DW$165)
...
DW$T$55	.dwtag  DW_TAG_const_type
	.dwattr DW$T$55, DW_AT_type(*DW$166)

DW$T$56	.dwtag  DW_TAG_subroutine_type, DW_AT_type(*DW$T$20)
	.dwattr DW$T$56, DW_AT_language(DW_LANG_C)
DW$167	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$22)
	.dwendtag DW$T$56
...
DW$178	.dwtag  DW_TAG_far_type
	.dwattr DW$178, DW_AT_type(*DW$T$37)
DW$T$74	.dwtag  DW_TAG_const_type
	.dwattr DW$T$74, DW_AT_type(*DW$178)

DW$T$75	.dwtag  DW_TAG_array_type, DW_AT_type(*DW$T$36)
...
DW$T$77	.dwtag  DW_TAG_pointer_type, DW_AT_type(*DW$T$25)
...
DW$198	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$198, DW_AT_name("s44sFlag_U16"), DW_AT_symbol_name("_s44sFlag_U16")
...
DW$T$79	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$79, DW_AT_type(*DW$199)
DW$200	.dwtag  DW_TAG_far_type
	.dwattr DW$200, DW_AT_type(*DW$T$29)
DW$T$81	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$81, DW_AT_type(*DW$200)
...
DW$T$24	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$24, DW_AT_type(*DW$201)
...
DW$232	.dwtag  DW_TAG_assign_register, DW_AT_name("AL")
	.dwattr DW$232, DW_AT_location[DW_OP_reg0]
DW$233	.dwtag  DW_TAG_assign_register, DW_AT_name("AH")
	.dwattr DW$233, DW_AT_location[DW_OP_reg1]
DW$234	.dwtag  DW_TAG_assign_register, DW_AT_name("PL")
	.dwattr DW$234, DW_AT_location[DW_OP_reg2]
DW$235	.dwtag  DW_TAG_assign_register, DW_AT_name("PH")
	.dwattr DW$235, DW_AT_location[DW_OP_reg3]
DW$236	.dwtag  DW_TAG_assign_register, DW_AT_name("AR0")
	.dwattr DW$236, DW_AT_location[DW_OP_reg4]
DW$237	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR0")
	.dwattr DW$237, DW_AT_location[DW_OP_reg5]
DW$238	.dwtag  DW_TAG_assign_register, DW_AT_name("AR1")
	.dwattr DW$238, DW_AT_location[DW_OP_reg6]
DW$239	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR1")
	.dwattr DW$239, DW_AT_location[DW_OP_reg7]
DW$240	.dwtag  DW_TAG_assign_register, DW_AT_name("AR2")
	.dwattr DW$240, DW_AT_location[DW_OP_reg8]
DW$241	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR2")
	.dwattr DW$241, DW_AT_location[DW_OP_reg9]
DW$242	.dwtag  DW_TAG_assign_register, DW_AT_name("AR3")
	.dwattr DW$242, DW_AT_location[DW_OP_reg10]
DW$243	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR3")
	.dwattr DW$243, DW_AT_location[DW_OP_reg11]
DW$244	.dwtag  DW_TAG_assign_register, DW_AT_name("AR4")
	.dwattr DW$244, DW_AT_location[DW_OP_reg12]
DW$245	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR4")
	.dwattr DW$245, DW_AT_location[DW_OP_reg13]
DW$246	.dwtag  DW_TAG_assign_register, DW_AT_name("AR5")
	.dwattr DW$246, DW_AT_location[DW_OP_reg14]
DW$247	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR5")
	.dwattr DW$247, DW_AT_location[DW_OP_reg15]
DW$248	.dwtag  DW_TAG_assign_register, DW_AT_name("AR6")
	.dwattr DW$248, DW_AT_location[DW_OP_reg16]
DW$249	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR6")
	.dwattr DW$249, DW_AT_location[DW_OP_reg17]
DW$250	.dwtag  DW_TAG_assign_register, DW_AT_name("AR7")
	.dwattr DW$250, DW_AT_location[DW_OP_reg18]
DW$251	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR7")
	.dwattr DW$251, DW_AT_location[DW_OP_reg19]
DW$252	.dwtag  DW_TAG_assign_register, DW_AT_name("SP")
	.dwattr DW$252, DW_AT_location[DW_OP_reg20]
DW$253	.dwtag  DW_TAG_assign_register, DW_AT_name("XT")
	.dwattr DW$253, DW_AT_location[DW_OP_reg21]
DW$254	.dwtag  DW_TAG_assign_register, DW_AT_name("T")
	.dwattr DW$254, DW_AT_location[DW_OP_reg22]
DW$255	.dwtag  DW_TAG_assign_register, DW_AT_name("ST0")
	.dwattr DW$255, DW_AT_location[DW_OP_reg23]
DW$256	.dwtag  DW_TAG_assign_register, DW_AT_name("ST1")
	.dwattr DW$256, DW_AT_location[DW_OP_reg24]
DW$257	.dwtag  DW_TAG_assign_register, DW_AT_name("PC")
	.dwattr DW$257, DW_AT_location[DW_OP_reg25]
DW$258	.dwtag  DW_TAG_assign_register, DW_AT_name("RPC")
	.dwattr DW$258, DW_AT_location[DW_OP_reg26]
DW$259	.dwtag  DW_TAG_assign_register, DW_AT_name("FP")
	.dwattr DW$259, DW_AT_location[DW_OP_reg27]
DW$260	.dwtag  DW_TAG_assign_register, DW_AT_name("DP")
	.dwattr DW$260, DW_AT_location[DW_OP_reg28]
DW$261	.dwtag  DW_TAG_assign_register, DW_AT_name("SXM")
	.dwattr DW$261, DW_AT_location[DW_OP_reg29]
DW$262	.dwtag  DW_TAG_assign_register, DW_AT_name("PM")
	.dwattr DW$262, DW_AT_location[DW_OP_reg30]
DW$263	.dwtag  DW_TAG_assign_register, DW_AT_name("OVM")
	.dwattr DW$263, DW_AT_location[DW_OP_reg31]
DW$264	.dwtag  DW_TAG_assign_register, DW_AT_name("PAGE0")
	.dwattr DW$264, DW_AT_location[DW_OP_regx 0x20]
DW$265	.dwtag  DW_TAG_assign_register, DW_AT_name("AMODE")
	.dwattr DW$265, DW_AT_location[DW_OP_regx 0x21]
DW$266	.dwtag  DW_TAG_assign_register, DW_AT_name("IFR")
	.dwattr DW$266, DW_AT_location[DW_OP_regx 0x22]
DW$267	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$267, DW_AT_location[DW_OP_regx 0x23]
DW$268	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$268, DW_AT_location[DW_OP_regx 0x24]
DW$269	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDO")
	.dwattr DW$269, DW_AT_location[DW_OP_regx 0x25]
DW$270	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDOH")
	.dwattr DW$270, DW_AT_location[DW_OP_regx 0x26]
DW$271	.dwtag  DW_TAG_assign_register, DW_AT_name("VOL")
	.dwattr DW$271, DW_AT_location[DW_OP_regx 0x27]
DW$272	.dwtag  DW_TAG_assign_register, DW_AT_name("CIE_RETA")
	.dwattr DW$272, DW_AT_location[DW_OP_regx 0x28]
	.dwendtag DW$CU
