...
DW$26	.dwtag  DW_TAG_variable, DW_AT_name("Flag"), DW_AT_symbol_name("_Flag")
	.dwattr DW$26, DW_AT_type(*DW$T$153)
...
DW$38	.dwtag  DW_TAG_variable, DW_AT_name("JERK_U32"), DW_AT_symbol_name("_JERK_U32")
...
DW$51	.dwtag  DW_TAG_variable, DW_AT_name("GpioDataRegs"), DW_AT_symbol_name("_GpioDataRegs")
	.dwattr DW$51, DW_AT_type(*DW$T$130)
...
DW$53	.dwtag  DW_TAG_variable, DW_AT_name("EPwm4Regs"), DW_AT_symbol_name("_EPwm4Regs")
...
;*** 63	-----------------------    *&EPwm4Regs;
;*** 63	-----------------------    *&EPwm4Regs = *&EPwm4Regs|0x1c00u;
;*** 63	-----------------------    *&EPwm3Regs = *&EPwm3Regs|0x1c00u;
;*** 63	-----------------------    *&EPwm2Regs = *&EPwm2Regs|0x1c00u;
;*** 63	-----------------------    *&EPwm1Regs = *&EPwm1Regs|0x1c00u;
;*** 64	-----------------------    EPwm1Regs.TBPRD = EPwm2Regs.TBPRD = EPwm3Regs.TBPRD = EPwm4Regs.TBPRD = 32766u;
;*** 65	-----------------------    EPwm1Regs.CMPA.half.CMPA = EPwm2Regs.CMPA.half.CMPA = EPwm1Regs.TBPRD>>2;
;*** 65	-----------------------    EPwm1Regs.CMPB = EPwm2Regs.CMPB = (EPwm2Regs.TBPRD>>2)+(EPwm2Regs.TBPRD>>1);
;*** 66	-----------------------    EPwm3Regs.CMPA.half.CMPA = EPwm4Regs.CMPA.half.CMPA = EPwm3Regs.TBPRD>>2;
;*** 66	-----------------------    EPwm3Regs.CMPB = EPwm4Regs.CMPB = (EPwm4Regs.TBPRD>>2)+(EPwm4Regs.TBPRD>>1);
;*** 68	-----------------------    *&EPwm4Regs;
;*** 68	-----------------------    *&EPwm4Regs = *&EPwm4Regs|3u;
;*** 68	-----------------------    *&EPwm3Regs = *&EPwm3Regs|3u;
;*** 68	-----------------------    *&EPwm2Regs = *&EPwm2Regs|3u;
;*** 68	-----------------------    *&EPwm1Regs = *&EPwm1Regs|3u;
;*** 69	-----------------------    EPwm4Regs.TBCTR = 0u;
;*** 69	-----------------------    EPwm3Regs.TBCTR = 0u;
;*** 69	-----------------------    EPwm2Regs.TBCTR = 0u;
;*** 69	-----------------------    EPwm1Regs.TBCTR = 0u;
;*** 77	-----------------------    EPwm1Regs.AQCTLA.all = EPwm3Regs.AQCTLA.all = 2064u;
;*** 78	-----------------------    EPwm1Regs.AQCTLB.all = EPwm3Regs.AQCTLB.all = 1056u;
;*** 79	-----------------------    EPwm2Regs.AQCTLA.all = EPwm4Regs.AQCTLA.all = 384u;
;*** 80	-----------------------    EPwm2Regs.AQCTLB.all = EPwm4Regs.AQCTLB.all = 576u;
;*** 80	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
	...
	.dwpsn	"search.c",63,2
        MOVW      DP,#_EPwm4Regs
        MOV       AL,@_EPwm4Regs        ; |63| 
        OR        @_EPwm4Regs,#0x1c00   ; |63| 
        MOVW      DP,#_EPwm3Regs
        OR        @_EPwm3Regs,#0x1c00   ; |63| 
        MOVW      DP,#_EPwm2Regs
        OR        @_EPwm2Regs,#0x1c00   ; |63| 
        MOVW      DP,#_EPwm1Regs
	...
	.dwpsn	"search.c",65,2
        MOV       AL,@_EPwm1Regs+5      ; |65| 
        LSR       AL,2                  ; |65| 
        MOVW      DP,#_EPwm2Regs+9
        MOV       @_EPwm2Regs+9,AL      ; |65| 
        MOVW      DP,#_EPwm1Regs+9
        MOV       @_EPwm1Regs+9,AL      ; |65| 
	.dwpsn	"search.c",65,81
        MOVW      DP,#_EPwm2Regs+5
        MOV       AH,@_EPwm2Regs+5      ; |65| 
        MOV       AL,@_EPwm2Regs+5      ; |65| 
        LSR       AH,2                  ; |65| 
        LSR       AL,1                  ; |65| 
        ADD       AL,AH                 ; |65| 
        MOV       @_EPwm2Regs+10,AL     ; |65| 
        MOVW      DP,#_EPwm1Regs+10
        MOV       @_EPwm1Regs+10,AL     ; |65| 
	.dwpsn	"search.c",66,2
        MOVW      DP,#_EPwm3Regs+5
        MOV       AL,@_EPwm3Regs+5      ; |66| 
        MOVW      DP,#_EPwm4Regs+9
        LSR       AL,2                  ; |66| 
        MOV       @_EPwm4Regs+9,AL      ; |66| 
        MOVW      DP,#_EPwm3Regs+9
        MOV       @_EPwm3Regs+9,AL      ; |66| 
	.dwpsn	"search.c",66,81
        MOVW      DP,#_EPwm4Regs+5
        MOV       AH,@_EPwm4Regs+5      ; |66| 
        MOV       AL,@_EPwm4Regs+5      ; |66| 
        LSR       AH,2                  ; |66| 
        LSR       AL,1                  ; |66| 
        ADD       AL,AH                 ; |66| 
        MOV       @_EPwm4Regs+10,AL     ; |66| 
        MOVW      DP,#_EPwm3Regs+10
        MOV       @_EPwm3Regs+10,AL     ; |66| 
	.dwpsn	"search.c",68,2
        MOVW      DP,#_EPwm4Regs
        MOV       AL,@_EPwm4Regs        ; |68| 
        OR        @_EPwm4Regs,#0x0003   ; |68| 
        MOVW      DP,#_EPwm3Regs
        OR        @_EPwm3Regs,#0x0003   ; |68| 
        MOVW      DP,#_EPwm2Regs
        OR        @_EPwm2Regs,#0x0003   ; |68| 
        MOVW      DP,#_EPwm1Regs
        OR        @_EPwm1Regs,#0x0003   ; |68| 
	.dwpsn	"search.c",69,2
        MOVW      DP,#_EPwm4Regs+4
        MOV       @_EPwm4Regs+4,#0      ; |69| 
        MOVW      DP,#_EPwm3Regs+4
        MOV       @_EPwm3Regs+4,#0      ; |69| 
        MOVW      DP,#_EPwm2Regs+4
        MOV       @_EPwm2Regs+4,#0      ; |69| 
        MOVW      DP,#_EPwm1Regs+4
        MOV       @_EPwm1Regs+4,#0      ; |69| 
	.dwpsn	"search.c",77,2
        MOVW      DP,#_EPwm3Regs+11
        MOV       AL,#2064              ; |77| 
        MOV       @_EPwm3Regs+11,AL     ; |77| 
        MOVW      DP,#_EPwm1Regs+11
        MOV       @_EPwm1Regs+11,AL     ; |77| 
	.dwpsn	"search.c",78,2
        MOVW      DP,#_EPwm3Regs+12
        MOV       AL,#1056              ; |78| 
        MOV       @_EPwm3Regs+12,AL     ; |78| 
        MOVW      DP,#_EPwm1Regs+12
        MOV       @_EPwm1Regs+12,AL     ; |78| 
	.dwpsn	"search.c",79,2
        MOVW      DP,#_EPwm4Regs+11
        MOV       AL,#384               ; |79| 
        MOV       @_EPwm4Regs+11,AL     ; |79| 
        MOVW      DP,#_EPwm2Regs+11
        MOV       @_EPwm2Regs+11,AL     ; |79| 
	.dwpsn	"search.c",80,2
        MOV       AL,#576               ; |80| 
        MOVW      DP,#_EPwm4Regs+12
        MOV       @_EPwm4Regs+12,AL     ; |80| 
        MOVW      DP,#_EPwm2Regs+12
        MOV       @_EPwm2Regs+12,AL     ; |80| 
	.dwpsn	"search.c",123,1
        LRETR
        ; return occurs
	.dwattr DW$60, DW_AT_end_file("search.c")
	.dwattr DW$60, DW_AT_end_line(0x7b)
...
DW$61	.dwtag  DW_TAG_subprogram, DW_AT_name("RUN"), DW_AT_symbol_name("_RUN")
	...
	.dwattr DW$61, DW_AT_begin_line(0x7d)
...
_RUN:
;*** 127	-----------------------    Init_RUN();
;*** 129	-----------------------    VFDPrintf("1stREADY");
;*** 130	-----------------------    DSP28x_usDelay(0x1312cfeuL);
;*** 131	-----------------------    VFDPrintf("        ");
;*** 133	-----------------------    *&Flag |= 0x40u;
;*** 134	-----------------------    *&Flag |= 4u;
;*** 135	-----------------------    *&Flag |= 2u;
;*** 137	-----------------------    C$3 = MOTOR_SPEED_U32<<17;
;*** 137	-----------------------    MOVE_TO_MOVE(65536000L, 0L, C$3, C$3, JERK_U32<<16);
;*** 141	-----------------------    *&EPwm4Regs = *&EPwm4Regs&0xfffeu|2u;
;*** 141	-----------------------    *&EPwm3Regs = *&EPwm3Regs&0xfffeu|2u;
;*** 141	-----------------------    *&EPwm2Regs = *&EPwm2Regs&0xfffeu|2u;
;*** 141	-----------------------    *&EPwm1Regs = *&EPwm1Regs&0xfffeu|2u;
;*** 142	-----------------------    EPwm4Regs.TBCTR = 0u;
;*** 142	-----------------------    EPwm3Regs.TBCTR = 0u;
;*** 142	-----------------------    EPwm2Regs.TBCTR = 0u;
;*** 142	-----------------------    EPwm1Regs.TBCTR = 0u;
...
;***  	-----------------------    K$20 = &SENSOR_ENABLE;
	...
	.dwcfa	0x1d, -22
;* AL    assigned to C$3
DW$62	.dwtag  DW_TAG_variable, DW_AT_name("C$3"), DW_AT_symbol_name("C$3")
	.dwattr DW$62, DW_AT_type(*DW$T$12)
	.dwattr DW$62, DW_AT_location[DW_OP_reg0]
;* AR1   assigned to K$29
DW$63	.dwtag  DW_TAG_variable, DW_AT_name("K$29"), DW_AT_symbol_name("K$29")
	.dwattr DW$63, DW_AT_type(*DW$T$107)
	.dwattr DW$63, DW_AT_location[DW_OP_reg6]
;* AR3   assigned to K$30
DW$64	.dwtag  DW_TAG_variable, DW_AT_name("K$30"), DW_AT_symbol_name("K$30")
	.dwattr DW$64, DW_AT_type(*DW$T$107)
	.dwattr DW$64, DW_AT_location[DW_OP_reg10]
DW$65	.dwtag  DW_TAG_variable, DW_AT_name("K$25"), DW_AT_symbol_name("K$25")
	.dwattr DW$65, DW_AT_type(*DW$T$99)
	.dwattr DW$65, DW_AT_location[DW_OP_breg20 -10]
DW$66	.dwtag  DW_TAG_variable, DW_AT_name("K$23"), DW_AT_symbol_name("K$23")
	.dwattr DW$66, DW_AT_type(*DW$T$122)
	.dwattr DW$66, DW_AT_location[DW_OP_breg20 -12]
DW$67	.dwtag  DW_TAG_variable, DW_AT_name("K$21"), DW_AT_symbol_name("K$21")
...
DW$68	.dwtag  DW_TAG_variable, DW_AT_name("K$20"), DW_AT_symbol_name("K$20")
	...
	.dwpsn	"search.c",137,2
        ...
        MOVW      DP,#_JERK_U32
        MOVL      *-SP[6],ACC           ; |137| 
        MOVL      ACC,@_JERK_U32        ; |137| 
        LSL       ACC,16                ; |137| 
        MOVL      *-SP[8],ACC           ; |137| 
        MOV       ACC,#2000 << 15
        LCR       #_MOVE_TO_MOVE        ; |137| 
        ; call occurs [#_MOVE_TO_MOVE] ; |137| 
	.dwpsn	"search.c",141,2
        MOVW      DP,#_EPwm4Regs
        AND       AL,@_EPwm4Regs,#0xfffe ; |141| 
        ORB       AL,#0x02              ; |141| 
        MOV       @_EPwm4Regs,AL        ; |141| 
        MOVW      DP,#_EPwm3Regs
        AND       AL,@_EPwm3Regs,#0xfffe ; |141| 
        ORB       AL,#0x02              ; |141| 
        MOV       @_EPwm3Regs,AL        ; |141| 
        MOVW      DP,#_EPwm2Regs
        AND       AL,@_EPwm2Regs,#0xfffe ; |141| 
        ORB       AL,#0x02              ; |141| 
        MOV       @_EPwm2Regs,AL        ; |141| 
        MOVW      DP,#_EPwm1Regs
        AND       AL,@_EPwm1Regs,#0xfffe ; |141| 
        ORB       AL,#0x02              ; |141| 
        MOV       @_EPwm1Regs,AL        ; |141| 
	.dwpsn	"search.c",142,2
        MOVW      DP,#_EPwm4Regs+4
        MOVL      XAR4,#_SenAdc
        MOV       @_EPwm4Regs+4,#0      ; |142| 
        MOVL      *-SP[10],XAR4
        MOVW      DP,#_EPwm3Regs+4
        MOVL      XAR4,#_POSITION_WEIGHT_I32
        MOV       @_EPwm3Regs+4,#0      ; |142| 
        MOVL      *-SP[12],XAR4
        MOVW      DP,#_EPwm2Regs+4
        MOVL      XAR4,#_SENSOR_STATE_U16_CNT
        MOV       @_EPwm2Regs+4,#0      ; |142| 
        MOVL      *-SP[14],XAR4
        MOVW      DP,#_EPwm1Regs+4
        MOVL      XAR3,#_LMark          ; |156| 
        MOVL      XAR4,#_SENSOR_ENABLE
        MOV       @_EPwm1Regs+4,#0      ; |142| 
        MOVL      XAR2,XAR4
L1:    
DW$L$_RUN$2$B:
;***	-----------------------g2:
;*** 154	-----------------------    POSITION_COMPUTE(K$25, K$23, K$21, K$20);
;*** 156	-----------------------    K$30 = &LMark;
;*** 156	-----------------------    K$29 = &RMark;
;*** 156	-----------------------    (*K$30).TurnmarkDistance_IQ17 = (*K$29).TurnmarkDistance_IQ17 = (RMotor.TurnMarkCheckDistance_IQ17>>1)+(LMotor.TurnMarkCheckDistance_IQ17>>1);
;*** 158	-----------------------    TURN_DECIDE(K$29, K$30);
;*** 159	-----------------------    TURN_DECIDE(K$30, K$29);
;*** 160	-----------------------    if ( END_STOP() ) goto g4;
	.dwpsn	"search.c",154,3
        ...
        MOVL      XAR4,*-SP[10]         ; |154| 
        MOVL      XAR5,*-SP[12]         ; |154| 
        LCR       #_POSITION_COMPUTE    ; |154| 
        ; call occurs [#_POSITION_COMPUTE] ; |154| 
	.dwpsn	"search.c",156,3
        MOVW      DP,#_RMotor+8
        MOVL      P,@_RMotor+8          ; |156| 
        MOVW      DP,#_LMotor+8
        MOVL      XAR4,#_RMark          ; |156| 
        SETC      SXM
        MOVL      ACC,@_LMotor+8        ; |156| 
        MOVL      XAR1,XAR4             ; |156| 
        SPM       #-1
        SFR       ACC,1                 ; |156| 
        ADDL      ACC,P << PM           ; |156| 
	...
	.dwpsn	"search.c",158,3
        ...
        MOVL      XAR4,XAR1
        SPM       #0
        LCR       #_TURN_DECIDE         ; |158| 
        ; call occurs [#_TURN_DECIDE] ; |158| 
	.dwpsn	"search.c",159,3
        MOVL      XAR4,XAR3             ; |159| 
        MOVL      XAR5,XAR1             ; |159| 
        LCR       #_TURN_DECIDE         ; |159| 
        ; call occurs [#_TURN_DECIDE] ; |159| 
...
DW$69	.dwtag  DW_TAG_loop
	.dwattr DW$69, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L1:1:1643119025")
	.dwattr DW$69, DW_AT_begin_file("search.c")
	.dwattr DW$69, DW_AT_begin_line(0x90)
	.dwattr DW$69, DW_AT_end_line(0xa2)
DW$70	.dwtag  DW_TAG_loop_range
	.dwattr DW$70, DW_AT_low_pc(DW$L$_RUN$2$B)
	.dwattr DW$70, DW_AT_high_pc(DW$L$_RUN$2$E)
DW$71	.dwtag  DW_TAG_loop_range
	.dwattr DW$71, DW_AT_low_pc(DW$L$_RUN$3$B)
	.dwattr DW$71, DW_AT_high_pc(DW$L$_RUN$3$E)
	.dwendtag DW$69

	.dwattr DW$61, DW_AT_end_file("search.c")
	.dwattr DW$61, DW_AT_end_line(0xa3)
...
DW$72	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_PRINTF"), DW_AT_symbol_name("_LINE_PRINTF")
	...
	.dwattr DW$72, DW_AT_begin_line(0xba)
...
DW$74	.dwtag  DW_TAG_variable, DW_AT_name("map_U16_cnt"), DW_AT_symbol_name("_map_U16_cnt")
	.dwattr DW$74, DW_AT_type(*DW$T$19)
	.dwattr DW$74, DW_AT_location[DW_OP_breg20 -7]
...
DW$76	.dwtag  DW_TAG_variable, DW_AT_name("U$16"), DW_AT_symbol_name("U$16")
...
DW$78	.dwtag  DW_TAG_variable, DW_AT_name("shutdown_U16"), DW_AT_symbol_name("_shutdown_U16")
	...
	.dwpsn	"search.c",188,9
        MOV       *-SP[7],#0            ; |188| 
	.dwpsn	"search.c",190,18
        MOV       *-SP[8],#1            ; |190| 
	.dwpsn	"search.c",192,2
        LCR       #_Init_RUN            ; |192| 
        ; call occurs [#_Init_RUN] ; |192| 
	.dwpsn	"search.c",193,2
        LCR       #_load_line_info_rom  ; |193| 
        ; call occurs [#_load_line_info_rom] ; |193| 
	.dwpsn	"search.c",195,2
        MOVL      XAR4,#FSL3            ; |195| 
        MOVL      *-SP[2],XAR4          ; |195| 
        LCR       #_VFDPrintf           ; |195| 
        ; call occurs [#_VFDPrintf] ; |195| 
	.dwpsn	"search.c",189,9
        MOVB      XAR1,#0
...
;***	-----------------------g2:
;*** 198	-----------------------    if ( !(*(&GpioDataRegs+1)&0x4000u) ) goto g5;
	.dwpsn	"search.c",198,3
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#14  ; |198| 
        BF        L4,NTC                ; |198| 
        ; branchcc occurs ; |198| 
DW$L$_LINE_PRINTF$2$E:
DW$L$_LINE_PRINTF$3$B:
;*** 199	-----------------------    if ( *&GpioDataRegs&0x4000u ) goto g6;
	.dwpsn	"search.c",199,8
...
;*** 199	-----------------------    TxPrintf("\n\nTHIRD_LINE_INFO\n\n");
;*** 199	-----------------------    goto g6;
	.dwpsn	"search.c",199,20
        MOVW      DP,#_Flag
        AND       @_Flag,#0xff7f        ; |199| 
	.dwpsn	"search.c",199,41
        OR        @_Flag,#0x0100        ; |199| 
	.dwpsn	"search.c",199,63
        MOVL      XAR4,#FSL4            ; |199| 
        MOVL      *-SP[2],XAR4          ; |199| 
        LCR       #_TxPrintf            ; |199| 
...
;*** 198	-----------------------    *&Flag &= 0xfeffu;
;*** 198	-----------------------    TxPrintf("\n\nSECOND_LINE_INFO\n\n");
	.dwpsn	"search.c",198,16
        MOVW      DP,#_Flag
        OR        @_Flag,#0x0080        ; |198| 
	.dwpsn	"search.c",198,37
        AND       @_Flag,#0xfeff        ; |198| 
	.dwpsn	"search.c",198,60
        MOVL      XAR4,#FSL5            ; |198| 
        MOVL      *-SP[2],XAR4          ; |198| 
        LCR       #_TxPrintf            ; |198| 
...
;***	-----------------------g6:
;*** 200	-----------------------    C$1 = &GpioDataRegs;
;*** 200	-----------------------    if ( C$1[1]>>14&1u&(*C$1>>14&1u) ) goto g2;
...
;*** 203	-----------------------    *&Flag |= 0x200u;
;*** 205	-----------------------    TURN_COMPUTE_FUNC();
;*** 206	-----------------------    TURN_DIVISION_FUNC();
;*** 208	-----------------------    if ( !shutdown_U16 ) goto g26;
;***  	-----------------------    #pragma LOOP_FLAGS(5120u)
	...
	.dwpsn	"search.c",205,2
        LCR       #_TURN_COMPUTE_FUNC   ; |205| 
        ; call occurs [#_TURN_COMPUTE_FUNC] ; |205| 
	.dwpsn	"search.c",206,2
        LCR       #_TURN_DIVISION_FUNC  ; |206| 
        ; call occurs [#_TURN_DIVISION_FUNC] ; |206| 
...
;***	-----------------------g9:
;*** 210	-----------------------    switch ( menu_U16_cnt ) {case 0u: goto g14;, case 1u: goto g12;, case 2u: goto g10;, DEFAULT goto g21};
...
;***	-----------------------g11:
;*** 258	-----------------------    VFDPrintf("%3u:%4lu", map_U16_cnt, (*U$16).TurnDir_U32);
;*** 259	-----------------------    goto g21;
	.dwpsn	"search.c",258,5
        ...
        MOV       AL,*-SP[7]            ; |258| 
        MOV       *-SP[3],AL            ; |258| 
        MOVL      ACC,*+XAR5[AR0]       ; |258| 
        MOVL      *-SP[6],ACC           ; |258| 
        LCR       #_VFDPrintf           ; |258| 
        ; call occurs [#_VFDPrintf] ; |258| 
	.dwpsn	"search.c",259,10
        BF        L18,UNC               ; |259| 
        ; branch occurs ; |259| 
...
;***	-----------------------g12:
;*** 236	-----------------------    U$16 = &Search[(long)map_U16_cnt];
;*** 236	-----------------------    switch ( (*U$16).TurnWay_U32 ) {case 1uL: goto g13;, case 2uL: goto g13;, case 4uL: goto g13;, case 4096uL: goto g13;, case 8192uL: goto g13;, DEFAULT goto g15};
	.dwpsn	"search.c",236,4
        MOV       T,#24                 ; |236| 
        MOVL      XAR4,#_Search         ; |236| 
        MPYXU     ACC,T,*-SP[7]         ; |236| 
        ADDL      XAR4,ACC
        MOVL      XAR6,*+XAR4[6]        ; |236| 
        MOVB      XAR7,#1
        MOVL      ACC,XAR6              ; |236| 
        SUBB      ACC,#1                ; |236| 
        CMPL      ACC,XAR7              ; |236| 
...
;***	-----------------------g13:
;*** 243	-----------------------    VFDPrintf("%3u:%4lu", map_U16_cnt, (*U$16).Distance_U32);
;*** 244	-----------------------    goto g21;
...
;***	-----------------------g14:
;*** 213	-----------------------    switch ( (Search[(long)map_U16_cnt]).TurnWay_U32 ) {case 1uL: goto g20;, case 2uL: goto g19;, case 4uL: goto g18;, case 4096uL: goto g17;, case 8192uL: goto g16;, DEFAULT goto g15};
	.dwpsn	"search.c",213,4
        MOV       T,#24                 ; |213| 
        MOVL      XAR4,#_Search+6       ; |213| 
        MPYXU     ACC,T,*-SP[7]         ; |213| 
        ADDL      XAR4,ACC
        MOVL      XAR6,*+XAR4[0]        ; |213| 
        MOVB      ACC,#4
        CMPL      ACC,XAR6              ; |213| 
        BF        L11,LT                ; |213| 
        ; branchcc occurs ; |213| 
...
;***	-----------------------g15:
;*** 231	-----------------------    VFDPrintf("%3u: err", map_U16_cnt);
;*** 232	-----------------------    goto g21;
...
;***	-----------------------g16:
;*** 228	-----------------------    VFDPrintf("%3u:E-|-", map_U16_cnt);
;*** 229	-----------------------    goto g21;
...
;***	-----------------------g17:
;*** 225	-----------------------    VFDPrintf("%3u:G-|-", map_U16_cnt);
;*** 226	-----------------------    goto g21;
...
;***	-----------------------g18:
;*** 219	-----------------------    VFDPrintf("%3u:R |-", map_U16_cnt);
;*** 220	-----------------------    goto g21;
...
;***	-----------------------g19:
;*** 222	-----------------------    VFDPrintf("%3u:L-| ", map_U16_cnt);
;*** 223	-----------------------    goto g21;
...
;***	-----------------------g20:
;*** 216	-----------------------    VFDPrintf("%3u:S | ", map_U16_cnt);
...
;***	-----------------------g21:
;*** 266	-----------------------    if ( !(*(&GpioDataRegs+1)&0x8000u) ) goto g24;
	.dwpsn	"search.c",266,3
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#15  ; |266| 
        BF        L20,NTC               ; |266| 
        ; branchcc occurs ; |266| 
DW$L$_LINE_PRINTF$34$E:
DW$L$_LINE_PRINTF$35$B:
;*** 267	-----------------------    if ( *&GpioDataRegs&0x8000u ) goto g25;
	.dwpsn	"search.c",267,8
...
;*** 270	-----------------------    (menu_U16_cnt < 2u) ? (menu_U16_cnt = menu_U16_cnt+1u) : (menu_U16_cnt = 0u);
...
;*** 266	-----------------------    shutdown_U16 = 0u;
	.dwpsn	"search.c",266,16
        MOV       AL,#9630
        MOV       AH,#38
        LCR       #_DSP28x_usDelay      ; |266| 
        ; call occurs [#_DSP28x_usDelay] ; |266| 
	.dwpsn	"search.c",266,36
        MOV       *-SP[8],#0            ; |266| 
DW$L$_LINE_PRINTF$39$E:
L21:    
DW$L$_LINE_PRINTF$40$B:
;***	-----------------------g25:
;*** 273	-----------------------    MENU_SW(&map_U16_cnt, MARK_U16_CNT);
;*** 274	-----------------------    if ( shutdown_U16 ) goto g9;
...
DW$79	.dwtag  DW_TAG_loop
	.dwattr DW$79, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L6:1:1643119025")
	.dwattr DW$79, DW_AT_begin_file("search.c")
	.dwattr DW$79, DW_AT_begin_line(0xd0)
	.dwattr DW$79, DW_AT_end_line(0x112)
DW$80	.dwtag  DW_TAG_loop_range
	.dwattr DW$80, DW_AT_low_pc(DW$L$_LINE_PRINTF$8$B)
	.dwattr DW$80, DW_AT_high_pc(DW$L$_LINE_PRINTF$8$E)
DW$81	.dwtag  DW_TAG_loop_range
	.dwattr DW$81, DW_AT_low_pc(DW$L$_LINE_PRINTF$36$B)
	.dwattr DW$81, DW_AT_high_pc(DW$L$_LINE_PRINTF$36$E)
DW$82	.dwtag  DW_TAG_loop_range
	.dwattr DW$82, DW_AT_low_pc(DW$L$_LINE_PRINTF$26$B)
	.dwattr DW$82, DW_AT_high_pc(DW$L$_LINE_PRINTF$26$E)
DW$83	.dwtag  DW_TAG_loop_range
	.dwattr DW$83, DW_AT_low_pc(DW$L$_LINE_PRINTF$21$B)
	.dwattr DW$83, DW_AT_high_pc(DW$L$_LINE_PRINTF$21$E)
DW$84	.dwtag  DW_TAG_loop_range
	.dwattr DW$84, DW_AT_low_pc(DW$L$_LINE_PRINTF$22$B)
	.dwattr DW$84, DW_AT_high_pc(DW$L$_LINE_PRINTF$22$E)
DW$85	.dwtag  DW_TAG_loop_range
	.dwattr DW$85, DW_AT_low_pc(DW$L$_LINE_PRINTF$23$B)
	.dwattr DW$85, DW_AT_high_pc(DW$L$_LINE_PRINTF$23$E)
DW$86	.dwtag  DW_TAG_loop_range
	.dwattr DW$86, DW_AT_low_pc(DW$L$_LINE_PRINTF$24$B)
	.dwattr DW$86, DW_AT_high_pc(DW$L$_LINE_PRINTF$24$E)
DW$87	.dwtag  DW_TAG_loop_range
	.dwattr DW$87, DW_AT_low_pc(DW$L$_LINE_PRINTF$25$B)
	.dwattr DW$87, DW_AT_high_pc(DW$L$_LINE_PRINTF$25$E)
DW$88	.dwtag  DW_TAG_loop_range
	.dwattr DW$88, DW_AT_low_pc(DW$L$_LINE_PRINTF$27$B)
	.dwattr DW$88, DW_AT_high_pc(DW$L$_LINE_PRINTF$27$E)
DW$89	.dwtag  DW_TAG_loop_range
	.dwattr DW$89, DW_AT_low_pc(DW$L$_LINE_PRINTF$16$B)
	.dwattr DW$89, DW_AT_high_pc(DW$L$_LINE_PRINTF$16$E)
DW$90	.dwtag  DW_TAG_loop_range
	.dwattr DW$90, DW_AT_low_pc(DW$L$_LINE_PRINTF$17$B)
	.dwattr DW$90, DW_AT_high_pc(DW$L$_LINE_PRINTF$17$E)
DW$91	.dwtag  DW_TAG_loop_range
	.dwattr DW$91, DW_AT_low_pc(DW$L$_LINE_PRINTF$18$B)
	.dwattr DW$91, DW_AT_high_pc(DW$L$_LINE_PRINTF$18$E)
DW$92	.dwtag  DW_TAG_loop_range
	.dwattr DW$92, DW_AT_low_pc(DW$L$_LINE_PRINTF$19$B)
	.dwattr DW$92, DW_AT_high_pc(DW$L$_LINE_PRINTF$19$E)
...
DW$96	.dwtag  DW_TAG_loop_range
	.dwattr DW$96, DW_AT_low_pc(DW$L$_LINE_PRINTF$14$B)
	.dwattr DW$96, DW_AT_high_pc(DW$L$_LINE_PRINTF$14$E)
DW$97	.dwtag  DW_TAG_loop_range
	.dwattr DW$97, DW_AT_low_pc(DW$L$_LINE_PRINTF$9$B)
	.dwattr DW$97, DW_AT_high_pc(DW$L$_LINE_PRINTF$9$E)
DW$98	.dwtag  DW_TAG_loop_range
	.dwattr DW$98, DW_AT_low_pc(DW$L$_LINE_PRINTF$10$B)
	.dwattr DW$98, DW_AT_high_pc(DW$L$_LINE_PRINTF$10$E)
DW$99	.dwtag  DW_TAG_loop_range
	.dwattr DW$99, DW_AT_low_pc(DW$L$_LINE_PRINTF$15$B)
	.dwattr DW$99, DW_AT_high_pc(DW$L$_LINE_PRINTF$15$E)
DW$100	.dwtag  DW_TAG_loop_range
	.dwattr DW$100, DW_AT_low_pc(DW$L$_LINE_PRINTF$20$B)
	.dwattr DW$100, DW_AT_high_pc(DW$L$_LINE_PRINTF$20$E)
DW$101	.dwtag  DW_TAG_loop_range
	.dwattr DW$101, DW_AT_low_pc(DW$L$_LINE_PRINTF$28$B)
	.dwattr DW$101, DW_AT_high_pc(DW$L$_LINE_PRINTF$28$E)
DW$102	.dwtag  DW_TAG_loop_range
	.dwattr DW$102, DW_AT_low_pc(DW$L$_LINE_PRINTF$29$B)
	.dwattr DW$102, DW_AT_high_pc(DW$L$_LINE_PRINTF$29$E)
DW$103	.dwtag  DW_TAG_loop_range
	.dwattr DW$103, DW_AT_low_pc(DW$L$_LINE_PRINTF$30$B)
	.dwattr DW$103, DW_AT_high_pc(DW$L$_LINE_PRINTF$30$E)
DW$104	.dwtag  DW_TAG_loop_range
	.dwattr DW$104, DW_AT_low_pc(DW$L$_LINE_PRINTF$31$B)
	.dwattr DW$104, DW_AT_high_pc(DW$L$_LINE_PRINTF$31$E)
...
DW$109	.dwtag  DW_TAG_loop_range
	.dwattr DW$109, DW_AT_low_pc(DW$L$_LINE_PRINTF$37$B)
	.dwattr DW$109, DW_AT_high_pc(DW$L$_LINE_PRINTF$37$E)
DW$110	.dwtag  DW_TAG_loop_range
	.dwattr DW$110, DW_AT_low_pc(DW$L$_LINE_PRINTF$38$B)
	.dwattr DW$110, DW_AT_high_pc(DW$L$_LINE_PRINTF$38$E)
DW$111	.dwtag  DW_TAG_loop_range
	.dwattr DW$111, DW_AT_low_pc(DW$L$_LINE_PRINTF$39$B)
	.dwattr DW$111, DW_AT_high_pc(DW$L$_LINE_PRINTF$39$E)
DW$112	.dwtag  DW_TAG_loop_range
	.dwattr DW$112, DW_AT_low_pc(DW$L$_LINE_PRINTF$40$B)
	.dwattr DW$112, DW_AT_high_pc(DW$L$_LINE_PRINTF$40$E)
	.dwendtag DW$79


DW$113	.dwtag  DW_TAG_loop
	.dwattr DW$113, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L5:1:1643119025")
	.dwattr DW$113, DW_AT_begin_file("search.c")
	.dwattr DW$113, DW_AT_begin_line(0xc4)
	.dwattr DW$113, DW_AT_end_line(0xc8)
DW$114	.dwtag  DW_TAG_loop_range
	.dwattr DW$114, DW_AT_low_pc(DW$L$_LINE_PRINTF$6$B)
	.dwattr DW$114, DW_AT_high_pc(DW$L$_LINE_PRINTF$6$E)
DW$115	.dwtag  DW_TAG_loop_range
	.dwattr DW$115, DW_AT_low_pc(DW$L$_LINE_PRINTF$2$B)
	.dwattr DW$115, DW_AT_high_pc(DW$L$_LINE_PRINTF$2$E)
DW$116	.dwtag  DW_TAG_loop_range
	.dwattr DW$116, DW_AT_low_pc(DW$L$_LINE_PRINTF$5$B)
	.dwattr DW$116, DW_AT_high_pc(DW$L$_LINE_PRINTF$5$E)
DW$117	.dwtag  DW_TAG_loop_range
	.dwattr DW$117, DW_AT_low_pc(DW$L$_LINE_PRINTF$4$B)
	.dwattr DW$117, DW_AT_high_pc(DW$L$_LINE_PRINTF$4$E)
DW$118	.dwtag  DW_TAG_loop_range
	.dwattr DW$118, DW_AT_low_pc(DW$L$_LINE_PRINTF$3$B)
	.dwattr DW$118, DW_AT_high_pc(DW$L$_LINE_PRINTF$3$E)
	.dwendtag DW$113

	.dwattr DW$72, DW_AT_end_file("search.c")
	.dwattr DW$72, DW_AT_end_line(0x114)
...
DW$119	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_INFO"), DW_AT_symbol_name("_LINE_INFO")
	.dwattr DW$119, DW_AT_low_pc(_LINE_INFO)
	.dwattr DW$119, DW_AT_high_pc(0x00)
	.dwattr DW$119, DW_AT_begin_file("search.c")
	.dwattr DW$119, DW_AT_begin_line(0xa5)
...
_LINE_INFO:
;*** 167	-----------------------    K$8 = &Search[0];
;*** 167	-----------------------    C$2 = &K$8[(long)MARK_U16_CNT];
;*** 167	-----------------------    (*C$2).Distance_R_U32 = RMotor.GoneDistance_IQ15>>15;
;*** 168	-----------------------    (*C$2).Distance_L_U32 = LMotor.GoneDistance_IQ15>>15;
;*** 169	-----------------------    K$8 = K$8;
;*** 169	-----------------------    U$9 = C$2;
;*** 169	-----------------------    (*U$9).Distance_U32 = (*U$9).Distance_L_U32+(*U$9).Distance_R_U32>>1;
...
DW$120	.dwtag  DW_TAG_formal_parameter, DW_AT_name("mark"), DW_AT_symbol_name("_mark")
...
;* AR6   assigned to U$9
DW$124	.dwtag  DW_TAG_variable, DW_AT_name("U$9"), DW_AT_symbol_name("U$9")
	.dwattr DW$124, DW_AT_type(*DW$T$158)
	.dwattr DW$124, DW_AT_location[DW_OP_reg16]
;* AR4   assigned to U$9
DW$125	.dwtag  DW_TAG_variable, DW_AT_name("U$9"), DW_AT_symbol_name("U$9")
	.dwattr DW$125, DW_AT_type(*DW$T$158)
	.dwattr DW$125, DW_AT_location[DW_OP_reg12]
;* AR5   assigned to K$8
DW$126	.dwtag  DW_TAG_variable, DW_AT_name("K$8"), DW_AT_symbol_name("K$8")
	.dwattr DW$126, DW_AT_type(*DW$T$158)
...
DW$127	.dwtag  DW_TAG_variable, DW_AT_name("K$8"), DW_AT_symbol_name("K$8")
	...
	.dwpsn	"search.c",167,2
        ...
        MOVL      XAR6,ACC              ; |167| 
        SETC      SXM
        MOVL      ACC,@_RMotor+10       ; |167| 
        SFR       ACC,15                ; |167| 
        MOVL      *+XAR6[0],ACC         ; |167| 
	.dwpsn	"search.c",168,2
        MOVW      DP,#_LMotor+10
        MOVL      ACC,@_LMotor+10       ; |168| 
        SFR       ACC,15                ; |168| 
        MOVL      *+XAR6[2],ACC         ; |168| 
	...
	.dwpsn	"search.c",170,2
        MOVW      DP,#_RMotor+10
        MOVB      ACC,#0
        MOVL      @_RMotor+10,ACC       ; |170| 
        MOVW      DP,#_LMotor+10
        MOVL      @_LMotor+10,ACC       ; |170| 
	.dwpsn	"search.c",172,2
        MOVL      ACC,XAR4
        BF        L24,NEQ               ; |172| 
        ; branchcc occurs ; |172| 
;*** 174	-----------------------    if ( *&Flag&0x20u ) goto g4;
	.dwpsn	"search.c",174,3
        MOVW      DP,#_Flag
        TBIT      @_Flag,#5             ; |174| 
        BF        L23,TC                ; |174| 
        ; branchcc occurs ; |174| 
;*** 175	-----------------------    (*U$9).TurnWay_U32 = 4096uL;
;*** 175	-----------------------    goto g7;
	.dwpsn	"search.c",175,10
        MOVL      XAR4,#4096            ; |175| 
        MOVL      *+XAR6[6],XAR4        ; |175| 
        BF        L27,UNC               ; |175| 
        ; branch occurs ; |175| 
L23:    
;***	-----------------------g4:
;*** 174	-----------------------    (*U$9).TurnWay_U32 = 8192uL;
;*** 174	-----------------------    goto g7;
	.dwpsn	"search.c",174,17
        MOVL      XAR4,#8192            ; |174| 
        MOVL      *+XAR6[6],XAR4        ; |174| 
        BF        L27,UNC               ; |174| 
        ; branch occurs ; |174| 
L24:    
;***	-----------------------g5:
;*** 179	-----------------------    ++MARK_U16_CNT;
;*** 181	-----------------------    (mark == &LMark) ? (S$1 = 2uL) : (S$1 = 4uL);
	.dwpsn	"search.c",179,3
        MOVW      DP,#_MARK_U16_CNT
        INC       @_MARK_U16_CNT        ; |179| 
	.dwpsn	"search.c",181,3
        MOVL      XAR6,#_LMark          ; |181| 
        MOVL      ACC,XAR6              ; |181| 
        CMPL      ACC,XAR4              ; |181| 
        BF        L25,NEQ               ; |181| 
        ; branchcc occurs ; |181| 
...
L25:    
        MOVB      XAR6,#4
L26:    
;*** 181	-----------------------    U$9 = &K$8[(long)MARK_U16_CNT];
;*** 181	-----------------------    (*U$9).TurnWay_U32 = S$1;
;*** 182	-----------------------    if ( MARK_U16_CNT == 0u || S$1 != (K$8[(long)(MARK_U16_CNT-1u)]).TurnWay_U32 ) goto g7;
        MOV       T,#24                 ; |181| 
        MPYXU     P,T,@_MARK_U16_CNT    ; |181| 
        MOVL      ACC,XAR5              ; |181| 
        ADDL      ACC,P
        MOVL      XAR4,ACC              ; |181| 
        MOVL      *+XAR4[6],XAR6        ; |181| 
	.dwpsn	"search.c",182,3
        MOV       AL,@_MARK_U16_CNT     ; |182| 
        BF        L27,EQ                ; |182| 
        ; branchcc occurs ; |182| 
        MOV       T,#24                 ; |182| 
        ADDB      AL,#-1
        ...
        BF        L27,NEQ               ; |182| 
        ; branchcc occurs ; |182| 
;*** 182	-----------------------    (*U$9).TurnWay_U32 = 1uL;
;***	-----------------------g7:
;***  	-----------------------    return;
	.dwpsn	"search.c",182,96
        MOVB      ACC,#1
        MOVL      *+XAR4[6],ACC         ; |182| 
L27:    
	.dwpsn	"search.c",184,1
        LRETR
        ; return occurs
	.dwattr DW$119, DW_AT_end_file("search.c")
	.dwattr DW$119, DW_AT_end_line(0xb8)
...
DW$130	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$87)
	.dwendtag DW$T$88


DW$T$92	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$92, DW_AT_language(DW_LANG_C)
DW$131	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$91)
...
DW$135	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$24)
DW$136	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$24)
DW$137	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$83)
	.dwendtag DW$T$96


DW$T$103	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$103, DW_AT_language(DW_LANG_C)
DW$138	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$99)
DW$139	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$101)
...
DW$142	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$107)
...
DW$144	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$30)
	.dwendtag DW$T$110
...
DW$T$20	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$20, DW_AT_type(*DW$146)
...
DW$T$124	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$124, DW_AT_type(*DW$148)
...
DW$T$127	.dwtag  DW_TAG_const_type
	.dwattr DW$T$127, DW_AT_type(*DW$149)
DW$150	.dwtag  DW_TAG_far_type
	.dwattr DW$150, DW_AT_type(*DW$T$35)
DW$T$130	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$130, DW_AT_type(*DW$150)
DW$151	.dwtag  DW_TAG_far_type
	.dwattr DW$151, DW_AT_type(*DW$T$80)
DW$T$148	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$148, DW_AT_type(*DW$151)
DW$T$151	.dwtag  DW_TAG_typedef, DW_AT_name("MOTORCTRL"), DW_AT_type(*DW$T$150)
	.dwattr DW$T$151, DW_AT_language(DW_LANG_C)
DW$T$153	.dwtag  DW_TAG_typedef, DW_AT_name("BITFLAG"), DW_AT_type(*DW$T$152)
	.dwattr DW$T$153, DW_AT_language(DW_LANG_C)

DW$T$156	.dwtag  DW_TAG_array_type, DW_AT_type(*DW$T$155)
...
DW$T$158	.dwtag  DW_TAG_pointer_type, DW_AT_type(*DW$T$86)
...
DW$163	.dwtag  DW_TAG_far_type
	.dwattr DW$163, DW_AT_type(*DW$T$28)
DW$T$105	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$105, DW_AT_type(*DW$163)
...
DW$191	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$57)
	.dwattr DW$191, DW_AT_name("TZCTL"), DW_AT_symbol_name("_TZCTL")
	.dwattr DW$191, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr DW$191, DW_AT_accessibility(DW_ACCESS_public)
DW$192	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$59)
	.dwattr DW$192, DW_AT_name("TZEINT"), DW_AT_symbol_name("_TZEINT")
	.dwattr DW$192, DW_AT_data_member_location[DW_OP_plus_uconst 0x15]
	.dwattr DW$192, DW_AT_accessibility(DW_ACCESS_public)
DW$193	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$61)
	.dwattr DW$193, DW_AT_name("TZFLG"), DW_AT_symbol_name("_TZFLG")
	.dwattr DW$193, DW_AT_data_member_location[DW_OP_plus_uconst 0x16]
	.dwattr DW$193, DW_AT_accessibility(DW_ACCESS_public)
DW$194	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$63)
	.dwattr DW$194, DW_AT_name("TZCLR"), DW_AT_symbol_name("_TZCLR")
	.dwattr DW$194, DW_AT_data_member_location[DW_OP_plus_uconst 0x17]
	.dwattr DW$194, DW_AT_accessibility(DW_ACCESS_public)
DW$195	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$65)
	.dwattr DW$195, DW_AT_name("TZFRC"), DW_AT_symbol_name("_TZFRC")
	.dwattr DW$195, DW_AT_data_member_location[DW_OP_plus_uconst 0x18]
	.dwattr DW$195, DW_AT_accessibility(DW_ACCESS_public)
DW$196	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$67)
	.dwattr DW$196, DW_AT_name("ETSEL"), DW_AT_symbol_name("_ETSEL")
	.dwattr DW$196, DW_AT_data_member_location[DW_OP_plus_uconst 0x19]
	.dwattr DW$196, DW_AT_accessibility(DW_ACCESS_public)
DW$197	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$69)
	.dwattr DW$197, DW_AT_name("ETPS"), DW_AT_symbol_name("_ETPS")
	.dwattr DW$197, DW_AT_data_member_location[DW_OP_plus_uconst 0x1a]
	.dwattr DW$197, DW_AT_accessibility(DW_ACCESS_public)
DW$198	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$71)
	.dwattr DW$198, DW_AT_name("ETFLG"), DW_AT_symbol_name("_ETFLG")
	.dwattr DW$198, DW_AT_data_member_location[DW_OP_plus_uconst 0x1b]
	.dwattr DW$198, DW_AT_accessibility(DW_ACCESS_public)
DW$199	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$73)
	.dwattr DW$199, DW_AT_name("ETCLR"), DW_AT_symbol_name("_ETCLR")
	.dwattr DW$199, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$199, DW_AT_accessibility(DW_ACCESS_public)
DW$200	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$75)
	.dwattr DW$200, DW_AT_name("ETFRC"), DW_AT_symbol_name("_ETFRC")
	.dwattr DW$200, DW_AT_data_member_location[DW_OP_plus_uconst 0x1d]
	.dwattr DW$200, DW_AT_accessibility(DW_ACCESS_public)
DW$201	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$77)
	.dwattr DW$201, DW_AT_name("PCCTL"), DW_AT_symbol_name("_PCCTL")
...
DW$220	.dwtag  DW_TAG_far_type
	.dwattr DW$220, DW_AT_type(*DW$T$22)
DW$T$23	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$23, DW_AT_type(*DW$220)
...
DW$222	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$222, DW_AT_name("TurnmarkDistance_IQ17"), DW_AT_symbol_name("_TurnmarkDistance_IQ17")
...
DW$224	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$224, DW_AT_name("coef_IQ17"), DW_AT_symbol_name("_coef_IQ17")
...
DW$236	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$38)
...
DW$238	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$40)
	.dwattr DW$238, DW_AT_name("half"), DW_AT_symbol_name("_half")
...
DW$242	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$44)
	.dwattr DW$242, DW_AT_name("half"), DW_AT_symbol_name("_half")
...
DW$244	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$46)
...
DW$246	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$48)
...
DW$248	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$50)
...
DW$250	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$52)
...
DW$254	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$56)
...
DW$256	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$58)
...
DW$258	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$60)
...
DW$260	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$62)
...
DW$264	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$66)
...
DW$272	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$74)
...
DW$274	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$76)
...
DW$296	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$296, DW_AT_name("MoveState_U16"), DW_AT_symbol_name("_MoveState_U16")
...
DW$301	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$301, DW_AT_name("STOP"), DW_AT_symbol_name("_STOP")
	.dwattr DW$301, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x01)
	.dwattr DW$301, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$301, DW_AT_accessibility(DW_ACCESS_public)
DW$302	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$302, DW_AT_name("Search_U16"), DW_AT_symbol_name("_Search_U16")
...
DW$303	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$303, DW_AT_name("Fast_U16"), DW_AT_symbol_name("_Fast_U16")
...
DW$304	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$304, DW_AT_name("Extrem_U16"), DW_AT_symbol_name("_Extrem_U16")
...
DW$305	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$305, DW_AT_name("TxFlag_U16"), DW_AT_symbol_name("_TxFlag_U16")
...
DW$306	.dwtag  DW_TAG_far_type
	.dwattr DW$306, DW_AT_type(*DW$T$24)
DW$T$25	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$25, DW_AT_type(*DW$306)
...
DW$345	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$345, DW_AT_name("CTRMODE"), DW_AT_symbol_name("_CTRMODE")
	.dwattr DW$345, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$345, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$345, DW_AT_accessibility(DW_ACCESS_public)
DW$346	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$346, DW_AT_name("PHSEN"), DW_AT_symbol_name("_PHSEN")
	.dwattr DW$346, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$346, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$346, DW_AT_accessibility(DW_ACCESS_public)
DW$347	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$347, DW_AT_name("PRDLD"), DW_AT_symbol_name("_PRDLD")
	.dwattr DW$347, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x01)
	.dwattr DW$347, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$347, DW_AT_accessibility(DW_ACCESS_public)
DW$348	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$348, DW_AT_name("SYNCOSEL"), DW_AT_symbol_name("_SYNCOSEL")
	.dwattr DW$348, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
	.dwattr DW$348, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$348, DW_AT_accessibility(DW_ACCESS_public)
DW$349	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$349, DW_AT_name("SWFSYNC"), DW_AT_symbol_name("_SWFSYNC")
	.dwattr DW$349, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x01)
	.dwattr DW$349, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$349, DW_AT_accessibility(DW_ACCESS_public)
DW$350	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$350, DW_AT_name("HSPCLKDIV"), DW_AT_symbol_name("_HSPCLKDIV")
	.dwattr DW$350, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x03)
	.dwattr DW$350, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$350, DW_AT_accessibility(DW_ACCESS_public)
DW$351	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$351, DW_AT_name("CLKDIV"), DW_AT_symbol_name("_CLKDIV")
	.dwattr DW$351, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x03)
	.dwattr DW$351, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$351, DW_AT_accessibility(DW_ACCESS_public)
DW$352	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$352, DW_AT_name("PHSDIR"), DW_AT_symbol_name("_PHSDIR")
	.dwattr DW$352, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x01)
	.dwattr DW$352, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$352, DW_AT_accessibility(DW_ACCESS_public)
DW$353	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$353, DW_AT_name("FREE_SOFT"), DW_AT_symbol_name("_FREE_SOFT")
	.dwattr DW$353, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
DW$357	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$357, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0d)
...
DW$358	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$358, DW_AT_name("TBPHSHR"), DW_AT_symbol_name("_TBPHSHR")
	.dwattr DW$358, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$358, DW_AT_accessibility(DW_ACCESS_public)
DW$359	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$359, DW_AT_name("TBPHS"), DW_AT_symbol_name("_TBPHS")
...
DW$360	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$360, DW_AT_name("LOADAMODE"), DW_AT_symbol_name("_LOADAMODE")
	.dwattr DW$360, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$360, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$360, DW_AT_accessibility(DW_ACCESS_public)
DW$361	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$361, DW_AT_name("LOADBMODE"), DW_AT_symbol_name("_LOADBMODE")
	.dwattr DW$361, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
	.dwattr DW$361, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$361, DW_AT_accessibility(DW_ACCESS_public)
DW$362	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$362, DW_AT_name("SHDWAMODE"), DW_AT_symbol_name("_SHDWAMODE")
...
DW$364	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$364, DW_AT_name("SHDWBMODE"), DW_AT_symbol_name("_SHDWBMODE")
...
DW$366	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$366, DW_AT_name("SHDWAFULL"), DW_AT_symbol_name("_SHDWAFULL")
	.dwattr DW$366, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
	.dwattr DW$366, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$366, DW_AT_accessibility(DW_ACCESS_public)
DW$367	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$367, DW_AT_name("SHDWBFULL"), DW_AT_symbol_name("_SHDWBFULL")
...
DW$368	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$368, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x06)
...
DW$369	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$369, DW_AT_name("CMPAHR"), DW_AT_symbol_name("_CMPAHR")
	.dwattr DW$369, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$369, DW_AT_accessibility(DW_ACCESS_public)
DW$370	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$370, DW_AT_name("CMPA"), DW_AT_symbol_name("_CMPA")
...
DW$371	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$371, DW_AT_name("ZRO"), DW_AT_symbol_name("_ZRO")
	.dwattr DW$371, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$371, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$371, DW_AT_accessibility(DW_ACCESS_public)
DW$372	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$372, DW_AT_name("PRD"), DW_AT_symbol_name("_PRD")
	.dwattr DW$372, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
	.dwattr DW$372, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$372, DW_AT_accessibility(DW_ACCESS_public)
DW$373	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$373, DW_AT_name("CAU"), DW_AT_symbol_name("_CAU")
	.dwattr DW$373, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
	.dwattr DW$373, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$373, DW_AT_accessibility(DW_ACCESS_public)
DW$374	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$374, DW_AT_name("CAD"), DW_AT_symbol_name("_CAD")
	.dwattr DW$374, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x02)
	.dwattr DW$374, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$374, DW_AT_accessibility(DW_ACCESS_public)
DW$375	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$375, DW_AT_name("CBU"), DW_AT_symbol_name("_CBU")
	.dwattr DW$375, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
	.dwattr DW$375, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$375, DW_AT_accessibility(DW_ACCESS_public)
DW$376	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$376, DW_AT_name("CBD"), DW_AT_symbol_name("_CBD")
	.dwattr DW$376, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
	.dwattr DW$376, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$376, DW_AT_accessibility(DW_ACCESS_public)
DW$377	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$377, DW_AT_name("rsvd"), DW_AT_symbol_name("_rsvd")
...
DW$378	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$378, DW_AT_name("ACTSFA"), DW_AT_symbol_name("_ACTSFA")
	.dwattr DW$378, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$378, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$378, DW_AT_accessibility(DW_ACCESS_public)
DW$379	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$379, DW_AT_name("OTSFA"), DW_AT_symbol_name("_OTSFA")
	.dwattr DW$379, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$379, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$379, DW_AT_accessibility(DW_ACCESS_public)
DW$380	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$380, DW_AT_name("ACTSFB"), DW_AT_symbol_name("_ACTSFB")
	.dwattr DW$380, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x02)
	.dwattr DW$380, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$380, DW_AT_accessibility(DW_ACCESS_public)
DW$381	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$381, DW_AT_name("OTSFB"), DW_AT_symbol_name("_OTSFB")
	.dwattr DW$381, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x01)
	.dwattr DW$381, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$381, DW_AT_accessibility(DW_ACCESS_public)
DW$382	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$382, DW_AT_name("RLDCSF"), DW_AT_symbol_name("_RLDCSF")
...
DW$384	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$384, DW_AT_name("CSFA"), DW_AT_symbol_name("_CSFA")
	.dwattr DW$384, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$384, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$384, DW_AT_accessibility(DW_ACCESS_public)
DW$385	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$385, DW_AT_name("CSFB"), DW_AT_symbol_name("_CSFB")
	.dwattr DW$385, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
...
DW$387	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$387, DW_AT_name("OUT_MODE"), DW_AT_symbol_name("_OUT_MODE")
	.dwattr DW$387, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$387, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$387, DW_AT_accessibility(DW_ACCESS_public)
DW$388	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$388, DW_AT_name("POLSEL"), DW_AT_symbol_name("_POLSEL")
	.dwattr DW$388, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
	.dwattr DW$388, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$388, DW_AT_accessibility(DW_ACCESS_public)
DW$389	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$389, DW_AT_name("IN_MODE"), DW_AT_symbol_name("_IN_MODE")
	.dwattr DW$389, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
	.dwattr DW$389, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$389, DW_AT_accessibility(DW_ACCESS_public)
DW$390	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$390, DW_AT_name("rsvd1"), DW_AT_symbol_name("_rsvd1")
	.dwattr DW$390, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0a)
...
DW$405	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$405, DW_AT_name("TZA"), DW_AT_symbol_name("_TZA")
	.dwattr DW$405, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$405, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$405, DW_AT_accessibility(DW_ACCESS_public)
DW$406	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$406, DW_AT_name("TZB"), DW_AT_symbol_name("_TZB")
...
DW$424	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$424, DW_AT_name("INTSEL"), DW_AT_symbol_name("_INTSEL")
	.dwattr DW$424, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x03)
	.dwattr DW$424, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$424, DW_AT_accessibility(DW_ACCESS_public)
DW$425	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$425, DW_AT_name("INTEN"), DW_AT_symbol_name("_INTEN")
...
DW$426	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$426, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x04)
	.dwattr DW$426, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$426, DW_AT_accessibility(DW_ACCESS_public)
DW$427	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$427, DW_AT_name("SOCASEL"), DW_AT_symbol_name("_SOCASEL")
	.dwattr DW$427, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x03)
	.dwattr DW$427, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$427, DW_AT_accessibility(DW_ACCESS_public)
DW$428	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$428, DW_AT_name("SOCAEN"), DW_AT_symbol_name("_SOCAEN")
	.dwattr DW$428, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x01)
	.dwattr DW$428, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$428, DW_AT_accessibility(DW_ACCESS_public)
DW$429	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$429, DW_AT_name("SOCBSEL"), DW_AT_symbol_name("_SOCBSEL")
	.dwattr DW$429, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x03)
	.dwattr DW$429, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$429, DW_AT_accessibility(DW_ACCESS_public)
DW$430	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$430, DW_AT_name("SOCBEN"), DW_AT_symbol_name("_SOCBEN")
...
DW$431	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$431, DW_AT_name("INTPRD"), DW_AT_symbol_name("_INTPRD")
	.dwattr DW$431, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$431, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$431, DW_AT_accessibility(DW_ACCESS_public)
DW$432	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$432, DW_AT_name("INTCNT"), DW_AT_symbol_name("_INTCNT")
...
DW$433	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$433, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x04)
	.dwattr DW$433, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$433, DW_AT_accessibility(DW_ACCESS_public)
DW$434	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$434, DW_AT_name("SOCAPRD"), DW_AT_symbol_name("_SOCAPRD")
	.dwattr DW$434, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
	.dwattr DW$434, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$434, DW_AT_accessibility(DW_ACCESS_public)
DW$435	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$435, DW_AT_name("SOCACNT"), DW_AT_symbol_name("_SOCACNT")
	.dwattr DW$435, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
	.dwattr DW$435, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$435, DW_AT_accessibility(DW_ACCESS_public)
DW$436	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$436, DW_AT_name("SOCBPRD"), DW_AT_symbol_name("_SOCBPRD")
	.dwattr DW$436, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
	.dwattr DW$436, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$436, DW_AT_accessibility(DW_ACCESS_public)
DW$437	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$437, DW_AT_name("SOCBCNT"), DW_AT_symbol_name("_SOCBCNT")
...
DW$443	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$443, DW_AT_name("INT"), DW_AT_symbol_name("_INT")
...
DW$445	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$445, DW_AT_name("SOCA"), DW_AT_symbol_name("_SOCA")
	.dwattr DW$445, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$445, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$445, DW_AT_accessibility(DW_ACCESS_public)
DW$446	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$446, DW_AT_name("SOCB"), DW_AT_symbol_name("_SOCB")
...
DW$453	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$453, DW_AT_name("CHPEN"), DW_AT_symbol_name("_CHPEN")
	.dwattr DW$453, DW_AT_bit_offset(0x0f), DW_AT_bit_size(0x01)
	.dwattr DW$453, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$453, DW_AT_accessibility(DW_ACCESS_public)
DW$454	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$454, DW_AT_name("OSHTWTH"), DW_AT_symbol_name("_OSHTWTH")
	.dwattr DW$454, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x04)
	.dwattr DW$454, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$454, DW_AT_accessibility(DW_ACCESS_public)
DW$455	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$455, DW_AT_name("CHPFREQ"), DW_AT_symbol_name("_CHPFREQ")
	.dwattr DW$455, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x03)
	.dwattr DW$455, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$455, DW_AT_accessibility(DW_ACCESS_public)
DW$456	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$456, DW_AT_name("CHPDUTY"), DW_AT_symbol_name("_CHPDUTY")
	.dwattr DW$456, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x03)
	.dwattr DW$456, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$456, DW_AT_accessibility(DW_ACCESS_public)
DW$457	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$457, DW_AT_name("rsvd1"), DW_AT_symbol_name("_rsvd1")
	.dwattr DW$457, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x05)
...
DW$458	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$458, DW_AT_name("EDGMODE"), DW_AT_symbol_name("_EDGMODE")
	.dwattr DW$458, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$458, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$458, DW_AT_accessibility(DW_ACCESS_public)
DW$459	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$459, DW_AT_name("CTLMODE"), DW_AT_symbol_name("_CTLMODE")
	.dwattr DW$459, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$459, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$459, DW_AT_accessibility(DW_ACCESS_public)
DW$460	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$460, DW_AT_name("HRLOAD"), DW_AT_symbol_name("_HRLOAD")
...
DW$462	.dwtag  DW_TAG_assign_register, DW_AT_name("AL")
	.dwattr DW$462, DW_AT_location[DW_OP_reg0]
DW$463	.dwtag  DW_TAG_assign_register, DW_AT_name("AH")
	.dwattr DW$463, DW_AT_location[DW_OP_reg1]
DW$464	.dwtag  DW_TAG_assign_register, DW_AT_name("PL")
	.dwattr DW$464, DW_AT_location[DW_OP_reg2]
DW$465	.dwtag  DW_TAG_assign_register, DW_AT_name("PH")
	.dwattr DW$465, DW_AT_location[DW_OP_reg3]
DW$466	.dwtag  DW_TAG_assign_register, DW_AT_name("AR0")
	.dwattr DW$466, DW_AT_location[DW_OP_reg4]
DW$467	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR0")
	.dwattr DW$467, DW_AT_location[DW_OP_reg5]
DW$468	.dwtag  DW_TAG_assign_register, DW_AT_name("AR1")
	.dwattr DW$468, DW_AT_location[DW_OP_reg6]
DW$469	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR1")
	.dwattr DW$469, DW_AT_location[DW_OP_reg7]
DW$470	.dwtag  DW_TAG_assign_register, DW_AT_name("AR2")
	.dwattr DW$470, DW_AT_location[DW_OP_reg8]
DW$471	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR2")
	.dwattr DW$471, DW_AT_location[DW_OP_reg9]
DW$472	.dwtag  DW_TAG_assign_register, DW_AT_name("AR3")
	.dwattr DW$472, DW_AT_location[DW_OP_reg10]
DW$473	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR3")
	.dwattr DW$473, DW_AT_location[DW_OP_reg11]
DW$474	.dwtag  DW_TAG_assign_register, DW_AT_name("AR4")
	.dwattr DW$474, DW_AT_location[DW_OP_reg12]
DW$475	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR4")
	.dwattr DW$475, DW_AT_location[DW_OP_reg13]
DW$476	.dwtag  DW_TAG_assign_register, DW_AT_name("AR5")
	.dwattr DW$476, DW_AT_location[DW_OP_reg14]
DW$477	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR5")
	.dwattr DW$477, DW_AT_location[DW_OP_reg15]
DW$478	.dwtag  DW_TAG_assign_register, DW_AT_name("AR6")
	.dwattr DW$478, DW_AT_location[DW_OP_reg16]
DW$479	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR6")
	.dwattr DW$479, DW_AT_location[DW_OP_reg17]
DW$480	.dwtag  DW_TAG_assign_register, DW_AT_name("AR7")
	.dwattr DW$480, DW_AT_location[DW_OP_reg18]
DW$481	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR7")
	.dwattr DW$481, DW_AT_location[DW_OP_reg19]
DW$482	.dwtag  DW_TAG_assign_register, DW_AT_name("SP")
	.dwattr DW$482, DW_AT_location[DW_OP_reg20]
DW$483	.dwtag  DW_TAG_assign_register, DW_AT_name("XT")
	.dwattr DW$483, DW_AT_location[DW_OP_reg21]
DW$484	.dwtag  DW_TAG_assign_register, DW_AT_name("T")
	.dwattr DW$484, DW_AT_location[DW_OP_reg22]
DW$485	.dwtag  DW_TAG_assign_register, DW_AT_name("ST0")
	.dwattr DW$485, DW_AT_location[DW_OP_reg23]
DW$486	.dwtag  DW_TAG_assign_register, DW_AT_name("ST1")
	.dwattr DW$486, DW_AT_location[DW_OP_reg24]
DW$487	.dwtag  DW_TAG_assign_register, DW_AT_name("PC")
	.dwattr DW$487, DW_AT_location[DW_OP_reg25]
DW$488	.dwtag  DW_TAG_assign_register, DW_AT_name("RPC")
	.dwattr DW$488, DW_AT_location[DW_OP_reg26]
DW$489	.dwtag  DW_TAG_assign_register, DW_AT_name("FP")
	.dwattr DW$489, DW_AT_location[DW_OP_reg27]
DW$490	.dwtag  DW_TAG_assign_register, DW_AT_name("DP")
	.dwattr DW$490, DW_AT_location[DW_OP_reg28]
DW$491	.dwtag  DW_TAG_assign_register, DW_AT_name("SXM")
	.dwattr DW$491, DW_AT_location[DW_OP_reg29]
DW$492	.dwtag  DW_TAG_assign_register, DW_AT_name("PM")
	.dwattr DW$492, DW_AT_location[DW_OP_reg30]
DW$493	.dwtag  DW_TAG_assign_register, DW_AT_name("OVM")
	.dwattr DW$493, DW_AT_location[DW_OP_reg31]
DW$494	.dwtag  DW_TAG_assign_register, DW_AT_name("PAGE0")
	.dwattr DW$494, DW_AT_location[DW_OP_regx 0x20]
DW$495	.dwtag  DW_TAG_assign_register, DW_AT_name("AMODE")
	.dwattr DW$495, DW_AT_location[DW_OP_regx 0x21]
DW$496	.dwtag  DW_TAG_assign_register, DW_AT_name("IFR")
	.dwattr DW$496, DW_AT_location[DW_OP_regx 0x22]
DW$497	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$497, DW_AT_location[DW_OP_regx 0x23]
DW$498	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$498, DW_AT_location[DW_OP_regx 0x24]
DW$499	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDO")
	.dwattr DW$499, DW_AT_location[DW_OP_regx 0x25]
DW$500	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDOH")
	.dwattr DW$500, DW_AT_location[DW_OP_regx 0x26]
DW$501	.dwtag  DW_TAG_assign_register, DW_AT_name("VOL")
	.dwattr DW$501, DW_AT_location[DW_OP_regx 0x27]
DW$502	.dwtag  DW_TAG_assign_register, DW_AT_name("CIE_RETA")
	.dwattr DW$502, DW_AT_location[DW_OP_regx 0x28]
	.dwendtag DW$CU
