...
;*** 66	-----------------------    *&EPwm1Regs = *&EPwm1Regs&0xefffu|0xc00u;
;*** 67	-----------------------    *&EPwm3Regs = *&EPwm3Regs&0xefffu|0xc00u;
...
;*** 70	-----------------------    return;
	...
	.dwpsn	"search.c",66,2
        MOVW      DP,#_EPwm1Regs
        AND       AL,@_EPwm1Regs,#0xefff ; |66| 
        OR        AL,#0x0c00            ; |66| 
        MOV       @_EPwm1Regs,AL        ; |66| 
	.dwpsn	"search.c",67,2
        MOVW      DP,#_EPwm3Regs
        AND       AL,@_EPwm3Regs,#0xefff ; |67| 
        OR        AL,#0x0c00            ; |67| 
...
DW$67	.dwtag  DW_TAG_loop
	.dwattr DW$67, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L1:1:1654788645")
...
DW$77	.dwtag  DW_TAG_loop
	.dwattr DW$77, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L6:1:1654788645")
...
DW$111	.dwtag  DW_TAG_loop
	.dwattr DW$111, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\search.asm:L5:1:1654788645")
