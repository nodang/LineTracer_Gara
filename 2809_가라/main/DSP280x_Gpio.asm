...
;	..\Compiler\bin\opt2000.exe C:\Users\노호진\AppData\Local\Temp\TI00810 C:\Users\노호진\AppData\Local\Temp\TI0084 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\노호진\AppData\Local\Temp\TI0082 --template_info_file C:\Users\노호진\AppData\Local\Temp\TI0086 --object_file DSP280x_Gpio.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_InitGpio
...
_InitGpio:
;*** 26	-----------------------    asm(" EALLOW");
;*** 65	-----------------------    GpioCtrlRegs.GPAMUX1.all = 21845uL;
...
;*** 185	-----------------------    GpioCtrlRegs.GPAPUD.all = 0xcfffffffuL;
