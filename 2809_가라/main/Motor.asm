...
DW$23	.dwtag  DW_TAG_variable, DW_AT_name("Flag"), DW_AT_symbol_name("_Flag")
	.dwattr DW$23, DW_AT_type(*DW$T$195)
...
DW$27	.dwtag  DW_TAG_variable, DW_AT_name("CROSS_PLUS_SEARCH_U32"), DW_AT_symbol_name("_CROSS_PLUS_SEARCH_U32")
...
DW$28	.dwtag  DW_TAG_variable, DW_AT_name("TIME_INDEX_U32"), DW_AT_symbol_name("_TIME_INDEX_U32")
	.dwattr DW$28, DW_AT_type(*DW$T$151)
...
DW$43	.dwtag  DW_TAG_subprogram, DW_AT_name("_IQ14div"), DW_AT_symbol_name("__IQ14div")
...
DW$49	.dwtag  DW_TAG_variable, DW_AT_name("SHIFT_DIST_IQ17"), DW_AT_symbol_name("_SHIFT_DIST_IQ17")
...
DW$57	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$98)
	.dwendtag DW$54
...
DW$61	.dwtag  DW_TAG_variable, DW_AT_name("CpuTimer2Regs"), DW_AT_symbol_name("_CpuTimer2Regs")
	.dwattr DW$61, DW_AT_type(*DW$T$182)
...
;	..\Compiler\bin\opt2000.exe C:\Users\노호진\AppData\Local\Temp\TI28810 C:\Users\노호진\AppData\Local\Temp\TI2884 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\노호진\AppData\Local\Temp\TI2882 --template_info_file C:\Users\노호진\AppData\Local\Temp\TI2886 --object_file Motor.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
DW$71	.dwtag  DW_TAG_subprogram, DW_AT_name("START_END_LINE"), DW_AT_symbol_name("_START_END_LINE")
	...
	.dwattr DW$71, DW_AT_begin_line(0x11a)
...
;*** 284	-----------------------    if ( *&Flag&1u ) goto g8;
	...
	.dwpsn	"Motor.c",284,2
        ...
        BF        L2,TC                 ; |284| 
        ; branchcc occurs ; |284| 
;*** 284	-----------------------    if ( *&Flag&0x20u ) goto g8;
        TBIT      @_Flag,#5             ; |284| 
        BF        L2,TC                 ; |284| 
        ; branchcc occurs ; |284| 
;*** 285	-----------------------    *&Flag |= 1u;
;*** 286	-----------------------    TIME_INDEX_U32 = 0uL;
;*** 288	-----------------------    if ( *&Flag&0x40u ) goto g11;
	.dwpsn	"Motor.c",285,3
        OR        @_Flag,#0x0001        ; |285| 
	.dwpsn	"Motor.c",286,3
        MOVW      DP,#_TIME_INDEX_U32
        MOVB      ACC,#0
        MOVL      @_TIME_INDEX_U32,ACC  ; |286| 
	.dwpsn	"Motor.c",288,3
        MOVW      DP,#_Flag
        TBIT      @_Flag,#6             ; |288| 
        BF        L3,TC                 ; |288| 
        ; branchcc occurs ; |288| 
;*** 290	-----------------------    if ( *&Flag&0x80u ) goto g7;
	.dwpsn	"Motor.c",290,8
        TBIT      @_Flag,#7             ; |290| 
        BF        L1,TC                 ; |290| 
        ; branchcc occurs ; |290| 
;*** 292	-----------------------    if ( !(*&Flag&0x100u) ) goto g12;
	.dwpsn	"Motor.c",292,8
        TBIT      @_Flag,#8             ; |292| 
        BF        L4,NTC                ; |292| 
        ; branchcc occurs ; |292| 
;*** 293	-----------------------    LINE_THIRD(((long)THIRD_MARK_U16_CNT<<5)+&Search);
;*** 293	-----------------------    goto g12;
	.dwpsn	"Motor.c",293,4
        ...
        ADDL      XAR4,ACC
        LCR       #_LINE_THIRD          ; |293| 
        ; call occurs [#_LINE_THIRD] ; |293| 
        BF        L4,UNC                ; |293| 
        ; branch occurs ; |293| 
L1:    
;***	-----------------------g7:
;*** 291	-----------------------    LINE_SECOND(((long)SECOND_MARK_U16_CNT<<5)+&Search);
;*** 291	-----------------------    goto g12;
	.dwpsn	"Motor.c",291,4
        MOVW      DP,#_SECOND_MARK_U16_CNT
        MOVU      ACC,@_SECOND_MARK_U16_CNT
        LSL       ACC,5                 ; |291| 
        MOVL      XAR4,#_Search         ; |291| 
        ADDL      XAR4,ACC
        LCR       #_LINE_SECOND         ; |291| 
        ; call occurs [#_LINE_SECOND] ; |291| 
        BF        L4,UNC                ; |291| 
        ; branch occurs ; |291| 
L2:    
;***	-----------------------g8:
...
;***  	-----------------------    return;
	.dwpsn	"Motor.c",301,4
        MOVB      XAR4,#0
        LCR       #_LINE_INFO           ; |301| 
        ; call occurs [#_LINE_INFO] ; |301| 
L4:    
	.dwpsn	"Motor.c",303,1
        LRETR
        ; return occurs
	.dwattr DW$71, DW_AT_end_file("Motor.c")
	.dwattr DW$71, DW_AT_end_line(0x12f)
...
DW$72	.dwtag  DW_TAG_subprogram, DW_AT_name("MOVE_TO_END"), DW_AT_symbol_name("_MOVE_TO_END")
	...
	.dwattr DW$72, DW_AT_begin_line(0x88)
...
;*** 147	-----------------------    RMotor.DecelAccel_IQ14 = __IQmpy(_IQ15div(__IQmpy(_IQ17div(RMotor.NextVelocity_IQ17, 13107200L)>>2, _IQ17div(RMotor.NextVelocity_IQ17, 13107200L)>>2, 15), 5406720L), 327680000L, 15)>>2;
;*** 148	-----------------------    LMotor.DecelAccel_IQ14 = __IQmpy(_IQ15div(__IQmpy(_IQ17div(LMotor.NextVelocity_IQ17, 13107200L)>>2, _IQ17div(LMotor.NextVelocity_IQ17, 13107200L)>>2, 15), 5406720L), 327680000L, 15)>>2;
...
DW$73	.dwtag  DW_TAG_formal_parameter, DW_AT_name("distance"), DW_AT_symbol_name("_distance")
	...
	.dwattr DW$72, DW_AT_end_line(0x99)
...
DW$74	.dwtag  DW_TAG_subprogram, DW_AT_name("SHUTDOWN"), DW_AT_symbol_name("_SHUTDOWN")
	...
	.dwattr DW$74, DW_AT_begin_line(0x131)
...
;***************************************************************
_SHUTDOWN:
;*** 307	-----------------------    K$1 = &GpioDataRegs+10L;
;*** 307	-----------------------    *(volatile unsigned *)K$1 |= 4u;
;*** 308	-----------------------    *(volatile unsigned *)K$1 |= 2u;
;*** 310	-----------------------    if ( LINE_OUT_U16 >= 777u ) goto g4;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        MOVL      *SP++,XAR1
...
;* AR5   assigned to K$6
DW$76	.dwtag  DW_TAG_variable, DW_AT_name("K$6"), DW_AT_symbol_name("K$6")
...
DW$80	.dwtag  DW_TAG_variable, DW_AT_name("K$12"), DW_AT_symbol_name("K$12")
	.dwattr DW$80, DW_AT_type(*DW$T$108)
	.dwattr DW$80, DW_AT_location[DW_OP_reg6]
;* AR4   assigned to K$1
DW$81	.dwtag  DW_TAG_variable, DW_AT_name("K$1"), DW_AT_symbol_name("K$1")
	.dwattr DW$81, DW_AT_type(*DW$T$169)
...
DW$82	.dwtag  DW_TAG_variable, DW_AT_name("K$1"), DW_AT_symbol_name("K$1")
	...
	.dwpsn	"Motor.c",307,2
        MOVL      XAR4,#_GpioDataRegs+10 ; |307| 
        OR        *+XAR4[0],#0x0004     ; |307| 
	.dwpsn	"Motor.c",308,2
        OR        *+XAR4[0],#0x0002     ; |308| 
	.dwpsn	"Motor.c",310,2
        MOVW      DP,#_LINE_OUT_U16
        CMP       @_LINE_OUT_U16,#777   ; |310| 
        BF        L5,HIS                ; |310| 
        ; branchcc occurs ; |310| 
;*** 318	-----------------------    if ( !(*&Flag&0x20u) ) goto g5;
	.dwpsn	"Motor.c",318,7
        MOVW      DP,#_Flag
        TBIT      @_Flag,#5             ; |318| 
        BF        L6,NTC                ; |318| 
...
;*** 312	-----------------------    MOVE_TO_END(0L);
;*** 314	-----------------------    *&Flag &= 0xfffbu;
;*** 315	-----------------------    GpioDataRegs.GPACLEAR.all = 7347968uL;
;*** 316	-----------------------    SenAdc.PositionTemporary_IQ10 = 0L;
	...
	.dwpsn	"Motor.c",314,3
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfffb        ; |314| 
	.dwpsn	"Motor.c",315,3
        MOV       PH,#112
        MOV       PL,#7936
        MOVW      DP,#_GpioDataRegs+4
        MOVL      @_GpioDataRegs+4,P    ; |315| 
	.dwpsn	"Motor.c",316,3
        MOVW      DP,#_SenAdc+68
        MOVB      ACC,#0
...
DW$L$_SHUTDOWN$7$B:
;***	-----------------------g7:
;*** 361	-----------------------    POSITION_COMPUTE(K$12, K$20, K$18, K$17);
;*** 361	-----------------------    if ( LMotor.NextVelocity_IQ17 >= 1310720L ) goto g7;
	.dwpsn	"Motor.c",361,4
        MOVL      *-SP[2],XAR3          ; |361| 
        MOVL      XAR5,XAR2             ; |361| 
        MOVL      XAR4,XAR1             ; |361| 
        MOVL      ACC,*-SP[6]           ; |361| 
        MOVL      *-SP[4],ACC           ; |361| 
        LCR       #_POSITION_COMPUTE    ; |361| 
        ; call occurs [#_POSITION_COMPUTE] ; |361| 
        MOVL      XAR4,#1310720         ; |361| 
        MOVW      DP,#_LMotor+2
        MOVL      ACC,XAR4              ; |361| 
        CMPL      ACC,@_LMotor+2        ; |361| 
        BF        L8,LEQ                ; |361| 
        ; branchcc occurs ; |361| 
DW$L$_SHUTDOWN$7$E:
L9:    
...
;*** 338	-----------------------    K$6 = &Flag;
;*** 338	-----------------------    *K$6 &= 0xfffbu;
;*** 339	-----------------------    C$1 = &GpioDataRegs;
;*** 339	-----------------------    (*C$1).GPACLEAR.all = 7347968uL;
;*** 340	-----------------------    *(&CpuTimer0Regs+4L) |= 0x10u;
;*** 342	-----------------------    *K$6 &= 0xfffdu;
;*** 343	-----------------------    (*C$1).GPADAT.all = (*C$1).GPADAT.all&0xffffffdfuL|2uL;
;*** 344	-----------------------    EPwm3Regs.CMPA.half.CMPA = 0u;
;*** 344	-----------------------    EPwm1Regs.CMPA.half.CMPA = 0u;
;*** 346	-----------------------    STOP_TIME_INDEX_U32 = 0uL;
	.dwpsn	"Motor.c",338,4
        MOVL      XAR5,#_Flag           ; |338| 
        AND       *+XAR5[0],#0xfffb     ; |338| 
	.dwpsn	"Motor.c",339,4
        MOV       PH,#112
        MOV       PL,#7936
        MOVL      XAR4,#_GpioDataRegs   ; |339| 
        MOVL      *+XAR4[4],P           ; |339| 
	.dwpsn	"Motor.c",340,4
        MOVW      DP,#_CpuTimer0Regs+4
        OR        @_CpuTimer0Regs+4,#0x0010 ; |340| 
	.dwpsn	"Motor.c",342,4
        AND       *+XAR5[0],#0xfffd     ; |342| 
	.dwpsn	"Motor.c",343,4
        MOVL      ACC,*+XAR4[0]         ; |343| 
        AND       AL,#65503             ; |343| 
        ORB       AL,#0x02              ; |343| 
	...
	.dwpsn	"Motor.c",344,4
        ...
        MOV       @_EPwm3Regs+9,#0      ; |344| 
        MOVW      DP,#_EPwm1Regs+9
        MOV       @_EPwm1Regs+9,#0      ; |344| 
	.dwpsn	"Motor.c",346,4
        MOVW      DP,#_STOP_TIME_INDEX_U32
        MOVB      ACC,#0
        MOVL      @_STOP_TIME_INDEX_U32,ACC ; |346| 
L10:    
DW$L$_SHUTDOWN$10$B:
;***	-----------------------g10:
;*** 348	-----------------------    if ( LINE_OUT_U16 >= 777u ) goto g12;
	.dwpsn	"Motor.c",348,10
        MOVW      DP,#_LINE_OUT_U16
        CMP       @_LINE_OUT_U16,#777   ; |348| 
        BF        L11,HIS               ; |348| 
        ; branchcc occurs ; |348| 
DW$L$_SHUTDOWN$10$E:
DW$L$_SHUTDOWN$11$B:
;*** 348	-----------------------    if ( STOP_TIME_INDEX_U32 < 1000uL ) goto g10;
        MOV       ACC,#1000             ; |348| 
        MOVW      DP,#_STOP_TIME_INDEX_U32
        CMPL      ACC,@_STOP_TIME_INDEX_U32 ; |348| 
        BF        L10,HI                ; |348| 
        ; branchcc occurs ; |348| 
DW$L$_SHUTDOWN$11$E:
L11:    
...
;*** 352	-----------------------    K$1 = &GpioDataRegs;
;*** 352	-----------------------    (*(volatile struct _GPIO_DATA_REGS *)K$1).GPACLEAR.all = 68uL;
;*** 354	-----------------------    ((volatile unsigned *)K$1)[12] |= 4u;
;*** 355	-----------------------    ((volatile unsigned *)K$1)[12] |= 2u;
;*** 356	-----------------------    ((volatile unsigned *)K$1)[12] |= 1u;
;*** 358	-----------------------    return;
	.dwpsn	"Motor.c",350,4
        MOVW      DP,#_CpuTimer2Regs+4
	...
	.dwpsn	"Motor.c",352,4
        MOVB      ACC,#68
        MOVL      XAR5,#_GpioDataRegs   ; |352| 
        MOVL      *+XAR5[4],ACC         ; |352| 
	.dwpsn	"Motor.c",354,4
        MOVB      ACC,#12
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |354| 
        OR        *+XAR4[0],#0x0004     ; |354| 
	.dwpsn	"Motor.c",355,4
        MOVB      ACC,#12
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |355| 
...
DW$83	.dwtag  DW_TAG_loop
	.dwattr DW$83, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L10:1:1659632796")
	.dwattr DW$83, DW_AT_begin_file("Motor.c")
	.dwattr DW$83, DW_AT_begin_line(0x15c)
	.dwattr DW$83, DW_AT_end_line(0x15c)
DW$84	.dwtag  DW_TAG_loop_range
	.dwattr DW$84, DW_AT_low_pc(DW$L$_SHUTDOWN$10$B)
	.dwattr DW$84, DW_AT_high_pc(DW$L$_SHUTDOWN$10$E)
DW$85	.dwtag  DW_TAG_loop_range
	.dwattr DW$85, DW_AT_low_pc(DW$L$_SHUTDOWN$11$B)
	.dwattr DW$85, DW_AT_high_pc(DW$L$_SHUTDOWN$11$E)
	.dwendtag DW$83


DW$86	.dwtag  DW_TAG_loop
	.dwattr DW$86, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L8:1:1659632796")
	.dwattr DW$86, DW_AT_begin_file("Motor.c")
	.dwattr DW$86, DW_AT_begin_line(0x169)
	.dwattr DW$86, DW_AT_end_line(0x169)
DW$87	.dwtag  DW_TAG_loop_range
	.dwattr DW$87, DW_AT_low_pc(DW$L$_SHUTDOWN$7$B)
	.dwattr DW$87, DW_AT_high_pc(DW$L$_SHUTDOWN$7$E)
	.dwendtag DW$86

	.dwattr DW$74, DW_AT_end_file("Motor.c")
	.dwattr DW$74, DW_AT_end_line(0x16b)
...
DW$88	.dwtag  DW_TAG_subprogram, DW_AT_name("MOVE_TO_MOVE"), DW_AT_symbol_name("_MOVE_TO_MOVE")
	.dwattr DW$88, DW_AT_low_pc(_MOVE_TO_MOVE)
	.dwattr DW$88, DW_AT_high_pc(0x00)
	.dwattr DW$88, DW_AT_begin_file("Motor.c")
	.dwattr DW$88, DW_AT_begin_line(0x77)
...
;*** 133	-----------------------    return;
	...
	.dwcfa	0x1d, -6
;* AL    assigned to _distance
DW$89	.dwtag  DW_TAG_formal_parameter, DW_AT_name("distance"), DW_AT_symbol_name("_distance")
	.dwattr DW$89, DW_AT_type(*DW$T$24)
	.dwattr DW$89, DW_AT_location[DW_OP_reg0]
DW$90	.dwtag  DW_TAG_formal_parameter, DW_AT_name("decel_distance"), DW_AT_symbol_name("_decel_distance")
	.dwattr DW$90, DW_AT_type(*DW$T$24)
	.dwattr DW$90, DW_AT_location[DW_OP_breg20 -8]
DW$91	.dwtag  DW_TAG_formal_parameter, DW_AT_name("target_velocity"), DW_AT_symbol_name("_target_velocity")
	.dwattr DW$91, DW_AT_type(*DW$T$24)
	.dwattr DW$91, DW_AT_location[DW_OP_breg20 -10]
DW$92	.dwtag  DW_TAG_formal_parameter, DW_AT_name("decel_velocity"), DW_AT_symbol_name("_decel_velocity")
...
DW$93	.dwtag  DW_TAG_formal_parameter, DW_AT_name("jerk"), DW_AT_symbol_name("_jerk")
	.dwattr DW$93, DW_AT_type(*DW$T$30)
	.dwattr DW$93, DW_AT_location[DW_OP_breg20 -14]
DW$94	.dwtag  DW_TAG_formal_parameter, DW_AT_name("decel_acc"), DW_AT_symbol_name("_decel_acc")
	.dwattr DW$94, DW_AT_type(*DW$T$30)
	.dwattr DW$94, DW_AT_location[DW_OP_breg20 -16]
;* AR4   assigned to _decel_distance
DW$95	.dwtag  DW_TAG_variable, DW_AT_name("decel_distance"), DW_AT_symbol_name("_decel_distance")
	.dwattr DW$95, DW_AT_type(*DW$T$140)
	.dwattr DW$95, DW_AT_location[DW_OP_reg12]
;* PL    assigned to _target_velocity
DW$96	.dwtag  DW_TAG_variable, DW_AT_name("target_velocity"), DW_AT_symbol_name("_target_velocity")
	.dwattr DW$96, DW_AT_type(*DW$T$140)
	.dwattr DW$96, DW_AT_location[DW_OP_reg2]
;* AR7   assigned to _decel_velocity
DW$97	.dwtag  DW_TAG_variable, DW_AT_name("decel_velocity"), DW_AT_symbol_name("_decel_velocity")
...
DW$99	.dwtag  DW_TAG_variable, DW_AT_name("decel_acc"), DW_AT_symbol_name("_decel_acc")
	...
	.dwattr DW$88, DW_AT_end_line(0x86)
...
DW$100	.dwtag  DW_TAG_subprogram, DW_AT_name("MOTOR_ISR"), DW_AT_symbol_name("_MOTOR_ISR")
	.dwattr DW$100, DW_AT_low_pc(_MOTOR_ISR)
	.dwattr DW$100, DW_AT_high_pc(0x00)
	.dwattr DW$100, DW_AT_begin_file("Motor.c")
	.dwattr DW$100, DW_AT_begin_line(0xb0)
...
;*** 187	-----------------------    if ( !(*&Flag&2u) ) goto g61;
	...
	.dwcfa	0x1d, -20
        ...
        CLRC      AMODE
;* AR4   assigned to C$6
DW$101	.dwtag  DW_TAG_variable, DW_AT_name("C$6"), DW_AT_symbol_name("C$6")
	.dwattr DW$101, DW_AT_type(*DW$T$159)
	.dwattr DW$101, DW_AT_location[DW_OP_reg12]
;* AR3   assigned to C$7
DW$102	.dwtag  DW_TAG_variable, DW_AT_name("C$7"), DW_AT_symbol_name("C$7")
	.dwattr DW$102, DW_AT_type(*DW$T$159)
	.dwattr DW$102, DW_AT_location[DW_OP_reg10]
;* AR4   assigned to C$8
DW$103	.dwtag  DW_TAG_variable, DW_AT_name("C$8"), DW_AT_symbol_name("C$8")
	.dwattr DW$103, DW_AT_type(*DW$T$159)
	.dwattr DW$103, DW_AT_location[DW_OP_reg12]
;* AR4   assigned to C$9
DW$104	.dwtag  DW_TAG_variable, DW_AT_name("C$9"), DW_AT_symbol_name("C$9")
	.dwattr DW$104, DW_AT_type(*DW$T$159)
	.dwattr DW$104, DW_AT_location[DW_OP_reg12]
;* AL    assigned to U$27
DW$105	.dwtag  DW_TAG_variable, DW_AT_name("U$27"), DW_AT_symbol_name("U$27")
...
;* AL    assigned to U$53
DW$107	.dwtag  DW_TAG_variable, DW_AT_name("U$53"), DW_AT_symbol_name("U$53")
	.dwattr DW$107, DW_AT_type(*DW$T$12)
	.dwattr DW$107, DW_AT_location[DW_OP_reg0]
;* AR4   assigned to U$52
DW$108	.dwtag  DW_TAG_variable, DW_AT_name("U$52"), DW_AT_symbol_name("U$52")
	.dwattr DW$108, DW_AT_type(*DW$T$12)
	.dwattr DW$108, DW_AT_location[DW_OP_reg12]
;* AL    assigned to P$5
DW$109	.dwtag  DW_TAG_variable, DW_AT_name("P$5"), DW_AT_symbol_name("P$5")
...
DW$115	.dwtag  DW_TAG_variable, DW_AT_name("clk"), DW_AT_symbol_name("_clk")
	.dwattr DW$115, DW_AT_type(*DW$T$19)
	.dwattr DW$115, DW_AT_location[DW_OP_reg6]
;* AL    assigned to S$4
DW$116	.dwtag  DW_TAG_variable, DW_AT_name("S$4"), DW_AT_symbol_name("S$4")
	.dwattr DW$116, DW_AT_type(*DW$T$12)
	.dwattr DW$116, DW_AT_location[DW_OP_reg0]
;* AL    assigned to S$3
DW$117	.dwtag  DW_TAG_variable, DW_AT_name("S$3"), DW_AT_symbol_name("S$3")
...
DW$120	.dwtag  DW_TAG_variable, DW_AT_name("clk"), DW_AT_symbol_name("_clk")
	.dwattr DW$120, DW_AT_type(*DW$T$19)
	.dwattr DW$120, DW_AT_location[DW_OP_reg8]
;* AR6   assigned to T$1
DW$121	.dwtag  DW_TAG_variable, DW_AT_name("T$1"), DW_AT_symbol_name("T$1")
	.dwattr DW$121, DW_AT_type(*DW$T$12)
	.dwattr DW$121, DW_AT_location[DW_OP_reg16]
;* AR6   assigned to T$2
DW$122	.dwtag  DW_TAG_variable, DW_AT_name("T$2"), DW_AT_symbol_name("T$2")
	.dwattr DW$122, DW_AT_type(*DW$T$12)
	.dwattr DW$122, DW_AT_location[DW_OP_reg16]
;* AR6   assigned to T$3
DW$123	.dwtag  DW_TAG_variable, DW_AT_name("T$3"), DW_AT_symbol_name("T$3")
	.dwattr DW$123, DW_AT_type(*DW$T$12)
	.dwattr DW$123, DW_AT_location[DW_OP_reg16]
;* AR6   assigned to T$4
DW$124	.dwtag  DW_TAG_variable, DW_AT_name("T$4"), DW_AT_symbol_name("T$4")
...
DW$126	.dwtag  DW_TAG_variable, DW_AT_name("K$8"), DW_AT_symbol_name("K$8")
	.dwattr DW$126, DW_AT_type(*DW$T$159)
...
DW$135	.dwtag  DW_TAG_variable, DW_AT_name("K$51"), DW_AT_symbol_name("K$51")
	.dwattr DW$135, DW_AT_type(*DW$T$159)
	.dwattr DW$135, DW_AT_location[DW_OP_reg10]
;* AR4   assigned to K$51
DW$136	.dwtag  DW_TAG_variable, DW_AT_name("K$51"), DW_AT_symbol_name("K$51")
...
;*** 200	-----------------------    SHIFT_DIST_IQ17 = ((*K$51).RolEachStep_IQ17>>1)+((*K$8).RolEachStep_IQ17>>1);
;*** 202	-----------------------    if ( !((*&Flag>>1|*&Flag)&0x80u) ) goto g59;
	...
	.dwpsn	"Motor.c",200,3
        ...
        MOVL      P,*+XAR4[AR0]         ; |200| 
        SETC      SXM
        MOVL      ACC,*+XAR5[AR0]       ; |200| 
        SPM       #-1
        SFR       ACC,1                 ; |200| 
        MOVW      DP,#_SHIFT_DIST_IQ17
        ADDL      ACC,P << PM           ; |200| 
        MOVL      @_SHIFT_DIST_IQ17,ACC ; |200| 
	.dwpsn	"Motor.c",202,3
        MOVW      DP,#_Flag
        MOV       AL,@_Flag             ; |202| 
        LSR       AL,1                  ; |202| 
...
;*** 205	-----------------------    ++TIME_INDEX_U32;
	.dwpsn	"Motor.c",205,4
        MOVB      ACC,#1
        MOVW      DP,#_TIME_INDEX_U32
        ADDL      @_TIME_INDEX_U32,ACC  ; |205| 
L62:    
;***	-----------------------g61:
;*** 208	-----------------------    if ( !(*&Flag&0x20u) ) goto g63;
	.dwpsn	"Motor.c",208,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#5             ; |208| 
        BF        L63,NTC               ; |208| 
        ; branchcc occurs ; |208| 
;*** 209	-----------------------    ++STOP_TIME_INDEX_U32;
	.dwpsn	"Motor.c",209,3
        MOVB      ACC,#1
        MOVW      DP,#_STOP_TIME_INDEX_U32
        ADDL      @_STOP_TIME_INDEX_U32,ACC ; |209| 
L63:    
;***	-----------------------g63:
;*** 211	-----------------------    if ( !(*&Flag&4u) ) goto g65;
	.dwpsn	"Motor.c",211,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#2             ; |211| 
        BF        L64,NTC               ; |211| 
...
DW$145	.dwtag  DW_TAG_loop
	.dwattr DW$145, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L24:1:1659632796")
	.dwattr DW$145, DW_AT_begin_file("Motor.c")
	.dwattr DW$145, DW_AT_begin_line(0x53)
	.dwattr DW$145, DW_AT_end_line(0x63)
DW$146	.dwtag  DW_TAG_loop_range
	.dwattr DW$146, DW_AT_low_pc(DW$L$_MOTOR_ISR$23$B)
	.dwattr DW$146, DW_AT_high_pc(DW$L$_MOTOR_ISR$23$E)
DW$147	.dwtag  DW_TAG_loop_range
	.dwattr DW$147, DW_AT_low_pc(DW$L$_MOTOR_ISR$22$B)
	.dwattr DW$147, DW_AT_high_pc(DW$L$_MOTOR_ISR$22$E)

DW$148	.dwtag  DW_TAG_loop
	.dwattr DW$148, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L25:2:1659632796")
	.dwattr DW$148, DW_AT_begin_file("Motor.c")
	.dwattr DW$148, DW_AT_begin_line(0x53)
	.dwattr DW$148, DW_AT_end_line(0x5b)
DW$149	.dwtag  DW_TAG_loop_range
	.dwattr DW$149, DW_AT_low_pc(DW$L$_MOTOR_ISR$24$B)
	.dwattr DW$149, DW_AT_high_pc(DW$L$_MOTOR_ISR$24$E)
DW$150	.dwtag  DW_TAG_loop_range
	.dwattr DW$150, DW_AT_low_pc(DW$L$_MOTOR_ISR$25$B)
	.dwattr DW$150, DW_AT_high_pc(DW$L$_MOTOR_ISR$25$E)
	.dwendtag DW$148
...
DW$151	.dwtag  DW_TAG_loop
	.dwattr DW$151, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L27:1:1659632796")
	.dwattr DW$151, DW_AT_begin_file("Motor.c")
	.dwattr DW$151, DW_AT_begin_line(0x5d)
	.dwattr DW$151, DW_AT_end_line(0x66)
DW$152	.dwtag  DW_TAG_loop_range
	.dwattr DW$152, DW_AT_low_pc(DW$L$_MOTOR_ISR$27$B)
	.dwattr DW$152, DW_AT_high_pc(DW$L$_MOTOR_ISR$27$E)
DW$153	.dwtag  DW_TAG_loop_range
	.dwattr DW$153, DW_AT_low_pc(DW$L$_MOTOR_ISR$21$B)
	.dwattr DW$153, DW_AT_high_pc(DW$L$_MOTOR_ISR$21$E)

DW$154	.dwtag  DW_TAG_loop
	.dwattr DW$154, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L28:2:1659632796")
	.dwattr DW$154, DW_AT_begin_file("Motor.c")
	.dwattr DW$154, DW_AT_begin_line(0x5d)
	.dwattr DW$154, DW_AT_end_line(0x65)
DW$155	.dwtag  DW_TAG_loop_range
	.dwattr DW$155, DW_AT_low_pc(DW$L$_MOTOR_ISR$28$B)
	.dwattr DW$155, DW_AT_high_pc(DW$L$_MOTOR_ISR$28$E)
DW$156	.dwtag  DW_TAG_loop_range
	.dwattr DW$156, DW_AT_low_pc(DW$L$_MOTOR_ISR$29$B)
	.dwattr DW$156, DW_AT_high_pc(DW$L$_MOTOR_ISR$29$E)
	.dwendtag DW$154
...
DW$157	.dwtag  DW_TAG_loop
	.dwattr DW$157, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L45:1:1659632796")
	.dwattr DW$157, DW_AT_begin_file("Motor.c")
	.dwattr DW$157, DW_AT_begin_line(0x53)
	.dwattr DW$157, DW_AT_end_line(0x5c)
DW$158	.dwtag  DW_TAG_loop_range
	.dwattr DW$158, DW_AT_low_pc(DW$L$_MOTOR_ISR$57$B)
	.dwattr DW$158, DW_AT_high_pc(DW$L$_MOTOR_ISR$57$E)
DW$159	.dwtag  DW_TAG_loop_range
	.dwattr DW$159, DW_AT_low_pc(DW$L$_MOTOR_ISR$20$B)
	.dwattr DW$159, DW_AT_high_pc(DW$L$_MOTOR_ISR$20$E)

DW$160	.dwtag  DW_TAG_loop
	.dwattr DW$160, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L46:2:1659632796")
	.dwattr DW$160, DW_AT_begin_file("Motor.c")
	.dwattr DW$160, DW_AT_begin_line(0x53)
	.dwattr DW$160, DW_AT_end_line(0x5b)
DW$161	.dwtag  DW_TAG_loop_range
	.dwattr DW$161, DW_AT_low_pc(DW$L$_MOTOR_ISR$58$B)
	.dwattr DW$161, DW_AT_high_pc(DW$L$_MOTOR_ISR$58$E)
DW$162	.dwtag  DW_TAG_loop_range
	.dwattr DW$162, DW_AT_low_pc(DW$L$_MOTOR_ISR$59$B)
	.dwattr DW$162, DW_AT_high_pc(DW$L$_MOTOR_ISR$59$E)
	.dwendtag DW$160
...
DW$163	.dwtag  DW_TAG_loop
	.dwattr DW$163, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L48:1:1659632796")
...
DW$165	.dwtag  DW_TAG_loop_range
	.dwattr DW$165, DW_AT_low_pc(DW$L$_MOTOR_ISR$19$B)
	.dwattr DW$165, DW_AT_high_pc(DW$L$_MOTOR_ISR$19$E)

DW$166	.dwtag  DW_TAG_loop
	.dwattr DW$166, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L49:2:1659632796")
...
DW$168	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$100, DW_AT_end_line(0xd5)
...
DW$169	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_OUT_STOP"), DW_AT_symbol_name("_LINE_OUT_STOP")
	.dwattr DW$169, DW_AT_low_pc(_LINE_OUT_STOP)
	.dwattr DW$169, DW_AT_high_pc(0x00)
	.dwattr DW$169, DW_AT_begin_file("Motor.c")
	.dwattr DW$169, DW_AT_begin_line(0x10a)
...
;***************************************************************
_LINE_OUT_STOP:
;*** 269	-----------------------    if ( LINE_OUT_U16 >= 300u ) goto g3;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        ADDB      SP,#2
...
L65:    
;***	-----------------------g3:
;*** 272	-----------------------    LINE_OUT_U16 = 777u;
;*** 273	-----------------------    *&Flag &= 0xfffeu;
;*** 275	-----------------------    SHUTDOWN();
;*** 277	-----------------------    VFDPrintf("line OUT");
;*** 279	-----------------------    return 1u;
	.dwpsn	"Motor.c",272,2
        MOV       @_LINE_OUT_U16,#777   ; |272| 
	.dwpsn	"Motor.c",273,2
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfffe        ; |273| 
	.dwpsn	"Motor.c",275,2
        LCR       #_SHUTDOWN            ; |275| 
        ; call occurs [#_SHUTDOWN] ; |275| 
	.dwpsn	"Motor.c",277,2
        MOVL      XAR4,#FSL1            ; |277| 
        MOVL      *-SP[2],XAR4          ; |277| 
        LCR       #_VFDPrintf           ; |277| 
...
L66:    
	...
	.dwattr DW$169, DW_AT_end_line(0x118)
...
DW$170	.dwtag  DW_TAG_subprogram, DW_AT_name("Init_MotorCtrl"), DW_AT_symbol_name("_Init_MotorCtrl")
	.dwattr DW$170, DW_AT_low_pc(_Init_MotorCtrl)
	.dwattr DW$170, DW_AT_high_pc(0x00)
	.dwattr DW$170, DW_AT_begin_file("Motor.c")
	.dwattr DW$170, DW_AT_begin_line(0x28)
...
;*** 42	-----------------------    return;
	...
	.dwcfa	0x09, 40, 26
;* AR4   assigned to _pM
DW$171	.dwtag  DW_TAG_formal_parameter, DW_AT_name("pM"), DW_AT_symbol_name("_pM")
	.dwattr DW$171, DW_AT_type(*DW$T$127)
	.dwattr DW$171, DW_AT_location[DW_OP_reg12]
;* AR4   assigned to _pM
DW$172	.dwtag  DW_TAG_variable, DW_AT_name("pM"), DW_AT_symbol_name("_pM")
	.dwattr DW$172, DW_AT_type(*DW$T$158)
	...
	.dwattr DW$170, DW_AT_end_line(0x2b)
...
DW$173	.dwtag  DW_TAG_subprogram, DW_AT_name("Init_MOTOR"), DW_AT_symbol_name("_Init_MOTOR")
	.dwattr DW$173, DW_AT_low_pc(_Init_MOTOR)
	.dwattr DW$173, DW_AT_high_pc(0x00)
	.dwattr DW$173, DW_AT_begin_file("Motor.c")
	.dwattr DW$173, DW_AT_begin_line(0x17)
...
;*** 42	-----------------------    GpioDataRegs.GPADAT.all = GpioDataRegs.GPADAT.all&0xfffffffduL|0x20uL;  // [18]
;*** 37	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
	...
	.dwattr DW$173, DW_AT_end_line(0x26)
...
DW$174	.dwtag  DW_TAG_subprogram, DW_AT_name("END_STOP"), DW_AT_symbol_name("_END_STOP")
	.dwattr DW$174, DW_AT_low_pc(_END_STOP)
	.dwattr DW$174, DW_AT_high_pc(0x00)
	.dwattr DW$174, DW_AT_begin_file("Motor.c")
	.dwattr DW$174, DW_AT_begin_line(0xd7)
	.dwattr DW$174, DW_AT_begin_column(0x08)
	.dwpsn	"Motor.c",216,1
...
DW$175	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	.dwattr DW$175, DW_AT_type(*DW$T$137)
...
L67:    
;***	-----------------------g3:
;*** 218	-----------------------    LMotor.GoneDistance_IQ15 = 0L;
;*** 218	-----------------------    RMotor.GoneDistance_IQ15 = 0L;
;*** 219	-----------------------    SHUTDOWN();
;*** 221	-----------------------    if ( !(*(&CpuTimer0Regs+4L)&0x10u) ) goto g19;
	.dwpsn	"Motor.c",218,3
        MOVB      ACC,#0
        MOVW      DP,#_LMotor+10
        MOVL      @_LMotor+10,ACC       ; |218| 
        MOVW      DP,#_RMotor+10
        MOVL      @_RMotor+10,ACC       ; |218| 
	.dwpsn	"Motor.c",219,3
        LCR       #_SHUTDOWN            ; |219| 
        ; call occurs [#_SHUTDOWN] ; |219| 
	.dwpsn	"Motor.c",221,3
        MOVW      DP,#_CpuTimer0Regs+4
...
;*** 223	-----------------------    if ( *&Flag&0x40u ) goto g13;
	.dwpsn	"Motor.c",223,8
        ...
        BF        L70,TC                ; |223| 
        ; branchcc occurs ; |223| 
;*** 241	-----------------------    if ( *&Flag&0x80u ) goto g10;
	.dwpsn	"Motor.c",241,8
        TBIT      @_Flag,#7             ; |241| 
        BF        L69,TC                ; |241| 
        ; branchcc occurs ; |241| 
;*** 249	-----------------------    if ( !(*&Flag&0x100u) ) goto g20;
...
DW$L$_END_STOP$7$B:
;***	-----------------------g8:
;*** 250	-----------------------    if ( !(*(&CpuTimer0Regs+4L)&0x10u) ) goto g20;
...
DW$L$_END_STOP$7$E:
DW$L$_END_STOP$8$B:
;*** 251	-----------------------    VFDPrintf("M%3u|C%2lu", THIRD_MARK_U16_CNT-1u, CROSS_PLUS_SEARCH_U32);
;*** 254	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g8;
	.dwpsn	"Motor.c",251,5
        MOVW      DP,#_THIRD_MARK_U16_CNT
        MOVL      XAR4,#FSL2            ; |251| 
        MOV       AL,@_THIRD_MARK_U16_CNT ; |251| 
        MOVL      *-SP[2],XAR4          ; |251| 
        ADDB      AL,#-1
...
;*** 246	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g11;
	.dwpsn	"Motor.c",243,5
        MOVW      DP,#_SECOND_MARK_U16_CNT
        MOVL      XAR4,#FSL2            ; |243| 
...
DW$L$_END_STOP$13$E:
DW$L$_END_STOP$14$B:
;*** 225	-----------------------    VFDPrintf("M%3u|C%2lu", MARK_U16_CNT, CROSS_PLUS_SEARCH_U32);
;*** 226	-----------------------    DSP28x_usDelay(7999998uL);
;*** 227	-----------------------    VFDPrintf("<-N  S->");
;*** 228	-----------------------    DSP28x_usDelay(3999998uL);
;*** 230	-----------------------    C$1 = &GpioDataRegs;
;*** 230	-----------------------    if ( !(*C$1&0x4000u) ) goto g18;
	.dwpsn	"Motor.c",225,5
        MOVW      DP,#_MARK_U16_CNT
        MOVL      XAR4,#FSL2            ; |225| 
        MOV       AL,@_MARK_U16_CNT     ; |225| 
        MOVL      *-SP[2],XAR4          ; |225| 
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        MOV       *-SP[3],AL            ; |225| 
...
;*** 233	-----------------------    goto g20;
	...
	.dwpsn	"Motor.c",232,6
        LCR       #_save_line_info      ; |232| 
        ; call occurs [#_save_line_info] ; |232| 
	.dwpsn	"Motor.c",233,6
        BF        L73,UNC               ; |233| 
        ; branch occurs ; |233| 
L72:    
...
;*** 258	-----------------------    VFDPrintf("T %3lf", (float)TIME_INDEX_U32*5.00000023748725652695e-4F);
;*** 260	-----------------------    return 1u;
	.dwpsn	"Motor.c",257,3
        MOV       AL,#9630
        MOV       AH,#38
...
DW$176	.dwtag  DW_TAG_loop
	.dwattr DW$176, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L70:1:1659632796")
	.dwattr DW$176, DW_AT_begin_file("Motor.c")
	.dwattr DW$176, DW_AT_begin_line(0xe0)
	.dwattr DW$176, DW_AT_end_line(0xef)
DW$177	.dwtag  DW_TAG_loop_range
	.dwattr DW$177, DW_AT_low_pc(DW$L$_END_STOP$13$B)
	.dwattr DW$177, DW_AT_high_pc(DW$L$_END_STOP$13$E)
DW$178	.dwtag  DW_TAG_loop_range
	.dwattr DW$178, DW_AT_low_pc(DW$L$_END_STOP$14$B)
	.dwattr DW$178, DW_AT_high_pc(DW$L$_END_STOP$14$E)
DW$179	.dwtag  DW_TAG_loop_range
	.dwattr DW$179, DW_AT_low_pc(DW$L$_END_STOP$15$B)
	.dwattr DW$179, DW_AT_high_pc(DW$L$_END_STOP$15$E)
	.dwendtag DW$176


DW$180	.dwtag  DW_TAG_loop
	.dwattr DW$180, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L69:1:1659632796")
	.dwattr DW$180, DW_AT_begin_file("Motor.c")
	.dwattr DW$180, DW_AT_begin_line(0xf2)
	.dwattr DW$180, DW_AT_end_line(0xf7)
DW$181	.dwtag  DW_TAG_loop_range
	.dwattr DW$181, DW_AT_low_pc(DW$L$_END_STOP$10$B)
	.dwattr DW$181, DW_AT_high_pc(DW$L$_END_STOP$10$E)
DW$182	.dwtag  DW_TAG_loop_range
	.dwattr DW$182, DW_AT_low_pc(DW$L$_END_STOP$11$B)
	.dwattr DW$182, DW_AT_high_pc(DW$L$_END_STOP$11$E)
	.dwendtag DW$180


DW$183	.dwtag  DW_TAG_loop
	.dwattr DW$183, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L68:1:1659632796")
	.dwattr DW$183, DW_AT_begin_file("Motor.c")
	.dwattr DW$183, DW_AT_begin_line(0xfa)
	.dwattr DW$183, DW_AT_end_line(0xff)
DW$184	.dwtag  DW_TAG_loop_range
	.dwattr DW$184, DW_AT_low_pc(DW$L$_END_STOP$7$B)
	.dwattr DW$184, DW_AT_high_pc(DW$L$_END_STOP$7$E)
DW$185	.dwtag  DW_TAG_loop_range
	.dwattr DW$185, DW_AT_low_pc(DW$L$_END_STOP$8$B)
	.dwattr DW$185, DW_AT_high_pc(DW$L$_END_STOP$8$E)
	.dwendtag DW$183

	.dwattr DW$174, DW_AT_end_file("Motor.c")
	.dwattr DW$174, DW_AT_end_line(0x108)
...
DW$188	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$98)
	.dwendtag DW$T$99


DW$T$103	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$103, DW_AT_language(DW_LANG_C)
DW$189	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$102)
...
DW$191	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$108)
DW$192	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$110)
DW$193	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$111)
DW$194	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$111)
	.dwendtag DW$T$112


DW$T$117	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$117, DW_AT_language(DW_LANG_C)
DW$195	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$116)
	.dwendtag DW$T$117


DW$T$121	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$121, DW_AT_language(DW_LANG_C)
DW$196	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$120)
	.dwendtag DW$T$121


DW$T$123	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$123, DW_AT_language(DW_LANG_C)
DW$197	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$29)
	.dwendtag DW$T$123


DW$T$128	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$128, DW_AT_language(DW_LANG_C)
DW$198	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$127)
	.dwendtag DW$T$128
...
DW$203	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$30)
DW$204	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$30)
	.dwendtag DW$T$129
...
DW$206	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$127)
DW$207	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$127)
	.dwendtag DW$T$132
...
DW$T$20	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$20, DW_AT_type(*DW$208)
...
DW$210	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$19)
	.dwendtag DW$T$134
...
DW$T$136	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$136, DW_AT_type(*DW$211)
...
DW$212	.dwtag  DW_TAG_far_type
	.dwattr DW$212, DW_AT_type(*DW$T$24)
DW$T$140	.dwtag  DW_TAG_const_type
	.dwattr DW$T$140, DW_AT_type(*DW$212)
...
DW$T$141	.dwtag  DW_TAG_const_type
	.dwattr DW$T$141, DW_AT_type(*DW$213)
...
DW$221	.dwtag  DW_TAG_far_type
	.dwattr DW$221, DW_AT_type(*DW$T$29)
DW$T$151	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$151, DW_AT_type(*DW$221)
...
DW$222	.dwtag  DW_TAG_subrange_type
	.dwattr DW$222, DW_AT_upper_bound(0xff)
	.dwendtag DW$T$155
...
DW$223	.dwtag  DW_TAG_far_type
	.dwattr DW$223, DW_AT_type(*DW$T$127)
...
DW$224	.dwtag  DW_TAG_far_type
	.dwattr DW$224, DW_AT_type(*DW$T$40)
DW$T$170	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$170, DW_AT_type(*DW$224)
...
DW$T$182	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$182, DW_AT_type(*DW$225)
DW$226	.dwtag  DW_TAG_far_type
	.dwattr DW$226, DW_AT_type(*DW$T$96)
DW$T$192	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$192, DW_AT_type(*DW$226)
...
DW$227	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$227, DW_AT_name("Position_U16_CNT"), DW_AT_symbol_name("_Position_U16_CNT")
	.dwattr DW$227, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$227, DW_AT_accessibility(DW_ACCESS_public)
DW$228	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$228, DW_AT_name("Adc_U16"), DW_AT_symbol_name("_Adc_U16")
	.dwattr DW$228, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$228, DW_AT_accessibility(DW_ACCESS_public)
DW$229	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$229, DW_AT_name("Max_U16"), DW_AT_symbol_name("_Max_U16")
	.dwattr DW$229, DW_AT_data_member_location[DW_OP_plus_uconst 0x11]
	.dwattr DW$229, DW_AT_accessibility(DW_ACCESS_public)
DW$230	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$230, DW_AT_name("Min_U16"), DW_AT_symbol_name("_Min_U16")
	.dwattr DW$230, DW_AT_data_member_location[DW_OP_plus_uconst 0x21]
	.dwattr DW$230, DW_AT_accessibility(DW_ACCESS_public)
DW$231	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$231, DW_AT_name("Div127_U16"), DW_AT_symbol_name("_Div127_U16")
	.dwattr DW$231, DW_AT_data_member_location[DW_OP_plus_uconst 0x31]
	.dwattr DW$231, DW_AT_accessibility(DW_ACCESS_public)
DW$232	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$232, DW_AT_name("Position_IQ10"), DW_AT_symbol_name("_Position_IQ10")
	.dwattr DW$232, DW_AT_data_member_location[DW_OP_plus_uconst 0x42]
	.dwattr DW$232, DW_AT_accessibility(DW_ACCESS_public)
DW$233	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$233, DW_AT_name("PositionTemporary_IQ10"), DW_AT_symbol_name("_PositionTemporary_IQ10")
	.dwattr DW$233, DW_AT_data_member_location[DW_OP_plus_uconst 0x44]
	.dwattr DW$233, DW_AT_accessibility(DW_ACCESS_public)
DW$234	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$234, DW_AT_name("AdcValue_U16"), DW_AT_symbol_name("_AdcValue_U16")
	.dwattr DW$234, DW_AT_data_member_location[DW_OP_plus_uconst 0x46]
	.dwattr DW$234, DW_AT_accessibility(DW_ACCESS_public)
DW$235	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$235, DW_AT_name("MaxminusMin_IQ17"), DW_AT_symbol_name("_MaxminusMin_IQ17")
	.dwattr DW$235, DW_AT_data_member_location[DW_OP_plus_uconst 0x56]
...
DW$237	.dwtag  DW_TAG_far_type
	.dwattr DW$237, DW_AT_type(*DW$T$34)
DW$T$125	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$125, DW_AT_type(*DW$237)
DW$238	.dwtag  DW_TAG_far_type
	.dwattr DW$238, DW_AT_type(*DW$T$37)
DW$T$168	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$168, DW_AT_type(*DW$238)
...
DW$243	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$38)
...
DW$244	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$38)
...
DW$252	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$48)
	.dwattr DW$252, DW_AT_name("TPR"), DW_AT_symbol_name("_TPR")
	.dwattr DW$252, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$252, DW_AT_accessibility(DW_ACCESS_public)
DW$253	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$50)
	.dwattr DW$253, DW_AT_name("TPRH"), DW_AT_symbol_name("_TPRH")
	.dwattr DW$253, DW_AT_data_member_location[DW_OP_plus_uconst 0x7]
...
DW$272	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$73)
	.dwattr DW$272, DW_AT_name("TZCTL"), DW_AT_symbol_name("_TZCTL")
	.dwattr DW$272, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr DW$272, DW_AT_accessibility(DW_ACCESS_public)
DW$273	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$75)
	.dwattr DW$273, DW_AT_name("TZEINT"), DW_AT_symbol_name("_TZEINT")
	.dwattr DW$273, DW_AT_data_member_location[DW_OP_plus_uconst 0x15]
	.dwattr DW$273, DW_AT_accessibility(DW_ACCESS_public)
DW$274	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$77)
	.dwattr DW$274, DW_AT_name("TZFLG"), DW_AT_symbol_name("_TZFLG")
	.dwattr DW$274, DW_AT_data_member_location[DW_OP_plus_uconst 0x16]
	.dwattr DW$274, DW_AT_accessibility(DW_ACCESS_public)
DW$275	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$79)
	.dwattr DW$275, DW_AT_name("TZCLR"), DW_AT_symbol_name("_TZCLR")
	.dwattr DW$275, DW_AT_data_member_location[DW_OP_plus_uconst 0x17]
	.dwattr DW$275, DW_AT_accessibility(DW_ACCESS_public)
DW$276	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$81)
	.dwattr DW$276, DW_AT_name("TZFRC"), DW_AT_symbol_name("_TZFRC")
	.dwattr DW$276, DW_AT_data_member_location[DW_OP_plus_uconst 0x18]
	.dwattr DW$276, DW_AT_accessibility(DW_ACCESS_public)
DW$277	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$83)
	.dwattr DW$277, DW_AT_name("ETSEL"), DW_AT_symbol_name("_ETSEL")
	.dwattr DW$277, DW_AT_data_member_location[DW_OP_plus_uconst 0x19]
	.dwattr DW$277, DW_AT_accessibility(DW_ACCESS_public)
DW$278	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$85)
	.dwattr DW$278, DW_AT_name("ETPS"), DW_AT_symbol_name("_ETPS")
	.dwattr DW$278, DW_AT_data_member_location[DW_OP_plus_uconst 0x1a]
	.dwattr DW$278, DW_AT_accessibility(DW_ACCESS_public)
DW$279	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$87)
	.dwattr DW$279, DW_AT_name("ETFLG"), DW_AT_symbol_name("_ETFLG")
	.dwattr DW$279, DW_AT_data_member_location[DW_OP_plus_uconst 0x1b]
	.dwattr DW$279, DW_AT_accessibility(DW_ACCESS_public)
DW$280	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$89)
	.dwattr DW$280, DW_AT_name("ETCLR"), DW_AT_symbol_name("_ETCLR")
	.dwattr DW$280, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$280, DW_AT_accessibility(DW_ACCESS_public)
DW$281	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$91)
	.dwattr DW$281, DW_AT_name("ETFRC"), DW_AT_symbol_name("_ETFRC")
	.dwattr DW$281, DW_AT_data_member_location[DW_OP_plus_uconst 0x1d]
	.dwattr DW$281, DW_AT_accessibility(DW_ACCESS_public)
DW$282	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$93)
	.dwattr DW$282, DW_AT_name("PCCTL"), DW_AT_symbol_name("_PCCTL")
	.dwattr DW$282, DW_AT_data_member_location[DW_OP_plus_uconst 0x1e]
	.dwattr DW$282, DW_AT_accessibility(DW_ACCESS_public)
DW$283	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$283, DW_AT_name("rsvd3"), DW_AT_symbol_name("_rsvd3")
	.dwattr DW$283, DW_AT_data_member_location[DW_OP_plus_uconst 0x1f]
	.dwattr DW$283, DW_AT_accessibility(DW_ACCESS_public)
DW$284	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$95)
	.dwattr DW$284, DW_AT_name("HRCNFG"), DW_AT_symbol_name("_HRCNFG")
	.dwattr DW$284, DW_AT_data_member_location[DW_OP_plus_uconst 0x20]
	.dwattr DW$284, DW_AT_accessibility(DW_ACCESS_public)
	.dwendtag DW$T$96

DW$285	.dwtag  DW_TAG_far_type
	.dwattr DW$285, DW_AT_type(*DW$T$97)
DW$T$194	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$194, DW_AT_type(*DW$285)
...
DW$288	.dwtag  DW_TAG_far_type
	.dwattr DW$288, DW_AT_type(*DW$T$22)
DW$T$23	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$23, DW_AT_type(*DW$288)
...
DW$295	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$295, DW_AT_name("SingleFlag_U16"), DW_AT_symbol_name("_SingleFlag_U16")
...
DW$296	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$296, DW_AT_name("CrossMark_U16"), DW_AT_symbol_name("_CrossMark_U16")
...
DW$313	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$313, DW_AT_name("s44sFlag_U16"), DW_AT_symbol_name("_s44sFlag_U16")
	.dwattr DW$313, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x01)
	.dwattr DW$313, DW_AT_data_member_location[DW_OP_plus_uconst 0x1e]
...
DW$322	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$322, DW_AT_name("ErrorDistance_IQ17"), DW_AT_symbol_name("_ErrorDistance_IQ17")
	.dwattr DW$322, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$322, DW_AT_accessibility(DW_ACCESS_public)
DW$323	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$323, DW_AT_name("UserDistance_IQ17"), DW_AT_symbol_name("_UserDistance_IQ17")
	.dwattr DW$323, DW_AT_data_member_location[DW_OP_plus_uconst 0x12]
	.dwattr DW$323, DW_AT_accessibility(DW_ACCESS_public)
DW$324	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$324, DW_AT_name("DecelFlag_U16"), DW_AT_symbol_name("_DecelFlag_U16")
...
DW$333	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$333, DW_AT_name("StepCntFlag_U32"), DW_AT_symbol_name("_StepCntFlag_U32")
...
DW$351	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$47)
...
DW$353	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$49)
...
DW$357	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$54)
...
DW$359	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$56)
...
DW$363	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$60)
...
DW$365	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$62)
...
DW$367	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$64)
...
DW$369	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$66)
...
DW$371	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$68)
...
DW$375	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$72)
...
DW$381	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$78)
...
DW$389	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$86)
...
DW$391	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$88)
...
DW$393	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$90)
...
DW$395	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$92)
...
DW$408	.dwtag  DW_TAG_far_type
	.dwattr DW$408, DW_AT_type(*DW$T$24)
DW$T$25	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$25, DW_AT_type(*DW$408)
