...
;* Date/Time created: Sun Aug 07 16:42:39 2022                 *
;***************************************************************
...
DW$72	.dwtag  DW_TAG_subprogram, DW_AT_name("START_END_LINE"), DW_AT_symbol_name("_START_END_LINE")
	...
	.dwattr DW$72, DW_AT_begin_line(0x124)
...
;*** 294	-----------------------    if ( *&Flag&1u ) goto g8;
	...
	.dwpsn	"Motor.c",294,2
        ...
        BF        L2,TC                 ; |294| 
        ; branchcc occurs ; |294| 
;*** 294	-----------------------    if ( *&Flag&0x20u ) goto g8;
        TBIT      @_Flag,#5             ; |294| 
        BF        L2,TC                 ; |294| 
        ; branchcc occurs ; |294| 
;*** 295	-----------------------    *&Flag |= 1u;
;*** 296	-----------------------    TIME_INDEX_U32 = 0uL;
;*** 298	-----------------------    if ( *&Flag&0x40u ) goto g11;
	.dwpsn	"Motor.c",295,3
        OR        @_Flag,#0x0001        ; |295| 
	.dwpsn	"Motor.c",296,3
        MOVW      DP,#_TIME_INDEX_U32
        MOVB      ACC,#0
        MOVL      @_TIME_INDEX_U32,ACC  ; |296| 
	.dwpsn	"Motor.c",298,3
        MOVW      DP,#_Flag
        TBIT      @_Flag,#6             ; |298| 
        BF        L3,TC                 ; |298| 
        ; branchcc occurs ; |298| 
;*** 300	-----------------------    if ( *&Flag&0x80u ) goto g7;
	.dwpsn	"Motor.c",300,8
        TBIT      @_Flag,#7             ; |300| 
        BF        L1,TC                 ; |300| 
        ; branchcc occurs ; |300| 
;*** 302	-----------------------    if ( !(*&Flag&0x100u) ) goto g12;
	.dwpsn	"Motor.c",302,8
        ...
        BF        L4,NTC                ; |302| 
        ; branchcc occurs ; |302| 
;*** 303	-----------------------    LINE_THIRD(((long)THIRD_MARK_U16_CNT<<5)+&Search);
;*** 303	-----------------------    goto g12;
	.dwpsn	"Motor.c",303,4
        ...
        ADDL      XAR4,ACC
        LCR       #_LINE_THIRD          ; |303| 
        ; call occurs [#_LINE_THIRD] ; |303| 
        BF        L4,UNC                ; |303| 
        ; branch occurs ; |303| 
L1:    
;***	-----------------------g7:
;*** 301	-----------------------    LINE_SECOND(((long)SECOND_MARK_U16_CNT<<5)+&Search);
;*** 301	-----------------------    goto g12;
	.dwpsn	"Motor.c",301,4
...
;***  	-----------------------    return;
	.dwpsn	"Motor.c",311,4
        MOVB      XAR4,#0
        LCR       #_LINE_INFO           ; |311| 
        ; call occurs [#_LINE_INFO] ; |311| 
L4:    
	.dwpsn	"Motor.c",313,1
        LRETR
        ; return occurs
	.dwattr DW$72, DW_AT_end_file("Motor.c")
	.dwattr DW$72, DW_AT_end_line(0x139)
...
;*** 157	-----------------------    RMotor.DecelAccel_IQ14 = __IQmpy(_IQ15div(__IQmpy(_IQ17div(RMotor.NextVelocity_IQ17, 13107200L)>>2, _IQ17div(RMotor.NextVelocity_IQ17, 13107200L)>>2, 15), 5406720L), 327680000L, 15)>>2;
;*** 158	-----------------------    LMotor.DecelAccel_IQ14 = __IQmpy(_IQ15div(__IQmpy(_IQ17div(LMotor.NextVelocity_IQ17, 13107200L)>>2, _IQ17div(LMotor.NextVelocity_IQ17, 13107200L)>>2, 15), 5406720L), 327680000L, 15)>>2;
;*** 160	-----------------------    RMotor.DecelFlag_U16 = LMotor.DecelFlag_U16 = 1u;
...
DW$74	.dwtag  DW_TAG_formal_parameter, DW_AT_name("distance"), DW_AT_symbol_name("_distance")
	...
	.dwpsn	"Motor.c",160,2
        MOVB      AL,#1                 ; |160| 
        MOV       @_LMotor+20,AL        ; |160| 
        MOVW      DP,#_RMotor+20
        MOV       @_RMotor+20,AL        ; |160| 
	.dwpsn	"Motor.c",162,2
        MOVW      DP,#_CpuTimer2Regs+4
	...
	.dwattr DW$73, DW_AT_end_line(0xa3)
...
DW$75	.dwtag  DW_TAG_subprogram, DW_AT_name("SHUTDOWN"), DW_AT_symbol_name("_SHUTDOWN")
	...
	.dwattr DW$75, DW_AT_begin_line(0x13b)
...
;***************************************************************
_SHUTDOWN:
;*** 317	-----------------------    K$1 = &GpioDataRegs+10L;
;*** 317	-----------------------    *(volatile unsigned *)K$1 |= 4u;
;*** 318	-----------------------    *(volatile unsigned *)K$1 |= 2u;
...
DW$83	.dwtag  DW_TAG_variable, DW_AT_name("K$1"), DW_AT_symbol_name("K$1")
	...
	.dwpsn	"Motor.c",317,2
        MOVL      XAR4,#_GpioDataRegs+10 ; |317| 
        OR        *+XAR4[0],#0x0004     ; |317| 
	.dwpsn	"Motor.c",318,2
        OR        *+XAR4[0],#0x0002     ; |318| 
	.dwpsn	"Motor.c",320,2
...
;*** 329	-----------------------    goto g5;
	.dwpsn	"Motor.c",329,3
        MOVB      ACC,#0
        LCR       #_MOVE_TO_END         ; |329| 
        ; call occurs [#_MOVE_TO_END] ; |329| 
        BF        L6,UNC                ; |329| 
        ; branch occurs ; |329| 
L5:    
;***	-----------------------g4:
;*** 322	-----------------------    MOVE_TO_END(0L);
;*** 324	-----------------------    *&Flag &= 0xfffbu;
;*** 325	-----------------------    GpioDataRegs.GPACLEAR.all = 7347968uL;
;*** 326	-----------------------    SenAdc.PositionTemporary_IQ10 = 0L;
	.dwpsn	"Motor.c",322,3
        MOVB      ACC,#0
        LCR       #_MOVE_TO_END         ; |322| 
        ; call occurs [#_MOVE_TO_END] ; |322| 
	.dwpsn	"Motor.c",324,3
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfffb        ; |324| 
	.dwpsn	"Motor.c",325,3
        MOV       PH,#112
        MOV       PL,#7936
        MOVW      DP,#_GpioDataRegs+4
        MOVL      @_GpioDataRegs+4,P    ; |325| 
	.dwpsn	"Motor.c",326,3
        MOVW      DP,#_SenAdc+68
        MOVB      ACC,#0
...
L9:    
;***	-----------------------g8:
;*** 334	-----------------------    if ( RMotor.NextVelocity_IQ17 >= 1310720L ) goto g6;
	.dwpsn	"Motor.c",334,3
        MOVL      ACC,XAR4              ; |334| 
        MOVW      DP,#_RMotor+2
        CMPL      ACC,@_RMotor+2        ; |334| 
        BF        L7,LEQ                ; |334| 
        ; branchcc occurs ; |334| 
;*** 348	-----------------------    K$6 = &Flag;
;*** 348	-----------------------    *K$6 &= 0xfffbu;
;*** 349	-----------------------    C$1 = &GpioDataRegs;
;*** 349	-----------------------    (*C$1).GPACLEAR.all = 7347968uL;
;*** 350	-----------------------    *(&CpuTimer0Regs+4L) |= 0x10u;
;*** 352	-----------------------    *K$6 &= 0xfffdu;
;*** 353	-----------------------    (*C$1).GPADAT.all = (*C$1).GPADAT.all&0xffffffdfuL|2uL;
;*** 354	-----------------------    EPwm3Regs.CMPA.half.CMPA = 0u;
;*** 354	-----------------------    EPwm1Regs.CMPA.half.CMPA = 0u;
;*** 356	-----------------------    STOP_TIME_INDEX_U32 = 0uL;
	.dwpsn	"Motor.c",348,4
        MOVL      XAR5,#_Flag           ; |348| 
        AND       *+XAR5[0],#0xfffb     ; |348| 
	.dwpsn	"Motor.c",349,4
        MOV       PH,#112
        MOV       PL,#7936
        MOVL      XAR4,#_GpioDataRegs   ; |349| 
        MOVL      *+XAR4[4],P           ; |349| 
	.dwpsn	"Motor.c",350,4
        MOVW      DP,#_CpuTimer0Regs+4
        OR        @_CpuTimer0Regs+4,#0x0010 ; |350| 
	.dwpsn	"Motor.c",352,4
        AND       *+XAR5[0],#0xfffd     ; |352| 
	.dwpsn	"Motor.c",353,4
        MOVL      ACC,*+XAR4[0]         ; |353| 
        AND       AL,#65503             ; |353| 
        ORB       AL,#0x02              ; |353| 
	...
	.dwpsn	"Motor.c",354,4
        ...
        MOV       @_EPwm3Regs+9,#0      ; |354| 
        MOVW      DP,#_EPwm1Regs+9
        MOV       @_EPwm1Regs+9,#0      ; |354| 
	.dwpsn	"Motor.c",356,4
        MOVW      DP,#_STOP_TIME_INDEX_U32
        MOVB      ACC,#0
        MOVL      @_STOP_TIME_INDEX_U32,ACC ; |356| 
L10:    
DW$L$_SHUTDOWN$10$B:
;***	-----------------------g10:
;*** 358	-----------------------    if ( LINE_OUT_U16 >= 777u ) goto g12;
	.dwpsn	"Motor.c",358,10
        MOVW      DP,#_LINE_OUT_U16
        CMP       @_LINE_OUT_U16,#777   ; |358| 
        BF        L11,HIS               ; |358| 
        ; branchcc occurs ; |358| 
DW$L$_SHUTDOWN$10$E:
DW$L$_SHUTDOWN$11$B:
;*** 358	-----------------------    if ( STOP_TIME_INDEX_U32 < 1000uL ) goto g10;
        MOV       ACC,#1000             ; |358| 
        MOVW      DP,#_STOP_TIME_INDEX_U32
        CMPL      ACC,@_STOP_TIME_INDEX_U32 ; |358| 
        BF        L10,HI                ; |358| 
        ; branchcc occurs ; |358| 
DW$L$_SHUTDOWN$11$E:
L11:    
;***	-----------------------g12:
;*** 360	-----------------------    *(&CpuTimer2Regs+4L) |= 0x10u;
;*** 362	-----------------------    K$1 = &GpioDataRegs;
...
;*** 368	-----------------------    return;
	.dwpsn	"Motor.c",360,4
        MOVW      DP,#_CpuTimer2Regs+4
        OR        @_CpuTimer2Regs+4,#0x0010 ; |360| 
	.dwpsn	"Motor.c",362,4
        MOVB      ACC,#68
        MOVL      XAR5,#_GpioDataRegs   ; |362| 
        MOVL      *+XAR5[4],ACC         ; |362| 
	.dwpsn	"Motor.c",364,4
        MOVB      ACC,#12
        ADDL      ACC,XAR5
...
DW$84	.dwtag  DW_TAG_loop
	.dwattr DW$84, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L10:1:1659858159")
	.dwattr DW$84, DW_AT_begin_file("Motor.c")
	.dwattr DW$84, DW_AT_begin_line(0x166)
	.dwattr DW$84, DW_AT_end_line(0x166)
...
DW$87	.dwtag  DW_TAG_loop
	.dwattr DW$87, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L8:1:1659858159")
	.dwattr DW$87, DW_AT_begin_file("Motor.c")
	.dwattr DW$87, DW_AT_begin_line(0x173)
	.dwattr DW$87, DW_AT_end_line(0x173)
DW$88	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$75, DW_AT_end_line(0x175)
...
DW$103	.dwtag  DW_TAG_subprogram, DW_AT_name("MOTOR_ISR"), DW_AT_symbol_name("_MOTOR_ISR")
	...
	.dwattr DW$103, DW_AT_begin_line(0xba)
...
DW$147	.dwtag  DW_TAG_variable, DW_AT_name("K$51"), DW_AT_symbol_name("K$51")
 ...
 clrc INTM
	.dwpsn	"Motor.c",193,2
        SPM       #0
        LCR       #_xHANDLE             ; |193| 
        ; call occurs [#_xHANDLE] ; |193| 
	.dwpsn	"Motor.c",194,2
        LCR       #_HANDLE              ; |194| 
        ; call occurs [#_HANDLE] ; |194| 
	.dwpsn	"Motor.c",197,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#1             ; |197| 
        BF        L64,NTC               ; |197| 
        ; branchcc occurs ; |197| 
;*** 198	-----------------------    clk = *&EPwm1Regs>>10&7u;
;*** 47	-----------------------    if ( RMotor.NextVelocity_IQ17 < RMotor.TargetVel_IQ17 ) goto g8;  // [19]
	.dwpsn	"Motor.c",198,3
        MOVW      DP,#_EPwm1Regs
        AND       AL,@_EPwm1Regs,#0x1c00 ; |198| 
        LSR       AL,10                 ; |198| 
        MOVZ      AR2,AL                ; |198| 
	.dwpsn	"Motor.c",47,2
        MOVW      DP,#_RMotor
...
;*** 202	-----------------------    *&EPwm3Regs = *&EPwm3Regs&0xe3ffu|(clk&7u)<<10;
;*** 204	-----------------------    K$8 = &RMotor;
;*** 204	-----------------------    EPwm1Regs.TBPRD = (*K$8).PrdNext_IQ14>>14;
;*** 205	-----------------------    EPwm1Regs.CMPA.half.CMPA = EPwm1Regs.TBPRD>>1;
;*** 207	-----------------------    EPwm3Regs.TBPRD = (*K$51).PrdNext_IQ14>>14;
;*** 208	-----------------------    EPwm3Regs.CMPA.half.CMPA = EPwm3Regs.TBPRD>>1;
;*** 210	-----------------------    SHIFT_DIST_IQ17 = ((*K$51).RolEachStep_IQ17>>1)+((*K$8).RolEachStep_IQ17>>1);
;*** 212	-----------------------    if ( !((*&Flag>>1|*&Flag)&0x80u) ) goto g59;
	...
	.dwpsn	"Motor.c",202,3
        AND       AL,AR1,#0x0007        ; |202| 
        MOVW      DP,#_EPwm3Regs
        LSL       AL,10                 ; |202| 
        AND       AH,@_EPwm3Regs,#0xe3ff ; |202| 
        OR        AL,AH                 ; |202| 
        MOV       @_EPwm3Regs,AL        ; |202| 
	.dwpsn	"Motor.c",204,3
        MOVL      XAR5,#_RMotor         ; |204| 
        MOVB      XAR0,#22              ; |204| 
        MOVW      DP,#_EPwm1Regs+5
        MOVL      ACC,*+XAR5[AR0]       ; |204| 
        MOVH      @_EPwm1Regs+5,ACC << 2 ; |204| 
	.dwpsn	"Motor.c",205,3
        MOV       AL,@_EPwm1Regs+5      ; |205| 
        LSR       AL,1                  ; |205| 
        MOV       @_EPwm1Regs+9,AL      ; |205| 
	.dwpsn	"Motor.c",207,3
        MOVW      DP,#_EPwm3Regs+5
        MOVL      ACC,*+XAR4[AR0]       ; |207| 
        MOVH      @_EPwm3Regs+5,ACC << 2 ; |207| 
	.dwpsn	"Motor.c",208,3
        MOV       AL,@_EPwm3Regs+5      ; |208| 
        LSR       AL,1                  ; |208| 
        MOV       @_EPwm3Regs+9,AL      ; |208| 
	.dwpsn	"Motor.c",210,3
        MOVB      XAR0,#26              ; |210| 
        MOVL      P,*+XAR4[AR0]         ; |210| 
        SETC      SXM
        MOVL      ACC,*+XAR5[AR0]       ; |210| 
        SPM       #-1
        SFR       ACC,1                 ; |210| 
        MOVW      DP,#_SHIFT_DIST_IQ17
        ADDL      ACC,P << PM           ; |210| 
        MOVL      @_SHIFT_DIST_IQ17,ACC ; |210| 
	.dwpsn	"Motor.c",212,3
        MOVW      DP,#_Flag
        MOV       AL,@_Flag             ; |212| 
        LSR       AL,1                  ; |212| 
        ...
        BF        L63,EQ                ; |212| 
        ; branchcc occurs ; |212| 
;*** 167	-----------------------    if ( (*K$8).DecelFlag_U16 ) goto g55;  // [22]
	.dwpsn	"Motor.c",167,2
        MOVB      XAR0,#20              ; |167| 
        MOV       AL,*+XAR5[AR0]        ; |167| 
        BF        L61,NEQ               ; |167| 
        ; branchcc occurs ; |167| 
;*** 167	-----------------------    if ( !(*K$51).DecelFlag_U16 ) goto g59;  // [22]
        MOV       AL,*+XAR4[AR0]        ; |167| 
        BF        L63,EQ                ; |167| 
        ; branchcc occurs ; |167| 
L61:    
;***	-----------------------g55:
;*** 169	-----------------------    if ( RMotor.DecelDistance_IQ17 > RMotor.ErrorDistance_IQ17 ) goto g58;  // [22]
	.dwpsn	"Motor.c",169,3
        MOVW      DP,#_RMotor+16
        ...
        BF        L62,LT                ; |169| 
        ; branchcc occurs ; |169| 
;*** 176	-----------------------    if ( LMotor.DecelDistance_IQ17 <= LMotor.ErrorDistance_IQ17 ) goto g59;  // [22]
	.dwpsn	"Motor.c",176,8
        MOVW      DP,#_LMotor+16
        ...
        ; branchcc occurs ; |176| 
;*** 178	-----------------------    K$8 = &RMotor;  // [22]
;*** 178	-----------------------    (*K$8).TargetVel_IQ17 = RMotor.DecelVelocity_IQ17;  // [22]
;*** 179	-----------------------    K$51 = &LMotor;  // [22]
;*** 179	-----------------------    (*K$51).TargetVel_IQ17 = LMotor.DecelVelocity_IQ17;  // [22]
;*** 181	-----------------------    (*K$51).DecelFlag_U16 = 0u;  // [22]
;*** 181	-----------------------    (*K$8).DecelFlag_U16 = 0u;  // [22]
;*** 181	-----------------------    goto g59;  // [22]
	.dwpsn	"Motor.c",178,4
        MOVW      DP,#_RMotor+6
        MOVL      ACC,@_RMotor+6        ; |178| 
        MOVL      *+XAR5[0],ACC         ; |178| 
	.dwpsn	"Motor.c",179,4
        MOVW      DP,#_LMotor+6
        MOVL      ACC,@_LMotor+6        ; |179| 
        MOVL      *+XAR4[0],ACC         ; |179| 
	.dwpsn	"Motor.c",181,4
        MOV       *+XAR4[AR0],#0        ; |181| 
        MOV       *+XAR5[AR0],#0        ; |181| 
...
;***	-----------------------g58:
;*** 171	-----------------------    K$8 = &RMotor;  // [22]
;*** 171	-----------------------    (*K$8).TargetVel_IQ17 = RMotor.DecelVelocity_IQ17;  // [22]
;*** 172	-----------------------    K$51 = &LMotor;  // [22]
;*** 172	-----------------------    (*K$51).TargetVel_IQ17 = LMotor.DecelVelocity_IQ17;  // [22]
;*** 174	-----------------------    (*K$51).DecelFlag_U16 = 0u;  // [22]
;*** 174	-----------------------    (*K$8).DecelFlag_U16 = 0u;  // [22]
	.dwpsn	"Motor.c",171,4
...
;*** 215	-----------------------    ++TIME_INDEX_U32;
	.dwpsn	"Motor.c",215,4
        MOVB      ACC,#1
        MOVW      DP,#_TIME_INDEX_U32
        ADDL      @_TIME_INDEX_U32,ACC  ; |215| 
L64:    
;***	-----------------------g61:
;*** 218	-----------------------    if ( !(*&Flag&0x20u) ) goto g63;
	.dwpsn	"Motor.c",218,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#5             ; |218| 
        BF        L65,NTC               ; |218| 
        ; branchcc occurs ; |218| 
;*** 219	-----------------------    ++STOP_TIME_INDEX_U32;
	.dwpsn	"Motor.c",219,3
        MOVB      ACC,#1
        MOVW      DP,#_STOP_TIME_INDEX_U32
        ADDL      @_STOP_TIME_INDEX_U32,ACC ; |219| 
L65:    
;***	-----------------------g63:
;*** 221	-----------------------    if ( !(*&Flag&4u) ) goto g65;
	.dwpsn	"Motor.c",221,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#2             ; |221| 
        BF        L66,NTC               ; |221| 
        ; branchcc occurs ; |221| 
;*** 222	-----------------------    *(&CpuTimer0Regs+4L) &= 0xffefu;
;***	-----------------------g65:
;***  	-----------------------    return;
	.dwpsn	"Motor.c",222,3
        MOVW      DP,#_CpuTimer0Regs+4
        AND       @_CpuTimer0Regs+4,#0xffef ; |222| 
L66:    
	.dwpsn	"Motor.c",223,1
        SUBB      SP,#2
	.dwcfa	0x1d, -18
...
DW$148	.dwtag  DW_TAG_loop
	.dwattr DW$148, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L26:1:1659858159")
...
DW$151	.dwtag  DW_TAG_loop
	.dwattr DW$151, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L27:2:1659858159")
...
DW$154	.dwtag  DW_TAG_loop
	.dwattr DW$154, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L29:1:1659858159")
...
DW$157	.dwtag  DW_TAG_loop
	.dwattr DW$157, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L30:2:1659858159")
...
DW$160	.dwtag  DW_TAG_loop
	.dwattr DW$160, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L47:1:1659858159")
...
DW$163	.dwtag  DW_TAG_loop
	.dwattr DW$163, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L48:2:1659858159")
...
DW$166	.dwtag  DW_TAG_loop
	.dwattr DW$166, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L50:1:1659858159")
...
DW$169	.dwtag  DW_TAG_loop
	.dwattr DW$169, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L51:2:1659858159")
...
DW$171	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$103, DW_AT_end_line(0xdf)
...
DW$172	.dwtag  DW_TAG_subprogram, DW_AT_name("LINE_OUT_STOP"), DW_AT_symbol_name("_LINE_OUT_STOP")
	...
	.dwattr DW$172, DW_AT_begin_line(0x114)
...
;***************************************************************
_LINE_OUT_STOP:
;*** 279	-----------------------    if ( LINE_OUT_U16 >= 300u ) goto g3;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        ADDB      SP,#2
...
L67:    
;***	-----------------------g3:
;*** 282	-----------------------    LINE_OUT_U16 = 777u;
;*** 283	-----------------------    *&Flag &= 0xfffeu;
;*** 285	-----------------------    SHUTDOWN();
;*** 287	-----------------------    VFDPrintf("line OUT");
;*** 289	-----------------------    return 1u;
	.dwpsn	"Motor.c",282,2
        MOV       @_LINE_OUT_U16,#777   ; |282| 
	.dwpsn	"Motor.c",283,2
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfffe        ; |283| 
	.dwpsn	"Motor.c",285,2
        LCR       #_SHUTDOWN            ; |285| 
        ; call occurs [#_SHUTDOWN] ; |285| 
	.dwpsn	"Motor.c",287,2
        MOVL      XAR4,#FSL1            ; |287| 
        MOVL      *-SP[2],XAR4          ; |287| 
        LCR       #_VFDPrintf           ; |287| 
...
L68:    
	...
	.dwattr DW$172, DW_AT_end_line(0x122)
...
DW$177	.dwtag  DW_TAG_subprogram, DW_AT_name("END_STOP"), DW_AT_symbol_name("_END_STOP")
	...
	.dwattr DW$177, DW_AT_begin_line(0xe1)
...
L69:    
;***	-----------------------g3:
;*** 228	-----------------------    LMotor.GoneDistance_IQ15 = 0L;
;*** 228	-----------------------    RMotor.GoneDistance_IQ15 = 0L;
;*** 229	-----------------------    SHUTDOWN();
;*** 231	-----------------------    if ( !(*(&CpuTimer0Regs+4L)&0x10u) ) goto g19;
	.dwpsn	"Motor.c",228,3
        MOVB      ACC,#0
        MOVW      DP,#_LMotor+10
        MOVL      @_LMotor+10,ACC       ; |228| 
        MOVW      DP,#_RMotor+10
        MOVL      @_RMotor+10,ACC       ; |228| 
	.dwpsn	"Motor.c",229,3
        LCR       #_SHUTDOWN            ; |229| 
	...
	.dwpsn	"Motor.c",231,3
        ...
        BF        L74,NTC               ; |231| 
        ; branchcc occurs ; |231| 
;*** 233	-----------------------    if ( *&Flag&0x40u ) goto g13;
	.dwpsn	"Motor.c",233,8
        MOVW      DP,#_Flag
        TBIT      @_Flag,#6             ; |233| 
        BF        L72,TC                ; |233| 
        ; branchcc occurs ; |233| 
;*** 251	-----------------------    if ( *&Flag&0x80u ) goto g10;
	.dwpsn	"Motor.c",251,8
        TBIT      @_Flag,#7             ; |251| 
        BF        L71,TC                ; |251| 
        ; branchcc occurs ; |251| 
...
DW$L$_END_STOP$7$B:
;***	-----------------------g8:
;*** 260	-----------------------    if ( !(*(&CpuTimer0Regs+4L)&0x10u) ) goto g20;
...
DW$L$_END_STOP$7$E:
DW$L$_END_STOP$8$B:
;*** 261	-----------------------    VFDPrintf("M%3u|C%2lu", THIRD_MARK_U16_CNT-1u, CROSS_PLUS_SEARCH_U32);
;*** 264	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g8;
	.dwpsn	"Motor.c",261,5
        MOVW      DP,#_THIRD_MARK_U16_CNT
        MOVL      XAR4,#FSL2            ; |261| 
        MOV       AL,@_THIRD_MARK_U16_CNT ; |261| 
        MOVL      *-SP[2],XAR4          ; |261| 
        ADDB      AL,#-1
...
DW$L$_END_STOP$10$B:
;***	-----------------------g11:
;*** 252	-----------------------    if ( !(*(&CpuTimer0Regs+4L)&0x10u) ) goto g20;
...
DW$L$_END_STOP$10$E:
DW$L$_END_STOP$11$B:
;*** 253	-----------------------    VFDPrintf("M%3u|C%2lu", SECOND_MARK_U16_CNT-1u, CROSS_PLUS_SEARCH_U32);
;*** 256	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g11;
	.dwpsn	"Motor.c",253,5
        MOVW      DP,#_SECOND_MARK_U16_CNT
        MOVL      XAR4,#FSL2            ; |253| 
        MOV       AL,@_SECOND_MARK_U16_CNT ; |253| 
        MOVL      *-SP[2],XAR4          ; |253| 
        ADDB      AL,#-1
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        MOV       *-SP[3],AL            ; |253| 
        MOVL      ACC,@_CROSS_PLUS_SEARCH_U32 ; |253| 
        MOVL      *-SP[6],ACC           ; |253| 
        LCR       #_VFDPrintf           ; |253| 
...
DW$L$_END_STOP$13$E:
DW$L$_END_STOP$14$B:
;*** 235	-----------------------    VFDPrintf("M%3u|C%2lu", MARK_U16_CNT, CROSS_PLUS_SEARCH_U32);
;*** 236	-----------------------    DSP28x_usDelay(7999998uL);
;*** 237	-----------------------    VFDPrintf("<-N  S->");
;*** 238	-----------------------    DSP28x_usDelay(3999998uL);
;*** 240	-----------------------    C$1 = &GpioDataRegs;
;*** 240	-----------------------    if ( !(*C$1&0x4000u) ) goto g18;
	.dwpsn	"Motor.c",235,5
...
DW$L$_END_STOP$14$E:
DW$L$_END_STOP$15$B:
;*** 245	-----------------------    if ( C$1[1]&0x4000u ) goto g14;
	.dwpsn	"Motor.c",245,10
        TBIT      *+XAR4[1],#14         ; |245| 
        BF        L72,TC                ; |245| 
        ; branchcc occurs ; |245| 
DW$L$_END_STOP$15$E:
;*** 246	-----------------------    VFDPrintf("saveNONE");
;*** 247	-----------------------    goto g20;
	.dwpsn	"Motor.c",246,6
        MOVL      XAR4,#FSL4            ; |246| 
        MOVL      *-SP[2],XAR4          ; |246| 
...
;*** 243	-----------------------    goto g20;
	...
	.dwpsn	"Motor.c",242,6
        LCR       #_save_line_info      ; |242| 
        ; call occurs [#_save_line_info] ; |242| 
	.dwpsn	"Motor.c",243,6
        BF        L75,UNC               ; |243| 
        ; branch occurs ; |243| 
L74:    
;***	-----------------------g19:
;*** 232	-----------------------    VFDPrintf("runERROR");
	.dwpsn	"Motor.c",232,4
        MOVL      XAR4,#FSL6            ; |232| 
        MOVL      *-SP[2],XAR4          ; |232| 
        LCR       #_VFDPrintf           ; |232| 
...
;*** 268	-----------------------    VFDPrintf("T %3lf", (float)TIME_INDEX_U32*5.00000023748725652695e-4F);
;*** 270	-----------------------    return 1u;
	.dwpsn	"Motor.c",267,3
        MOV       AL,#9630
        MOV       AH,#38
	...
	.dwpsn	"Motor.c",268,3
        MOVW      DP,#_TIME_INDEX_U32
        MOVL      ACC,@_TIME_INDEX_U32  ; |268| 
        LCR       #UL$$TOFS             ; |268| 
        ; call occurs [#UL$$TOFS] ; |268| 
        MOVL      XAR6,ACC              ; |268| 
        MOV       AL,#4719
        MOV       AH,#14851
        MOVL      *-SP[2],ACC           ; |268| 
...
DW$179	.dwtag  DW_TAG_loop
	.dwattr DW$179, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L72:1:1659858159")
	.dwattr DW$179, DW_AT_begin_file("Motor.c")
	.dwattr DW$179, DW_AT_begin_line(0xea)
	.dwattr DW$179, DW_AT_end_line(0xf9)
...
DW$183	.dwtag  DW_TAG_loop
	.dwattr DW$183, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L71:1:1659858159")
	.dwattr DW$183, DW_AT_begin_file("Motor.c")
	.dwattr DW$183, DW_AT_begin_line(0xfc)
	.dwattr DW$183, DW_AT_end_line(0x101)
...
DW$186	.dwtag  DW_TAG_loop
	.dwattr DW$186, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라\main\Motor.asm:L70:1:1659858159")
	.dwattr DW$186, DW_AT_begin_file("Motor.c")
	.dwattr DW$186, DW_AT_begin_line(0x104)
	.dwattr DW$186, DW_AT_end_line(0x109)
...
DW$188	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$177, DW_AT_end_line(0x112)
