...
;* Date/Time created: Tue Aug 15 22:01:20 2023                 *
;***************************************************************
...
;*** 370	-----------------------    if ( !(*&Flag&0x100u) ) goto g12;
	.dwpsn	"Motor.c",370,8
        ...
        BF        L4,NTC                ; |370| 
        ; branchcc occurs ; |370| 
;*** 371	-----------------------    LINE_THIRD((long)THIRD_MARK_U16_CNT*36+&Search);
;*** 371	-----------------------    goto g12;
	.dwpsn	"Motor.c",371,4
        MOVW      DP,#_THIRD_MARK_U16_CNT
        MOV       T,#36                 ; |371| 
        MPYXU     ACC,T,@_THIRD_MARK_U16_CNT ; |371| 
...
L1:    
;***	-----------------------g7:
;*** 369	-----------------------    LINE_SECOND((long)SECOND_MARK_U16_CNT*36+&Search);
;*** 369	-----------------------    goto g12;
	.dwpsn	"Motor.c",369,4
        MOVW      DP,#_SECOND_MARK_U16_CNT
        MOV       T,#36                 ; |369| 
        MPYXU     ACC,T,@_SECOND_MARK_U16_CNT ; |369| 
...
L4:    
	...
	.dwattr DW$71, DW_AT_end_line(0x17d)
...
DW$72	.dwtag  DW_TAG_subprogram, DW_AT_name("MOVE_TO_END"), DW_AT_symbol_name("_MOVE_TO_END")
	...
	.dwattr DW$72, DW_AT_begin_line(0x8d)
...
L7:    
;***	-----------------------g7:
;*** 164	-----------------------    RMotor.DecelAccel_IQ14 = _IQ14div(RMotor.DecelAccel_IQ14, 163840000L);
;*** 165	-----------------------    LMotor.DecelAccel_IQ14 = _IQ14div(LMotor.DecelAccel_IQ14, 163840000L);
;*** 167	-----------------------    RMotor.DecelFlag_U16 = LMotor.DecelFlag_U16 = 1u;
;*** 169	-----------------------    *(&CpuTimer2Regs+4L) &= 0xffefu;
;***  	-----------------------    *(&EPwm3Regs+25L) |= 0x8u;
;*** 170	-----------------------    *(&EPwm1Regs+25L) |= 0x8u;
;*** 170	-----------------------    return;
	.dwpsn	"Motor.c",164,2
        MOV       PH,#2500
        MOV       PL,#0
        MOVW      DP,#_RMotor+34
        MOVL      *-SP[2],P             ; |164| 
        MOVL      ACC,@_RMotor+34       ; |164| 
        LCR       #__IQ14div            ; |164| 
        ; call occurs [#__IQ14div] ; |164| 
        MOVW      DP,#_RMotor+34
        MOVL      @_RMotor+34,ACC       ; |164| 
	.dwpsn	"Motor.c",165,2
        MOV       PH,#2500
        MOV       PL,#0
        MOVW      DP,#_LMotor+34
        MOVL      *-SP[2],P             ; |165| 
        MOVL      ACC,@_LMotor+34       ; |165| 
        LCR       #__IQ14div            ; |165| 
        ; call occurs [#__IQ14div] ; |165| 
        MOVW      DP,#_LMotor+34
        MOVL      @_LMotor+34,ACC       ; |165| 
	.dwpsn	"Motor.c",167,2
        MOVB      AL,#1                 ; |167| 
        MOV       @_LMotor+20,AL        ; |167| 
        MOVW      DP,#_RMotor+20
        MOV       @_RMotor+20,AL        ; |167| 
	.dwpsn	"Motor.c",169,2
        MOVW      DP,#_CpuTimer2Regs+4
	...
	.dwattr DW$72, DW_AT_end_line(0xab)
...
DW$75	.dwtag  DW_TAG_subprogram, DW_AT_name("SHUTDOWN"), DW_AT_symbol_name("_SHUTDOWN")
	...
	.dwattr DW$75, DW_AT_begin_line(0x17f)
...
;***  	-----------------------    goto g8;
	...
	.dwpsn	"Motor.c",394,3
        MOVW      DP,#_SenAdc+84
        MOVB      ACC,#0
        MOVL      @_SenAdc+84,ACC       ; |394| 
        BF        L10,UNC
        ; branch occurs
L9:    
DW$L$_SHUTDOWN$5$B:
;***	-----------------------g6:
;*** 426	-----------------------    if ( LINE_OUT_U16 >= 777u ) goto g9;
	.dwpsn	"Motor.c",426,8
        MOVW      DP,#_LINE_OUT_U16
        CMP       @_LINE_OUT_U16,#777   ; |426| 
        BF        L10,HIS               ; |426| 
        ; branchcc occurs ; |426| 
DW$L$_SHUTDOWN$5$E:
DW$L$_SHUTDOWN$6$B:
;*** 427	-----------------------    POSITION_COMPUTE(&SenAdc, &POSITION_WEIGHT_I32, &SENSOR_STATE_U16_CNT, &SENSOR_ENABLE);
;***	-----------------------g8:
;***  	-----------------------    #pragma LOOP_FLAGS(4352u)
	.dwpsn	"Motor.c",427,4
        MOVL      XAR4,#_SENSOR_STATE_U16_CNT ; |427| 
        MOVL      *-SP[2],XAR4          ; |427| 
        MOVL      XAR5,#_POSITION_WEIGHT_I32 ; |427| 
        MOVL      XAR4,#_SENSOR_ENABLE  ; |427| 
        MOVL      *-SP[4],XAR4          ; |427| 
        MOVL      XAR4,#_SenAdc         ; |427| 
...
;***  	-----------------------    *(&EPwm3Regs+25L) &= 0xfff7u;
;*** 406	-----------------------    *(&EPwm1Regs+25L) &= 0xfff7u;
;*** 408	-----------------------    *&Flag &= 0xfffdu;
;*** 409	-----------------------    EPwm3Regs.CMPA.half.CMPA = 0u;
;*** 409	-----------------------    EPwm1Regs.CMPA.half.CMPA = 0u;
;*** 410	-----------------------    STOP_TIME_INDEX_U32 = 0uL;
;***  	-----------------------    #pragma LOOP_FLAGS(4352u)
	.dwpsn	"Motor.c",403,4
        MOVW      DP,#_Flag
	...
	.dwpsn	"Motor.c",406,4
        MOVW      DP,#_EPwm1Regs+25
        AND       @_EPwm1Regs+25,#0xfff7 ; |406| 
	.dwpsn	"Motor.c",408,4
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfffd        ; |408| 
	.dwpsn	"Motor.c",409,4
        MOVW      DP,#_EPwm3Regs+9
        MOV       @_EPwm3Regs+9,#0      ; |409| 
        MOVW      DP,#_EPwm1Regs+9
        MOV       @_EPwm1Regs+9,#0      ; |409| 
	.dwpsn	"Motor.c",410,4
        MOVB      ACC,#0
        MOVW      DP,#_STOP_TIME_INDEX_U32
        MOVL      @_STOP_TIME_INDEX_U32,ACC ; |410| 
L11:    
DW$L$_SHUTDOWN$10$B:
;***	-----------------------g12:
;*** 412	-----------------------    if ( LINE_OUT_U16 >= 777u ) goto g14;
	.dwpsn	"Motor.c",412,10
        MOVW      DP,#_LINE_OUT_U16
...
DW$L$_SHUTDOWN$10$E:
DW$L$_SHUTDOWN$11$B:
;*** 412	-----------------------    if ( STOP_TIME_INDEX_U32 < 1000uL ) goto g12;
        MOV       ACC,#1000             ; |412| 
        MOVW      DP,#_STOP_TIME_INDEX_U32
        CMPL      ACC,@_STOP_TIME_INDEX_U32 ; |412| 
        BF        L11,HI                ; |412| 
        ; branchcc occurs ; |412| 
DW$L$_SHUTDOWN$11$E:
L12:    
;***	-----------------------g14:
;*** 415	-----------------------    *(&CpuTimer2Regs+4L) |= 0x10u;
;*** 416	-----------------------    *(&CpuTimer0Regs+4L) |= 0x10u;
;*** 418	-----------------------    C$1 = &GpioDataRegs;
;*** 418	-----------------------    (*C$1).GPACLEAR.all = 68uL;
;*** 420	-----------------------    *((volatile struct _GPBDAT_BITS *)C$1+12L) |= 4u;
;*** 421	-----------------------    *(&GpioDataRegs+12L) |= 2u;
;*** 422	-----------------------    *(&GpioDataRegs+12L) |= 1u;
;*** 424	-----------------------    return;
	.dwpsn	"Motor.c",415,4
        MOVW      DP,#_CpuTimer2Regs+4
        OR        @_CpuTimer2Regs+4,#0x0010 ; |415| 
	.dwpsn	"Motor.c",416,4
        MOVW      DP,#_CpuTimer0Regs+4
        OR        @_CpuTimer0Regs+4,#0x0010 ; |416| 
	.dwpsn	"Motor.c",418,4
        MOVB      ACC,#68
        MOVL      XAR4,#_GpioDataRegs   ; |418| 
        MOVL      *+XAR4[4],ACC         ; |418| 
	.dwpsn	"Motor.c",420,4
        MOVB      ACC,#12
        ADDL      ACC,XAR4
	...
	.dwpsn	"Motor.c",421,4
        ...
        OR        @_GpioDataRegs+12,#0x0002 ; |421| 
	.dwpsn	"Motor.c",422,4
        OR        @_GpioDataRegs+12,#0x0001 ; |422| 
	.dwpsn	"Motor.c",424,4
	.dwpsn	"Motor.c",429,1
        SUBB      SP,#4
	.dwcfa	0x1d, -2
...
DW$77	.dwtag  DW_TAG_loop
	.dwattr DW$77, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L11:1:1692104480")
	.dwattr DW$77, DW_AT_begin_file("Motor.c")
	.dwattr DW$77, DW_AT_begin_line(0x19c)
	.dwattr DW$77, DW_AT_end_line(0x19c)
...
DW$80	.dwtag  DW_TAG_loop
	.dwattr DW$80, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L10:1:1692104480")
	.dwattr DW$80, DW_AT_begin_file("Motor.c")
	.dwattr DW$80, DW_AT_begin_line(0x191)
	.dwattr DW$80, DW_AT_end_line(0x1ab)
...
DW$84	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$75, DW_AT_end_line(0x1ad)
...
DW$85	.dwtag  DW_TAG_subprogram, DW_AT_name("RMOTOR_ISR"), DW_AT_symbol_name("_RMOTOR_ISR")
	...
	.dwattr DW$85, DW_AT_begin_line(0xbc)
...
;***	-----------------------g13:
;*** 82	-----------------------    K$13 = &RMotor;  // [17]
;*** 82	-----------------------    (*K$13).PwmTBPRDdiv10000_IQ17 = __IQmpy(RMotor.PrdNextTranSecon_IQ17, RMotor.TargetHandle_IQ17, 17);  // [17]
;*** 84	-----------------------    if ( (*K$13).PwmTBPRDdiv10000_IQ17 < 233006L ) goto g16;  // [17]
	.dwpsn	"Motor.c",82,2
        SPM       #0
	...
	.dwpsn	"Motor.c",84,2
        ...
        BF        L18,GT                ; |84| 
        ; branchcc occurs ; |84| 
;*** 85	-----------------------    if ( (*K$13).PwmTBPRDdiv10000_IQ17 <= 109949488L ) goto g17;  // [17]
	.dwpsn	"Motor.c",85,7
        MOV       AL,#45616
        MOV       AH,#1677
        ...
        BF        L19,GEQ               ; |85| 
        ; branchcc occurs ; |85| 
;*** 85	-----------------------    (*K$13).PwmTBPRDdiv10000_IQ17 = 109949488L;  // [17]
;*** 85	-----------------------    goto g17;  // [17]
	.dwpsn	"Motor.c",85,71
...
L18:    
;***	-----------------------g16:
;*** 84	-----------------------    RMotor.PwmTBPRDdiv10000_IQ17 = 233006L;  // [17]
	.dwpsn	"Motor.c",84,68
        MOVL      @_RMotor+22,XAR4      ; |84| 
L19:    
;***	-----------------------g17:
;*** 87	-----------------------    K$13 = &RMotor;  // [17]
;*** 87	-----------------------    (*K$13).RolEachStep_IQ17 = _IQ17div(526041L, RMotor.PwmTBPRDdiv10000_IQ17);  // [17]
;*** 89	-----------------------    C$3 = 233006L<<clk;  // [17]
;*** 89	-----------------------    if ( (*K$13).PwmTBPRDdiv10000_IQ17 >= C$3 ) goto g22;  // [17]
	.dwpsn	"Motor.c",87,2
	...
	.dwpsn	"Motor.c",89,2
        ...
        BF        L21,LEQ               ; |89| 
        ; branchcc occurs ; |89| 
;*** 90	-----------------------    if ( (*K$13).PwmTBPRDdiv10000_IQ17 >= C$3 ) goto g22;  // [17]
;***  	-----------------------    #pragma LOOP_FLAGS(4352u)
	.dwpsn	"Motor.c",90,3
...
;*** 92	-----------------------    if ( RMotor.PwmTBPRDdiv10000_IQ17 < 233006L<<(--clk) ) goto g20;  // [17]
	.dwpsn	"Motor.c",92,17
        SUBB      XAR1,#1               ; |92| 
        MOVL      ACC,XAR4              ; |92| 
        MOVW      DP,#_RMotor+22
...
;***	-----------------------g22:
;*** 95	-----------------------    K$13 = &RMotor;  // [17]
;*** 95	-----------------------    C$2 = 858980L<<clk;  // [17]
;*** 95	-----------------------    if ( (*K$13).PwmTBPRDdiv10000_IQ17 <= C$2 ) goto g27;  // [17]
	.dwpsn	"Motor.c",95,2
        MOVL      XAR4,#858980          ; |95| 
        ...
        BF        L23,GEQ               ; |95| 
        ; branchcc occurs ; |95| 
;*** 96	-----------------------    if ( (*K$13).PwmTBPRDdiv10000_IQ17 <= C$2 ) goto g27;  // [17]
;***  	-----------------------    #pragma LOOP_FLAGS(4352u)
	.dwpsn	"Motor.c",96,3
...
;*** 98	-----------------------    if ( RMotor.PwmTBPRDdiv10000_IQ17 > 858980L<<(++clk) ) goto g25;  // [17]
	.dwpsn	"Motor.c",98,37
        ADDB      XAR1,#1               ; |98| 
        MOVL      ACC,XAR4              ; |98| 
        MOVW      DP,#_RMotor+22
...
;***	-----------------------g27:
;*** 101	-----------------------    K$13 = &RMotor;  // [17]
;*** 101	-----------------------    (*K$13).PrdNext_IQ14 = __IQxmpy(81920000L>>clk, RMotor.PwmTBPRDdiv10000_IQ17, 16);  // [17]
;*** 104	-----------------------    ((*K$13).TurnMarkCheckDistance_IQ17 > 2146959360L) ? (S$4 = 0L) : (S$4 = 105208L);  // [17]
	.dwpsn	"Motor.c",101,2
        MOV       ACC,#2500 << 15
        MOVW      DP,#_RMotor+22
        MOVB      XAR0,#24              ; |101| 
...
L25:    
;*** 104	-----------------------    K$13 = &RMotor;  // [17]
;*** 104	-----------------------    (*K$13).TurnMarkCheckDistance_IQ17 += S$4;  // [17]
;*** 105	-----------------------    ((*K$13).CrossCheckDistance_IQ15 > 1073479680L) ? (S$3 = 0L) : (S$3 = 26302L);  // [17]
        MOV       PH,#0
        MOV       PL,#8
        ADDUL     P,XAR5
        MOVL      XAR4,P                ; |104| 
...
L27:    
;*** 105	-----------------------    K$13 = &RMotor;  // [17]
;*** 105	-----------------------    (*K$13).CrossCheckDistance_IQ15 += S$3;  // [17]
;*** 106	-----------------------    ((*K$13).GoneDistance_IQ15 > 536739840L) ? (S$2 = 0L) : (S$2 = 26302L);  // [17]
...
L29:    
;*** 106	-----------------------    C$1 = &RMotor;  // [17]
;*** 106	-----------------------    (*C$1).GoneDistance_IQ15 += S$2;  // [17]
;*** 108	-----------------------    K$13 = C$1;  // [17]
;*** 108	-----------------------    (*K$13).ErrorDistance_IQ17 = RMotor.UserDistance_IQ17-RMotor.GoneDistance_IQ15*4L;  // [17]
;*** 109	-----------------------    ((*K$13).ErrorDistance_IQ17 < 0L) ? (S$1 = 0L) : (S$1 = (*K$13).ErrorDistance_IQ17);  // [17]
...
L31:    
;*** 109	-----------------------    K$13 = &RMotor;  // [17]
;*** 109	-----------------------    (*K$13).ErrorDistance_IQ17 = S$1;  // [17]
;*** 111	-----------------------    *&EPwm1Regs = *&EPwm1Regs&0xe3ffu|(clk&7u)<<10;  // [17]
;*** 112	-----------------------    EPwm1Regs.TBPRD = (*K$13).PrdNext_IQ14>>14;  // [17]
;*** 113	-----------------------    EPwm1Regs.CMPA.half.CMPA = EPwm1Regs.TBPRD>>1;  // [17]
;***	-----------------------g28:
;***  	-----------------------    return;
...
DW$103	.dwtag  DW_TAG_loop
	.dwattr DW$103, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L22:1:1692104480")
...
DW$106	.dwtag  DW_TAG_loop
	.dwattr DW$106, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L20:1:1692104480")
...
DW$108	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$85, DW_AT_end_line(0xc9)
...
DW$122	.dwtag  DW_TAG_subprogram, DW_AT_name("LMOTOR_ISR"), DW_AT_symbol_name("_LMOTOR_ISR")
	...
	.dwattr DW$122, DW_AT_begin_line(0xad)
...
;***************************************************************
_LMOTOR_ISR:
;*** 175	-----------------------    PieCtrlRegs.PIEACK.all = 4u;
;*** 177	-----------------------    IER &= 5u;
;*** 178	-----------------------    asm(" clrc INTM");
;*** 180	-----------------------    *(&EPwm3Regs+28L) |= 1u;
;*** 182	-----------------------    if ( !(*&Flag&2u) ) goto g28;
        ASP
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
;***	-----------------------g13:
;*** 82	-----------------------    K$13 = &LMotor;  // [17]
;*** 82	-----------------------    (*K$13).PwmTBPRDdiv10000_IQ17 = __IQmpy(LMotor.PrdNextTranSecon_IQ17, LMotor.TargetHandle_IQ17, 17);  // [17]
;*** 84	-----------------------    if ( (*K$13).PwmTBPRDdiv10000_IQ17 < 233006L ) goto g16;  // [17]
	.dwpsn	"Motor.c",82,2
        SPM       #0
...
L38:    
;***	-----------------------g16:
;*** 84	-----------------------    LMotor.PwmTBPRDdiv10000_IQ17 = 233006L;  // [17]
	.dwpsn	"Motor.c",84,68
        MOVL      @_LMotor+22,XAR4      ; |84| 
L39:    
;***	-----------------------g17:
;*** 87	-----------------------    K$13 = &LMotor;  // [17]
;*** 87	-----------------------    (*K$13).RolEachStep_IQ17 = _IQ17div(526041L, LMotor.PwmTBPRDdiv10000_IQ17);  // [17]
;*** 89	-----------------------    C$3 = 233006L<<clk;  // [17]
;*** 89	-----------------------    if ( (*K$13).PwmTBPRDdiv10000_IQ17 >= C$3 ) goto g22;  // [17]
	.dwpsn	"Motor.c",87,2
...
;*** 92	-----------------------    if ( LMotor.PwmTBPRDdiv10000_IQ17 < 233006L<<(--clk) ) goto g20;  // [17]
	.dwpsn	"Motor.c",92,17
        SUBB      XAR1,#1               ; |92| 
        MOVL      ACC,XAR4              ; |92| 
        MOVW      DP,#_LMotor+22
...
;*** 98	-----------------------    if ( LMotor.PwmTBPRDdiv10000_IQ17 > 858980L<<(++clk) ) goto g25;  // [17]
	.dwpsn	"Motor.c",98,37
        ADDB      XAR1,#1               ; |98| 
        MOVL      ACC,XAR4              ; |98| 
        MOVW      DP,#_LMotor+22
...
;***	-----------------------g27:
;*** 101	-----------------------    K$13 = &LMotor;  // [17]
;*** 101	-----------------------    (*K$13).PrdNext_IQ14 = __IQxmpy(81920000L>>clk, LMotor.PwmTBPRDdiv10000_IQ17, 16);  // [17]
;*** 104	-----------------------    ((*K$13).TurnMarkCheckDistance_IQ17 > 2146959360L) ? (S$4 = 0L) : (S$4 = 105208L);  // [17]
	.dwpsn	"Motor.c",101,2
        MOV       ACC,#2500 << 15
        MOVW      DP,#_LMotor+22
...
;*** 106	-----------------------    (*C$1).GoneDistance_IQ15 += S$2;  // [17]
;*** 108	-----------------------    K$13 = C$1;  // [17]
;*** 108	-----------------------    (*K$13).ErrorDistance_IQ17 = LMotor.UserDistance_IQ17-LMotor.GoneDistance_IQ15*4L;  // [17]
;*** 109	-----------------------    ((*K$13).ErrorDistance_IQ17 < 0L) ? (S$1 = 0L) : (S$1 = (*K$13).ErrorDistance_IQ17);  // [17]
...
;*** 109	-----------------------    K$13 = &LMotor;  // [17]
;*** 109	-----------------------    (*K$13).ErrorDistance_IQ17 = S$1;  // [17]
;*** 111	-----------------------    *&EPwm3Regs = *&EPwm3Regs&0xe3ffu|(clk&7u)<<10;  // [17]
;*** 112	-----------------------    EPwm3Regs.TBPRD = (*K$13).PrdNext_IQ14>>14;  // [17]
;*** 113	-----------------------    EPwm3Regs.CMPA.half.CMPA = EPwm3Regs.TBPRD>>1;  // [17]
;***	-----------------------g28:
;***  	-----------------------    return;
...
DW$140	.dwtag  DW_TAG_loop
	.dwattr DW$140, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L42:1:1692104480")
...
DW$143	.dwtag  DW_TAG_loop
	.dwattr DW$143, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L40:1:1692104480")
...
DW$145	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$122, DW_AT_end_line(0xba)
...
;***************************************************************
_LINE_OUT_STOP:
;*** 345	-----------------------    if ( LINE_OUT_U16 >= 50u ) goto g3;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        ADDB      SP,#2
...
L54:    
	...
	.dwattr DW$146, DW_AT_end_line(0x166)
...
DW$151	.dwtag  DW_TAG_subprogram, DW_AT_name("END_STOP"), DW_AT_symbol_name("_END_STOP")
	...
	.dwattr DW$151, DW_AT_begin_line(0x122)
...
DW$153	.dwtag  DW_TAG_loop
	.dwattr DW$153, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L58:1:1692104480")
	.dwattr DW$153, DW_AT_begin_file("Motor.c")
	.dwattr DW$153, DW_AT_begin_line(0x12b)
	.dwattr DW$153, DW_AT_end_line(0x13a)
...
DW$157	.dwtag  DW_TAG_loop
	.dwattr DW$157, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L57:1:1692104480")
	.dwattr DW$157, DW_AT_begin_file("Motor.c")
	.dwattr DW$157, DW_AT_begin_line(0x13d)
	.dwattr DW$157, DW_AT_end_line(0x142)
...
DW$160	.dwtag  DW_TAG_loop
	.dwattr DW$160, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\Motor.asm:L56:1:1692104480")
	.dwattr DW$160, DW_AT_begin_file("Motor.c")
	.dwattr DW$160, DW_AT_begin_line(0x145)
	.dwattr DW$160, DW_AT_end_line(0x14a)
...
DW$162	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$151, DW_AT_end_line(0x155)
...
DW$163	.dwtag  DW_TAG_subprogram, DW_AT_name("CONTROL_ISR"), DW_AT_symbol_name("_CONTROL_ISR")
	...
	.dwattr DW$163, DW_AT_begin_line(0xcb)
...
;*** 208	-----------------------    IER &= 0x13fu;
;*** 209	-----------------------    asm(" clrc INTM");
;*** 212	-----------------------    if ( !THIRD_MARK_U16_CNT ) goto g12;
        ASP
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$168	.dwtag  DW_TAG_variable, DW_AT_name("cnt"), DW_AT_symbol_name("_cnt")
	.dwattr DW$168, DW_AT_type(*DW$T$152)
...
DW$169	.dwtag  DW_TAG_variable, DW_AT_name("gone_dist"), DW_AT_symbol_name("_gone_dist")
 ...
 clrc INTM
	.dwpsn	"Motor.c",212,2
        ...
        BF        L68,EQ                ; |212| 
        ; branchcc occurs ; |212| 
;*** 214	-----------------------    cnt = (int)THIRD_MARK_U16_CNT-1;
;*** 216	-----------------------    K$10 = &Search[0];
;*** 216	-----------------------    S$2 = &K$10[(long)cnt];
;*** 216	-----------------------    if ( *((volatile unsigned *)S$2+34)&1u ) goto g6;
	.dwpsn	"Motor.c",214,3
        ADDB      AL,#-1
        MOV       *-SP[3],AL            ; |214| 
	.dwpsn	"Motor.c",216,3
        MOV       T,*-SP[3]             ; |216| 
        MOVL      XAR3,#_Search         ; |216| 
        MPYB      P,T,#36               ; |216| 
        MOVL      ACC,XAR3              ; |216| 
        ADDL      ACC,P
        MOVL      XAR4,ACC              ; |216| 
        ...
        BF        L64,TC                ; |216| 
        ; branchcc occurs ; |216| 
;*** 221	-----------------------    S$1 = &K$10[(long)cnt];
;*** 221	-----------------------    if ( !(*((volatile unsigned *)S$1+34)&2u) ) goto g5;
	.dwpsn	"Motor.c",221,8
        MOV       T,*-SP[3]             ; |221| 
        MOVL      ACC,XAR3              ; |221| 
        MPYB      P,T,#36               ; |221| 
        ...
        BF        L63,NTC               ; |221| 
        ; branchcc occurs ; |221| 
;*** 223	-----------------------    gone_dist = LMotor.GoneDistance_IQ15+RMotor.GoneDistance_IQ15>>1;
;*** 224	-----------------------    if ( gone_dist > ((K$10[(long)cnt]).Distance_U32<<15)-8192000L ) goto g6;
	.dwpsn	"Motor.c",223,4
        MOVW      DP,#_RMotor+10
        MOVL      ACC,@_RMotor+10       ; |223| 
        SETC      SXM
        MOVW      DP,#_LMotor+10
        ADDL      ACC,@_LMotor+10       ; |223| 
        SFR       ACC,1                 ; |223| 
        MOVL      *-SP[6],ACC           ; |223| 
	.dwpsn	"Motor.c",224,4
        MOVL      XAR4,XAR3             ; |224| 
...
L63:    
;***	-----------------------g5:
;*** 233	-----------------------    xCONTROL(0u, &HanPID, __IQmpy(13L, U_RATIO_I32<<17, 17), (K$10[(long)cnt]).Kp_UpDown_IQ17);
;*** 233	-----------------------    goto g7;
	.dwpsn	"Motor.c",233,4
        MOV       T,*-SP[3]             ; |233| 
        MOVL      XAR4,XAR3             ; |233| 
        ...
        MOVL      *-SP[2],ACC           ; |233| 
        MOVL      ACC,@_U_RATIO_I32     ; |233| 
        LSLL      ACC,T                 ; |233| 
        MOVL      XT,XAR6               ; |233| 
        IMPYL     P,XT,ACC              ; |233| 
        QMPYL     ACC,XT,ACC            ; |233| 
        MOVL      XAR4,#_HanPID         ; |233| 
        LSL64     ACC:P,#15             ; |233| 
        LCR       #_xCONTROL            ; |233| 
        ; call occurs [#_xCONTROL] ; |233| 
        BF        L65,UNC               ; |233| 
        ; branch occurs ; |233| 
L64:    
;***	-----------------------g6:
;*** 218	-----------------------    *(&GpioDataRegs+10L) |= 2u;
;*** 218	-----------------------    *(&GpioDataRegs+10L) |= 4u;
;*** 219	-----------------------    xCONTROL(1u, &HanPID, __IQmpy(13L, D_RATIO_I32<<17, 17), (K$10[(long)cnt]).Kp_UpDown_IQ17);
	.dwpsn	"Motor.c",218,4
        MOVW      DP,#_GpioDataRegs+10
        OR        @_GpioDataRegs+10,#0x0002 ; |218| 
	.dwpsn	"Motor.c",218,15
        OR        @_GpioDataRegs+10,#0x0004 ; |218| 
	.dwpsn	"Motor.c",219,4
        MOVL      XAR4,XAR3             ; |219| 
        MOV       T,*-SP[3]             ; |219| 
        MPYB      ACC,T,#36             ; |219| 
        ...
        MOV       T,#17                 ; |219| 
        MOVL      *-SP[2],ACC           ; |219| 
        MOVL      ACC,@_D_RATIO_I32     ; |219| 
        MOVB      XAR5,#1               ; |219| 
        LSLL      ACC,T                 ; |219| 
        MOVL      XT,XAR6               ; |219| 
        IMPYL     P,XT,ACC              ; |219| 
        QMPYL     ACC,XT,ACC            ; |219| 
        MOVL      XAR4,#_HanPID         ; |219| 
        LSL64     ACC:P,#15             ; |219| 
        LCR       #_xCONTROL            ; |219| 
        ; call occurs [#_xCONTROL] ; |219| 
L65:    
;***	-----------------------g7:
;*** 235	-----------------------    if ( SenAdc.PositionShift_IQ10 < (K$10[(long)cnt]).TargetPosition_IQ10 ) goto g10;
	.dwpsn	"Motor.c",235,3
        MOVL      XAR4,XAR3             ; |235| 
        MOV       T,*-SP[3]             ; |235| 
        MPYB      ACC,T,#36             ; |235| 
        ...
        CMPL      ACC,@_SenAdc+86       ; |235| 
        BF        L66,GT                ; |235| 
        ; branchcc occurs ; |235| 
;*** 242	-----------------------    if ( SenAdc.PositionShift_IQ10 <= (K$10[(long)cnt]).TargetPosition_IQ10 ) goto g11;
	.dwpsn	"Motor.c",242,8
        MOVL      XAR4,XAR3             ; |242| 
        MOV       T,*-SP[3]             ; |242| 
        MPYB      ACC,T,#36             ; |242| 
        ...
        BF        L67,GEQ               ; |242| 
        ; branchcc occurs ; |242| 
;*** 244	-----------------------    SenAdc.PositionShift_IQ10 -= __IQmpy((K$10[(long)cnt]).PositionRatio_IQ10<<7, LMotor.RolEachStep_IQ17+RMotor.RolEachStep_IQ17>>1, 17)>>7;
;*** 246	-----------------------    if ( SenAdc.PositionShift_IQ10 < (K$10[(long)cnt]).TargetPosition_IQ10 ) goto g11;
	.dwpsn	"Motor.c",244,4
        MOVL      XAR4,XAR3             ; |244| 
        MOV       T,*-SP[3]             ; |244| 
        MPYB      ACC,T,#36             ; |244| 
        ...
        MOVW      DP,#_RMotor+28
        SETC      SXM
        MOVL      ACC,*+XAR4[AR0]       ; |244| 
        LSL       ACC,7                 ; |244| 
        MOVL      XT,ACC                ; |244| 
        MOVL      ACC,@_RMotor+28       ; |244| 
        MOVW      DP,#_LMotor+28
        ADDL      ACC,@_LMotor+28       ; |244| 
        SFR       ACC,1                 ; |244| 
        IMPYL     P,XT,ACC              ; |244| 
...
L66:    
;***	-----------------------g10:
;*** 237	-----------------------    SenAdc.PositionShift_IQ10 += __IQmpy((K$10[(long)cnt]).PositionRatio_IQ10<<7, LMotor.RolEachStep_IQ17+RMotor.RolEachStep_IQ17>>1, 17)>>7;
;*** 239	-----------------------    if ( SenAdc.PositionShift_IQ10 <= (K$10[(long)cnt]).TargetPosition_IQ10 ) goto g12;
	.dwpsn	"Motor.c",237,4
        MOVL      XAR4,XAR3             ; |237| 
        MOV       T,*-SP[3]             ; |237| 
        MPYB      ACC,T,#36             ; |237| 
        ...
        LSL       ACC,7                 ; |237| 
        MOVL      XT,ACC                ; |237| 
        MOVL      ACC,@_RMotor+28       ; |237| 
        MOVW      DP,#_LMotor+28
        ADDL      ACC,@_LMotor+28       ; |237| 
        SFR       ACC,1                 ; |237| 
        IMPYL     P,XT,ACC              ; |237| 
...
L67:    
;***	-----------------------g11:
;*** 240	-----------------------    SenAdc.PositionShift_IQ10 = (K$10[(long)cnt]).TargetPosition_IQ10;
	.dwpsn	"Motor.c",240,5
        MOV       T,*-SP[3]             ; |240| 
        MPYB      ACC,T,#36             ; |240| 
        ADDL      XAR3,ACC
        MOVL      ACC,*+XAR3[AR0]       ; |240| 
        MOVL      @_SenAdc+86,ACC       ; |240| 
L68:    
;***	-----------------------g12:
;*** 253	-----------------------    HANDLE();
;*** 256	-----------------------    if ( !(*&Flag&2u) ) goto g20;
	.dwpsn	"Motor.c",253,2
        SPM       #0
        LCR       #_HANDLE              ; |253| 
        ; call occurs [#_HANDLE] ; |253| 
	.dwpsn	"Motor.c",256,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#1             ; |256| 
        BF        L73,NTC               ; |256| 
        ; branchcc occurs ; |256| 
;*** 256	-----------------------    if ( *&Flag&0x80u ) goto g15;
        TBIT      @_Flag,#7             ; |256| 
        BF        L69,TC                ; |256| 
        ; branchcc occurs ; |256| 
;*** 256	-----------------------    if ( !(*&Flag&0x100u) ) goto g20;
        TBIT      @_Flag,#8             ; |256| 
        BF        L73,NTC               ; |256| 
        ; branchcc occurs ; |256| 
L69:    
;***	-----------------------g15:
;*** 258	-----------------------    if ( P$3 = RMotor.DecelFlag_U16 != 0u ) goto g17;
	.dwpsn	"Motor.c",258,3
        MOVB      AL,#0
        MOVW      DP,#_RMotor+20
        MOV       AH,@_RMotor+20        ; |258| 
        BF        L70,EQ                ; |258| 
        ; branchcc occurs ; |258| 
        MOVB      AL,#1                 ; |258| 
L70:    
        ...
        BF        L71,NEQ               ; |258| 
        ; branchcc occurs ; |258| 
;*** 258	-----------------------    if ( !LMotor.DecelFlag_U16 ) goto g20;
        MOVW      DP,#_LMotor+20
        MOV       AL,@_LMotor+20        ; |258| 
        BF        L73,EQ                ; |258| 
        ; branchcc occurs ; |258| 
L71:    
;***	-----------------------g17:
;*** 260	-----------------------    if ( RMotor.DecelDistance_IQ17 > RMotor.ErrorDistance_IQ17 ) goto g19;
	.dwpsn	"Motor.c",260,4
        MOVW      DP,#_RMotor+16
        MOVL      ACC,@_RMotor+16       ; |260| 
        CMPL      ACC,@_RMotor+14       ; |260| 
        BF        L72,LT                ; |260| 
        ; branchcc occurs ; |260| 
;*** 267	-----------------------    if ( LMotor.DecelDistance_IQ17 <= LMotor.ErrorDistance_IQ17 ) goto g20;
	.dwpsn	"Motor.c",267,9
        MOVW      DP,#_LMotor+16
        MOVL      ACC,@_LMotor+16       ; |267| 
        CMPL      ACC,@_LMotor+14       ; |267| 
        BF        L73,GEQ               ; |267| 
        ; branchcc occurs ; |267| 
L72:    
;***	-----------------------g19:
;*** 262	-----------------------    RMotor.TargetVel_IQ17 = RMotor.DecelVelocity_IQ17;
;*** 263	-----------------------    LMotor.TargetVel_IQ17 = LMotor.DecelVelocity_IQ17;
;*** 265	-----------------------    LMotor.DecelFlag_U16 = 0u;
;*** 265	-----------------------    RMotor.DecelFlag_U16 = 0u;
	.dwpsn	"Motor.c",262,5
        MOVW      DP,#_RMotor+6
        MOVL      ACC,@_RMotor+6        ; |262| 
        MOVL      @_RMotor,ACC          ; |262| 
	.dwpsn	"Motor.c",263,5
        MOVW      DP,#_LMotor+6
        MOVL      ACC,@_LMotor+6        ; |263| 
        MOVL      @_LMotor,ACC          ; |263| 
	.dwpsn	"Motor.c",265,5
        MOV       @_LMotor+20,#0        ; |265| 
        MOVW      DP,#_RMotor+20
        MOV       @_RMotor+20,#0        ; |265| 
L73:    
;***	-----------------------g20:
;*** 277	-----------------------    if ( !(*&Flag&1u) ) goto g22;
	.dwpsn	"Motor.c",277,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#0             ; |277| 
        BF        L74,NTC               ; |277| 
...
;*** 278	-----------------------    ++TIME_INDEX_U32;
	.dwpsn	"Motor.c",278,3
        MOVB      ACC,#1
        MOVW      DP,#_TIME_INDEX_U32
        ADDL      @_TIME_INDEX_U32,ACC  ; |278| 
L74:    
;***	-----------------------g22:
;*** 279	-----------------------    if ( !(*&Flag&0x20u) ) goto g24;
	.dwpsn	"Motor.c",279,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#5             ; |279| 
        BF        L75,NTC               ; |279| 
        ; branchcc occurs ; |279| 
;*** 280	-----------------------    ++STOP_TIME_INDEX_U32;
	.dwpsn	"Motor.c",280,3
        MOVB      ACC,#1
        MOVW      DP,#_STOP_TIME_INDEX_U32
        ADDL      @_STOP_TIME_INDEX_U32,ACC ; |280| 
L75:    
;***	-----------------------g24:
;*** 282	-----------------------    if ( *&Flag&0x400u ) goto g26;
	.dwpsn	"Motor.c",282,2
        MOVW      DP,#_Flag
        TBIT      @_Flag,#10            ; |282| 
        BF        L76,TC                ; |282| 
...
;*** 287	-----------------------    return;
	...
	.dwattr DW$163, DW_AT_end_line(0x120)
...
DW$T$152	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$152, DW_AT_type(*DW$196)
...
DW$T$157	.dwtag  DW_TAG_const_type
	.dwattr DW$T$157, DW_AT_type(*DW$200)
...
DW$T$158	.dwtag  DW_TAG_const_type
	.dwattr DW$T$158, DW_AT_type(*DW$201)
...
DW$T$159	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$159, DW_AT_type(*DW$202)
...
DW$209	.dwtag  DW_TAG_far_type
	.dwattr DW$209, DW_AT_type(*DW$T$26)
DW$T$168	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$168, DW_AT_type(*DW$209)
...
DW$211	.dwtag  DW_TAG_far_type
	.dwattr DW$211, DW_AT_type(*DW$T$142)
...
DW$T$144	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$144, DW_AT_type(*DW$212)
...
DW$213	.dwtag  DW_TAG_far_type
	.dwattr DW$213, DW_AT_type(*DW$T$85)
...
DW$233	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$233, DW_AT_name("TargetPosition_IQ10"), DW_AT_symbol_name("_TargetPosition_IQ10")
	.dwattr DW$233, DW_AT_data_member_location[DW_OP_plus_uconst 0x1e]
	.dwattr DW$233, DW_AT_accessibility(DW_ACCESS_public)
DW$234	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$234, DW_AT_name("PositionRatio_IQ10"), DW_AT_symbol_name("_PositionRatio_IQ10")
...
DW$237	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$30)
	.dwattr DW$237, DW_AT_name("BlindFlag_U16"), DW_AT_symbol_name("_BlindFlag_U16")
...
DW$247	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$45)
...
DW$250	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$47)
...
DW$251	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$49)
...
DW$252	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$51)
...
DW$253	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$53)
...
DW$256	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$55)
...
DW$259	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$59)
...
DW$263	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$67)
...
DW$265	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$71)
...
DW$266	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$73)
...
DW$267	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$75)
...
DW$268	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$77)
...
DW$271	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$82)
	.dwattr DW$271, DW_AT_name("GPADAT"), DW_AT_symbol_name("_GPADAT")
	.dwattr DW$271, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$271, DW_AT_accessibility(DW_ACCESS_public)
DW$272	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$82)
...
DW$276	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$84)
...
DW$281	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$89)
...
DW$282	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$91)
...
DW$285	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$95)
...
DW$286	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$98)
...
DW$312	.dwtag  DW_TAG_far_type
	.dwattr DW$312, DW_AT_type(*DW$T$106)
DW$T$207	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$207, DW_AT_type(*DW$312)
...
DW$314	.dwtag  DW_TAG_far_type
	.dwattr DW$314, DW_AT_type(*DW$T$21)
...
DW$315	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$315, DW_AT_name("Position_U16_CNT"), DW_AT_symbol_name("_Position_U16_CNT")
	.dwattr DW$315, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$315, DW_AT_accessibility(DW_ACCESS_public)
DW$316	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$316, DW_AT_name("Adc_U16"), DW_AT_symbol_name("_Adc_U16")
	.dwattr DW$316, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$316, DW_AT_accessibility(DW_ACCESS_public)
DW$317	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$317, DW_AT_name("Max_U16"), DW_AT_symbol_name("_Max_U16")
	.dwattr DW$317, DW_AT_data_member_location[DW_OP_plus_uconst 0x11]
	.dwattr DW$317, DW_AT_accessibility(DW_ACCESS_public)
DW$318	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$318, DW_AT_name("Min_U16"), DW_AT_symbol_name("_Min_U16")
	.dwattr DW$318, DW_AT_data_member_location[DW_OP_plus_uconst 0x21]
	.dwattr DW$318, DW_AT_accessibility(DW_ACCESS_public)
DW$319	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$319, DW_AT_name("Div127_U16"), DW_AT_symbol_name("_Div127_U16")
	.dwattr DW$319, DW_AT_data_member_location[DW_OP_plus_uconst 0x31]
	.dwattr DW$319, DW_AT_accessibility(DW_ACCESS_public)
DW$320	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$320, DW_AT_name("AdcValue_U16"), DW_AT_symbol_name("_AdcValue_U16")
	.dwattr DW$320, DW_AT_data_member_location[DW_OP_plus_uconst 0x41]
...
DW$321	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	...
	.dwattr DW$321, DW_AT_data_member_location[DW_OP_plus_uconst 0x52]
...
DW$322	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	...
	.dwattr DW$322, DW_AT_data_member_location[DW_OP_plus_uconst 0x54]
	.dwattr DW$322, DW_AT_accessibility(DW_ACCESS_public)
DW$323	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$21)
	.dwattr DW$323, DW_AT_name("PositionShift_IQ10"), DW_AT_symbol_name("_PositionShift_IQ10")
	.dwattr DW$323, DW_AT_data_member_location[DW_OP_plus_uconst 0x56]
...
DW$324	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	...
	.dwattr DW$324, DW_AT_data_member_location[DW_OP_plus_uconst 0x58]
...
DW$325	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$325, DW_AT_name("TurnmarkDistance_IQ17"), DW_AT_symbol_name("_TurnmarkDistance_IQ17")
	.dwattr DW$325, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$325, DW_AT_accessibility(DW_ACCESS_public)
DW$326	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$326, DW_AT_name("LimitDistance_IQ17"), DW_AT_symbol_name("_LimitDistance_IQ17")
	.dwattr DW$326, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$326, DW_AT_accessibility(DW_ACCESS_public)
DW$327	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$327, DW_AT_name("coef_IQ17"), DW_AT_symbol_name("_coef_IQ17")
	.dwattr DW$327, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$327, DW_AT_accessibility(DW_ACCESS_public)
DW$328	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$328, DW_AT_name("MarkEnable_U16"), DW_AT_symbol_name("_MarkEnable_U16")
	.dwattr DW$328, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$328, DW_AT_accessibility(DW_ACCESS_public)
DW$329	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$329, DW_AT_name("TurnFlag_U16"), DW_AT_symbol_name("_TurnFlag_U16")
...
DW$330	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$330, DW_AT_name("SingleFlag_U16"), DW_AT_symbol_name("_SingleFlag_U16")
...
DW$331	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$331, DW_AT_name("CrossMark_U16"), DW_AT_symbol_name("_CrossMark_U16")
...
DW$338	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$338, DW_AT_name("TargetVel_IQ17"), DW_AT_symbol_name("_TargetVel_IQ17")
	.dwattr DW$338, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$338, DW_AT_accessibility(DW_ACCESS_public)
DW$339	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$339, DW_AT_name("NextVelocity_IQ17"), DW_AT_symbol_name("_NextVelocity_IQ17")
	.dwattr DW$339, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$339, DW_AT_accessibility(DW_ACCESS_public)
DW$340	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$340, DW_AT_name("HandleVelo_IQ17"), DW_AT_symbol_name("_HandleVelo_IQ17")
	.dwattr DW$340, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$340, DW_AT_accessibility(DW_ACCESS_public)
DW$341	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$341, DW_AT_name("DecelVelocity_IQ17"), DW_AT_symbol_name("_DecelVelocity_IQ17")
...
DW$343	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$34)
...
DW$361	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$38)
...
DW$363	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$40)
...
DW$365	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$42)
...
DW$367	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$44)
...
DW$369	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$46)
...
DW$373	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$50)
...
DW$375	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$52)
...
DW$381	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$58)
...
DW$383	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$60)
...
DW$385	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$62)
...
DW$387	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$64)
...
DW$389	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$66)
...
DW$391	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$68)
...
DW$393	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$70)
...
DW$395	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$72)
...
DW$397	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$74)
...
DW$401	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$78)
...
DW$405	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$83)
...
DW$407	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$86)
...
DW$409	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$88)
...
DW$411	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$90)
...
DW$413	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$92)
...
DW$415	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$94)
...
DW$417	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$97)
...
DW$419	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$99)
...
DW$421	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$101)
...
DW$435	.dwtag  DW_TAG_subrange_type
	.dwattr DW$435, DW_AT_upper_bound(0x04)
	.dwendtag DW$T$32
...
DW$436	.dwtag  DW_TAG_subrange_type
	.dwattr DW$436, DW_AT_upper_bound(0x0f)
	.dwendtag DW$T$23
...
DW$437	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$437, DW_AT_name("CTRMODE"), DW_AT_symbol_name("_CTRMODE")
	.dwattr DW$437, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$437, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$437, DW_AT_accessibility(DW_ACCESS_public)
DW$438	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$438, DW_AT_name("PHSEN"), DW_AT_symbol_name("_PHSEN")
	.dwattr DW$438, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$438, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$438, DW_AT_accessibility(DW_ACCESS_public)
DW$439	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$439, DW_AT_name("PRDLD"), DW_AT_symbol_name("_PRDLD")
	.dwattr DW$439, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x01)
	.dwattr DW$439, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$439, DW_AT_accessibility(DW_ACCESS_public)
DW$440	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$440, DW_AT_name("SYNCOSEL"), DW_AT_symbol_name("_SYNCOSEL")
	.dwattr DW$440, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
	.dwattr DW$440, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$440, DW_AT_accessibility(DW_ACCESS_public)
DW$441	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$441, DW_AT_name("SWFSYNC"), DW_AT_symbol_name("_SWFSYNC")
	.dwattr DW$441, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x01)
	.dwattr DW$441, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$441, DW_AT_accessibility(DW_ACCESS_public)
DW$442	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$442, DW_AT_name("HSPCLKDIV"), DW_AT_symbol_name("_HSPCLKDIV")
	.dwattr DW$442, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x03)
	.dwattr DW$442, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$442, DW_AT_accessibility(DW_ACCESS_public)
DW$443	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$443, DW_AT_name("CLKDIV"), DW_AT_symbol_name("_CLKDIV")
	.dwattr DW$443, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x03)
	.dwattr DW$443, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$443, DW_AT_accessibility(DW_ACCESS_public)
DW$444	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$444, DW_AT_name("PHSDIR"), DW_AT_symbol_name("_PHSDIR")
	.dwattr DW$444, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x01)
	.dwattr DW$444, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$444, DW_AT_accessibility(DW_ACCESS_public)
DW$445	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$445, DW_AT_name("FREE_SOFT"), DW_AT_symbol_name("_FREE_SOFT")
...
DW$450	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$450, DW_AT_name("TBPHSHR"), DW_AT_symbol_name("_TBPHSHR")
	.dwattr DW$450, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$450, DW_AT_accessibility(DW_ACCESS_public)
DW$451	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$451, DW_AT_name("TBPHS"), DW_AT_symbol_name("_TBPHS")
...
DW$452	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$452, DW_AT_name("LOADAMODE"), DW_AT_symbol_name("_LOADAMODE")
	.dwattr DW$452, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$452, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$452, DW_AT_accessibility(DW_ACCESS_public)
DW$453	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$453, DW_AT_name("LOADBMODE"), DW_AT_symbol_name("_LOADBMODE")
	.dwattr DW$453, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
	.dwattr DW$453, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$453, DW_AT_accessibility(DW_ACCESS_public)
DW$454	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$454, DW_AT_name("SHDWAMODE"), DW_AT_symbol_name("_SHDWAMODE")
...
DW$456	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$456, DW_AT_name("SHDWBMODE"), DW_AT_symbol_name("_SHDWBMODE")
...
DW$458	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$458, DW_AT_name("SHDWAFULL"), DW_AT_symbol_name("_SHDWAFULL")
	.dwattr DW$458, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
	.dwattr DW$458, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$458, DW_AT_accessibility(DW_ACCESS_public)
DW$459	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$459, DW_AT_name("SHDWBFULL"), DW_AT_symbol_name("_SHDWBFULL")
...
DW$460	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$460, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x06)
...
DW$461	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$461, DW_AT_name("CMPAHR"), DW_AT_symbol_name("_CMPAHR")
	.dwattr DW$461, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$461, DW_AT_accessibility(DW_ACCESS_public)
DW$462	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$462, DW_AT_name("CMPA"), DW_AT_symbol_name("_CMPA")
...
DW$470	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$470, DW_AT_name("ACTSFA"), DW_AT_symbol_name("_ACTSFA")
	.dwattr DW$470, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$470, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$470, DW_AT_accessibility(DW_ACCESS_public)
DW$471	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$471, DW_AT_name("OTSFA"), DW_AT_symbol_name("_OTSFA")
	.dwattr DW$471, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$471, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$471, DW_AT_accessibility(DW_ACCESS_public)
DW$472	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$472, DW_AT_name("ACTSFB"), DW_AT_symbol_name("_ACTSFB")
	.dwattr DW$472, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x02)
	.dwattr DW$472, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$472, DW_AT_accessibility(DW_ACCESS_public)
DW$473	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$473, DW_AT_name("OTSFB"), DW_AT_symbol_name("_OTSFB")
	.dwattr DW$473, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x01)
	.dwattr DW$473, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$473, DW_AT_accessibility(DW_ACCESS_public)
DW$474	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$474, DW_AT_name("RLDCSF"), DW_AT_symbol_name("_RLDCSF")
	.dwattr DW$474, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x02)
...
DW$476	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$476, DW_AT_name("CSFA"), DW_AT_symbol_name("_CSFA")
	.dwattr DW$476, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$476, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$476, DW_AT_accessibility(DW_ACCESS_public)
DW$477	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$477, DW_AT_name("CSFB"), DW_AT_symbol_name("_CSFB")
...
DW$479	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$479, DW_AT_name("OUT_MODE"), DW_AT_symbol_name("_OUT_MODE")
	.dwattr DW$479, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$479, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$479, DW_AT_accessibility(DW_ACCESS_public)
DW$480	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$480, DW_AT_name("POLSEL"), DW_AT_symbol_name("_POLSEL")
	.dwattr DW$480, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
	.dwattr DW$480, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$480, DW_AT_accessibility(DW_ACCESS_public)
DW$481	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$481, DW_AT_name("IN_MODE"), DW_AT_symbol_name("_IN_MODE")
...
DW$482	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$482, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0a)
...
DW$497	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$497, DW_AT_name("TZA"), DW_AT_symbol_name("_TZA")
	.dwattr DW$497, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$497, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$497, DW_AT_accessibility(DW_ACCESS_public)
DW$498	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$498, DW_AT_name("TZB"), DW_AT_symbol_name("_TZB")
...
DW$509	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$509, DW_AT_name("CBC"), DW_AT_symbol_name("_CBC")
	.dwattr DW$509, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x01)
	.dwattr DW$509, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$509, DW_AT_accessibility(DW_ACCESS_public)
DW$510	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$510, DW_AT_name("OST"), DW_AT_symbol_name("_OST")
...
DW$511	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$511, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0d)
...
DW$513	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$513, DW_AT_name("CBC"), DW_AT_symbol_name("_CBC")
	.dwattr DW$513, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x01)
	.dwattr DW$513, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$513, DW_AT_accessibility(DW_ACCESS_public)
DW$514	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$514, DW_AT_name("OST"), DW_AT_symbol_name("_OST")
...
DW$515	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$515, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0d)
...
DW$516	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$516, DW_AT_name("INTSEL"), DW_AT_symbol_name("_INTSEL")
	.dwattr DW$516, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x03)
	.dwattr DW$516, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$516, DW_AT_accessibility(DW_ACCESS_public)
DW$517	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$517, DW_AT_name("INTEN"), DW_AT_symbol_name("_INTEN")
...
DW$519	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$519, DW_AT_name("SOCASEL"), DW_AT_symbol_name("_SOCASEL")
	.dwattr DW$519, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x03)
	.dwattr DW$519, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$519, DW_AT_accessibility(DW_ACCESS_public)
DW$520	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$520, DW_AT_name("SOCAEN"), DW_AT_symbol_name("_SOCAEN")
	.dwattr DW$520, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x01)
	.dwattr DW$520, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$520, DW_AT_accessibility(DW_ACCESS_public)
DW$521	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$521, DW_AT_name("SOCBSEL"), DW_AT_symbol_name("_SOCBSEL")
	.dwattr DW$521, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x03)
	.dwattr DW$521, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$521, DW_AT_accessibility(DW_ACCESS_public)
DW$522	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$522, DW_AT_name("SOCBEN"), DW_AT_symbol_name("_SOCBEN")
...
DW$523	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$523, DW_AT_name("INTPRD"), DW_AT_symbol_name("_INTPRD")
	.dwattr DW$523, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$523, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$523, DW_AT_accessibility(DW_ACCESS_public)
DW$524	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$524, DW_AT_name("INTCNT"), DW_AT_symbol_name("_INTCNT")
...
DW$532	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$532, DW_AT_name("SOCA"), DW_AT_symbol_name("_SOCA")
	.dwattr DW$532, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$532, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$532, DW_AT_accessibility(DW_ACCESS_public)
DW$533	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$533, DW_AT_name("SOCB"), DW_AT_symbol_name("_SOCB")
...
DW$537	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$537, DW_AT_name("SOCA"), DW_AT_symbol_name("_SOCA")
	.dwattr DW$537, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$537, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$537, DW_AT_accessibility(DW_ACCESS_public)
DW$538	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$538, DW_AT_name("SOCB"), DW_AT_symbol_name("_SOCB")
...
DW$542	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$542, DW_AT_name("SOCA"), DW_AT_symbol_name("_SOCA")
	.dwattr DW$542, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$542, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$542, DW_AT_accessibility(DW_ACCESS_public)
DW$543	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$543, DW_AT_name("SOCB"), DW_AT_symbol_name("_SOCB")
...
DW$545	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$545, DW_AT_name("CHPEN"), DW_AT_symbol_name("_CHPEN")
	.dwattr DW$545, DW_AT_bit_offset(0x0f), DW_AT_bit_size(0x01)
	.dwattr DW$545, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$545, DW_AT_accessibility(DW_ACCESS_public)
DW$546	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$546, DW_AT_name("OSHTWTH"), DW_AT_symbol_name("_OSHTWTH")
	.dwattr DW$546, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x04)
	.dwattr DW$546, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$546, DW_AT_accessibility(DW_ACCESS_public)
DW$547	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$547, DW_AT_name("CHPFREQ"), DW_AT_symbol_name("_CHPFREQ")
	.dwattr DW$547, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x03)
	.dwattr DW$547, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$547, DW_AT_accessibility(DW_ACCESS_public)
DW$548	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$548, DW_AT_name("CHPDUTY"), DW_AT_symbol_name("_CHPDUTY")
	.dwattr DW$548, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x03)
	.dwattr DW$548, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$548, DW_AT_accessibility(DW_ACCESS_public)
DW$549	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$549, DW_AT_name("rsvd1"), DW_AT_symbol_name("_rsvd1")
	.dwattr DW$549, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x05)
...
DW$550	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$550, DW_AT_name("EDGMODE"), DW_AT_symbol_name("_EDGMODE")
	.dwattr DW$550, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$550, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$550, DW_AT_accessibility(DW_ACCESS_public)
DW$551	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$551, DW_AT_name("CTLMODE"), DW_AT_symbol_name("_CTLMODE")
	.dwattr DW$551, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$551, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$551, DW_AT_accessibility(DW_ACCESS_public)
DW$552	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$552, DW_AT_name("HRLOAD"), DW_AT_symbol_name("_HRLOAD")
...
DW$570	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$570, DW_AT_name("GPIO16"), DW_AT_symbol_name("_GPIO16")
...
DW$571	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$571, DW_AT_name("GPIO17"), DW_AT_symbol_name("_GPIO17")
...
DW$572	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$572, DW_AT_name("GPIO18"), DW_AT_symbol_name("_GPIO18")
...
DW$573	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$573, DW_AT_name("GPIO19"), DW_AT_symbol_name("_GPIO19")
...
DW$574	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$574, DW_AT_name("GPIO20"), DW_AT_symbol_name("_GPIO20")
	.dwattr DW$574, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x01)
	.dwattr DW$574, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$574, DW_AT_accessibility(DW_ACCESS_public)
DW$575	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$575, DW_AT_name("GPIO21"), DW_AT_symbol_name("_GPIO21")
...
DW$576	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$576, DW_AT_name("GPIO22"), DW_AT_symbol_name("_GPIO22")
...
DW$577	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$577, DW_AT_name("GPIO23"), DW_AT_symbol_name("_GPIO23")
	.dwattr DW$577, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x01)
	.dwattr DW$577, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$577, DW_AT_accessibility(DW_ACCESS_public)
DW$578	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$578, DW_AT_name("GPIO24"), DW_AT_symbol_name("_GPIO24")
	.dwattr DW$578, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
	.dwattr DW$578, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$578, DW_AT_accessibility(DW_ACCESS_public)
DW$579	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$579, DW_AT_name("GPIO25"), DW_AT_symbol_name("_GPIO25")
	.dwattr DW$579, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x01)
	.dwattr DW$579, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$579, DW_AT_accessibility(DW_ACCESS_public)
DW$580	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$580, DW_AT_name("GPIO26"), DW_AT_symbol_name("_GPIO26")
	.dwattr DW$580, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x01)
	.dwattr DW$580, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$580, DW_AT_accessibility(DW_ACCESS_public)
DW$581	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$581, DW_AT_name("GPIO27"), DW_AT_symbol_name("_GPIO27")
...
DW$582	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$582, DW_AT_name("GPIO28"), DW_AT_symbol_name("_GPIO28")
	.dwattr DW$582, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x01)
	.dwattr DW$582, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$582, DW_AT_accessibility(DW_ACCESS_public)
DW$583	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$583, DW_AT_name("GPIO29"), DW_AT_symbol_name("_GPIO29")
	.dwattr DW$583, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x01)
	.dwattr DW$583, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$583, DW_AT_accessibility(DW_ACCESS_public)
DW$584	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$584, DW_AT_name("GPIO30"), DW_AT_symbol_name("_GPIO30")
...
DW$585	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$585, DW_AT_name("GPIO31"), DW_AT_symbol_name("_GPIO31")
...
DW$586	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$586, DW_AT_name("GPIO32"), DW_AT_symbol_name("_GPIO32")
...
DW$587	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$587, DW_AT_name("GPIO33"), DW_AT_symbol_name("_GPIO33")
...
DW$588	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$588, DW_AT_name("GPIO34"), DW_AT_symbol_name("_GPIO34")
...
DW$591	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$591, DW_AT_name("rsvd3"), DW_AT_symbol_name("_rsvd3")
	.dwattr DW$591, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x10)
...
DW$597	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$597, DW_AT_name("TSS"), DW_AT_symbol_name("_TSS")
...
DW$598	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$598, DW_AT_name("TRB"), DW_AT_symbol_name("_TRB")
...
DW$599	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$599, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x04)
	.dwattr DW$599, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$599, DW_AT_accessibility(DW_ACCESS_public)
DW$600	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$600, DW_AT_name("SOFT"), DW_AT_symbol_name("_SOFT")
...
DW$601	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$601, DW_AT_name("FREE"), DW_AT_symbol_name("_FREE")
...
DW$602	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$602, DW_AT_name("rsvd3"), DW_AT_symbol_name("_rsvd3")
...
DW$603	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$603, DW_AT_name("TIE"), DW_AT_symbol_name("_TIE")
...
DW$604	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$604, DW_AT_name("TIF"), DW_AT_symbol_name("_TIF")
...
DW$605	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$605, DW_AT_name("TDDR"), DW_AT_symbol_name("_TDDR")
...
DW$606	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$606, DW_AT_name("PSC"), DW_AT_symbol_name("_PSC")
...
DW$607	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$607, DW_AT_name("TDDRH"), DW_AT_symbol_name("_TDDRH")
...
DW$608	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$608, DW_AT_name("PSCH"), DW_AT_symbol_name("_PSCH")
...
DW$609	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$609, DW_AT_name("ENPIE"), DW_AT_symbol_name("_ENPIE")
...
DW$610	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$610, DW_AT_name("PIEVECT"), DW_AT_symbol_name("_PIEVECT")
	.dwattr DW$610, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0f)
...
DW$611	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$611, DW_AT_name("ACK1"), DW_AT_symbol_name("_ACK1")
...
DW$612	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$612, DW_AT_name("ACK2"), DW_AT_symbol_name("_ACK2")
...
DW$613	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$613, DW_AT_name("ACK3"), DW_AT_symbol_name("_ACK3")
...
DW$614	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$614, DW_AT_name("ACK4"), DW_AT_symbol_name("_ACK4")
...
DW$615	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$615, DW_AT_name("ACK5"), DW_AT_symbol_name("_ACK5")
...
DW$616	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$616, DW_AT_name("ACK6"), DW_AT_symbol_name("_ACK6")
...
DW$617	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$617, DW_AT_name("ACK7"), DW_AT_symbol_name("_ACK7")
...
DW$618	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$618, DW_AT_name("ACK8"), DW_AT_symbol_name("_ACK8")
...
DW$619	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$619, DW_AT_name("ACK9"), DW_AT_symbol_name("_ACK9")
	.dwattr DW$619, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
	.dwattr DW$619, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$619, DW_AT_accessibility(DW_ACCESS_public)
DW$620	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$620, DW_AT_name("ACK10"), DW_AT_symbol_name("_ACK10")
	.dwattr DW$620, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x01)
	.dwattr DW$620, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$620, DW_AT_accessibility(DW_ACCESS_public)
DW$621	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$621, DW_AT_name("ACK11"), DW_AT_symbol_name("_ACK11")
...
DW$622	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$622, DW_AT_name("ACK12"), DW_AT_symbol_name("_ACK12")
...
DW$624	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$624, DW_AT_name("INTx1"), DW_AT_symbol_name("_INTx1")
...
DW$625	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$625, DW_AT_name("INTx2"), DW_AT_symbol_name("_INTx2")
...
DW$626	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$626, DW_AT_name("INTx3"), DW_AT_symbol_name("_INTx3")
...
DW$627	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$627, DW_AT_name("INTx4"), DW_AT_symbol_name("_INTx4")
...
DW$628	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$628, DW_AT_name("INTx5"), DW_AT_symbol_name("_INTx5")
...
DW$629	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$629, DW_AT_name("INTx6"), DW_AT_symbol_name("_INTx6")
...
DW$630	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$630, DW_AT_name("INTx7"), DW_AT_symbol_name("_INTx7")
...
DW$631	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$631, DW_AT_name("INTx8"), DW_AT_symbol_name("_INTx8")
...
DW$632	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$632, DW_AT_name("rsvd"), DW_AT_symbol_name("_rsvd")
...
DW$633	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$633, DW_AT_name("INTx1"), DW_AT_symbol_name("_INTx1")
...
DW$634	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$634, DW_AT_name("INTx2"), DW_AT_symbol_name("_INTx2")
...
DW$635	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$635, DW_AT_name("INTx3"), DW_AT_symbol_name("_INTx3")
...
DW$636	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$636, DW_AT_name("INTx4"), DW_AT_symbol_name("_INTx4")
...
DW$637	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$637, DW_AT_name("INTx5"), DW_AT_symbol_name("_INTx5")
...
DW$638	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$638, DW_AT_name("INTx6"), DW_AT_symbol_name("_INTx6")
...
DW$639	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$639, DW_AT_name("INTx7"), DW_AT_symbol_name("_INTx7")
...
DW$640	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$640, DW_AT_name("INTx8"), DW_AT_symbol_name("_INTx8")
...
DW$641	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$641, DW_AT_name("rsvd"), DW_AT_symbol_name("_rsvd")
...
DW$642	.dwtag  DW_TAG_assign_register, DW_AT_name("AL")
	.dwattr DW$642, DW_AT_location[DW_OP_reg0]
DW$643	.dwtag  DW_TAG_assign_register, DW_AT_name("AH")
	.dwattr DW$643, DW_AT_location[DW_OP_reg1]
DW$644	.dwtag  DW_TAG_assign_register, DW_AT_name("PL")
	.dwattr DW$644, DW_AT_location[DW_OP_reg2]
DW$645	.dwtag  DW_TAG_assign_register, DW_AT_name("PH")
	.dwattr DW$645, DW_AT_location[DW_OP_reg3]
DW$646	.dwtag  DW_TAG_assign_register, DW_AT_name("AR0")
	.dwattr DW$646, DW_AT_location[DW_OP_reg4]
DW$647	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR0")
	.dwattr DW$647, DW_AT_location[DW_OP_reg5]
DW$648	.dwtag  DW_TAG_assign_register, DW_AT_name("AR1")
	.dwattr DW$648, DW_AT_location[DW_OP_reg6]
DW$649	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR1")
	.dwattr DW$649, DW_AT_location[DW_OP_reg7]
DW$650	.dwtag  DW_TAG_assign_register, DW_AT_name("AR2")
	.dwattr DW$650, DW_AT_location[DW_OP_reg8]
DW$651	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR2")
	.dwattr DW$651, DW_AT_location[DW_OP_reg9]
DW$652	.dwtag  DW_TAG_assign_register, DW_AT_name("AR3")
	.dwattr DW$652, DW_AT_location[DW_OP_reg10]
DW$653	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR3")
	.dwattr DW$653, DW_AT_location[DW_OP_reg11]
DW$654	.dwtag  DW_TAG_assign_register, DW_AT_name("AR4")
	.dwattr DW$654, DW_AT_location[DW_OP_reg12]
DW$655	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR4")
	.dwattr DW$655, DW_AT_location[DW_OP_reg13]
DW$656	.dwtag  DW_TAG_assign_register, DW_AT_name("AR5")
	.dwattr DW$656, DW_AT_location[DW_OP_reg14]
DW$657	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR5")
	.dwattr DW$657, DW_AT_location[DW_OP_reg15]
DW$658	.dwtag  DW_TAG_assign_register, DW_AT_name("AR6")
	.dwattr DW$658, DW_AT_location[DW_OP_reg16]
DW$659	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR6")
	.dwattr DW$659, DW_AT_location[DW_OP_reg17]
DW$660	.dwtag  DW_TAG_assign_register, DW_AT_name("AR7")
	.dwattr DW$660, DW_AT_location[DW_OP_reg18]
DW$661	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR7")
	.dwattr DW$661, DW_AT_location[DW_OP_reg19]
DW$662	.dwtag  DW_TAG_assign_register, DW_AT_name("SP")
	.dwattr DW$662, DW_AT_location[DW_OP_reg20]
DW$663	.dwtag  DW_TAG_assign_register, DW_AT_name("XT")
	.dwattr DW$663, DW_AT_location[DW_OP_reg21]
DW$664	.dwtag  DW_TAG_assign_register, DW_AT_name("T")
	.dwattr DW$664, DW_AT_location[DW_OP_reg22]
DW$665	.dwtag  DW_TAG_assign_register, DW_AT_name("ST0")
	.dwattr DW$665, DW_AT_location[DW_OP_reg23]
DW$666	.dwtag  DW_TAG_assign_register, DW_AT_name("ST1")
	.dwattr DW$666, DW_AT_location[DW_OP_reg24]
DW$667	.dwtag  DW_TAG_assign_register, DW_AT_name("PC")
	.dwattr DW$667, DW_AT_location[DW_OP_reg25]
DW$668	.dwtag  DW_TAG_assign_register, DW_AT_name("RPC")
	.dwattr DW$668, DW_AT_location[DW_OP_reg26]
DW$669	.dwtag  DW_TAG_assign_register, DW_AT_name("FP")
	.dwattr DW$669, DW_AT_location[DW_OP_reg27]
DW$670	.dwtag  DW_TAG_assign_register, DW_AT_name("DP")
	.dwattr DW$670, DW_AT_location[DW_OP_reg28]
DW$671	.dwtag  DW_TAG_assign_register, DW_AT_name("SXM")
	.dwattr DW$671, DW_AT_location[DW_OP_reg29]
DW$672	.dwtag  DW_TAG_assign_register, DW_AT_name("PM")
	.dwattr DW$672, DW_AT_location[DW_OP_reg30]
DW$673	.dwtag  DW_TAG_assign_register, DW_AT_name("OVM")
	.dwattr DW$673, DW_AT_location[DW_OP_reg31]
DW$674	.dwtag  DW_TAG_assign_register, DW_AT_name("PAGE0")
	.dwattr DW$674, DW_AT_location[DW_OP_regx 0x20]
DW$675	.dwtag  DW_TAG_assign_register, DW_AT_name("AMODE")
	.dwattr DW$675, DW_AT_location[DW_OP_regx 0x21]
DW$676	.dwtag  DW_TAG_assign_register, DW_AT_name("IFR")
	.dwattr DW$676, DW_AT_location[DW_OP_regx 0x22]
DW$677	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$677, DW_AT_location[DW_OP_regx 0x23]
DW$678	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$678, DW_AT_location[DW_OP_regx 0x24]
DW$679	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDO")
	.dwattr DW$679, DW_AT_location[DW_OP_regx 0x25]
DW$680	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDOH")
	.dwattr DW$680, DW_AT_location[DW_OP_regx 0x26]
DW$681	.dwtag  DW_TAG_assign_register, DW_AT_name("VOL")
	.dwattr DW$681, DW_AT_location[DW_OP_regx 0x27]
DW$682	.dwtag  DW_TAG_assign_register, DW_AT_name("CIE_RETA")
	.dwattr DW$682, DW_AT_location[DW_OP_regx 0x28]
	.dwendtag DW$CU
