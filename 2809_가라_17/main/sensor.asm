...
DW$69	.dwtag  DW_TAG_subprogram, DW_AT_name("MARK_ENABLE_SHIFT"), DW_AT_symbol_name("_MARK_ENABLE_SHIFT")
	...
	.dwattr DW$69, DW_AT_begin_line(0x1c8)
...
L3:    
	...
	.dwattr DW$69, DW_AT_end_line(0x1cd)
...
DW$74	.dwtag  DW_TAG_subprogram, DW_AT_name("TURN_DECIDE"), DW_AT_symbol_name("_TURN_DECIDE")
	...
	.dwattr DW$74, DW_AT_begin_line(0x1cf)
...
;***************************************************************
_TURN_DECIDE:
;*** 465	-----------------------    if ( *((volatile unsigned * const)mark+7)&2u ) goto g12;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$79	.dwtag  DW_TAG_variable, DW_AT_name("K$6"), DW_AT_symbol_name("K$6")
	...
	.dwpsn	"sensor.c",465,2
        ...
        ; branchcc occurs ; |465| 
;*** 507	-----------------------    K$6 = &RMark;
;*** 507	-----------------------    MARK_ENABLE_SHIFT(&LMark, K$6);
;*** 510	-----------------------    if ( !((*mark).MarkEnable_U16&SENSOR_STATE_U16) ) goto g11;
	.dwpsn	"sensor.c",507,2
        MOVL      XAR4,#_RMark          ; |507| 
        MOVL      XAR5,XAR4             ; |507| 
        MOVL      XAR7,XAR4             ; |507| 
        MOVL      XAR4,#_LMark          ; |507| 
        LCR       #_MARK_ENABLE_SHIFT   ; |507| 
        ; call occurs [#_MARK_ENABLE_SHIFT] ; |507| 
	.dwpsn	"sensor.c",510,2
        MOVW      DP,#_SENSOR_STATE_U16
        MOV       AL,@_SENSOR_STATE_U16 ; |510| 
        AND       AL,*+XAR6[6]          ; |510| 
        BF        L7,EQ                 ; |510| 
        ; branchcc occurs ; |510| 
;*** 512	-----------------------    if ( !(*((volatile unsigned * const)mark+7)&1u) ) goto g10;
	.dwpsn	"sensor.c",512,3
        TBIT      *+XAR6[7],#0          ; |512| 
        BF        L6,NTC                ; |512| 
        ; branchcc occurs ; |512| 
;*** 521	-----------------------    if ( (*mark).TurnmarkDistance_IQ17 <= (*mark).LimitDistance_IQ17 ) goto g27;
	.dwpsn	"sensor.c",521,8
        MOVL      ACC,*+XAR6[2]         ; |521| 
        CMPL      ACC,*+XAR6[0]         ; |521| 
        BF        L13,GEQ               ; |521| 
        ; branchcc occurs ; |521| 
;*** 523	-----------------------    *((volatile unsigned * const)mark+7) |= 2u;
;*** 524	-----------------------    (*mark).LimitDistance_IQ17 = (*mark).TurnmarkDistance_IQ17+7864320L;
;*** 526	-----------------------    if ( mark == K$6 ) goto g7;
	.dwpsn	"sensor.c",523,4
        OR        *+XAR6[7],#0x0002     ; |523| 
	...
	.dwpsn	"sensor.c",526,4
        ...
        BF        L4,EQ                 ; |526| 
        ; branchcc occurs ; |526| 
;*** 529	-----------------------    *(&GpioDataRegs+10L) |= 2u;
;*** 529	-----------------------    goto g8;
	.dwpsn	"sensor.c",529,5
        MOVW      DP,#_GpioDataRegs+10
        OR        @_GpioDataRegs+10,#0x0002 ; |529| 
        BF        L5,UNC                ; |529| 
        ; branch occurs ; |529| 
L4:    
;***	-----------------------g7:
;*** 527	-----------------------    *(&GpioDataRegs+10L) |= 4u;
	.dwpsn	"sensor.c",527,5
        MOVW      DP,#_GpioDataRegs+10
        OR        @_GpioDataRegs+10,#0x0004 ; |527| 
L5:    
;***	-----------------------g8:
;*** 527	-----------------------    if ( *&Flag&0x8u ) goto g27;
        MOVW      DP,#_Flag
        TBIT      @_Flag,#3             ; |527| 
        BF        L13,TC                ; |527| 
        ; branchcc occurs ; |527| 
;*** 532	-----------------------    *(&GpioDataRegs+10L) |= 1u;
;*** 532	-----------------------    goto g27;
	.dwpsn	"sensor.c",532,5
        MOVW      DP,#_GpioDataRegs+10
        OR        @_GpioDataRegs+10,#0x0001 ; |532| 
        BF        L13,UNC               ; |532| 
        ; branch occurs ; |532| 
L6:    
;***	-----------------------g10:
;*** 514	-----------------------    RMotor.TurnMarkCheckDistance_IQ17 = 0L;
;*** 515	-----------------------    LMotor.TurnMarkCheckDistance_IQ17 = 0L;
;*** 516	-----------------------    (*mark).TurnmarkDistance_IQ17 = 0L;
;*** 518	-----------------------    (*mark).LimitDistance_IQ17 = (*mark).TurnmarkDistance_IQ17+655360L;
;*** 519	-----------------------    *((volatile unsigned * const)mark+7) |= 1u;
;*** 520	-----------------------    goto g27;
	.dwpsn	"sensor.c",514,4
        MOVB      ACC,#0
        MOVW      DP,#_RMotor+8
        MOVL      @_RMotor+8,ACC        ; |514| 
	.dwpsn	"sensor.c",515,4
        MOVW      DP,#_LMotor+8
        MOVL      @_LMotor+8,ACC        ; |515| 
	.dwpsn	"sensor.c",516,4
        MOVL      *+XAR6[0],ACC         ; |516| 
	.dwpsn	"sensor.c",518,4
        MOVL      XAR4,#655360          ; |518| 
        MOVL      ACC,XAR4              ; |518| 
        ADDL      ACC,*+XAR6[0]         ; |518| 
        MOVL      *+XAR6[2],ACC         ; |518| 
	.dwpsn	"sensor.c",519,4
        OR        *+XAR6[7],#0x0001     ; |519| 
	.dwpsn	"sensor.c",520,3
        BF        L13,UNC               ; |520| 
        ; branch occurs ; |520| 
L7:    
;***	-----------------------g11:
;*** 538	-----------------------    (*mark).TurnmarkDistance_IQ17 = 0L;
;*** 539	-----------------------    *((volatile unsigned * const)mark+7) &= 0xfffeu;
;*** 539	-----------------------    goto g27;
	.dwpsn	"sensor.c",538,3
        MOVB      ACC,#0
        MOVL      *+XAR6[0],ACC         ; |538| 
	.dwpsn	"sensor.c",539,3
        AND       *+XAR6[7],#0xfffe     ; |539| 
        BF        L13,UNC               ; |539| 
        ; branch occurs ; |539| 
L8:    
;***	-----------------------g12:
;*** 467	-----------------------    if ( (*mark).TurnmarkDistance_IQ17 > (*mark).LimitDistance_IQ17 ) goto g15;
	.dwpsn	"sensor.c",467,3
        MOVL      ACC,*+XAR6[2]         ; |467| 
        CMPL      ACC,*+XAR6[0]         ; |467| 
        BF        L9,LT                 ; |467| 
        ; branchcc occurs ; |467| 
;*** 501	-----------------------    if ( !(*((volatile unsigned * const)remark+7)&2u) ) goto g27;
	.dwpsn	"sensor.c",501,8
        TBIT      *+XAR5[7],#1          ; |501| 
        BF        L13,NTC               ; |501| 
        ; branchcc occurs ; |501| 
;*** 502	-----------------------    *((volatile unsigned * const)mark+7) |= 4u;
;*** 502	-----------------------    goto g27;
	.dwpsn	"sensor.c",502,4
        OR        *+XAR6[7],#0x0004     ; |502| 
        BF        L13,UNC               ; |502| 
        ; branch occurs ; |502| 
L9:    
;***	-----------------------g15:
...
;*** 471	-----------------------    *(&GpioDataRegs+12L) |= 1u;
;*** 473	-----------------------    *((volatile unsigned * const)mark+7) &= 0xfffdu;
;*** 474	-----------------------    *((volatile unsigned * const)mark+7) &= 0xfffeu;
;*** 475	-----------------------    (*mark).TurnmarkDistance_IQ17 = 0L;
;*** 478	-----------------------    if ( *((volatile unsigned * const)mark+7)&4u ) goto g24;
	...
	.dwpsn	"sensor.c",471,4
        OR        @_GpioDataRegs+12,#0x0001 ; |471| 
	.dwpsn	"sensor.c",473,4
        AND       *+XAR6[7],#0xfffd     ; |473| 
	.dwpsn	"sensor.c",474,4
        AND       *+XAR6[7],#0xfffe     ; |474| 
...
;*** 490	-----------------------    if ( *&Flag&0x8u ) goto g27;
        ...
        BF        L13,TC                ; |490| 
        ; branchcc occurs ; |490| 
;*** 493	-----------------------    if ( *&Flag&0x40u ) goto g23;
	.dwpsn	"sensor.c",493,5
        TBIT      @_Flag,#6             ; |493| 
        BF        L11,TC                ; |493| 
        ; branchcc occurs ; |493| 
;*** 495	-----------------------    if ( *&Flag&0x80u ) goto g22;
	.dwpsn	"sensor.c",495,10
        TBIT      @_Flag,#7             ; |495| 
        BF        L10,TC                ; |495| 
        ; branchcc occurs ; |495| 
;*** 497	-----------------------    if ( !(*&Flag&0x100u) ) goto g27;
	.dwpsn	"sensor.c",497,10
        TBIT      @_Flag,#8             ; |497| 
        BF        L13,NTC               ; |497| 
        ; branchcc occurs ; |497| 
;*** 498	-----------------------    LINE_THIRD(((long)THIRD_MARK_U16_CNT<<5)+&Search);
;*** 498	-----------------------    goto g27;
	.dwpsn	"sensor.c",498,6
        MOVW      DP,#_THIRD_MARK_U16_CNT
        MOVU      ACC,@_THIRD_MARK_U16_CNT
        LSL       ACC,5                 ; |498| 
        MOVL      XAR4,#_Search         ; |498| 
        ADDL      XAR4,ACC
        LCR       #_LINE_THIRD          ; |498| 
        ; call occurs [#_LINE_THIRD] ; |498| 
        BF        L13,UNC               ; |498| 
        ; branch occurs ; |498| 
L10:    
;***	-----------------------g22:
;*** 496	-----------------------    LINE_SECOND(((long)SECOND_MARK_U16_CNT<<5)+&Search);
;*** 496	-----------------------    goto g27;
	.dwpsn	"sensor.c",496,6
        MOVW      DP,#_SECOND_MARK_U16_CNT
        MOVU      ACC,@_SECOND_MARK_U16_CNT
        LSL       ACC,5                 ; |496| 
        MOVL      XAR4,#_Search         ; |496| 
        ADDL      XAR4,ACC
        LCR       #_LINE_SECOND         ; |496| 
        ; call occurs [#_LINE_SECOND] ; |496| 
        BF        L13,UNC               ; |496| 
        ; branch occurs ; |496| 
L11:    
;***	-----------------------g23:
...
L12:    
;***	-----------------------g24:
;*** 479	-----------------------    *((volatile unsigned * const)mark+7) &= 0xfffbu;
;*** 481	-----------------------    if ( mark != &RMark ) goto g27;
	.dwpsn	"sensor.c",479,5
        AND       *+XAR6[7],#0xfffb     ; |479| 
	.dwpsn	"sensor.c",481,5
        MOVL      XAR4,#_RMark          ; |481| 
        MOVL      ACC,XAR4              ; |481| 
        CMPL      ACC,XAR6              ; |481| 
        BF        L13,NEQ               ; |481| 
        ; branchcc occurs ; |481| 
;*** 482	-----------------------    if ( *&Flag&0x8u ) goto g27;
...
L13:    
	...
	.dwattr DW$74, DW_AT_end_line(0x21d)
...
DW$119	.dwtag  DW_TAG_loop
	.dwattr DW$119, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L48:1:1659895904")
...
DW$129	.dwtag  DW_TAG_loop
	.dwattr DW$129, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L42:1:1659895904")
...
DW$131	.dwtag  DW_TAG_loop
	.dwattr DW$131, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L41:1:1659895904")
...
DW$133	.dwtag  DW_TAG_loop
	.dwattr DW$133, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L40:1:1659895904")
...
DW$135	.dwtag  DW_TAG_loop
	.dwattr DW$135, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L35:1:1659895904")
...
DW$142	.dwtag  DW_TAG_loop
	.dwattr DW$142, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L30:1:1659895904")
...
DW$149	.dwtag  DW_TAG_loop
	.dwattr DW$149, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L25:1:1659895904")
...
DW$156	.dwtag  DW_TAG_loop
	.dwattr DW$156, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L24:1:1659895904")
...
DW$158	.dwtag  DW_TAG_loop
	.dwattr DW$158, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L19:1:1659895904")
...
DW$161	.dwtag  DW_TAG_loop
	.dwattr DW$161, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L20:2:1659895904")
...
DW$166	.dwtag  DW_TAG_loop
	.dwattr DW$166, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L14:1:1659895904")
...
DW$169	.dwtag  DW_TAG_loop
	.dwattr DW$169, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L15:2:1659895904")
...
DW$177	.dwtag  DW_TAG_subprogram, DW_AT_name("CROSS_CHECK"), DW_AT_symbol_name("_CROSS_CHECK$0")
	...
	.dwattr DW$177, DW_AT_begin_line(0x21f)
...
;*** 547	-----------------------    condition2 = 0u;
;*** 548	-----------------------    condition3 = 0u;
;*** 550	-----------------------    if ( SENSOR_ENABLE&0xfu ) goto g5;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        ADDB      SP,#4
...
DW$182	.dwtag  DW_TAG_variable, DW_AT_name("condition3"), DW_AT_symbol_name("_condition3")
	...
	.dwpsn	"sensor.c",545,18
        MOV       *-SP[1],#0            ; |545| 
	.dwpsn	"sensor.c",546,18
        MOV       *-SP[2],#0            ; |546| 
	.dwpsn	"sensor.c",547,18
        MOV       *-SP[3],#0            ; |547| 
	.dwpsn	"sensor.c",548,18
        MOV       *-SP[4],#0            ; |548| 
	.dwpsn	"sensor.c",550,2
        MOVW      DP,#_SENSOR_ENABLE
        MOV       AL,@_SENSOR_ENABLE    ; |550| 
        ANDB      AL,#0x0f              ; |550| 
        BF        L52,NEQ               ; |550| 
        ; branchcc occurs ; |550| 
;*** 551	-----------------------    if ( SENSOR_ENABLE&0xf000u ) goto g4;
	.dwpsn	"sensor.c",551,7
        AND       AL,@_SENSOR_ENABLE,#0xf000 ; |551| 
        BF        L51,NEQ               ; |551| 
        ; branchcc occurs ; |551| 
;*** 552	-----------------------    state = 9u;
;*** 552	-----------------------    goto g6;
	.dwpsn	"sensor.c",552,15
        MOV       *-SP[1],#9            ; |552| 
        BF        L53,UNC               ; |552| 
        ; branch occurs ; |552| 
L51:    
;***	-----------------------g4:
;*** 551	-----------------------    state = SENSOR_STATE_U16_CNT+9u;
;*** 551	-----------------------    goto g6;
	.dwpsn	"sensor.c",551,39
        MOVW      DP,#_SENSOR_STATE_U16_CNT
        MOV       AL,@_SENSOR_STATE_U16_CNT ; |551| 
        ADDB      AL,#9                 ; |551| 
        MOV       *-SP[1],AL            ; |551| 
        BF        L53,UNC               ; |551| 
        ; branch occurs ; |551| 
L52:    
;***	-----------------------g5:
;*** 550	-----------------------    state = 9u-SENSOR_STATE_U16_CNT;
	.dwpsn	"sensor.c",550,36
        MOVB      AL,#9                 ; |550| 
        MOVW      DP,#_SENSOR_STATE_U16_CNT
        SUB       AL,@_SENSOR_STATE_U16_CNT ; |550| 
        MOV       *-SP[1],AL            ; |550| 
L53:    
;***	-----------------------g6:
;*** 554	-----------------------    C$1 = &state_table[0];
;*** 554	-----------------------    condition1 = (C$1[state]&SENSOR_STATE_U16) == C$1[state];
	.dwpsn	"sensor.c",554,2
        MOVW      DP,#_SENSOR_STATE_U16
        MOVZ      AR0,*-SP[1]           ; |554| 
        MOVB      AH,#0
        MOVL      XAR5,#_state_table    ; |554| 
        MOV       AL,@_SENSOR_STATE_U16 ; |554| 
        AND       AL,*+XAR5[AR0]        ; |554| 
        MOVZ      AR0,*-SP[1]           ; |554| 
        CMP       AL,*+XAR5[AR0]        ; |554| 
        BF        L54,NEQ               ; |554| 
        ...
        MOVB      AH,#1                 ; |554| 
L54:    
;*** 555	-----------------------    condition2 = (C$1[state-1]&SENSOR_STATE_U16) == C$1[state-1];
        MOV       *-SP[2],AH            ; |554| 
	.dwpsn	"sensor.c",555,2
        MOV       AL,*-SP[1]            ; |555| 
        ADDB      AL,#-1
        MOVZ      AR0,AL                ; |555| 
        MOV       AH,@_SENSOR_STATE_U16 ; |555| 
        AND       AH,*+XAR5[AR0]        ; |555| 
        MOV       AL,*-SP[1]            ; |555| 
        ADDB      AL,#-1
        MOVZ      AR0,AL                ; |555| 
        ...
        MOVB      XAR4,#1               ; |555| 
L55:    
;*** 556	-----------------------    condition3 = (C$1[state+1]&SENSOR_STATE_U16) == C$1[state+1];
        MOV       *-SP[3],AR4           ; |555| 
	.dwpsn	"sensor.c",556,2
        MOV       AL,*-SP[1]            ; |556| 
        ADDB      AL,#1                 ; |556| 
        MOVZ      AR0,AL                ; |556| 
        MOV       AH,@_SENSOR_STATE_U16 ; |556| 
        AND       AH,*+XAR5[AR0]        ; |556| 
        MOV       AL,*-SP[1]            ; |556| 
        ADDB      AL,#1                 ; |556| 
        MOVZ      AR0,AL                ; |556| 
        ...
        MOVB      XAR4,#1               ; |556| 
L56:    
;*** 557	-----------------------    if ( condition1 ) goto g17;
        MOV       *-SP[4],AR4           ; |556| 
	.dwpsn	"sensor.c",557,2
        MOV       AL,*-SP[2]            ; |557| 
        BF        L60,NEQ               ; |557| 
        ; branchcc occurs ; |557| 
;*** 557	-----------------------    if ( condition2 ) goto g17;
        MOV       AL,*-SP[3]            ; |557| 
        BF        L60,NEQ               ; |557| 
        ; branchcc occurs ; |557| 
;*** 557	-----------------------    if ( condition3 ) goto g17;
        MOV       AL,*-SP[4]            ; |557| 
        BF        L60,NEQ               ; |557| 
        ; branchcc occurs ; |557| 
;*** 558	-----------------------    if ( !(*&Flag&0x8u) ) goto g16;
	.dwpsn	"sensor.c",558,7
        MOVW      DP,#_Flag
        TBIT      @_Flag,#3             ; |558| 
        BF        L59,NTC               ; |558| 
        ; branchcc occurs ; |558| 
;*** 560	-----------------------    if ( (CROSS_DISTANCE_IQ15 = RMotor.CrossCheckDistance_IQ15+LMotor.CrossCheckDistance_IQ15>>1) <= 4915200L ) goto g18;
	.dwpsn	"sensor.c",560,3
        MOVW      DP,#_LMotor+12
        MOVL      ACC,@_LMotor+12       ; |560| 
        SETC      SXM
        MOVW      DP,#_RMotor+12
        ADDL      ACC,@_RMotor+12       ; |560| 
        SFR       ACC,1                 ; |560| 
...
;*** 564	-----------------------    *(&LMark+7) &= 0xfffeu;
;*** 564	-----------------------    *(&RMark+7) &= 0xfffeu;
;*** 565	-----------------------    LMark.TurnmarkDistance_IQ17 = 0L;
;*** 565	-----------------------    RMark.TurnmarkDistance_IQ17 = 0L;
;*** 566	-----------------------    LMotor.CrossCheckDistance_IQ15 = 0L;
;*** 566	-----------------------    RMotor.CrossCheckDistance_IQ15 = 0L;
;*** 567	-----------------------    CROSS_DISTANCE_IQ15 = 0L;
;*** 569	-----------------------    if ( *&Flag&0x40u ) goto g15;
	.dwpsn	"sensor.c",563,4
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfff7        ; |563| 
	.dwpsn	"sensor.c",564,4
        MOVW      DP,#_LMark+7
        AND       @_LMark+7,#0xfffe     ; |564| 
        MOVW      DP,#_RMark+7
        AND       @_RMark+7,#0xfffe     ; |564| 
	...
	.dwpsn	"sensor.c",566,4
        MOVW      DP,#_LMotor+12
        MOVL      @_LMotor+12,ACC       ; |566| 
        MOVW      DP,#_RMotor+12
        MOVL      @_RMotor+12,ACC       ; |566| 
	...
	.dwpsn	"sensor.c",569,4
        ...
        BF        L58,TC                ; |569| 
        ; branchcc occurs ; |569| 
;*** 570	-----------------------    if ( *&Flag&0x80u ) goto g14;
	.dwpsn	"sensor.c",570,9
        TBIT      @_Flag,#7             ; |570| 
        BF        L57,TC                ; |570| 
        ; branchcc occurs ; |570| 
;*** 571	-----------------------    if ( !(*&Flag&0x100u) ) goto g18;
	.dwpsn	"sensor.c",571,9
        TBIT      @_Flag,#8             ; |571| 
        BF        L61,NTC               ; |571| 
        ; branchcc occurs ; |571| 
L57:    
;***	-----------------------g14:
;*** 570	-----------------------    ++CROSS_PLUS_U32;
;*** 570	-----------------------    ++CROSS_PLUS_SEARCH_U32;
;*** 570	-----------------------    goto g18;
	.dwpsn	"sensor.c",570,30
        MOVB      ACC,#1
        MOVW      DP,#_CROSS_PLUS_U32
        ADDL      @_CROSS_PLUS_U32,ACC  ; |570| 
	.dwpsn	"sensor.c",570,53
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        ADDL      @_CROSS_PLUS_SEARCH_U32,ACC ; |570| 
	.dwpsn	"sensor.c",570,78
        BF        L61,UNC               ; |570| 
        ; branch occurs ; |570| 
L58:    
;***	-----------------------g15:
;*** 569	-----------------------    ++(*(((long)MARK_U16_CNT<<5)+&Search)).CrossPlus_U32;
;*** 569	-----------------------    ++CROSS_PLUS_SEARCH_U32;
;*** 569	-----------------------    goto g18;
	.dwpsn	"sensor.c",569,28
        MOVW      DP,#_MARK_U16_CNT
        MOVL      XAR4,#_Search+10      ; |569| 
        MOVU      ACC,@_MARK_U16_CNT
        LSL       ACC,5                 ; |569| 
        ADDL      XAR4,ACC
        MOVB      ACC,#1
        ADDL      *+XAR4[0],ACC         ; |569| 
	.dwpsn	"sensor.c",569,66
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        ADDL      @_CROSS_PLUS_SEARCH_U32,ACC ; |569| 
	.dwpsn	"sensor.c",569,91
        BF        L61,UNC               ; |569| 
        ; branch occurs ; |569| 
L59:    
;***	-----------------------g16:
;*** 576	-----------------------    LMotor.CrossCheckDistance_IQ15 = 0L;
;*** 576	-----------------------    RMotor.CrossCheckDistance_IQ15 = 0L;
;*** 576	-----------------------    CROSS_DISTANCE_IQ15 = 0L;
;*** 576	-----------------------    goto g18;
	.dwpsn	"sensor.c",576,7
        MOVB      ACC,#0
        MOVW      DP,#_LMotor+12
        MOVL      @_LMotor+12,ACC       ; |576| 
        MOVW      DP,#_RMotor+12
        MOVL      @_RMotor+12,ACC       ; |576| 
        MOVW      DP,#_CROSS_DISTANCE_IQ15
        MOVL      @_CROSS_DISTANCE_IQ15,ACC ; |576| 
        BF        L61,UNC               ; |576| 
        ; branch occurs ; |576| 
L60:    
;***	-----------------------g17:
...
L61:    
	...
	.dwattr DW$177, DW_AT_end_line(0x241)
...
;*** 337	-----------------------    if ( (*pS).Position_IQ10 > 14848000L ) goto g7;
	...
	.dwpsn	"sensor.c",337,3
        ...
        BF        L63,LT                ; |337| 
        ; branchcc occurs ; |337| 
;*** 338	-----------------------    if ( (*pS).Position_IQ10 >= (-14848000L) ) goto g8;
	.dwpsn	"sensor.c",338,8
        ...
        BF        L64,LEQ               ; |338| 
        ; branchcc occurs ; |338| 
;*** 338	-----------------------    (*pS).Position_IQ10 = (-14848000L);
;*** 338	-----------------------    goto g8;
...
L63:    
;***	-----------------------g7:
;*** 337	-----------------------    (*pS).Position_IQ10 = 14848000L;
...
DW$205	.dwtag  DW_TAG_loop
	.dwattr DW$205, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L86:1:1659895904")
...
L87:    
;***	-----------------------g3:
;*** 433	-----------------------    if ( (U$31 = HanPID.Pos_PID_IQ17) > 0L ) goto g8;
	.dwpsn	"sensor.c",433,3
        MOVW      DP,#_HanPID
        MOVL      XAR1,@_HanPID         ; |433| 
        MOVL      ACC,XAR1              ; |433| 
        BF        L89,GT                ; |433| 
        ; branchcc occurs ; |433| 
;*** 441	-----------------------    if ( U$31 >= 0L ) goto g7;
	.dwpsn	"sensor.c",441,7
        MOVL      ACC,XAR1
        BF        L88,GEQ               ; |441| 
        ; branchcc occurs ; |441| 
;*** 443	-----------------------    LMotor.TargetHandle_IQ17 = __IQmpy(U$31, _IQ17div(ACCEL_COEF_I32<<17, 1310720000L), 17)+131072L;
;*** 444	-----------------------    RMotor.TargetHandle_IQ17 = 131072L-__IQmpy(HanPID.Pos_PID_IQ17, _IQ17div(DECEL_COEF_I32<<17, 131072000L), 17);
;*** 446	-----------------------    if ( LMotor.TargetHandle_IQ17 >= 0L ) goto g10;
	.dwpsn	"sensor.c",443,3
        MOVW      DP,#_ACCEL_COEF_I32
        MOV       PH,#20000
        MOV       PL,#0
        MOV       T,#17                 ; |443| 
        MOVL      ACC,@_ACCEL_COEF_I32  ; |443| 
        MOVL      *-SP[2],P             ; |443| 
        LSLL      ACC,T                 ; |443| 
        LCR       #__IQ17div            ; |443| 
        ; call occurs [#__IQ17div] ; |443| 
        MOVL      XT,XAR1               ; |443| 
        IMPYL     P,XT,ACC              ; |443| 
        MOVL      XT,XAR1               ; |443| 
	...
	.dwpsn	"sensor.c",444,3
        ...
        MOV       PL,#0
        MOV       T,#17                 ; |444| 
        MOVL      ACC,@_DECEL_COEF_I32  ; |444| 
        MOVL      *-SP[2],P             ; |444| 
        LSLL      ACC,T                 ; |444| 
        LCR       #__IQ17div            ; |444| 
        ; call occurs [#__IQ17div] ; |444| 
        MOVW      DP,#_HanPID
        MOVL      XT,@_HanPID           ; |444| 
        IMPYL     P,XT,ACC              ; |444| 
        ...
        SUBL      XAR4,ACC
        MOVW      DP,#_RMotor+36
        MOVL      @_RMotor+36,XAR4      ; |444| 
	.dwpsn	"sensor.c",446,3
        MOVW      DP,#_LMotor+36
        MOVL      ACC,@_LMotor+36       ; |446| 
        BF        L90,GEQ               ; |446| 
        ; branchcc occurs ; |446| 
;*** 447	-----------------------    LMotor.TargetHandle_IQ17 = 0L;
;*** 447	-----------------------    goto g10;
...
L88:    
;***	-----------------------g7:
;*** 451	-----------------------    LMotor.TargetHandle_IQ17 = 131072L;
;*** 452	-----------------------    RMotor.TargetHandle_IQ17 = 131072L;
;*** 452	-----------------------    goto g10;
	.dwpsn	"sensor.c",451,3
        MOVL      XAR4,#131072          ; |451| 
        MOVW      DP,#_LMotor+36
        MOVL      @_LMotor+36,XAR4      ; |451| 
	.dwpsn	"sensor.c",452,3
        MOVW      DP,#_RMotor+36
        MOVL      @_RMotor+36,XAR4      ; |452| 
        BF        L90,UNC               ; |452| 
        ; branch occurs ; |452| 
L89:    
;***	-----------------------g8:
;*** 435	-----------------------    LMotor.TargetHandle_IQ17 = __IQmpy(U$31, _IQ17div(DECEL_COEF_I32<<17, 131072000L), 17)+131072L;
;*** 436	-----------------------    RMotor.TargetHandle_IQ17 = 131072L-__IQmpy(HanPID.Pos_PID_IQ17, _IQ17div(ACCEL_COEF_I32<<17, 1310720000L), 17);
;*** 438	-----------------------    if ( RMotor.TargetHandle_IQ17 >= 0L ) goto g10;
	.dwpsn	"sensor.c",435,3
        ...
        MOVW      DP,#_LMotor+36
        ADD       ACC,#4 << 15          ; |435| 
        MOVL      @_LMotor+36,ACC       ; |435| 
	.dwpsn	"sensor.c",436,3
        MOVW      DP,#_ACCEL_COEF_I32
        MOV       PH,#20000
        MOV       PL,#0
        MOV       T,#17                 ; |436| 
        MOVL      ACC,@_ACCEL_COEF_I32  ; |436| 
        MOVL      *-SP[2],P             ; |436| 
        LSLL      ACC,T                 ; |436| 
        LCR       #__IQ17div            ; |436| 
        ...
        SUBL      XAR4,ACC
        MOVW      DP,#_RMotor+36
        MOVL      @_RMotor+36,XAR4      ; |436| 
	.dwpsn	"sensor.c",438,3
        MOVL      ACC,@_RMotor+36       ; |438| 
        BF        L90,GEQ               ; |438| 
        ; branchcc occurs ; |438| 
;*** 439	-----------------------    RMotor.TargetHandle_IQ17 = 0L;
;***	-----------------------g10:
;***  	-----------------------    return;
	.dwpsn	"sensor.c",439,4
        MOVB      ACC,#0
        MOVL      @_RMotor+36,ACC       ; |439| 
L90:    
	...
	.dwattr DW$207, DW_AT_end_line(0x1c6)
