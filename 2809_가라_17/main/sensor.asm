...
DW$18	.dwtag  DW_TAG_variable, DW_AT_name("Flag"), DW_AT_symbol_name("_Flag")
	.dwattr DW$18, DW_AT_type(*DW$T$193)
...
DW$53	.dwtag  DW_TAG_variable, DW_AT_name("CpuTimer0Regs"), DW_AT_symbol_name("_CpuTimer0Regs")
	.dwattr DW$53, DW_AT_type(*DW$T$183)
...
DW$54	.dwtag  DW_TAG_variable, DW_AT_name("sensor_prog"), DW_AT_symbol_name("_sensor_prog")
	...
	.dwattr DW$54, DW_AT_type(*DW$T$149)
...
DW$68	.dwtag  DW_TAG_variable, DW_AT_name("Search"), DW_AT_symbol_name("_Search")
	.dwattr DW$68, DW_AT_type(*DW$T$157)
	.dwattr DW$68, DW_AT_declaration(0x01)
	.dwattr DW$68, DW_AT_external(0x01)
;	..\Compiler\bin\opt2000.exe C:\Users\노호진\AppData\Local\Temp\TI30810 C:\Users\노호진\AppData\Local\Temp\TI3084 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\노호진\AppData\Local\Temp\TI3082 --template_info_file C:\Users\노호진\AppData\Local\Temp\TI3086 --object_file sensor.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
DW$69	.dwtag  DW_TAG_subprogram, DW_AT_name("MARK_ENABLE_SHIFT"), DW_AT_symbol_name("_MARK_ENABLE_SHIFT")
	...
	.dwattr DW$69, DW_AT_begin_line(0x1b4)
...
;***************************************************************
_MARK_ENABLE_SHIFT:
;*** 438	-----------------------    if ( SENSOR_ENABLE&0xfu ) goto g5;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$73	.dwtag  DW_TAG_variable, DW_AT_name("left"), DW_AT_symbol_name("_left")
	...
	.dwpsn	"sensor.c",438,2
        ...
        MOV       AL,@_SENSOR_ENABLE    ; |438| 
        ANDB      AL,#0x0f              ; |438| 
        BF        L2,NEQ                ; |438| 
        ; branchcc occurs ; |438| 
;*** 439	-----------------------    if ( SENSOR_ENABLE&0xf000u ) goto g4;
	.dwpsn	"sensor.c",439,7
        AND       AL,@_SENSOR_ENABLE,#0xf000 ; |439| 
        BF        L1,NEQ                ; |439| 
        ; branchcc occurs ; |439| 
;*** 440	-----------------------    (*left).MarkEnable_U16 = 0xf000u;
;*** 440	-----------------------    (*right).MarkEnable_U16 = 15u;
;*** 440	-----------------------    goto g6;
	.dwpsn	"sensor.c",440,17
        MOV       *+XAR4[6],#61440      ; |440| 
	.dwpsn	"sensor.c",440,59
        MOV       *+XAR5[6],#15         ; |440| 
        BF        L3,UNC                ; |440| 
        ; branch occurs ; |440| 
L1:    
...
;*** 439	-----------------------    (*right).MarkEnable_U16 = 15u<<SENSOR_STATE_U16_CNT;
;*** 439	-----------------------    goto g6;
	.dwpsn	"sensor.c",439,41
        MOVW      DP,#_SENSOR_STATE_U16_CNT
        MOV       AL,#61440             ; |439| 
        MOV       T,@_SENSOR_STATE_U16_CNT ; |439| 
        LSL       AL,T                  ; |439| 
        MOV       *+XAR4[6],AL          ; |439| 
	.dwpsn	"sensor.c",439,101
        MOV       T,@_SENSOR_STATE_U16_CNT ; |439| 
        MOVB      AL,#15                ; |439| 
        LSL       AL,T                  ; |439| 
        MOV       *+XAR5[6],AL          ; |439| 
	.dwpsn	"sensor.c",439,163
        BF        L3,UNC                ; |439| 
        ; branch occurs ; |439| 
L2:    
;***	-----------------------g5:
;*** 438	-----------------------    (*left).MarkEnable_U16 = 0xf000u>>SENSOR_STATE_U16_CNT;
;*** 438	-----------------------    (*right).MarkEnable_U16 = 15>>SENSOR_STATE_U16_CNT;
;***	-----------------------g6:
;***  	-----------------------    return;
	.dwpsn	"sensor.c",438,38
        MOVW      DP,#_SENSOR_STATE_U16_CNT
        MOV       AL,#61440             ; |438| 
        MOV       T,@_SENSOR_STATE_U16_CNT ; |438| 
        LSR       AL,T                  ; |438| 
        MOV       *+XAR4[6],AL          ; |438| 
	.dwpsn	"sensor.c",438,98
        MOV       T,@_SENSOR_STATE_U16_CNT ; |438| 
        MOVB      AL,#15                ; |438| 
        LSR       AL,T                  ; |438| 
        MOV       *+XAR5[6],AL          ; |438| 
L3:    
	...
	.dwattr DW$69, DW_AT_end_line(0x1b9)
...
DW$74	.dwtag  DW_TAG_subprogram, DW_AT_name("TURN_DECIDE"), DW_AT_symbol_name("_TURN_DECIDE")
	...
	.dwattr DW$74, DW_AT_begin_line(0x1bb)
...
;***************************************************************
_TURN_DECIDE:
;*** 445	-----------------------    if ( *((volatile unsigned * const)mark+7)&2u ) goto g12;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$77	.dwtag  DW_TAG_variable, DW_AT_name("remark"), DW_AT_symbol_name("_remark")
	.dwattr DW$77, DW_AT_type(*DW$T$154)
...
DW$78	.dwtag  DW_TAG_variable, DW_AT_name("mark"), DW_AT_symbol_name("_mark")
	.dwattr DW$78, DW_AT_type(*DW$T$154)
...
DW$79	.dwtag  DW_TAG_variable, DW_AT_name("K$6"), DW_AT_symbol_name("K$6")
	...
	.dwpsn	"sensor.c",445,2
        ...
        ; branchcc occurs ; |445| 
;*** 487	-----------------------    K$6 = &RMark;
;*** 487	-----------------------    MARK_ENABLE_SHIFT(&LMark, K$6);
;*** 490	-----------------------    if ( !((*mark).MarkEnable_U16&SENSOR_STATE_U16) ) goto g11;
	.dwpsn	"sensor.c",487,2
        MOVL      XAR4,#_RMark          ; |487| 
        MOVL      XAR5,XAR4             ; |487| 
        MOVL      XAR7,XAR4             ; |487| 
        MOVL      XAR4,#_LMark          ; |487| 
        LCR       #_MARK_ENABLE_SHIFT   ; |487| 
        ; call occurs [#_MARK_ENABLE_SHIFT] ; |487| 
	.dwpsn	"sensor.c",490,2
        MOVW      DP,#_SENSOR_STATE_U16
        MOV       AL,@_SENSOR_STATE_U16 ; |490| 
        AND       AL,*+XAR6[6]          ; |490| 
        BF        L7,EQ                 ; |490| 
        ; branchcc occurs ; |490| 
;*** 492	-----------------------    if ( !(*((volatile unsigned * const)mark+7)&1u) ) goto g10;
	.dwpsn	"sensor.c",492,3
        TBIT      *+XAR6[7],#0          ; |492| 
        BF        L6,NTC                ; |492| 
        ; branchcc occurs ; |492| 
;*** 501	-----------------------    if ( (*mark).TurnmarkDistance_IQ17 <= (*mark).LimitDistance_IQ17 ) goto g27;
	.dwpsn	"sensor.c",501,8
        MOVL      ACC,*+XAR6[2]         ; |501| 
        CMPL      ACC,*+XAR6[0]         ; |501| 
        BF        L13,GEQ               ; |501| 
        ; branchcc occurs ; |501| 
;*** 503	-----------------------    *((volatile unsigned * const)mark+7) |= 2u;
;*** 504	-----------------------    (*mark).LimitDistance_IQ17 = (*mark).TurnmarkDistance_IQ17+7864320L;
;*** 506	-----------------------    if ( mark == K$6 ) goto g7;
	.dwpsn	"sensor.c",503,4
        OR        *+XAR6[7],#0x0002     ; |503| 
	...
	.dwpsn	"sensor.c",506,4
        ...
        BF        L4,EQ                 ; |506| 
        ; branchcc occurs ; |506| 
;*** 509	-----------------------    *(&GpioDataRegs+10L) |= 2u;
;*** 509	-----------------------    goto g8;
	.dwpsn	"sensor.c",509,5
        MOVW      DP,#_GpioDataRegs+10
        OR        @_GpioDataRegs+10,#0x0002 ; |509| 
        BF        L5,UNC                ; |509| 
        ; branch occurs ; |509| 
L4:    
;***	-----------------------g7:
;*** 507	-----------------------    *(&GpioDataRegs+10L) |= 4u;
	.dwpsn	"sensor.c",507,5
        MOVW      DP,#_GpioDataRegs+10
        OR        @_GpioDataRegs+10,#0x0004 ; |507| 
L5:    
;***	-----------------------g8:
;*** 507	-----------------------    if ( *&Flag&0x8u ) goto g27;
        MOVW      DP,#_Flag
        TBIT      @_Flag,#3             ; |507| 
        BF        L13,TC                ; |507| 
        ; branchcc occurs ; |507| 
;*** 512	-----------------------    *(&GpioDataRegs+10L) |= 1u;
;*** 512	-----------------------    goto g27;
	.dwpsn	"sensor.c",512,5
        MOVW      DP,#_GpioDataRegs+10
        OR        @_GpioDataRegs+10,#0x0001 ; |512| 
        BF        L13,UNC               ; |512| 
        ; branch occurs ; |512| 
L6:    
;***	-----------------------g10:
;*** 494	-----------------------    RMotor.TurnMarkCheckDistance_IQ17 = 0L;
;*** 495	-----------------------    LMotor.TurnMarkCheckDistance_IQ17 = 0L;
;*** 496	-----------------------    (*mark).TurnmarkDistance_IQ17 = 0L;
;*** 498	-----------------------    (*mark).LimitDistance_IQ17 = (*mark).TurnmarkDistance_IQ17+655360L;
;*** 499	-----------------------    *((volatile unsigned * const)mark+7) |= 1u;
;*** 500	-----------------------    goto g27;
	.dwpsn	"sensor.c",494,4
        MOVB      ACC,#0
        MOVW      DP,#_RMotor+8
        MOVL      @_RMotor+8,ACC        ; |494| 
	.dwpsn	"sensor.c",495,4
        MOVW      DP,#_LMotor+8
        MOVL      @_LMotor+8,ACC        ; |495| 
	.dwpsn	"sensor.c",496,4
        MOVL      *+XAR6[0],ACC         ; |496| 
	.dwpsn	"sensor.c",498,4
        MOVL      XAR4,#655360          ; |498| 
        MOVL      ACC,XAR4              ; |498| 
        ADDL      ACC,*+XAR6[0]         ; |498| 
        MOVL      *+XAR6[2],ACC         ; |498| 
	.dwpsn	"sensor.c",499,4
        OR        *+XAR6[7],#0x0001     ; |499| 
	.dwpsn	"sensor.c",500,3
        BF        L13,UNC               ; |500| 
        ; branch occurs ; |500| 
L7:    
;***	-----------------------g11:
;*** 518	-----------------------    (*mark).TurnmarkDistance_IQ17 = 0L;
;*** 519	-----------------------    *((volatile unsigned * const)mark+7) &= 0xfffeu;
;*** 519	-----------------------    goto g27;
	.dwpsn	"sensor.c",518,3
        MOVB      ACC,#0
        MOVL      *+XAR6[0],ACC         ; |518| 
	.dwpsn	"sensor.c",519,3
        AND       *+XAR6[7],#0xfffe     ; |519| 
        BF        L13,UNC               ; |519| 
        ; branch occurs ; |519| 
L8:    
;***	-----------------------g12:
;*** 447	-----------------------    if ( (*mark).TurnmarkDistance_IQ17 > (*mark).LimitDistance_IQ17 ) goto g15;
	.dwpsn	"sensor.c",447,3
        MOVL      ACC,*+XAR6[2]         ; |447| 
        CMPL      ACC,*+XAR6[0]         ; |447| 
        BF        L9,LT                 ; |447| 
        ; branchcc occurs ; |447| 
;*** 481	-----------------------    if ( !(*((volatile unsigned * const)remark+7)&2u) ) goto g27;
	.dwpsn	"sensor.c",481,8
        TBIT      *+XAR5[7],#1          ; |481| 
        BF        L13,NTC               ; |481| 
        ; branchcc occurs ; |481| 
;*** 482	-----------------------    *((volatile unsigned * const)mark+7) |= 4u;
;*** 482	-----------------------    goto g27;
	.dwpsn	"sensor.c",482,4
        OR        *+XAR6[7],#0x0004     ; |482| 
        BF        L13,UNC               ; |482| 
        ; branch occurs ; |482| 
L9:    
;***	-----------------------g15:
;*** 449	-----------------------    *(&GpioDataRegs+12L) |= 4u;
;*** 450	-----------------------    *(&GpioDataRegs+12L) |= 2u;
;*** 451	-----------------------    *(&GpioDataRegs+12L) |= 1u;
;*** 453	-----------------------    *((volatile unsigned * const)mark+7) &= 0xfffdu;
;*** 454	-----------------------    *((volatile unsigned * const)mark+7) &= 0xfffeu;
;*** 455	-----------------------    (*mark).TurnmarkDistance_IQ17 = 0L;
;*** 458	-----------------------    if ( *((volatile unsigned * const)mark+7)&4u ) goto g24;
	.dwpsn	"sensor.c",449,4
        MOVW      DP,#_GpioDataRegs+12
        OR        @_GpioDataRegs+12,#0x0004 ; |449| 
	.dwpsn	"sensor.c",450,4
        OR        @_GpioDataRegs+12,#0x0002 ; |450| 
	.dwpsn	"sensor.c",451,4
        OR        @_GpioDataRegs+12,#0x0001 ; |451| 
	.dwpsn	"sensor.c",453,4
        AND       *+XAR6[7],#0xfffd     ; |453| 
	.dwpsn	"sensor.c",454,4
        AND       *+XAR6[7],#0xfffe     ; |454| 
...
;*** 470	-----------------------    if ( *&Flag&0x8u ) goto g27;
        ...
        BF        L13,TC                ; |470| 
        ; branchcc occurs ; |470| 
;*** 473	-----------------------    if ( *&Flag&0x40u ) goto g23;
	.dwpsn	"sensor.c",473,5
        TBIT      @_Flag,#6             ; |473| 
        BF        L11,TC                ; |473| 
        ; branchcc occurs ; |473| 
;*** 475	-----------------------    if ( *&Flag&0x80u ) goto g22;
	.dwpsn	"sensor.c",475,10
        TBIT      @_Flag,#7             ; |475| 
        BF        L10,TC                ; |475| 
        ; branchcc occurs ; |475| 
;*** 477	-----------------------    if ( !(*&Flag&0x100u) ) goto g27;
	.dwpsn	"sensor.c",477,10
        TBIT      @_Flag,#8             ; |477| 
        BF        L13,NTC               ; |477| 
        ; branchcc occurs ; |477| 
;*** 478	-----------------------    LINE_THIRD((long)THIRD_MARK_U16_CNT*36+&Search);
;*** 478	-----------------------    goto g27;
	.dwpsn	"sensor.c",478,6
        MOVW      DP,#_THIRD_MARK_U16_CNT
        MOV       T,#36                 ; |478| 
        MPYXU     ACC,T,@_THIRD_MARK_U16_CNT ; |478| 
        MOVL      XAR4,#_Search         ; |478| 
        ADDL      XAR4,ACC
        LCR       #_LINE_THIRD          ; |478| 
        ; call occurs [#_LINE_THIRD] ; |478| 
        BF        L13,UNC               ; |478| 
        ; branch occurs ; |478| 
L10:    
;***	-----------------------g22:
;*** 476	-----------------------    LINE_SECOND((long)SECOND_MARK_U16_CNT*36+&Search);
;*** 476	-----------------------    goto g27;
	.dwpsn	"sensor.c",476,6
        MOVW      DP,#_SECOND_MARK_U16_CNT
        MOV       T,#36                 ; |476| 
        MPYXU     ACC,T,@_SECOND_MARK_U16_CNT ; |476| 
        MOVL      XAR4,#_Search         ; |476| 
        ADDL      XAR4,ACC
        LCR       #_LINE_SECOND         ; |476| 
        ; call occurs [#_LINE_SECOND] ; |476| 
        BF        L13,UNC               ; |476| 
        ; branch occurs ; |476| 
L11:    
;***	-----------------------g23:
...
;*** 474	-----------------------    goto g27;
	.dwpsn	"sensor.c",474,6
        MOVL      XAR4,XAR6             ; |474| 
        LCR       #_LINE_INFO           ; |474| 
        ; call occurs [#_LINE_INFO] ; |474| 
        BF        L13,UNC               ; |474| 
        ; branch occurs ; |474| 
L12:    
;***	-----------------------g24:
;*** 459	-----------------------    *((volatile unsigned * const)mark+7) &= 0xfffbu;
;*** 461	-----------------------    if ( mark != &RMark ) goto g27;
	.dwpsn	"sensor.c",459,5
        AND       *+XAR6[7],#0xfffb     ; |459| 
	.dwpsn	"sensor.c",461,5
        MOVL      XAR4,#_RMark          ; |461| 
        MOVL      ACC,XAR4              ; |461| 
        CMPL      ACC,XAR6              ; |461| 
        BF        L13,NEQ               ; |461| 
        ; branchcc occurs ; |461| 
;*** 462	-----------------------    if ( *&Flag&0x8u ) goto g27;
...
;***  	-----------------------    return;
	.dwpsn	"sensor.c",465,6
        LCR       #_START_END_LINE      ; |465| 
        ; call occurs [#_START_END_LINE] ; |465| 
L13:    
	.dwpsn	"sensor.c",521,1
        LRETR
        ; return occurs
	.dwattr DW$74, DW_AT_end_file("sensor.c")
	.dwattr DW$74, DW_AT_end_line(0x209)
...
DW$119	.dwtag  DW_TAG_loop
	.dwattr DW$119, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L48:1:1692388961")
...
DW$129	.dwtag  DW_TAG_loop
	.dwattr DW$129, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L42:1:1692388961")
...
DW$131	.dwtag  DW_TAG_loop
	.dwattr DW$131, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L41:1:1692388961")
...
DW$133	.dwtag  DW_TAG_loop
	.dwattr DW$133, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L40:1:1692388961")
...
DW$135	.dwtag  DW_TAG_loop
	.dwattr DW$135, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L35:1:1692388961")
...
DW$142	.dwtag  DW_TAG_loop
	.dwattr DW$142, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L30:1:1692388961")
...
DW$149	.dwtag  DW_TAG_loop
	.dwattr DW$149, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L25:1:1692388961")
...
DW$156	.dwtag  DW_TAG_loop
	.dwattr DW$156, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L24:1:1692388961")
...
DW$158	.dwtag  DW_TAG_loop
	.dwattr DW$158, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L19:1:1692388961")
...
DW$161	.dwtag  DW_TAG_loop
	.dwattr DW$161, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L20:2:1692388961")
...
DW$166	.dwtag  DW_TAG_loop
	.dwattr DW$166, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L14:1:1692388961")
...
DW$169	.dwtag  DW_TAG_loop
	.dwattr DW$169, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L15:2:1692388961")
...
DW$177	.dwtag  DW_TAG_subprogram, DW_AT_name("CROSS_CHECK"), DW_AT_symbol_name("_CROSS_CHECK$0")
	...
	.dwattr DW$177, DW_AT_begin_line(0x20b)
...
;*** 527	-----------------------    condition2 = 0u;
;*** 528	-----------------------    condition3 = 0u;
;*** 530	-----------------------    if ( SENSOR_ENABLE&0xfu ) goto g5;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        ADDB      SP,#4
...
DW$182	.dwtag  DW_TAG_variable, DW_AT_name("condition3"), DW_AT_symbol_name("_condition3")
	...
	.dwpsn	"sensor.c",530,2
        MOVW      DP,#_SENSOR_ENABLE
        MOV       AL,@_SENSOR_ENABLE    ; |530| 
        ANDB      AL,#0x0f              ; |530| 
        BF        L52,NEQ               ; |530| 
        ; branchcc occurs ; |530| 
;*** 531	-----------------------    if ( SENSOR_ENABLE&0xf000u ) goto g4;
	.dwpsn	"sensor.c",531,7
        AND       AL,@_SENSOR_ENABLE,#0xf000 ; |531| 
        BF        L51,NEQ               ; |531| 
        ; branchcc occurs ; |531| 
;*** 532	-----------------------    state = 9u;
;*** 532	-----------------------    goto g6;
	.dwpsn	"sensor.c",532,15
        MOV       *-SP[1],#9            ; |532| 
        BF        L53,UNC               ; |532| 
        ; branch occurs ; |532| 
L51:    
;***	-----------------------g4:
;*** 531	-----------------------    state = SENSOR_STATE_U16_CNT+9u;
;*** 531	-----------------------    goto g6;
	.dwpsn	"sensor.c",531,39
        MOVW      DP,#_SENSOR_STATE_U16_CNT
        MOV       AL,@_SENSOR_STATE_U16_CNT ; |531| 
        ADDB      AL,#9                 ; |531| 
        MOV       *-SP[1],AL            ; |531| 
        BF        L53,UNC               ; |531| 
        ; branch occurs ; |531| 
L52:    
;***	-----------------------g5:
;*** 530	-----------------------    state = 9u-SENSOR_STATE_U16_CNT;
	.dwpsn	"sensor.c",530,36
        MOVB      AL,#9                 ; |530| 
        MOVW      DP,#_SENSOR_STATE_U16_CNT
        SUB       AL,@_SENSOR_STATE_U16_CNT ; |530| 
        MOV       *-SP[1],AL            ; |530| 
L53:    
;***	-----------------------g6:
;*** 534	-----------------------    C$1 = &state_table[0];
;*** 534	-----------------------    condition1 = (C$1[state]&SENSOR_STATE_U16) == C$1[state];
	.dwpsn	"sensor.c",534,2
        MOVW      DP,#_SENSOR_STATE_U16
        MOVZ      AR0,*-SP[1]           ; |534| 
        MOVB      AH,#0
        MOVL      XAR5,#_state_table    ; |534| 
        MOV       AL,@_SENSOR_STATE_U16 ; |534| 
        AND       AL,*+XAR5[AR0]        ; |534| 
        MOVZ      AR0,*-SP[1]           ; |534| 
        CMP       AL,*+XAR5[AR0]        ; |534| 
        BF        L54,NEQ               ; |534| 
        ...
        MOVB      AH,#1                 ; |534| 
L54:    
;*** 535	-----------------------    condition2 = (C$1[state-1]&SENSOR_STATE_U16) == C$1[state-1];
        MOV       *-SP[2],AH            ; |534| 
	.dwpsn	"sensor.c",535,2
        MOV       AL,*-SP[1]            ; |535| 
        ADDB      AL,#-1
        MOVZ      AR0,AL                ; |535| 
        MOV       AH,@_SENSOR_STATE_U16 ; |535| 
        AND       AH,*+XAR5[AR0]        ; |535| 
        MOV       AL,*-SP[1]            ; |535| 
        ADDB      AL,#-1
        MOVZ      AR0,AL                ; |535| 
        ...
        MOVB      XAR4,#1               ; |535| 
L55:    
;*** 536	-----------------------    condition3 = (C$1[state+1]&SENSOR_STATE_U16) == C$1[state+1];
        MOV       *-SP[3],AR4           ; |535| 
	.dwpsn	"sensor.c",536,2
        ...
        MOVB      XAR4,#1               ; |536| 
L56:    
;*** 537	-----------------------    if ( condition1 ) goto g17;
        MOV       *-SP[4],AR4           ; |536| 
	.dwpsn	"sensor.c",537,2
        MOV       AL,*-SP[2]            ; |537| 
        BF        L60,NEQ               ; |537| 
        ; branchcc occurs ; |537| 
;*** 537	-----------------------    if ( condition2 ) goto g17;
        MOV       AL,*-SP[3]            ; |537| 
        BF        L60,NEQ               ; |537| 
        ; branchcc occurs ; |537| 
;*** 537	-----------------------    if ( condition3 ) goto g17;
        MOV       AL,*-SP[4]            ; |537| 
        BF        L60,NEQ               ; |537| 
        ; branchcc occurs ; |537| 
;*** 538	-----------------------    if ( !(*&Flag&0x8u) ) goto g16;
	.dwpsn	"sensor.c",538,7
        MOVW      DP,#_Flag
        TBIT      @_Flag,#3             ; |538| 
        BF        L59,NTC               ; |538| 
        ; branchcc occurs ; |538| 
;*** 540	-----------------------    if ( (CROSS_DISTANCE_IQ15 = RMotor.CrossCheckDistance_IQ15+LMotor.CrossCheckDistance_IQ15>>1) <= 4915200L ) goto g18;
	.dwpsn	"sensor.c",540,3
        MOVW      DP,#_LMotor+12
        MOVL      ACC,@_LMotor+12       ; |540| 
        SETC      SXM
        MOVW      DP,#_RMotor+12
        ADDL      ACC,@_RMotor+12       ; |540| 
        SFR       ACC,1                 ; |540| 
...
;*** 544	-----------------------    *(&LMark+7) &= 0xfffeu;
;*** 544	-----------------------    *(&RMark+7) &= 0xfffeu;
;*** 545	-----------------------    LMark.TurnmarkDistance_IQ17 = 0L;
;*** 545	-----------------------    RMark.TurnmarkDistance_IQ17 = 0L;
;*** 546	-----------------------    LMotor.CrossCheckDistance_IQ15 = 0L;
;*** 546	-----------------------    RMotor.CrossCheckDistance_IQ15 = 0L;
;*** 547	-----------------------    CROSS_DISTANCE_IQ15 = 0L;
;*** 549	-----------------------    if ( *&Flag&0x40u ) goto g15;
	.dwpsn	"sensor.c",543,4
        MOVW      DP,#_Flag
        AND       @_Flag,#0xfff7        ; |543| 
	.dwpsn	"sensor.c",544,4
        MOVW      DP,#_LMark+7
        AND       @_LMark+7,#0xfffe     ; |544| 
        MOVW      DP,#_RMark+7
        AND       @_RMark+7,#0xfffe     ; |544| 
	...
	.dwpsn	"sensor.c",546,4
        MOVW      DP,#_LMotor+12
        MOVL      @_LMotor+12,ACC       ; |546| 
        MOVW      DP,#_RMotor+12
        MOVL      @_RMotor+12,ACC       ; |546| 
	.dwpsn	"sensor.c",547,4
        MOVW      DP,#_CROSS_DISTANCE_IQ15
        MOVL      @_CROSS_DISTANCE_IQ15,ACC ; |547| 
	.dwpsn	"sensor.c",549,4
        MOVW      DP,#_Flag
        TBIT      @_Flag,#6             ; |549| 
        BF        L58,TC                ; |549| 
        ; branchcc occurs ; |549| 
;*** 550	-----------------------    if ( *&Flag&0x80u ) goto g14;
	.dwpsn	"sensor.c",550,9
        TBIT      @_Flag,#7             ; |550| 
        BF        L57,TC                ; |550| 
        ; branchcc occurs ; |550| 
;*** 551	-----------------------    if ( !(*&Flag&0x100u) ) goto g18;
...
;*** 550	-----------------------    goto g18;
	.dwpsn	"sensor.c",550,30
        MOVB      ACC,#1
        MOVW      DP,#_CROSS_PLUS_U32
        ADDL      @_CROSS_PLUS_U32,ACC  ; |550| 
	.dwpsn	"sensor.c",550,53
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        ADDL      @_CROSS_PLUS_SEARCH_U32,ACC ; |550| 
	.dwpsn	"sensor.c",550,78
        BF        L61,UNC               ; |550| 
        ; branch occurs ; |550| 
L58:    
;***	-----------------------g15:
;*** 549	-----------------------    ++(Search[(long)MARK_U16_CNT]).CrossPlus_U32;
;*** 549	-----------------------    ++CROSS_PLUS_SEARCH_U32;
;*** 549	-----------------------    goto g18;
	.dwpsn	"sensor.c",549,28
        MOVW      DP,#_MARK_U16_CNT
        MOV       T,#36                 ; |549| 
        MOVL      XAR4,#_Search+10      ; |549| 
        MPYXU     ACC,T,@_MARK_U16_CNT  ; |549| 
        ADDL      XAR4,ACC
        MOVB      ACC,#1
        ADDL      *+XAR4[0],ACC         ; |549| 
	.dwpsn	"sensor.c",549,66
        MOVW      DP,#_CROSS_PLUS_SEARCH_U32
        ADDL      @_CROSS_PLUS_SEARCH_U32,ACC ; |549| 
	.dwpsn	"sensor.c",549,91
        BF        L61,UNC               ; |549| 
        ; branch occurs ; |549| 
L59:    
;***	-----------------------g16:
;*** 556	-----------------------    LMotor.CrossCheckDistance_IQ15 = 0L;
;*** 556	-----------------------    RMotor.CrossCheckDistance_IQ15 = 0L;
;*** 556	-----------------------    CROSS_DISTANCE_IQ15 = 0L;
;*** 556	-----------------------    goto g18;
	.dwpsn	"sensor.c",556,7
        MOVB      ACC,#0
        MOVW      DP,#_LMotor+12
        MOVL      @_LMotor+12,ACC       ; |556| 
        MOVW      DP,#_RMotor+12
        MOVL      @_RMotor+12,ACC       ; |556| 
        MOVW      DP,#_CROSS_DISTANCE_IQ15
...
L61:    
	...
	.dwattr DW$177, DW_AT_end_line(0x22d)
...
DW$183	.dwtag  DW_TAG_subprogram, DW_AT_name("HANDLE"), DW_AT_symbol_name("_HANDLE")
	...
	.dwattr DW$183, DW_AT_begin_line(0x183)
...
;***************************************************************
_HANDLE:
;*** 405	-----------------------    HanPID.Pos_P_IQ17 = __IQxmpy(HanPID.Kp_val_IQ17, SenAdc.PositionTemporary_IQ10+SenAdc.PositionShift_IQ10, 22);
;*** 408	-----------------------    HanPID.Pos_PID_IQ17 = __IQmpy(HanPID.Pos_P_IQ17, 131L, 17);
;*** 410	-----------------------    if ( HanPID.Pos_PID_IQ17 > 1572864L ) goto g4;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
	.dwpsn	"sensor.c",405,2
        MOVW      DP,#_SenAdc+86
        MOVL      ACC,@_SenAdc+86       ; |405| 
        ADDL      ACC,@_SenAdc+84       ; |405| 
        MOVW      DP,#_HanPID+16
        MOVL      XT,@_HanPID+16        ; |405| 
        IMPYL     P,XT,ACC              ; |405| 
        QMPYL     ACC,XT,ACC            ; |405| 
        ASR64     ACC:P,10              ; |405| 
        MOVL      @_HanPID+2,P          ; |405| 
	.dwpsn	"sensor.c",408,2
        MOVB      ACC,#131
        MOVL      XT,@_HanPID+2         ; |408| 
        IMPYL     P,XT,ACC              ; |408| 
        QMPYL     ACC,XT,ACC            ; |408| 
        LSL64     ACC:P,#15             ; |408| 
        MOVL      @_HanPID,ACC          ; |408| 
	.dwpsn	"sensor.c",410,2
        MOVL      XAR4,#1572864         ; |410| 
        MOVL      ACC,XAR4              ; |410| 
        CMPL      ACC,@_HanPID          ; |410| 
        BF        L62,LT                ; |410| 
        ; branchcc occurs ; |410| 
;*** 411	-----------------------    if ( HanPID.Pos_PID_IQ17 >= (-1572864L) ) goto g5;
...
L62:    
;***	-----------------------g4:
;*** 410	-----------------------    HanPID.Pos_PID_IQ17 = 1572864L;
	.dwpsn	"sensor.c",410,45
        MOVL      @_HanPID,XAR4         ; |410| 
L63:    
;***	-----------------------g5:
;*** 413	-----------------------    if ( HanPID.Pos_PID_IQ17 > 0L ) goto g10;
	.dwpsn	"sensor.c",413,2
        MOVL      ACC,@_HanPID          ; |413| 
        BF        L65,GT                ; |413| 
        ; branchcc occurs ; |413| 
;*** 421	-----------------------    if ( HanPID.Pos_PID_IQ17 >= 0L ) goto g9;
	.dwpsn	"sensor.c",421,7
        MOVL      ACC,@_HanPID          ; |421| 
        BF        L64,GEQ               ; |421| 
        ; branchcc occurs ; |421| 
;*** 423	-----------------------    RMotor.TargetHandle_IQ17 = __IQmpy(HanPID.Pos_PID_IQ17, __IQmpy(ACCEL_COEF_I32<<17, 13L, 17), 17)+131072L;
;*** 424	-----------------------    LMotor.TargetHandle_IQ17 = 131072L-__IQmpy(HanPID.Pos_PID_IQ17, __IQmpy(DECEL_COEF_I32<<17, 131L, 17), 17);
;*** 426	-----------------------    if ( RMotor.TargetHandle_IQ17 >= 0L ) goto g12;
	.dwpsn	"sensor.c",423,3
        MOVW      DP,#_ACCEL_COEF_I32
        MOV       T,#17                 ; |423| 
        MOVL      ACC,@_ACCEL_COEF_I32  ; |423| 
        MOVB      XAR6,#13
        LSLL      ACC,T                 ; |423| 
        MOVL      XT,ACC                ; |423| 
        MOVW      DP,#_HanPID
	...
	.dwpsn	"sensor.c",426,3
        MOVW      DP,#_RMotor+38
        MOVL      ACC,@_RMotor+38       ; |426| 
        BF        L66,GEQ               ; |426| 
        ; branchcc occurs ; |426| 
;*** 427	-----------------------    RMotor.TargetHandle_IQ17 = 0L;
;*** 427	-----------------------    goto g12;
...
L64:    
;***	-----------------------g9:
;*** 431	-----------------------    RMotor.TargetHandle_IQ17 = 131072L;
;*** 432	-----------------------    LMotor.TargetHandle_IQ17 = 131072L;
;*** 432	-----------------------    goto g12;
	.dwpsn	"sensor.c",431,3
        MOVL      XAR4,#131072          ; |431| 
        MOVW      DP,#_RMotor+38
        MOVL      @_RMotor+38,XAR4      ; |431| 
...
L65:    
;***	-----------------------g10:
;*** 415	-----------------------    RMotor.TargetHandle_IQ17 = __IQmpy(HanPID.Pos_PID_IQ17, __IQmpy(DECEL_COEF_I32<<17, 131L, 17), 17)+131072L;
;*** 416	-----------------------    LMotor.TargetHandle_IQ17 = 131072L-__IQmpy(HanPID.Pos_PID_IQ17, __IQmpy(ACCEL_COEF_I32<<17, 13L, 17), 17);
;*** 418	-----------------------    if ( LMotor.TargetHandle_IQ17 >= 0L ) goto g12;
	.dwpsn	"sensor.c",415,3
        MOVW      DP,#_DECEL_COEF_I32
        MOV       T,#17                 ; |415| 
        MOVL      ACC,@_DECEL_COEF_I32  ; |415| 
        MOVB      XAR6,#131
        LSLL      ACC,T                 ; |415| 
        MOVL      XT,ACC                ; |415| 
        MOVW      DP,#_HanPID
        ...
        MOVW      DP,#_RMotor+38
        ADD       ACC,#4 << 15          ; |415| 
        MOVL      @_RMotor+38,ACC       ; |415| 
	.dwpsn	"sensor.c",416,3
        MOVW      DP,#_ACCEL_COEF_I32
        MOV       T,#17                 ; |416| 
        MOVB      XAR6,#13
        MOVL      ACC,@_ACCEL_COEF_I32  ; |416| 
        LSLL      ACC,T                 ; |416| 
        MOVL      XT,ACC                ; |416| 
        IMPYL     P,XT,XAR6             ; |416| 
        MOVL      XT,ACC                ; |416| 
	...
	.dwpsn	"sensor.c",418,3
        MOVL      ACC,@_LMotor+38       ; |418| 
        BF        L66,GEQ               ; |418| 
        ; branchcc occurs ; |418| 
;*** 419	-----------------------    LMotor.TargetHandle_IQ17 = 0L;
;***	-----------------------g12:
;***  	-----------------------    return;
	.dwpsn	"sensor.c",419,4
        MOVB      ACC,#0
        MOVL      @_LMotor+38,ACC       ; |419| 
L66:    
	.dwpsn	"sensor.c",434,1
        LRETR
        ; return occurs
	.dwattr DW$183, DW_AT_end_file("sensor.c")
	.dwattr DW$183, DW_AT_end_line(0x1b2)
...
DW$184	.dwtag  DW_TAG_subprogram, DW_AT_name("POSITION_COMPUTE"), DW_AT_symbol_name("_POSITION_COMPUTE")
	.dwattr DW$184, DW_AT_low_pc(_POSITION_COMPUTE)
	.dwattr DW$184, DW_AT_high_pc(0x00)
	.dwattr DW$184, DW_AT_begin_file("sensor.c")
	.dwattr DW$184, DW_AT_begin_line(0x139)
...
;*** 325	-----------------------    if ( !sum_127div_u16 ) goto g41;
	...
	.dwcfa	0x1d, -18
;* AR4   assigned to _pS
DW$185	.dwtag  DW_TAG_formal_parameter, DW_AT_name("pS"), DW_AT_symbol_name("_pS")
	.dwattr DW$185, DW_AT_type(*DW$T$111)
	.dwattr DW$185, DW_AT_location[DW_OP_reg12]
;* AR5   assigned to _pA
DW$186	.dwtag  DW_TAG_formal_parameter, DW_AT_name("pA"), DW_AT_symbol_name("_pA")
	.dwattr DW$186, DW_AT_type(*DW$T$113)
	.dwattr DW$186, DW_AT_location[DW_OP_reg14]
DW$187	.dwtag  DW_TAG_formal_parameter, DW_AT_name("state"), DW_AT_symbol_name("_state")
	.dwattr DW$187, DW_AT_type(*DW$T$114)
	.dwattr DW$187, DW_AT_location[DW_OP_breg20 -20]
DW$188	.dwtag  DW_TAG_formal_parameter, DW_AT_name("enable"), DW_AT_symbol_name("_enable")
	.dwattr DW$188, DW_AT_type(*DW$T$114)
	.dwattr DW$188, DW_AT_location[DW_OP_breg20 -22]
DW$189	.dwtag  DW_TAG_variable, DW_AT_name("enable"), DW_AT_symbol_name("_enable")
...
;* AR3   assigned to _pA
DW$191	.dwtag  DW_TAG_variable, DW_AT_name("pA"), DW_AT_symbol_name("_pA")
	.dwattr DW$191, DW_AT_type(*DW$T$133)
	.dwattr DW$191, DW_AT_location[DW_OP_reg10]
;* AR1   assigned to _pS
DW$192	.dwtag  DW_TAG_variable, DW_AT_name("pS"), DW_AT_symbol_name("_pS")
	.dwattr DW$192, DW_AT_type(*DW$T$160)
...
;*** 373	-----------------------    return;
	...
	.dwattr DW$184, DW_AT_end_line(0x176)
...
DW$205	.dwtag  DW_TAG_loop
	.dwattr DW$205, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\sensor.asm:L88:1:1692388961")
...
DW$207	.dwtag  DW_TAG_subprogram, DW_AT_name("ADC_ISR"), DW_AT_symbol_name("_ADC_ISR")
	.dwattr DW$207, DW_AT_low_pc(_ADC_ISR)
	.dwattr DW$207, DW_AT_high_pc(0x00)
	.dwattr DW$207, DW_AT_begin_file("sensor.c")
	.dwattr DW$207, DW_AT_begin_line(0x84)
...
DW$208	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	.dwattr DW$208, DW_AT_type(*DW$T$171)
	.dwattr DW$208, DW_AT_location[DW_OP_reg12]
;* AR7   assigned to _adc_result0
DW$209	.dwtag  DW_TAG_variable, DW_AT_name("adc_result0"), DW_AT_symbol_name("_adc_result0")
	.dwattr DW$209, DW_AT_type(*DW$T$20)
	.dwattr DW$209, DW_AT_location[DW_OP_reg18]
;* AR6   assigned to _adc_result1
DW$210	.dwtag  DW_TAG_variable, DW_AT_name("adc_result1"), DW_AT_symbol_name("_adc_result1")
	.dwattr DW$210, DW_AT_type(*DW$T$20)
	.dwattr DW$210, DW_AT_location[DW_OP_reg16]
;* AR4   assigned to K$17
DW$211	.dwtag  DW_TAG_variable, DW_AT_name("K$17"), DW_AT_symbol_name("K$17")
	.dwattr DW$211, DW_AT_type(*DW$T$125)
	.dwattr DW$211, DW_AT_location[DW_OP_reg12]
;* AR1   assigned to K$17
DW$212	.dwtag  DW_TAG_variable, DW_AT_name("K$17"), DW_AT_symbol_name("K$17")
	.dwattr DW$212, DW_AT_type(*DW$T$125)
...
L100:    
	...
	.dwattr DW$207, DW_AT_end_line(0xc3)
...
DW$213	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$3)
DW$214	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$10)
DW$215	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$89)
	.dwendtag DW$T$90


DW$T$94	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$94, DW_AT_language(DW_LANG_C)
DW$216	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$93)
...
DW$218	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$100)
	.dwendtag DW$T$101


DW$T$105	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$105, DW_AT_language(DW_LANG_C)
DW$219	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$104)
	.dwendtag DW$T$105
...
DW$223	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$114)
DW$224	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$114)
	.dwendtag DW$T$115
...
DW$226	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$100)
	.dwendtag DW$T$116
...
DW$T$27	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$27, DW_AT_type(*DW$227)
...
DW$228	.dwtag  DW_TAG_far_type
	.dwattr DW$228, DW_AT_type(*DW$T$114)
DW$T$120	.dwtag  DW_TAG_const_type
	.dwattr DW$T$120, DW_AT_type(*DW$228)
...
DW$T$123	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$123, DW_AT_type(*DW$231)
...
DW$232	.dwtag  DW_TAG_far_type
	.dwattr DW$232, DW_AT_type(*DW$T$113)
...
DW$234	.dwtag  DW_TAG_far_type
	.dwattr DW$234, DW_AT_type(*DW$T$112)
DW$T$135	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$135, DW_AT_type(*DW$234)
...
DW$240	.dwtag  DW_TAG_far_type
	.dwattr DW$240, DW_AT_type(*DW$T$139)
...
DW$T$148	.dwtag  DW_TAG_array_type, DW_AT_type(*DW$T$22)
	...
	.dwattr DW$T$148, DW_AT_byte_size(0x20)
DW$241	.dwtag  DW_TAG_subrange_type
	.dwattr DW$241, DW_AT_upper_bound(0x0f)
	.dwendtag DW$T$148


DW$T$149	.dwtag  DW_TAG_array_type, DW_AT_type(*DW$T$22)
	.dwattr DW$T$149, DW_AT_language(DW_LANG_C)
	.dwattr DW$T$149, DW_AT_byte_size(0x10)
...
DW$T$153	.dwtag  DW_TAG_pointer_type, DW_AT_type(*DW$T$13)
...
DW$245	.dwtag  DW_TAG_far_type
	.dwattr DW$245, DW_AT_type(*DW$T$111)
DW$T$160	.dwtag  DW_TAG_const_type
	.dwattr DW$T$160, DW_AT_type(*DW$245)
DW$246	.dwtag  DW_TAG_far_type
	.dwattr DW$246, DW_AT_type(*DW$T$36)
DW$T$168	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$168, DW_AT_type(*DW$246)
...
DW$247	.dwtag  DW_TAG_far_type
	.dwattr DW$247, DW_AT_type(*DW$T$62)
DW$T$178	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$178, DW_AT_type(*DW$247)
...
DW$248	.dwtag  DW_TAG_far_type
	.dwattr DW$248, DW_AT_type(*DW$T$63)
DW$T$180	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$180, DW_AT_type(*DW$248)
DW$249	.dwtag  DW_TAG_far_type
	.dwattr DW$249, DW_AT_type(*DW$T$74)
DW$T$183	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$183, DW_AT_type(*DW$249)
DW$250	.dwtag  DW_TAG_far_type
	.dwattr DW$250, DW_AT_type(*DW$T$83)
DW$T$187	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$187, DW_AT_type(*DW$250)
DW$T$189	.dwtag  DW_TAG_typedef, DW_AT_name("HANDLEPID"), DW_AT_type(*DW$T$188)
	.dwattr DW$T$189, DW_AT_language(DW_LANG_C)
DW$T$191	.dwtag  DW_TAG_typedef, DW_AT_name("MOTORCTRL"), DW_AT_type(*DW$T$190)
...
DW$263	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	...
	.dwattr DW$263, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$263, DW_AT_accessibility(DW_ACCESS_public)
	.dwendtag DW$T$36

DW$264	.dwtag  DW_TAG_far_type
	.dwattr DW$264, DW_AT_type(*DW$T$39)
DW$T$170	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$170, DW_AT_type(*DW$264)
...
DW$265	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$38)
	.dwattr DW$265, DW_AT_name("ADCTRL1"), DW_AT_symbol_name("_ADCTRL1")
	.dwattr DW$265, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$265, DW_AT_accessibility(DW_ACCESS_public)
DW$266	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$40)
	.dwattr DW$266, DW_AT_name("ADCTRL2"), DW_AT_symbol_name("_ADCTRL2")
	.dwattr DW$266, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$266, DW_AT_accessibility(DW_ACCESS_public)
DW$267	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$42)
	.dwattr DW$267, DW_AT_name("ADCMAXCONV"), DW_AT_symbol_name("_ADCMAXCONV")
	.dwattr DW$267, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$267, DW_AT_accessibility(DW_ACCESS_public)
DW$268	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$44)
	.dwattr DW$268, DW_AT_name("ADCCHSELSEQ1"), DW_AT_symbol_name("_ADCCHSELSEQ1")
	.dwattr DW$268, DW_AT_data_member_location[DW_OP_plus_uconst 0x3]
	.dwattr DW$268, DW_AT_accessibility(DW_ACCESS_public)
DW$269	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$46)
	.dwattr DW$269, DW_AT_name("ADCCHSELSEQ2"), DW_AT_symbol_name("_ADCCHSELSEQ2")
	.dwattr DW$269, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$269, DW_AT_accessibility(DW_ACCESS_public)
DW$270	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$48)
	.dwattr DW$270, DW_AT_name("ADCCHSELSEQ3"), DW_AT_symbol_name("_ADCCHSELSEQ3")
	.dwattr DW$270, DW_AT_data_member_location[DW_OP_plus_uconst 0x5]
	.dwattr DW$270, DW_AT_accessibility(DW_ACCESS_public)
DW$271	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$50)
	.dwattr DW$271, DW_AT_name("ADCCHSELSEQ4"), DW_AT_symbol_name("_ADCCHSELSEQ4")
	.dwattr DW$271, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$271, DW_AT_accessibility(DW_ACCESS_public)
DW$272	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$52)
	.dwattr DW$272, DW_AT_name("ADCASEQSR"), DW_AT_symbol_name("_ADCASEQSR")
	.dwattr DW$272, DW_AT_data_member_location[DW_OP_plus_uconst 0x7]
	.dwattr DW$272, DW_AT_accessibility(DW_ACCESS_public)
DW$273	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$273, DW_AT_name("ADCRESULT0"), DW_AT_symbol_name("_ADCRESULT0")
	.dwattr DW$273, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$273, DW_AT_accessibility(DW_ACCESS_public)
DW$274	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$274, DW_AT_name("ADCRESULT1"), DW_AT_symbol_name("_ADCRESULT1")
	.dwattr DW$274, DW_AT_data_member_location[DW_OP_plus_uconst 0x9]
	.dwattr DW$274, DW_AT_accessibility(DW_ACCESS_public)
DW$275	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$275, DW_AT_name("ADCRESULT2"), DW_AT_symbol_name("_ADCRESULT2")
	.dwattr DW$275, DW_AT_data_member_location[DW_OP_plus_uconst 0xa]
	.dwattr DW$275, DW_AT_accessibility(DW_ACCESS_public)
DW$276	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$276, DW_AT_name("ADCRESULT3"), DW_AT_symbol_name("_ADCRESULT3")
	.dwattr DW$276, DW_AT_data_member_location[DW_OP_plus_uconst 0xb]
	.dwattr DW$276, DW_AT_accessibility(DW_ACCESS_public)
DW$277	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$277, DW_AT_name("ADCRESULT4"), DW_AT_symbol_name("_ADCRESULT4")
	.dwattr DW$277, DW_AT_data_member_location[DW_OP_plus_uconst 0xc]
	.dwattr DW$277, DW_AT_accessibility(DW_ACCESS_public)
DW$278	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$278, DW_AT_name("ADCRESULT5"), DW_AT_symbol_name("_ADCRESULT5")
	.dwattr DW$278, DW_AT_data_member_location[DW_OP_plus_uconst 0xd]
	.dwattr DW$278, DW_AT_accessibility(DW_ACCESS_public)
DW$279	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$279, DW_AT_name("ADCRESULT6"), DW_AT_symbol_name("_ADCRESULT6")
	.dwattr DW$279, DW_AT_data_member_location[DW_OP_plus_uconst 0xe]
	.dwattr DW$279, DW_AT_accessibility(DW_ACCESS_public)
DW$280	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$280, DW_AT_name("ADCRESULT7"), DW_AT_symbol_name("_ADCRESULT7")
	.dwattr DW$280, DW_AT_data_member_location[DW_OP_plus_uconst 0xf]
	.dwattr DW$280, DW_AT_accessibility(DW_ACCESS_public)
DW$281	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$281, DW_AT_name("ADCRESULT8"), DW_AT_symbol_name("_ADCRESULT8")
	.dwattr DW$281, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$281, DW_AT_accessibility(DW_ACCESS_public)
DW$282	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$282, DW_AT_name("ADCRESULT9"), DW_AT_symbol_name("_ADCRESULT9")
	.dwattr DW$282, DW_AT_data_member_location[DW_OP_plus_uconst 0x11]
	.dwattr DW$282, DW_AT_accessibility(DW_ACCESS_public)
DW$283	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$283, DW_AT_name("ADCRESULT10"), DW_AT_symbol_name("_ADCRESULT10")
	.dwattr DW$283, DW_AT_data_member_location[DW_OP_plus_uconst 0x12]
	.dwattr DW$283, DW_AT_accessibility(DW_ACCESS_public)
DW$284	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$284, DW_AT_name("ADCRESULT11"), DW_AT_symbol_name("_ADCRESULT11")
	.dwattr DW$284, DW_AT_data_member_location[DW_OP_plus_uconst 0x13]
	.dwattr DW$284, DW_AT_accessibility(DW_ACCESS_public)
DW$285	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$285, DW_AT_name("ADCRESULT12"), DW_AT_symbol_name("_ADCRESULT12")
	.dwattr DW$285, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr DW$285, DW_AT_accessibility(DW_ACCESS_public)
DW$286	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$286, DW_AT_name("ADCRESULT13"), DW_AT_symbol_name("_ADCRESULT13")
	.dwattr DW$286, DW_AT_data_member_location[DW_OP_plus_uconst 0x15]
	.dwattr DW$286, DW_AT_accessibility(DW_ACCESS_public)
DW$287	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$287, DW_AT_name("ADCRESULT14"), DW_AT_symbol_name("_ADCRESULT14")
	.dwattr DW$287, DW_AT_data_member_location[DW_OP_plus_uconst 0x16]
	.dwattr DW$287, DW_AT_accessibility(DW_ACCESS_public)
DW$288	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$288, DW_AT_name("ADCRESULT15"), DW_AT_symbol_name("_ADCRESULT15")
	.dwattr DW$288, DW_AT_data_member_location[DW_OP_plus_uconst 0x17]
	.dwattr DW$288, DW_AT_accessibility(DW_ACCESS_public)
DW$289	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$54)
	.dwattr DW$289, DW_AT_name("ADCTRL3"), DW_AT_symbol_name("_ADCTRL3")
	.dwattr DW$289, DW_AT_data_member_location[DW_OP_plus_uconst 0x18]
	.dwattr DW$289, DW_AT_accessibility(DW_ACCESS_public)
DW$290	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$56)
	.dwattr DW$290, DW_AT_name("ADCST"), DW_AT_symbol_name("_ADCST")
	.dwattr DW$290, DW_AT_data_member_location[DW_OP_plus_uconst 0x19]
	.dwattr DW$290, DW_AT_accessibility(DW_ACCESS_public)
DW$291	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$291, DW_AT_name("rsvd1"), DW_AT_symbol_name("_rsvd1")
	.dwattr DW$291, DW_AT_data_member_location[DW_OP_plus_uconst 0x1a]
	.dwattr DW$291, DW_AT_accessibility(DW_ACCESS_public)
DW$292	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$292, DW_AT_name("rsvd2"), DW_AT_symbol_name("_rsvd2")
	.dwattr DW$292, DW_AT_data_member_location[DW_OP_plus_uconst 0x1b]
	.dwattr DW$292, DW_AT_accessibility(DW_ACCESS_public)
DW$293	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$58)
	.dwattr DW$293, DW_AT_name("ADCREFSEL"), DW_AT_symbol_name("_ADCREFSEL")
	.dwattr DW$293, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$293, DW_AT_accessibility(DW_ACCESS_public)
DW$294	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$61)
	.dwattr DW$294, DW_AT_name("ADCOFFTRIM"), DW_AT_symbol_name("_ADCOFFTRIM")
	.dwattr DW$294, DW_AT_data_member_location[DW_OP_plus_uconst 0x1d]
...
DW$298	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$298, DW_AT_data_member_location[DW_OP_plus_uconst 0x3]
...
DW$300	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$300, DW_AT_data_member_location[DW_OP_plus_uconst 0x5]
...
DW$306	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$306, DW_AT_data_member_location[DW_OP_plus_uconst 0xb]
...
DW$308	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$308, DW_AT_data_member_location[DW_OP_plus_uconst 0xd]
...
DW$310	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$310, DW_AT_data_member_location[DW_OP_plus_uconst 0xf]
...
DW$311	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$65)
	.dwattr DW$311, DW_AT_name("TIM"), DW_AT_symbol_name("_TIM")
	.dwattr DW$311, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$311, DW_AT_accessibility(DW_ACCESS_public)
DW$312	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$67)
	.dwattr DW$312, DW_AT_name("PRD"), DW_AT_symbol_name("_PRD")
	.dwattr DW$312, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$312, DW_AT_accessibility(DW_ACCESS_public)
DW$313	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$69)
	.dwattr DW$313, DW_AT_name("TCR"), DW_AT_symbol_name("_TCR")
...
DW$315	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$71)
	.dwattr DW$315, DW_AT_name("TPR"), DW_AT_symbol_name("_TPR")
	.dwattr DW$315, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$315, DW_AT_accessibility(DW_ACCESS_public)
DW$316	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$73)
	.dwattr DW$316, DW_AT_name("TPRH"), DW_AT_symbol_name("_TPRH")
...
DW$359	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$359, DW_AT_name("StepCnt_U32"), DW_AT_symbol_name("_StepCnt_U32")
...
DW$365	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$365, DW_AT_name("Jerk_IQ14"), DW_AT_symbol_name("_Jerk_IQ14")
	.dwattr DW$365, DW_AT_data_member_location[DW_OP_plus_uconst 0x18]
	.dwattr DW$365, DW_AT_accessibility(DW_ACCESS_public)
DW$366	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$366, DW_AT_name("Decel_IQ14"), DW_AT_symbol_name("_Decel_IQ14")
	.dwattr DW$366, DW_AT_data_member_location[DW_OP_plus_uconst 0x1a]
	.dwattr DW$366, DW_AT_accessibility(DW_ACCESS_public)
DW$367	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$367, DW_AT_name("Kp_UpDown_IQ17"), DW_AT_symbol_name("_Kp_UpDown_IQ17")
	.dwattr DW$367, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$367, DW_AT_accessibility(DW_ACCESS_public)
DW$368	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$368, DW_AT_name("TargetPosition_IQ10"), DW_AT_symbol_name("_TargetPosition_IQ10")
	.dwattr DW$368, DW_AT_data_member_location[DW_OP_plus_uconst 0x1e]
	.dwattr DW$368, DW_AT_accessibility(DW_ACCESS_public)
DW$369	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$369, DW_AT_name("PositionRatio_IQ10"), DW_AT_symbol_name("_PositionRatio_IQ10")
	.dwattr DW$369, DW_AT_data_member_location[DW_OP_plus_uconst 0x20]
	.dwattr DW$369, DW_AT_accessibility(DW_ACCESS_public)
DW$370	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$370, DW_AT_name("DownFlag_U16"), DW_AT_symbol_name("_DownFlag_U16")
...
DW$371	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$371, DW_AT_name("s44sFlag_U16"), DW_AT_symbol_name("_s44sFlag_U16")
...
DW$372	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$372, DW_AT_name("BlindFlag_U16"), DW_AT_symbol_name("_BlindFlag_U16")
...
DW$373	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$373, DW_AT_name("Position_U16_CNT"), DW_AT_symbol_name("_Position_U16_CNT")
	.dwattr DW$373, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$373, DW_AT_accessibility(DW_ACCESS_public)
DW$374	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$374, DW_AT_name("Adc_U16"), DW_AT_symbol_name("_Adc_U16")
	.dwattr DW$374, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$374, DW_AT_accessibility(DW_ACCESS_public)
DW$375	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$375, DW_AT_name("Max_U16"), DW_AT_symbol_name("_Max_U16")
	.dwattr DW$375, DW_AT_data_member_location[DW_OP_plus_uconst 0x11]
	.dwattr DW$375, DW_AT_accessibility(DW_ACCESS_public)
DW$376	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$376, DW_AT_name("Min_U16"), DW_AT_symbol_name("_Min_U16")
	.dwattr DW$376, DW_AT_data_member_location[DW_OP_plus_uconst 0x21]
	.dwattr DW$376, DW_AT_accessibility(DW_ACCESS_public)
DW$377	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$377, DW_AT_name("Div127_U16"), DW_AT_symbol_name("_Div127_U16")
	.dwattr DW$377, DW_AT_data_member_location[DW_OP_plus_uconst 0x31]
	.dwattr DW$377, DW_AT_accessibility(DW_ACCESS_public)
DW$378	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$378, DW_AT_name("AdcValue_U16"), DW_AT_symbol_name("_AdcValue_U16")
	.dwattr DW$378, DW_AT_data_member_location[DW_OP_plus_uconst 0x41]
	.dwattr DW$378, DW_AT_accessibility(DW_ACCESS_public)
DW$379	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$25)
	.dwattr DW$379, DW_AT_name("Position_IQ10"), DW_AT_symbol_name("_Position_IQ10")
	.dwattr DW$379, DW_AT_data_member_location[DW_OP_plus_uconst 0x52]
	.dwattr DW$379, DW_AT_accessibility(DW_ACCESS_public)
DW$380	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$25)
	.dwattr DW$380, DW_AT_name("PositionTemporary_IQ10"), DW_AT_symbol_name("_PositionTemporary_IQ10")
	.dwattr DW$380, DW_AT_data_member_location[DW_OP_plus_uconst 0x54]
	.dwattr DW$380, DW_AT_accessibility(DW_ACCESS_public)
DW$381	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$25)
	.dwattr DW$381, DW_AT_name("PositionShift_IQ10"), DW_AT_symbol_name("_PositionShift_IQ10")
	.dwattr DW$381, DW_AT_data_member_location[DW_OP_plus_uconst 0x56]
	.dwattr DW$381, DW_AT_accessibility(DW_ACCESS_public)
DW$382	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$30)
	.dwattr DW$382, DW_AT_name("MaxminusMin_IQ17"), DW_AT_symbol_name("_MaxminusMin_IQ17")
	.dwattr DW$382, DW_AT_data_member_location[DW_OP_plus_uconst 0x58]
...
DW$386	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$34)
...
DW$406	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$39)
...
DW$426	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$60)
...
DW$428	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$64)
...
DW$430	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$66)
	.dwattr DW$430, DW_AT_name("half"), DW_AT_symbol_name("_half")
...
DW$432	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$68)
...
DW$434	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$70)
...
DW$436	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$72)
...
DW$438	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$75)
...
DW$440	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$77)
...
DW$442	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$79)
...
DW$444	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$81)
...
DW$445	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$445, DW_AT_name("Pos_PID_IQ17"), DW_AT_symbol_name("_Pos_PID_IQ17")
	.dwattr DW$445, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$445, DW_AT_accessibility(DW_ACCESS_public)
DW$446	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$446, DW_AT_name("Pos_P_IQ17"), DW_AT_symbol_name("_Pos_P_IQ17")
	.dwattr DW$446, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$446, DW_AT_accessibility(DW_ACCESS_public)
DW$447	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$447, DW_AT_name("Pos_D_IQ17"), DW_AT_symbol_name("_Pos_D_IQ17")
	.dwattr DW$447, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$447, DW_AT_accessibility(DW_ACCESS_public)
DW$448	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$84)
	.dwattr DW$448, DW_AT_name("Pos_Err_IQ10"), DW_AT_symbol_name("_Pos_Err_IQ10")
	.dwattr DW$448, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$448, DW_AT_accessibility(DW_ACCESS_public)
DW$449	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$449, DW_AT_name("Kp_val_IQ17"), DW_AT_symbol_name("_Kp_val_IQ17")
	.dwattr DW$449, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$449, DW_AT_accessibility(DW_ACCESS_public)
DW$450	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$450, DW_AT_name("Kd_val_IQ17"), DW_AT_symbol_name("_Kd_val_IQ17")
...
DW$451	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$451, DW_AT_name("TargetVel_IQ17"), DW_AT_symbol_name("_TargetVel_IQ17")
	.dwattr DW$451, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$451, DW_AT_accessibility(DW_ACCESS_public)
DW$452	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$452, DW_AT_name("NextVelocity_IQ17"), DW_AT_symbol_name("_NextVelocity_IQ17")
	.dwattr DW$452, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$452, DW_AT_accessibility(DW_ACCESS_public)
DW$453	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$453, DW_AT_name("HandleVelo_IQ17"), DW_AT_symbol_name("_HandleVelo_IQ17")
	.dwattr DW$453, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$453, DW_AT_accessibility(DW_ACCESS_public)
DW$454	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$454, DW_AT_name("DecelVelocity_IQ17"), DW_AT_symbol_name("_DecelVelocity_IQ17")
...
DW$456	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$86)
...
DW$458	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$458, DW_AT_name("DecelDistance_IQ17"), DW_AT_symbol_name("_DecelDistance_IQ17")
	.dwattr DW$458, DW_AT_data_member_location[DW_OP_plus_uconst 0xe]
	.dwattr DW$458, DW_AT_accessibility(DW_ACCESS_public)
DW$459	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$459, DW_AT_name("ErrorDistance_IQ17"), DW_AT_symbol_name("_ErrorDistance_IQ17")
	.dwattr DW$459, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$459, DW_AT_accessibility(DW_ACCESS_public)
DW$460	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$460, DW_AT_name("UserDistance_IQ17"), DW_AT_symbol_name("_UserDistance_IQ17")
	.dwattr DW$460, DW_AT_data_member_location[DW_OP_plus_uconst 0x12]
	.dwattr DW$460, DW_AT_accessibility(DW_ACCESS_public)
DW$461	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$461, DW_AT_name("DecelFlag_U16"), DW_AT_symbol_name("_DecelFlag_U16")
	.dwattr DW$461, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr DW$461, DW_AT_accessibility(DW_ACCESS_public)
DW$462	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$462, DW_AT_name("PwmTBPRDdiv10000_IQ17"), DW_AT_symbol_name("_PwmTBPRDdiv10000_IQ17")
	.dwattr DW$462, DW_AT_data_member_location[DW_OP_plus_uconst 0x16]
	.dwattr DW$462, DW_AT_accessibility(DW_ACCESS_public)
DW$463	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$463, DW_AT_name("PrdNext_IQ14"), DW_AT_symbol_name("_PrdNext_IQ14")
	.dwattr DW$463, DW_AT_data_member_location[DW_OP_plus_uconst 0x18]
	.dwattr DW$463, DW_AT_accessibility(DW_ACCESS_public)
DW$464	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$464, DW_AT_name("PrdNextTranSecon_IQ17"), DW_AT_symbol_name("_PrdNextTranSecon_IQ17")
	.dwattr DW$464, DW_AT_data_member_location[DW_OP_plus_uconst 0x1a]
	.dwattr DW$464, DW_AT_accessibility(DW_ACCESS_public)
DW$465	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$465, DW_AT_name("RolEachStep_IQ17"), DW_AT_symbol_name("_RolEachStep_IQ17")
	.dwattr DW$465, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$465, DW_AT_accessibility(DW_ACCESS_public)
DW$466	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$466, DW_AT_name("NextAccel_IQ14"), DW_AT_symbol_name("_NextAccel_IQ14")
	.dwattr DW$466, DW_AT_data_member_location[DW_OP_plus_uconst 0x1e]
	.dwattr DW$466, DW_AT_accessibility(DW_ACCESS_public)
DW$467	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$467, DW_AT_name("AccelLimit_IQ14"), DW_AT_symbol_name("_AccelLimit_IQ14")
	.dwattr DW$467, DW_AT_data_member_location[DW_OP_plus_uconst 0x20]
	.dwattr DW$467, DW_AT_accessibility(DW_ACCESS_public)
DW$468	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$468, DW_AT_name("DecelAccel_IQ14"), DW_AT_symbol_name("_DecelAccel_IQ14")
	.dwattr DW$468, DW_AT_data_member_location[DW_OP_plus_uconst 0x22]
	.dwattr DW$468, DW_AT_accessibility(DW_ACCESS_public)
DW$469	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$23)
	.dwattr DW$469, DW_AT_name("Jerk_IQ14"), DW_AT_symbol_name("_Jerk_IQ14")
...
DW$471	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$471, DW_AT_name("MoveState_U16"), DW_AT_symbol_name("_MoveState_U16")
...
DW$472	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$472, DW_AT_name("Motor_U16"), DW_AT_symbol_name("_Motor_U16")
...
DW$473	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$473, DW_AT_name("Sensor_U16"), DW_AT_symbol_name("_Sensor_U16")
...
DW$474	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$474, DW_AT_name("Cross"), DW_AT_symbol_name("_Cross")
...
DW$475	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$475, DW_AT_name("CrossFlag_U16"), DW_AT_symbol_name("_CrossFlag_U16")
...
DW$476	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$476, DW_AT_name("STOP"), DW_AT_symbol_name("_STOP")
...
DW$477	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$477, DW_AT_name("Search_U16"), DW_AT_symbol_name("_Search_U16")
...
DW$478	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$478, DW_AT_name("Fast_U16"), DW_AT_symbol_name("_Fast_U16")
...
DW$479	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$479, DW_AT_name("Extrem_U16"), DW_AT_symbol_name("_Extrem_U16")
...
DW$480	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$480, DW_AT_name("TxFlag_U16"), DW_AT_symbol_name("_TxFlag_U16")
...
DW$481	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$481, DW_AT_name("line_out_flag"), DW_AT_symbol_name("_line_out_flag")
...
DW$482	.dwtag  DW_TAG_far_type
	.dwattr DW$482, DW_AT_type(*DW$T$19)
DW$T$24	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$24, DW_AT_type(*DW$482)
...
DW$483	.dwtag  DW_TAG_subrange_type
	.dwattr DW$483, DW_AT_upper_bound(0x0f)
	.dwendtag DW$T$30
...
DW$484	.dwtag  DW_TAG_far_type
	.dwattr DW$484, DW_AT_type(*DW$T$25)
DW$T$26	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$26, DW_AT_type(*DW$484)
...
DW$485	.dwtag  DW_TAG_subrange_type
	.dwattr DW$485, DW_AT_upper_bound(0x04)
	.dwendtag DW$T$84
...
DW$525	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$525, DW_AT_name("SEQ_CASC"), DW_AT_symbol_name("_SEQ_CASC")
...
DW$526	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$526, DW_AT_name("SEQ_OVRD"), DW_AT_symbol_name("_SEQ_OVRD")
...
DW$527	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$527, DW_AT_name("CONT_RUN"), DW_AT_symbol_name("_CONT_RUN")
...
DW$528	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$528, DW_AT_name("CPS"), DW_AT_symbol_name("_CPS")
...
DW$529	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$529, DW_AT_name("ACQ_PS"), DW_AT_symbol_name("_ACQ_PS")
...
DW$530	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$530, DW_AT_name("SUSMOD"), DW_AT_symbol_name("_SUSMOD")
...
DW$531	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$531, DW_AT_name("RESET"), DW_AT_symbol_name("_RESET")
...
DW$533	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$533, DW_AT_name("MAX_CONV1"), DW_AT_symbol_name("_MAX_CONV1")
...
DW$534	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$534, DW_AT_name("MAX_CONV2"), DW_AT_symbol_name("_MAX_CONV2")
	.dwattr DW$534, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x03)
...
DW$536	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$536, DW_AT_name("CONV00"), DW_AT_symbol_name("_CONV00")
...
DW$537	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$537, DW_AT_name("CONV01"), DW_AT_symbol_name("_CONV01")
...
DW$538	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$538, DW_AT_name("CONV02"), DW_AT_symbol_name("_CONV02")
...
DW$539	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$539, DW_AT_name("CONV03"), DW_AT_symbol_name("_CONV03")
...
DW$540	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$540, DW_AT_name("CONV04"), DW_AT_symbol_name("_CONV04")
...
DW$541	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$541, DW_AT_name("CONV05"), DW_AT_symbol_name("_CONV05")
...
DW$542	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$542, DW_AT_name("CONV06"), DW_AT_symbol_name("_CONV06")
...
DW$543	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$543, DW_AT_name("CONV07"), DW_AT_symbol_name("_CONV07")
...
DW$544	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$544, DW_AT_name("CONV08"), DW_AT_symbol_name("_CONV08")
...
DW$545	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$545, DW_AT_name("CONV09"), DW_AT_symbol_name("_CONV09")
...
DW$546	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$546, DW_AT_name("CONV10"), DW_AT_symbol_name("_CONV10")
...
DW$547	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$547, DW_AT_name("CONV11"), DW_AT_symbol_name("_CONV11")
...
DW$548	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$548, DW_AT_name("CONV12"), DW_AT_symbol_name("_CONV12")
...
DW$549	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$549, DW_AT_name("CONV13"), DW_AT_symbol_name("_CONV13")
...
DW$550	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$550, DW_AT_name("CONV14"), DW_AT_symbol_name("_CONV14")
...
DW$551	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$551, DW_AT_name("CONV15"), DW_AT_symbol_name("_CONV15")
...
DW$552	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$552, DW_AT_name("SEQ1_STATE"), DW_AT_symbol_name("_SEQ1_STATE")
...
DW$553	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$553, DW_AT_name("SEQ2_STATE"), DW_AT_symbol_name("_SEQ2_STATE")
	.dwattr DW$553, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x03)
...
DW$555	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$555, DW_AT_name("SEQ_CNTR"), DW_AT_symbol_name("_SEQ_CNTR")
...
DW$557	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$557, DW_AT_name("SMODE_SEL"), DW_AT_symbol_name("_SMODE_SEL")
...
DW$558	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$558, DW_AT_name("ADCCLKPS"), DW_AT_symbol_name("_ADCCLKPS")
	.dwattr DW$558, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x04)
	.dwattr DW$558, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$558, DW_AT_accessibility(DW_ACCESS_public)
DW$559	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$559, DW_AT_name("ADCPWDN"), DW_AT_symbol_name("_ADCPWDN")
...
DW$560	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$560, DW_AT_name("ADCBGRFDN"), DW_AT_symbol_name("_ADCBGRFDN")
...
DW$562	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$562, DW_AT_name("INT_SEQ1"), DW_AT_symbol_name("_INT_SEQ1")
...
DW$563	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$563, DW_AT_name("INT_SEQ2"), DW_AT_symbol_name("_INT_SEQ2")
...
DW$564	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$564, DW_AT_name("SEQ1_BSY"), DW_AT_symbol_name("_SEQ1_BSY")
...
DW$565	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$565, DW_AT_name("SEQ2_BSY"), DW_AT_symbol_name("_SEQ2_BSY")
...
DW$566	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$566, DW_AT_name("INT_SEQ1_CLR"), DW_AT_symbol_name("_INT_SEQ1_CLR")
...
DW$567	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$567, DW_AT_name("INT_SEQ2_CLR"), DW_AT_symbol_name("_INT_SEQ2_CLR")
...
DW$568	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$568, DW_AT_name("EOS_BUF1"), DW_AT_symbol_name("_EOS_BUF1")
...
DW$569	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$569, DW_AT_name("EOS_BUF2"), DW_AT_symbol_name("_EOS_BUF2")
...
DW$571	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$571, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x0e)
	.dwattr DW$571, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$571, DW_AT_accessibility(DW_ACCESS_public)
DW$572	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$572, DW_AT_name("REF_SEL"), DW_AT_symbol_name("_REF_SEL")
...
DW$573	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$59)
	.dwattr DW$573, DW_AT_name("OFFSET_TRIM"), DW_AT_symbol_name("_OFFSET_TRIM")
	.dwattr DW$573, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x09)
...
DW$574	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$574, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x07)
...
DW$577	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$577, DW_AT_name("LSW"), DW_AT_symbol_name("_LSW")
	.dwattr DW$577, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$577, DW_AT_accessibility(DW_ACCESS_public)
DW$578	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$578, DW_AT_name("MSW"), DW_AT_symbol_name("_MSW")
...
DW$580	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$580, DW_AT_name("TSS"), DW_AT_symbol_name("_TSS")
...
DW$581	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$581, DW_AT_name("TRB"), DW_AT_symbol_name("_TRB")
...
DW$582	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$582, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x04)
	.dwattr DW$582, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$582, DW_AT_accessibility(DW_ACCESS_public)
DW$583	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$583, DW_AT_name("SOFT"), DW_AT_symbol_name("_SOFT")
...
DW$584	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$584, DW_AT_name("FREE"), DW_AT_symbol_name("_FREE")
...
DW$586	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$586, DW_AT_name("TIE"), DW_AT_symbol_name("_TIE")
...
DW$587	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$587, DW_AT_name("TIF"), DW_AT_symbol_name("_TIF")
...
DW$588	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$588, DW_AT_name("TDDR"), DW_AT_symbol_name("_TDDR")
...
DW$589	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$589, DW_AT_name("PSC"), DW_AT_symbol_name("_PSC")
...
DW$590	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$590, DW_AT_name("TDDRH"), DW_AT_symbol_name("_TDDRH")
	.dwattr DW$590, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x08)
	.dwattr DW$590, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$590, DW_AT_accessibility(DW_ACCESS_public)
DW$591	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$591, DW_AT_name("PSCH"), DW_AT_symbol_name("_PSCH")
...
DW$592	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$592, DW_AT_name("ENPIE"), DW_AT_symbol_name("_ENPIE")
...
DW$593	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$593, DW_AT_name("PIEVECT"), DW_AT_symbol_name("_PIEVECT")
	.dwattr DW$593, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0f)
...
DW$594	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$594, DW_AT_name("ACK1"), DW_AT_symbol_name("_ACK1")
...
DW$595	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$595, DW_AT_name("ACK2"), DW_AT_symbol_name("_ACK2")
...
DW$596	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$596, DW_AT_name("ACK3"), DW_AT_symbol_name("_ACK3")
...
DW$597	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$597, DW_AT_name("ACK4"), DW_AT_symbol_name("_ACK4")
...
DW$598	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$598, DW_AT_name("ACK5"), DW_AT_symbol_name("_ACK5")
...
DW$599	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$599, DW_AT_name("ACK6"), DW_AT_symbol_name("_ACK6")
...
DW$600	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$600, DW_AT_name("ACK7"), DW_AT_symbol_name("_ACK7")
...
DW$601	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$601, DW_AT_name("ACK8"), DW_AT_symbol_name("_ACK8")
...
DW$602	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$602, DW_AT_name("ACK9"), DW_AT_symbol_name("_ACK9")
...
DW$603	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$603, DW_AT_name("ACK10"), DW_AT_symbol_name("_ACK10")
...
DW$604	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$604, DW_AT_name("ACK11"), DW_AT_symbol_name("_ACK11")
...
DW$605	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$605, DW_AT_name("ACK12"), DW_AT_symbol_name("_ACK12")
...
DW$606	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$606, DW_AT_name("rsvd"), DW_AT_symbol_name("_rsvd")
...
DW$607	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$607, DW_AT_name("INTx1"), DW_AT_symbol_name("_INTx1")
...
DW$608	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$608, DW_AT_name("INTx2"), DW_AT_symbol_name("_INTx2")
...
DW$609	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$609, DW_AT_name("INTx3"), DW_AT_symbol_name("_INTx3")
...
DW$610	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$610, DW_AT_name("INTx4"), DW_AT_symbol_name("_INTx4")
...
DW$611	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$611, DW_AT_name("INTx5"), DW_AT_symbol_name("_INTx5")
...
DW$612	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$612, DW_AT_name("INTx6"), DW_AT_symbol_name("_INTx6")
...
DW$613	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$613, DW_AT_name("INTx7"), DW_AT_symbol_name("_INTx7")
...
DW$614	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$614, DW_AT_name("INTx8"), DW_AT_symbol_name("_INTx8")
