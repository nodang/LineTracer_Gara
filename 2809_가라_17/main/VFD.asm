...
;*** 170	-----------------------    ((volatile unsigned *)C$2)[5] |= 0x200u;
;*** 171	-----------------------    ((volatile unsigned *)C$2)[3] |= 0x800u;
;*** 172	-----------------------    *(&GpioDataRegs+3L) |= 0x100u;
;*** 173	-----------------------    *(&GpioDataRegs+3L) |= 0x200u;
;*** 174	-----------------------    *(&GpioDataRegs+5L) |= 0x100u;
...
DW$13	.dwtag  DW_TAG_variable, DW_AT_name("L$1"), DW_AT_symbol_name("L$1")
	...
	.dwpsn	"VFD.c",170,2
        ...
        OR        *+XAR4[5],#0x0200     ; |170| 
	.dwpsn	"VFD.c",171,2
        OR        *+XAR4[3],#0x0800     ; |171| 
	.dwpsn	"VFD.c",172,2
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0100 ; |172| 
	.dwpsn	"VFD.c",173,2
        OR        @_GpioDataRegs+3,#0x0200 ; |173| 
	.dwpsn	"VFD.c",174,2
        OR        @_GpioDataRegs+5,#0x0100 ; |174| 
	.dwpsn	"VFD.c",177,6
        MOVB      XAR6,#7
        MOVB      AH,#7                 ; |177| 
L1:    
...
;***	-----------------------g2:
;*** 179	-----------------------    *(&GpioDataRegs+5L) |= 0x200u;
;*** 180	-----------------------    if ( CrlReg&1<<Cnt ) goto g4;
	.dwpsn	"VFD.c",179,3
        OR        @_GpioDataRegs+5,#0x0200 ; |179| 
	.dwpsn	"VFD.c",180,3
        MOVB      AL,#1                 ; |180| 
        MOV       T,AH                  ; |180| 
        LSL       AL,T                  ; |180| 
...
;*** 186	-----------------------    *(&GpioDataRegs+5L) |= 0x80u;
;*** 186	-----------------------    goto g5;
	.dwpsn	"VFD.c",186,4
        OR        @_GpioDataRegs+5,#0x0080 ; |186| 
        BF        L3,UNC                ; |186| 
        ; branch occurs ; |186| 
...
;***	-----------------------g4:
;*** 182	-----------------------    *(&GpioDataRegs+3L) |= 0x80u;
	.dwpsn	"VFD.c",182,4
        OR        @_GpioDataRegs+3,#0x0080 ; |182| 
DW$L$_VfdCtlRegInit$4$E:
L3:    
DW$L$_VfdCtlRegInit$5$B:
;***	-----------------------g5:
;*** 188	-----------------------    *(&GpioDataRegs+3L) |= 0x200u;
;*** 177	-----------------------    --Cnt;
;*** 177	-----------------------    if ( (--L$1) != (-1) ) goto g2;
	.dwpsn	"VFD.c",188,3
        OR        @_GpioDataRegs+3,#0x0200 ; |188| 
	.dwpsn	"VFD.c",177,24
        ADDB      AH,#-1
	.dwpsn	"VFD.c",177,14
        BANZ      L1,AR6--              ; |177| 
...
;*** 191	-----------------------    ((volatile unsigned *)C$1)[3] |= 0x100u;
;*** 192	-----------------------    ((volatile unsigned *)C$1)[5] |= 0x200u;
;*** 192	-----------------------    return;
	.dwpsn	"VFD.c",191,2
        OR        *+XAR4[3],#0x0100     ; |191| 
	.dwpsn	"VFD.c",192,2
        OR        *+XAR4[5],#0x0200     ; |192| 
	.dwpsn	"VFD.c",194,1
        LRETR
        ; return occurs

DW$14	.dwtag  DW_TAG_loop
	.dwattr DW$14, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\VFD.asm:L1:1:1691571614")
...
;***************************************************************
_VfdInit:
;*** 197	-----------------------    *(&GpioDataRegs+5L) |= 0x100u;
;*** 198	-----------------------    *(&GpioDataRegs+5L) |= 0x200u;
;*** 199	-----------------------    *(&GpioDataRegs+5L) |= 0x80u;
;*** 200	-----------------------    *(&GpioDataRegs+5L) |= 0x800u;
...
;*** 202	-----------------------    return;
	...
	.dwpsn	"VFD.c",197,2
        ...
        OR        @_GpioDataRegs+5,#0x0100 ; |197| 
	.dwpsn	"VFD.c",198,2
        OR        @_GpioDataRegs+5,#0x0200 ; |198| 
	.dwpsn	"VFD.c",199,2
        OR        @_GpioDataRegs+5,#0x0080 ; |199| 
	.dwpsn	"VFD.c",200,2
        OR        @_GpioDataRegs+5,#0x0800 ; |200| 
	.dwpsn	"VFD.c",201,2
        MOVB      AL,#129               ; |201| 
...
DW$20	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdDataLoad"), DW_AT_symbol_name("_VfdDataLoad")
	...
	.dwattr DW$20, DW_AT_begin_line(0xcd)
...
;***************************************************************
_VfdDataLoad:
;*** 215	-----------------------    K$2 = &GpioDataRegs+3L;
;*** 215	-----------------------    ((volatile unsigned *)K$2)[2] |= 0x200u;
;*** 216	-----------------------    ((volatile unsigned *)K$2)[2] |= 0x800u;
;*** 217	-----------------------    *(volatile unsigned *)K$2 |= 0x100u;
;*** 218	-----------------------    *(volatile unsigned *)K$2 |= 0x200u;
;*** 219	-----------------------    ((volatile unsigned *)K$2)[2] |= 0x100u;
;***  	-----------------------    #pragma MUST_ITERATE(8, 8, 8)
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;***  	-----------------------    K$22 = (char *)(&FontData);
;*** 211	-----------------------    ConverData = 0;
...
DW$34	.dwtag  DW_TAG_variable, DW_AT_name("K$2"), DW_AT_symbol_name("K$2")
	...
	.dwattr DW$34, DW_AT_location[DW_OP_reg10]
        MOVL      XAR5,XAR4             ; |206| 
	.dwpsn	"VFD.c",215,2
        MOVL      XAR6,#_GpioDataRegs+3 ; |215| 
        OR        *+XAR6[2],#0x0200     ; |215| 
	.dwpsn	"VFD.c",216,2
        OR        *+XAR6[2],#0x0800     ; |216| 
	.dwpsn	"VFD.c",217,2
        OR        *+XAR6[0],#0x0100     ; |217| 
	.dwpsn	"VFD.c",218,2
        OR        *+XAR6[0],#0x0200     ; |218| 
	.dwpsn	"VFD.c",219,2
        OR        *+XAR6[2],#0x0100     ; |219| 
        MOVL      XAR7,#_FontData
	.dwpsn	"VFD.c",211,6
        SETC      SXM
        MOV       PL,#0                 ; |211| 
...
;*** 231	-----------------------    *(volatile unsigned *)K$2 |= 0x200u;
;*** 232	-----------------------    if ( ConverData&1<<x ) goto g8;
	.dwpsn	"VFD.c",231,5
        MOVL      XAR3,#_GpioDataRegs+5 ; |231| 
        OR        *+XAR3[0],#0x0200     ; |231| 
	.dwpsn	"VFD.c",232,5
        MOVB      AH,#1                 ; |232| 
        MOV       T,AL                  ; |232| 
        LSL       AH,T                  ; |232| 
...
;*** 238	-----------------------    *(volatile unsigned *)K$2 |= 0x80u;
;*** 238	-----------------------    goto g9;
	.dwpsn	"VFD.c",238,6
        OR        *+XAR3[0],#0x0080     ; |238| 
        BF        L9,UNC                ; |238| 
        ; branch occurs ; |238| 
...
;***	-----------------------g8:
;*** 234	-----------------------    *(&GpioDataRegs+3L) |= 0x80u;
	.dwpsn	"VFD.c",234,6
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0080 ; |234| 
DW$L$_VfdDataLoad$8$E:
L9:    
DW$L$_VfdDataLoad$9$B:
;***	-----------------------g9:
;*** 240	-----------------------    K$2 = &GpioDataRegs+3L;
;*** 240	-----------------------    *(volatile unsigned *)K$2 |= 0x200u;
;*** 229	-----------------------    --x;
;*** 229	-----------------------    if ( (--L$4) != (-1) ) goto g6;
	.dwpsn	"VFD.c",240,5
        MOVL      XAR3,#_GpioDataRegs+3 ; |240| 
        OR        *+XAR3[0],#0x0200     ; |240| 
	.dwpsn	"VFD.c",229,23
        ADDB      AL,#-1
	.dwpsn	"VFD.c",229,15
        BANZ      L7,AR6--              ; |229| 
...
;*** 246	-----------------------    *(volatile unsigned *)K$2 |= 0x100u;
;*** 247	-----------------------    ((volatile unsigned *)K$2)[2] |= 0x200u;
;*** 247	-----------------------    return;
	.dwpsn	"VFD.c",246,2
        OR        *+XAR3[0],#0x0100     ; |246| 
	.dwpsn	"VFD.c",247,2
        OR        *+XAR3[2],#0x0200     ; |247| 
	.dwpsn	"VFD.c",249,1
	.dwcfa	0x1d, -6
        MOVL      XAR3,*--SP
	.dwcfa	0x1d, -4
...
DW$35	.dwtag  DW_TAG_loop
	.dwattr DW$35, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\VFD.asm:L4:1:1691571614")
	.dwattr DW$35, DW_AT_begin_file("VFD.c")
	.dwattr DW$35, DW_AT_begin_line(0xde)
	.dwattr DW$35, DW_AT_end_line(0xf5)
...
DW$38	.dwtag  DW_TAG_loop
	.dwattr DW$38, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\VFD.asm:L5:2:1691571614")
	.dwattr DW$38, DW_AT_begin_file("VFD.c")
	.dwattr DW$38, DW_AT_begin_line(0xe0)
	.dwattr DW$38, DW_AT_end_line(0xf3)
...
DW$42	.dwtag  DW_TAG_loop
	.dwattr DW$42, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\VFD.asm:L6:3:1691571614")
	.dwattr DW$42, DW_AT_begin_file("VFD.c")
	.dwattr DW$42, DW_AT_begin_line(0xe2)
	.dwattr DW$42, DW_AT_end_line(0xe3)
...
DW$44	.dwtag  DW_TAG_loop
	.dwattr DW$44, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\VFD.asm:L7:3:1691571614")
	.dwattr DW$44, DW_AT_begin_file("VFD.c")
	.dwattr DW$44, DW_AT_begin_line(0xe5)
	.dwattr DW$44, DW_AT_end_line(0xf1)
...
DW$48	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$20, DW_AT_end_line(0xf9)
...
DW$49	.dwtag  DW_TAG_subprogram, DW_AT_name("VFDPrintf"), DW_AT_symbol_name("_VFDPrintf")
	...
	.dwattr DW$49, DW_AT_begin_line(0xfb)
...
DW$53	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwattr DW$49, DW_AT_end_line(0x103)
