...
;*** 374	-----------------------    (*LINE).Decel_IQ14 = 1507328000L-__IQmpy(_IQ17div(760217600L, 588513280L), turn_vel, 17)>>3;
...
;*** 280	-----------------------    (*LINE).Decel_IQ14 = 1507328000L-__IQmpy(_IQ17div(760217600L, 588513280L), turn_vel, 17)>>3;
...
;***  	-----------------------    if ( !(*((unsigned long * const)LINE+40L)&0x10uL && *((unsigned long * const)LINE+72L)&0x10uL && (*((unsigned long * const)LINE+40L)&0x300uL && *((unsigned long * const)LINE+72L)&0x300uL)) ) goto g27;
        ...
        BF        L45,EQ
        ; branchcc occurs
;*** 251	-----------------------    if ( (float)(*LINE).Distance_U32 < 250.0F ) goto g23;
...
;*** 154	-----------------------    (*LINE).Decel_IQ14 = 1507328000L-__IQmpy(_IQ17div(760217600L, 588513280L), (*LINE).Velo_IQ17, 17)>>3;
;*** 154	-----------------------    goto g8;
...
DW$156	.dwtag  DW_TAG_loop
	.dwattr DW$156, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_17\main\extremerun.asm:L50:1:1659895905")
...
;*** 68	-----------------------    if ( !(*((volatile unsigned *)S$1+30)&2u) ) goto g5;
	.dwpsn	"extremerun.c",68,8
        ...
        BF        L57,NTC               ; |68| 
        ; branchcc occurs ; |68| 
;*** 70	-----------------------    if ( XRUN_DIST_IQ15 > ((*(((long)cnt<<5)+K$9)).Distance_U32<<15)-8192000L ) goto g6;
...
;*** 95	-----------------------    if ( dist+8192000L >= XRUN_DIST_IQ15 ) goto g9;
