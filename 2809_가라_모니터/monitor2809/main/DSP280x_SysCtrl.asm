...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_모니터\monitor2809\main\DSP280x_SysCtrl.asm:L3:1:1692384813")
...
;*** 244	-----------------------    *((volatile struct _PCLKCR0_BITS *)C$1+12L) |= 0x400u;
;*** 266	-----------------------    asm(" EDIS");
;*** 266	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
...
DW$12	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
 ...
 EALLOW
	...
	.dwpsn	"DSP280x_SysCtrl.c",244,2
        ...
        ADDL      ACC,XAR4
        MOVL      XAR4,ACC              ; |244| 
        OR        *+XAR4[0],#0x0400     ; |244| 
	.dwpsn	"DSP280x_SysCtrl.c",266,5
 EDIS
	.dwpsn	"DSP280x_SysCtrl.c",267,1
        SPM       #0
        LRETR
        ; return occurs
	.dwattr DW$11, DW_AT_end_file("DSP280x_SysCtrl.c")
	.dwattr DW$11, DW_AT_end_line(0x10b)
