...
;	C:\Users\노호진\Desktop\MAZE\2809moniter\Compiler\bin\opt2000.exe C:\Users\노호진\AppData\Local\Temp\TI67210 C:\Users\노호진\AppData\Local\Temp\TI6724 
...
DW$6	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIx_TxChar"), DW_AT_symbol_name("_SCIx_TxChar")
	...
	.dwattr DW$6, DW_AT_begin_line(0x4a)
	.dwattr DW$6, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_Sci.c",75,1
...
;***	-----------------------g2:
;*** 78	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g2;
	.dwpsn	"DSP280x_Sci.c",78,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |78| 
        BF        L1,NTC                ; |78| 
        ; branchcc occurs ; |78| 
DW$L$_SCIx_TxChar$2$E:
;*** 79	-----------------------    SciaRegs.SCITXBUF = Data;
;*** 79	-----------------------    return;
	.dwpsn	"DSP280x_Sci.c",79,5
        MOV       @_SciaRegs+9,AL       ; |79| 
	.dwpsn	"DSP280x_Sci.c",80,1
        LRETR
        ; return occurs

DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_모니터\monitor2809\main\DSP280x_Sci.asm:L1:1:1692384812")
	.dwattr DW$9, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$9, DW_AT_begin_line(0x4e)
	.dwattr DW$9, DW_AT_end_line(0x4e)
DW$10	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$6, DW_AT_end_line(0x50)
...
DW$11	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIx_TxString"), DW_AT_symbol_name("_SCIx_TxString")
	...
	.dwattr DW$11, DW_AT_begin_line(0x52)
...
;***	-----------------------g3:
;*** 86	-----------------------    if ( U$1 != 10 ) goto g7;
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	.dwpsn	"DSP280x_Sci.c",86,9
        CMPB      AL,#10                ; |86| 
        BF        L4,NEQ                ; |86| 
        ; branchcc occurs ; |86| 
...
;***	-----------------------g5:
;*** 78	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g5;  // [3]
	.dwpsn	"DSP280x_Sci.c",78,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |78| 
        BF        L3,NTC                ; |78| 
...
;*** 79	-----------------------    SciaRegs.SCITXBUF = 13u;  // [3]
	.dwpsn	"DSP280x_Sci.c",79,5
        MOV       @_SciaRegs+9,#13      ; |79| 
...
;*** 90	-----------------------    Data = U$1;
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	.dwpsn	"DSP280x_Sci.c",90,9
DW$L$_SCIx_TxString$5$E:
L5:    
DW$L$_SCIx_TxString$6$B:
;***	-----------------------g8:
;*** 78	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g8;  // [3]
	.dwpsn	"DSP280x_Sci.c",78,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |78| 
        BF        L5,NTC                ; |78| 
...
;*** 79	-----------------------    SciaRegs.SCITXBUF = Data;  // [3]
;*** 79	-----------------------    if ( U$1 = *(++Str) ) goto g3;  // [3]
;***	-----------------------g10:
;***  	-----------------------    return;
	.dwpsn	"DSP280x_Sci.c",79,5
        MOV       @_SciaRegs+9,AL       ; |79| 
...
L6:    
	.dwpsn	"DSP280x_Sci.c",92,1
        LRETR
        ; return occurs

DW$16	.dwtag  DW_TAG_loop
	.dwattr DW$16, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_모니터\monitor2809\main\DSP280x_Sci.asm:L2:1:1692384812")
	.dwattr DW$16, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$16, DW_AT_begin_line(0x4f)
	.dwattr DW$16, DW_AT_end_line(0x5b)
...
DW$21	.dwtag  DW_TAG_loop
	.dwattr DW$21, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_모니터\monitor2809\main\DSP280x_Sci.asm:L3:2:1692384812")
	.dwattr DW$21, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$21, DW_AT_begin_line(0x4e)
...
DW$23	.dwtag  DW_TAG_loop
	.dwattr DW$23, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_모니터\monitor2809\main\DSP280x_Sci.asm:L5:2:1692384812")
	.dwattr DW$23, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$23, DW_AT_begin_line(0x4e)
	.dwattr DW$23, DW_AT_end_line(0x5a)
DW$24	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$11, DW_AT_end_line(0x5c)
...
DW$25	.dwtag  DW_TAG_subprogram, DW_AT_name("TxPrintf"), DW_AT_symbol_name("_TxPrintf")
	...
	.dwattr DW$25, DW_AT_begin_line(0x5d)
	.dwattr DW$25, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_Sci.c",94,1
...
_TxPrintf:
;*** 98	-----------------------    C$1 = &Buff[0];
;*** 98	-----------------------    vsprintf(C$1, (char *)Form, (char *)(&Form));
;*** 100	-----------------------    SCIx_TxString(C$1);
;*** 100	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$29	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwpsn	"DSP280x_Sci.c",98,5
        MOVZ      AR4,SP                ; |98| 
        SUBB      XAR4,#8               ; |98| 
        MOVL      *-SP[2],XAR4          ; |98| 
        MOVL      XAR5,*-SP[8]          ; |98| 
        MOVL      XAR3,#_Buff$1$0       ; |98| 
        MOVL      XAR4,XAR3             ; |98| 
        LCR       #_vsprintf            ; |98| 
        ; call occurs [#_vsprintf] ; |98| 
	.dwpsn	"DSP280x_Sci.c",100,5
        MOVL      XAR4,XAR3             ; |100| 
        LCR       #_SCIx_TxString       ; |100| 
        ; call occurs [#_SCIx_TxString] ; |100| 
	.dwpsn	"DSP280x_Sci.c",101,1
        SUBB      SP,#2
	.dwcfa	0x1d, -4
        MOVL      XAR3,*--SP
	.dwcfa	0x1d, -2
	...
	.dwattr DW$25, DW_AT_end_line(0x65)
...
DW$30	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIx_RxChar"), DW_AT_symbol_name("_SCIx_RxChar")
	...
	.dwattr DW$30, DW_AT_begin_line(0x41)
	.dwattr DW$30, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_Sci.c",66,1
...
;***	-----------------------g2:
;*** 69	-----------------------    if ( !(*((volatile struct _SCIRXST_BITS *)&SciaRegs+5L)&0x40u) ) goto g2;
	.dwpsn	"DSP280x_Sci.c",69,12
        MOVW      DP,#_SciaRegs+5
        TBIT      @_SciaRegs+5,#6       ; |69| 
        BF        L7,NTC                ; |69| 
        ; branchcc occurs ; |69| 
DW$L$_SCIx_RxChar$2$E:
;*** 71	-----------------------    return (int)SciaRegs.SCIRXBUF.all;
	.dwpsn	"DSP280x_Sci.c",71,5
        MOV       AL,@_SciaRegs+7       ; |71| 
	.dwpsn	"DSP280x_Sci.c",72,1
        LRETR
        ; return occurs

DW$31	.dwtag  DW_TAG_loop
	.dwattr DW$31, DW_AT_name("C:\Users\노호진\Desktop\2809_STEPTRACER\2809_가라_모니터\monitor2809\main\DSP280x_Sci.asm:L7:1:1692384812")
	.dwattr DW$31, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$31, DW_AT_begin_line(0x45)
	.dwattr DW$31, DW_AT_end_line(0x45)
DW$32	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$30, DW_AT_end_line(0x48)
...
;*** 61	-----------------------    *((volatile struct _SCICTL1_BITS *)C$1+1L) |= 0x20u;
;*** 61	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$34	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwpsn	"DSP280x_Sci.c",61,2
        OR        *+XAR4[1],#0x0020     ; |61| 
	.dwpsn	"DSP280x_Sci.c",63,1
        LRETR
        ; return occurs
