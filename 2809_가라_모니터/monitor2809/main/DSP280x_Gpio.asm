...
_InitGpio:
;*** 27	-----------------------    asm(" EALLOW");
;*** 66	-----------------------    GpioCtrlRegs.GPAMUX1.all = 0uL;
;*** 106	-----------------------    GpioCtrlRegs.GPAMUX2.all = 0x5000015uL;
;*** 117	-----------------------    GpioCtrlRegs.GPBMUX1.all = 0uL;
;*** 160	-----------------------    GpioCtrlRegs.GPADIR.all = 0x2ffd3fffuL;
