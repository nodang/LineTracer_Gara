...
;*** 76	-----------------------    return;
	...
	.dwpsn	"DSP280x_PieCtrl.c",76,5
 clrc INTM
	.dwpsn	"DSP280x_PieCtrl.c",78,1
        SPM       #0
        LRETR
        ; return occurs
	.dwattr DW$3, DW_AT_end_file("DSP280x_PieCtrl.c")
	.dwattr DW$3, DW_AT_end_line(0x4e)
