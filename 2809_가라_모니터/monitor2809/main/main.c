...
#define MOTOR	(GpioDataRegs.GPADAT.all & 0x000000ff)	
#define SEN		(GpioDataRegs.GPADAT.all & 0x00701f00)
...
void main(void)
{
	...
	GpioDataRegs.GPACLEAR.all = MOTOR;
	GpioDataRegs.GPACLEAR.all = SEN;
